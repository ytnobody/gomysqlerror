...
var ErrorMap = map[int]definition.ErrorDefinition{
    1000: definition.ErrorDefinition{ErrorNumber:1000, ErrorType:"ServerError", Symbol:"ER_HASHCHK", SQLState:"HY000", Message:"hashchk", Description:"Unused. ", MySQLVersion:"5.6"},
    1001: definition.ErrorDefinition{ErrorNumber:1001, ErrorType:"ServerError", Symbol:"ER_NISAMCHK", SQLState:"HY000", Message:"isamchk", Description:"Unused. ", MySQLVersion:"5.6"},
    1002: definition.ErrorDefinition{ErrorNumber:1002, ErrorType:"ServerError", Symbol:"ER_NO", SQLState:"HY000", Message:"NO", Description:"Used in the construction of other messages. ", MySQLVersion:"5.6"},
    1003: definition.ErrorDefinition{ErrorNumber:1003, ErrorType:"ServerError", Symbol:"ER_YES", SQLState:"HY000", Message:"YES", Description:"Extended EXPLAIN format generates Note messages. ER_YES is used in the Code column for these messages in subsequent SHOW WARNINGS output. ", MySQLVersion:"5.6"},
    1004: definition.ErrorDefinition{ErrorNumber:1004, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_FILE", SQLState:"HY000", Message:"Can't create file '%s' (errno: %d - %s)", Description:"destination file already exists but is not writeable. ", MySQLVersion:"5.6"},
    1005: definition.ErrorDefinition{ErrorNumber:1005, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_TABLE", SQLState:"HY000", Message:"Can't create table '%s' (errno: %d)", Description:"InnoDB reports this error when a table cannot be created. If the error message refers to error 150, table creation failed because a foreign key constraint was not correctly formed. If the error message refers to error −1, table creation probably failed because the table includes a column name that matched the name of an internal InnoDB table. ", MySQLVersion:"5.6"},
    1006: definition.ErrorDefinition{ErrorNumber:1006, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_DB", SQLState:"HY000", Message:"Can't create database '%s' (errno: %d) ", Description:"", MySQLVersion:"5.6"},
    ...
    1008: definition.ErrorDefinition{ErrorNumber:1008, ErrorType:"ServerError", Symbol:"ER_DB_DROP_EXISTS", SQLState:"HY000", Message:"Can't drop database '%s'", Description:"database doesn't exist ", MySQLVersion:"5.6"},
    1009: definition.ErrorDefinition{ErrorNumber:1009, ErrorType:"ServerError", Symbol:"ER_DB_DROP_DELETE", SQLState:"HY000", Message:"Error dropping database (can't delete '%s', errno: %d) ", Description:"", MySQLVersion:"5.6"},
    1010: definition.ErrorDefinition{ErrorNumber:1010, ErrorType:"ServerError", Symbol:"ER_DB_DROP_RMDIR", SQLState:"HY000", Message:"Error dropping database (can't rmdir '%s', errno: %d) ", Description:"", MySQLVersion:"5.6"},
    1011: definition.ErrorDefinition{ErrorNumber:1011, ErrorType:"ServerError", Symbol:"ER_CANT_DELETE_FILE", SQLState:"HY000", Message:"Error on delete of '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1012: definition.ErrorDefinition{ErrorNumber:1012, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_SYSTEM_REC", SQLState:"HY000", Message:"Can't read record in system table", Description:"Returned by InnoDB for attempts to access InnoDB INFORMATION_SCHEMA tables when InnoDB is unavailable. ", MySQLVersion:"5.6"},
    1013: definition.ErrorDefinition{ErrorNumber:1013, ErrorType:"ServerError", Symbol:"ER_CANT_GET_STAT", SQLState:"HY000", Message:"Can't get status of '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1014: definition.ErrorDefinition{ErrorNumber:1014, ErrorType:"ServerError", Symbol:"ER_CANT_GET_WD", SQLState:"HY000", Message:"Can't get working directory (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1015: definition.ErrorDefinition{ErrorNumber:1015, ErrorType:"ServerError", Symbol:"ER_CANT_LOCK", SQLState:"HY000", Message:"Can't lock file (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1016: definition.ErrorDefinition{ErrorNumber:1016, ErrorType:"ServerError", Symbol:"ER_CANT_OPEN_FILE", SQLState:"HY000", Message:"Can't open file: '%s' (errno: %d - %s)", Description:"InnoDB reports this error when the table from the InnoDB data files cannot be found, even though the .frm file for the table exists. See Section\u00a014.21.3, “Troubleshooting InnoDB Data Dictionary Operations”. ", MySQLVersion:"5.6"},
    1017: definition.ErrorDefinition{ErrorNumber:1017, ErrorType:"ServerError", Symbol:"ER_FILE_NOT_FOUND", SQLState:"HY000", Message:"Can't find file: '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1018: definition.ErrorDefinition{ErrorNumber:1018, ErrorType:"ServerError", Symbol:"ER_CANT_READ_DIR", SQLState:"HY000", Message:"Can't read dir of '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1019: definition.ErrorDefinition{ErrorNumber:1019, ErrorType:"ServerError", Symbol:"ER_CANT_SET_WD", SQLState:"HY000", Message:"Can't change dir to '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1020: definition.ErrorDefinition{ErrorNumber:1020, ErrorType:"ServerError", Symbol:"ER_CHECKREAD", SQLState:"HY000", Message:"Record has changed since last read in table '%s' ", Description:"", MySQLVersion:"5.6"},
    1021: definition.ErrorDefinition{ErrorNumber:1021, ErrorType:"ServerError", Symbol:"ER_DISK_FULL", SQLState:"HY000", Message:"Disk full (%s)", Description:"waiting for someone to free some space... (errno: %d - %s) ", MySQLVersion:"5.6"},
    1022: definition.ErrorDefinition{ErrorNumber:1022, ErrorType:"ServerError", Symbol:"ER_DUP_KEY", SQLState:"23000", Message:"Can't write", Description:"duplicate key in table '%s' ", MySQLVersion:"5.6"},
    1023: definition.ErrorDefinition{ErrorNumber:1023, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_CLOSE", SQLState:"HY000", Message:"Error on close of '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1024: definition.ErrorDefinition{ErrorNumber:1024, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_READ", SQLState:"HY000", Message:"Error reading file '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1025: definition.ErrorDefinition{ErrorNumber:1025, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_RENAME", SQLState:"HY000", Message:"Error on rename of '%s' to '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1026: definition.ErrorDefinition{ErrorNumber:1026, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_WRITE", SQLState:"HY000", Message:"Error writing file '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1027: definition.ErrorDefinition{ErrorNumber:1027, ErrorType:"ServerError", Symbol:"ER_FILE_USED", SQLState:"HY000", Message:"'%s' is locked against change ", Description:"", MySQLVersion:"5.6"},
    1028: definition.ErrorDefinition{ErrorNumber:1028, ErrorType:"ServerError", Symbol:"ER_FILSORT_ABORT", SQLState:"HY000", Message:"Sort aborted ", Description:"", MySQLVersion:"5.6"},
    1029: definition.ErrorDefinition{ErrorNumber:1029, ErrorType:"ServerError", Symbol:"ER_FORM_NOT_FOUND", SQLState:"HY000", Message:"View '%s' doesn't exist for '%s' ", Description:"", MySQLVersion:"5.6"},
    1030: definition.ErrorDefinition{ErrorNumber:1030, ErrorType:"ServerError", Symbol:"ER_GET_ERRNO", SQLState:"HY000", Message:"Got error %d from storage engine", Description:"Check the %d value to see what the OS error means. For example, 28 indicates that you have run out of disk space. ", MySQLVersion:"5.6"},
    1031: definition.ErrorDefinition{ErrorNumber:1031, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_HA", SQLState:"HY000", Message:"Table storage engine for '%s' doesn't have this option ", Description:"", MySQLVersion:"5.6"},
    1032: definition.ErrorDefinition{ErrorNumber:1032, ErrorType:"ServerError", Symbol:"ER_KEY_NOT_FOUND", SQLState:"HY000", Message:"Can't find record in '%s' ", Description:"", MySQLVersion:"5.6"},
    1033: definition.ErrorDefinition{ErrorNumber:1033, ErrorType:"ServerError", Symbol:"ER_NOT_FORM_FILE", SQLState:"HY000", Message:"Incorrect information in file: '%s' ", Description:"", MySQLVersion:"5.6"},
    1034: definition.ErrorDefinition{ErrorNumber:1034, ErrorType:"ServerError", Symbol:"ER_NOT_KEYFILE", SQLState:"HY000", Message:"Incorrect key file for table '%s'", Description:"try to repair it ", MySQLVersion:"5.6"},
    1035: definition.ErrorDefinition{ErrorNumber:1035, ErrorType:"ServerError", Symbol:"ER_OLD_KEYFILE", SQLState:"HY000", Message:"Old key file for table '%s'", Description:"repair it! ", MySQLVersion:"5.6"},
    1036: definition.ErrorDefinition{ErrorNumber:1036, ErrorType:"ServerError", Symbol:"ER_OPEN_AS_READONLY", SQLState:"HY000", Message:"Table '%s' is read only ", Description:"", MySQLVersion:"5.6"},
    1037: definition.ErrorDefinition{ErrorNumber:1037, ErrorType:"ServerError", Symbol:"ER_OUTOFMEMORY", SQLState:"HY001", Message:"Out of memory", Description:"restart server and try again (needed %d bytes) ", MySQLVersion:"5.6"},
    1038: definition.ErrorDefinition{ErrorNumber:1038, ErrorType:"ServerError", Symbol:"ER_OUT_OF_SORTMEMORY", SQLState:"HY001", Message:"Out of sort memory, consider increasing server sort buffer size ", Description:"", MySQLVersion:"5.6"},
    1039: definition.ErrorDefinition{ErrorNumber:1039, ErrorType:"ServerError", Symbol:"ER_UNEXPECTED_EOF", SQLState:"HY000", Message:"Unexpected EOF found when reading file '%s' (errno: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    1040: definition.ErrorDefinition{ErrorNumber:1040, ErrorType:"ServerError", Symbol:"ER_CON_COUNT_ERROR", SQLState:"08004", Message:"Too many connections ", Description:"", MySQLVersion:"5.6"},
    1041: definition.ErrorDefinition{ErrorNumber:1041, ErrorType:"ServerError", Symbol:"ER_OUT_OF_RESOURCES", SQLState:"HY000", Message:"Out of memory", Description:"if not, you may have to use 'ulimit' to allow mysqld to use more memory or you can add more swap space ", MySQLVersion:"5.6"},
    1042: definition.ErrorDefinition{ErrorNumber:1042, ErrorType:"ServerError", Symbol:"ER_BAD_HOST_ERROR", SQLState:"08S01", Message:"Can't get hostname for your address ", Description:"", MySQLVersion:"5.6"},
    1043: definition.ErrorDefinition{ErrorNumber:1043, ErrorType:"ServerError", Symbol:"ER_HANDSHAKE_ERROR", SQLState:"08S01", Message:"Bad handshake ", Description:"", MySQLVersion:"5.6"},
    1044: definition.ErrorDefinition{ErrorNumber:1044, ErrorType:"ServerError", Symbol:"ER_DBACCESS_DENIED_ERROR", SQLState:"42000", Message:"Access denied for user '%s'@'%s' to database '%s' ", Description:"", MySQLVersion:"5.6"},
    1045: definition.ErrorDefinition{ErrorNumber:1045, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_ERROR", SQLState:"28000", Message:"Access denied for user '%s'@'%s' (using password: %s) ", Description:"", MySQLVersion:"5.6"},
    1046: definition.ErrorDefinition{ErrorNumber:1046, ErrorType:"ServerError", Symbol:"ER_NO_DB_ERROR", SQLState:"3D000", Message:"No database selected ", Description:"", MySQLVersion:"5.6"},
    1047: definition.ErrorDefinition{ErrorNumber:1047, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_COM_ERROR", SQLState:"08S01", Message:"Unknown command ", Description:"", MySQLVersion:"5.6"},
    1048: definition.ErrorDefinition{ErrorNumber:1048, ErrorType:"ServerError", Symbol:"ER_BAD_NULL_ERROR", SQLState:"23000", Message:"Column '%s' cannot be null ", Description:"", MySQLVersion:"5.6"},
    1049: definition.ErrorDefinition{ErrorNumber:1049, ErrorType:"ServerError", Symbol:"ER_BAD_DB_ERROR", SQLState:"42000", Message:"Unknown database '%s' ", Description:"", MySQLVersion:"5.6"},
    1050: definition.ErrorDefinition{ErrorNumber:1050, ErrorType:"ServerError", Symbol:"ER_TABLE_EXISTS_ERROR", SQLState:"42S01", Message:"Table '%s' already exists ", Description:"", MySQLVersion:"5.6"},
    1051: definition.ErrorDefinition{ErrorNumber:1051, ErrorType:"ServerError", Symbol:"ER_BAD_TABLE_ERROR", SQLState:"42S02", Message:"Unknown table '%s' ", Description:"", MySQLVersion:"5.6"},
    ...
    1053: definition.ErrorDefinition{ErrorNumber:1053, ErrorType:"ServerError", Symbol:"ER_SERVER_SHUTDOWN", SQLState:"08S01", Message:"Server shutdown in progress ", Description:"", MySQLVersion:"5.6"},
    1054: definition.ErrorDefinition{ErrorNumber:1054, ErrorType:"ServerError", Symbol:"ER_BAD_FIELD_ERROR", SQLState:"42S22", Message:"Unknown column '%s' in '%s' ", Description:"", MySQLVersion:"5.6"},
    1055: definition.ErrorDefinition{ErrorNumber:1055, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_WITH_GROUP", SQLState:"42000", Message:"'%s' isn't in GROUP BY ", Description:"", MySQLVersion:"5.6"},
    1056: definition.ErrorDefinition{ErrorNumber:1056, ErrorType:"ServerError", Symbol:"ER_WRONG_GROUP_FIELD", SQLState:"42000", Message:"Can't group on '%s' ", Description:"", MySQLVersion:"5.6"},
    1057: definition.ErrorDefinition{ErrorNumber:1057, ErrorType:"ServerError", Symbol:"ER_WRONG_SUM_SELECT", SQLState:"42000", Message:"Statement has sum functions and columns in same statement ", Description:"", MySQLVersion:"5.6"},
    1058: definition.ErrorDefinition{ErrorNumber:1058, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_COUNT", SQLState:"21S01", Message:"Column count doesn't match value count ", Description:"", MySQLVersion:"5.6"},
    1059: definition.ErrorDefinition{ErrorNumber:1059, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_IDENT", SQLState:"42000", Message:"Identifier name '%s' is too long ", Description:"", MySQLVersion:"5.6"},
    1060: definition.ErrorDefinition{ErrorNumber:1060, ErrorType:"ServerError", Symbol:"ER_DUP_FIELDNAME", SQLState:"42S21", Message:"Duplicate column name '%s' ", Description:"", MySQLVersion:"5.6"},
    1061: definition.ErrorDefinition{ErrorNumber:1061, ErrorType:"ServerError", Symbol:"ER_DUP_KEYNAME", SQLState:"42000", Message:"Duplicate key name '%s' ", Description:"", MySQLVersion:"5.6"},
    1062: definition.ErrorDefinition{ErrorNumber:1062, ErrorType:"ServerError", Symbol:"ER_DUP_ENTRY", SQLState:"23000", Message:"Duplicate entry '%s' for key %d", Description:"The message returned with this error uses the format string for ER_DUP_ENTRY_WITH_KEY_NAME. ", MySQLVersion:"5.6"},
    1063: definition.ErrorDefinition{ErrorNumber:1063, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_SPEC", SQLState:"42000", Message:"Incorrect column specifier for column '%s' ", Description:"", MySQLVersion:"5.6"},
    1064: definition.ErrorDefinition{ErrorNumber:1064, ErrorType:"ServerError", Symbol:"ER_PARSE_ERROR", SQLState:"42000", Message:"%s near '%s' at line %d ", Description:"", MySQLVersion:"5.6"},
    1065: definition.ErrorDefinition{ErrorNumber:1065, ErrorType:"ServerError", Symbol:"ER_EMPTY_QUERY", SQLState:"42000", Message:"Query was empty ", Description:"", MySQLVersion:"5.6"},
    1066: definition.ErrorDefinition{ErrorNumber:1066, ErrorType:"ServerError", Symbol:"ER_NONUNIQ_TABLE", SQLState:"42000", Message:"Not unique table/alias: '%s' ", Description:"", MySQLVersion:"5.6"},
    1067: definition.ErrorDefinition{ErrorNumber:1067, ErrorType:"ServerError", Symbol:"ER_INVALID_DEFAULT", SQLState:"42000", Message:"Invalid default value for '%s' ", Description:"", MySQLVersion:"5.6"},
    1068: definition.ErrorDefinition{ErrorNumber:1068, ErrorType:"ServerError", Symbol:"ER_MULTIPLE_PRI_KEY", SQLState:"42000", Message:"Multiple primary key defined ", Description:"", MySQLVersion:"5.6"},
    1069: definition.ErrorDefinition{ErrorNumber:1069, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_KEYS", SQLState:"42000", Message:"Too many keys specified", Description:"max %d keys allowed ", MySQLVersion:"5.6"},
    1070: definition.ErrorDefinition{ErrorNumber:1070, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_KEY_PARTS", SQLState:"42000", Message:"Too many key parts specified", Description:"max %d parts allowed ", MySQLVersion:"5.6"},
    1071: definition.ErrorDefinition{ErrorNumber:1071, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_KEY", SQLState:"42000", Message:"Specified key was too long", Description:"max key length is %d bytes ", MySQLVersion:"5.6"},
    1072: definition.ErrorDefinition{ErrorNumber:1072, ErrorType:"ServerError", Symbol:"ER_KEY_COLUMN_DOES_NOT_EXITS", SQLState:"42000", Message:"Key column '%s' doesn't exist in table ", Description:"", MySQLVersion:"5.6"},
    1073: definition.ErrorDefinition{ErrorNumber:1073, ErrorType:"ServerError", Symbol:"ER_BLOB_USED_AS_KEY", SQLState:"42000", Message:"BLOB column '%s' can't be used in key specification with the used table type ", Description:"", MySQLVersion:"5.6"},
    1074: definition.ErrorDefinition{ErrorNumber:1074, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_FIELDLENGTH", SQLState:"42000", Message:"Column length too big for column '%s' (max = %lu)", Description:"use BLOB or TEXT instead ", MySQLVersion:"5.6"},
    1075: definition.ErrorDefinition{ErrorNumber:1075, ErrorType:"ServerError", Symbol:"ER_WRONG_AUTO_KEY", SQLState:"42000", Message:"Incorrect table definition", Description:"there can be only one auto column and it must be defined as a key ", MySQLVersion:"5.6"},
    1076: definition.ErrorDefinition{ErrorNumber:1076, ErrorType:"ServerError", Symbol:"ER_READY", SQLState:"HY000", Message:"%s: ready for connections. Version: '%s' socket: '%s' port: %d ", Description:"", MySQLVersion:"5.6"},
    1077: definition.ErrorDefinition{ErrorNumber:1077, ErrorType:"ServerError", Symbol:"ER_NORMAL_SHUTDOWN", SQLState:"HY000", Message:"%s: Normal shutdown ", Description:"", MySQLVersion:"5.6"},
    1078: definition.ErrorDefinition{ErrorNumber:1078, ErrorType:"ServerError", Symbol:"ER_GOT_SIGNAL", SQLState:"HY000", Message:"%s: Got signal %d. Aborting! ", Description:"", MySQLVersion:"5.6"},
    1079: definition.ErrorDefinition{ErrorNumber:1079, ErrorType:"ServerError", Symbol:"ER_SHUTDOWN_COMPLETE", SQLState:"HY000", Message:"%s: Shutdown complete ", Description:"", MySQLVersion:"5.6"},
    1080: definition.ErrorDefinition{ErrorNumber:1080, ErrorType:"ServerError", Symbol:"ER_FORCING_CLOSE", SQLState:"08S01", Message:"%s: Forcing close of thread %ld user: '%s' ", Description:"", MySQLVersion:"5.6"},
    1081: definition.ErrorDefinition{ErrorNumber:1081, ErrorType:"ServerError", Symbol:"ER_IPSOCK_ERROR", SQLState:"08S01", Message:"Can't create IP socket ", Description:"", MySQLVersion:"5.6"},
    1082: definition.ErrorDefinition{ErrorNumber:1082, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_INDEX", SQLState:"42S12", Message:"Table '%s' has no index like the one used in CREATE INDEX", Description:"recreate the table ", MySQLVersion:"5.6"},
    1083: definition.ErrorDefinition{ErrorNumber:1083, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_TERMINATORS", SQLState:"42000", Message:"Field separator argument is not what is expected", Description:"check the manual ", MySQLVersion:"5.6"},
    1084: definition.ErrorDefinition{ErrorNumber:1084, ErrorType:"ServerError", Symbol:"ER_BLOBS_AND_NO_TERMINATED", SQLState:"42000", Message:"You can't use fixed rowlength with BLOBs", Description:"please use 'fields terminated by' ", MySQLVersion:"5.6"},
    1085: definition.ErrorDefinition{ErrorNumber:1085, ErrorType:"ServerError", Symbol:"ER_TEXTFILE_NOT_READABLE", SQLState:"HY000", Message:"The file '%s' must be in the database directory or be readable by all ", Description:"", MySQLVersion:"5.6"},
    1086: definition.ErrorDefinition{ErrorNumber:1086, ErrorType:"ServerError", Symbol:"ER_FILE_EXISTS_ERROR", SQLState:"HY000", Message:"File '%s' already exists ", Description:"", MySQLVersion:"5.6"},
    1087: definition.ErrorDefinition{ErrorNumber:1087, ErrorType:"ServerError", Symbol:"ER_LOAD_INFO", SQLState:"HY000", Message:"Records: %ld Deleted: %ld Skipped: %ld Warnings: %ld ", Description:"", MySQLVersion:"5.6"},
    1088: definition.ErrorDefinition{ErrorNumber:1088, ErrorType:"ServerError", Symbol:"ER_ALTER_INFO", SQLState:"HY000", Message:"Records: %ld Duplicates: %ld ", Description:"", MySQLVersion:"5.6"},
    1089: definition.ErrorDefinition{ErrorNumber:1089, ErrorType:"ServerError", Symbol:"ER_WRONG_SUB_KEY", SQLState:"HY000", Message:"Incorrect prefix key", Description:"the used key part isn't a string, the used length is longer than the key part, or the storage engine doesn't support unique prefix keys ", MySQLVersion:"5.6"},
    1090: definition.ErrorDefinition{ErrorNumber:1090, ErrorType:"ServerError", Symbol:"ER_CANT_REMOVE_ALL_FIELDS", SQLState:"42000", Message:"You can't delete all columns with ALTER TABLE", Description:"use DROP TABLE instead ", MySQLVersion:"5.6"},
    1091: definition.ErrorDefinition{ErrorNumber:1091, ErrorType:"ServerError", Symbol:"ER_CANT_DROP_FIELD_OR_KEY", SQLState:"42000", Message:"Can't DROP '%s'", Description:"check that column/key exists ", MySQLVersion:"5.6"},
    1092: definition.ErrorDefinition{ErrorNumber:1092, ErrorType:"ServerError", Symbol:"ER_INSERT_INFO", SQLState:"HY000", Message:"Records: %ld Duplicates: %ld Warnings: %ld ", Description:"", MySQLVersion:"5.6"},
    1093: definition.ErrorDefinition{ErrorNumber:1093, ErrorType:"ServerError", Symbol:"ER_UPDATE_TABLE_USED", SQLState:"HY000", Message:"You can't specify target table '%s' for update in FROM clause", Description:"This error occurs for attempts to select from and modify the same table within a single statement. See Section\u00a013.2.10.12, “Restrictions on Subqueries”. ", MySQLVersion:"5.6"},
    1094: definition.ErrorDefinition{ErrorNumber:1094, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_THREAD", SQLState:"HY000", Message:"Unknown thread id: %lu ", Description:"", MySQLVersion:"5.6"},
    1095: definition.ErrorDefinition{ErrorNumber:1095, ErrorType:"ServerError", Symbol:"ER_KILL_DENIED_ERROR", SQLState:"HY000", Message:"You are not owner of thread %lu ", Description:"", MySQLVersion:"5.6"},
    1096: definition.ErrorDefinition{ErrorNumber:1096, ErrorType:"ServerError", Symbol:"ER_NO_TABLES_USED", SQLState:"HY000", Message:"No tables used ", Description:"", MySQLVersion:"5.6"},
    1097: definition.ErrorDefinition{ErrorNumber:1097, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SET", SQLState:"HY000", Message:"Too many strings for column %s and SET ", Description:"", MySQLVersion:"5.6"},
    1098: definition.ErrorDefinition{ErrorNumber:1098, ErrorType:"ServerError", Symbol:"ER_NO_UNIQUE_LOGFILE", SQLState:"HY000", Message:"Can't generate a unique log-filename %s.(1-999) ", Description:"", MySQLVersion:"5.6"},
    1099: definition.ErrorDefinition{ErrorNumber:1099, ErrorType:"ServerError", Symbol:"ER_TABLE_NOT_LOCKED_FOR_WRITE", SQLState:"HY000", Message:"Table '%s' was locked with a READ lock and can't be updated ", Description:"", MySQLVersion:"5.6"},
    1100: definition.ErrorDefinition{ErrorNumber:1100, ErrorType:"ServerError", Symbol:"ER_TABLE_NOT_LOCKED", SQLState:"HY000", Message:"Table '%s' was not locked with LOCK TABLES ", Description:"", MySQLVersion:"5.6"},
    1101: definition.ErrorDefinition{ErrorNumber:1101, ErrorType:"ServerError", Symbol:"ER_BLOB_CANT_HAVE_DEFAULT", SQLState:"42000", Message:"BLOB/TEXT column '%s' can't have a default value ", Description:"", MySQLVersion:"5.6"},
    1102: definition.ErrorDefinition{ErrorNumber:1102, ErrorType:"ServerError", Symbol:"ER_WRONG_DB_NAME", SQLState:"42000", Message:"Incorrect database name '%s' ", Description:"", MySQLVersion:"5.6"},
    1103: definition.ErrorDefinition{ErrorNumber:1103, ErrorType:"ServerError", Symbol:"ER_WRONG_TABLE_NAME", SQLState:"42000", Message:"Incorrect table name '%s' ", Description:"", MySQLVersion:"5.6"},
    1104: definition.ErrorDefinition{ErrorNumber:1104, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SELECT", SQLState:"42000", Message:"The SELECT would examine more than MAX_JOIN_SIZE rows", Description:"check your WHERE and use SET SQL_BIG_SELECTS=1 or SET MAX_JOIN_SIZE=# if the SELECT is okay ", MySQLVersion:"5.6"},
    1105: definition.ErrorDefinition{ErrorNumber:1105, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ERROR", SQLState:"HY000", Message:"Unknown error ", Description:"", MySQLVersion:"5.6"},
    1106: definition.ErrorDefinition{ErrorNumber:1106, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_PROCEDURE", SQLState:"42000", Message:"Unknown procedure '%s' ", Description:"", MySQLVersion:"5.6"},
    1107: definition.ErrorDefinition{ErrorNumber:1107, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMCOUNT_TO_PROCEDURE", SQLState:"42000", Message:"Incorrect parameter count to procedure '%s' ", Description:"", MySQLVersion:"5.6"},
    1108: definition.ErrorDefinition{ErrorNumber:1108, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_PROCEDURE", SQLState:"HY000", Message:"Incorrect parameters to procedure '%s' ", Description:"", MySQLVersion:"5.6"},
    1109: definition.ErrorDefinition{ErrorNumber:1109, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TABLE", SQLState:"42S02", Message:"Unknown table '%s' in %s ", Description:"", MySQLVersion:"5.6"},
    1110: definition.ErrorDefinition{ErrorNumber:1110, ErrorType:"ServerError", Symbol:"ER_FIELD_SPECIFIED_TWICE", SQLState:"42000", Message:"Column '%s' specified twice ", Description:"", MySQLVersion:"5.6"},
    1111: definition.ErrorDefinition{ErrorNumber:1111, ErrorType:"ServerError", Symbol:"ER_INVALID_GROUP_FUNC_USE", SQLState:"HY000", Message:"Invalid use of group function ", Description:"", MySQLVersion:"5.6"},
    1112: definition.ErrorDefinition{ErrorNumber:1112, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_EXTENSION", SQLState:"42000", Message:"Table '%s' uses an extension that doesn't exist in this MySQL version ", Description:"", MySQLVersion:"5.6"},
    1113: definition.ErrorDefinition{ErrorNumber:1113, ErrorType:"ServerError", Symbol:"ER_TABLE_MUST_HAVE_COLUMNS", SQLState:"42000", Message:"A table must have at least 1 column ", Description:"", MySQLVersion:"5.6"},
    1114: definition.ErrorDefinition{ErrorNumber:1114, ErrorType:"ServerError", Symbol:"ER_RECORD_FILE_FULL", SQLState:"HY000", Message:"The table '%s' is full", Description:"InnoDB reports this error when the system tablespace runs out of free space. Reconfigure the system tablespace to add a new data file. ", MySQLVersion:"5.6"},
    1115: definition.ErrorDefinition{ErrorNumber:1115, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_CHARACTER_SET", SQLState:"42000", Message:"Unknown character set: '%s' ", Description:"", MySQLVersion:"5.6"},
    1116: definition.ErrorDefinition{ErrorNumber:1116, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_TABLES", SQLState:"HY000", Message:"Too many tables", Description:"MySQL can only use %d tables in a join ", MySQLVersion:"5.6"},
    1117: definition.ErrorDefinition{ErrorNumber:1117, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_FIELDS", SQLState:"HY000", Message:"Too many columns ", Description:"", MySQLVersion:"5.6"},
    1118: definition.ErrorDefinition{ErrorNumber:1118, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_ROWSIZE", SQLState:"42000", Message:"Row size too large. The maximum row size for the used table type, not counting BLOBs, is %ld. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs ", Description:"", MySQLVersion:"5.6"},
    1119: definition.ErrorDefinition{ErrorNumber:1119, ErrorType:"ServerError", Symbol:"ER_STACK_OVERRUN", SQLState:"HY000", Message:"Thread stack overrun: Used: %ld of a %ld stack. Use 'mysqld --thread_stack=#' to specify a bigger stack if needed ", Description:"", MySQLVersion:"5.6"},
    1120: definition.ErrorDefinition{ErrorNumber:1120, ErrorType:"ServerError", Symbol:"ER_WRONG_OUTER_JOIN", SQLState:"42000", Message:"Cross dependency found in OUTER JOIN", Description:"examine your ON conditions ", MySQLVersion:"5.6"},
    1121: definition.ErrorDefinition{ErrorNumber:1121, ErrorType:"ServerError", Symbol:"ER_NULL_COLUMN_IN_INDEX", SQLState:"42000", Message:"Table handler doesn't support NULL in given index. Please change column '%s' to be NOT NULL or use another handler ", Description:"", MySQLVersion:"5.6"},
    1122: definition.ErrorDefinition{ErrorNumber:1122, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_UDF", SQLState:"HY000", Message:"Can't load function '%s' ", Description:"", MySQLVersion:"5.6"},
    1123: definition.ErrorDefinition{ErrorNumber:1123, ErrorType:"ServerError", Symbol:"ER_CANT_INITIALIZE_UDF", SQLState:"HY000", Message:"Can't initialize function '%s'", Description:"%s ", MySQLVersion:"5.6"},
    1124: definition.ErrorDefinition{ErrorNumber:1124, ErrorType:"ServerError", Symbol:"ER_UDF_NO_PATHS", SQLState:"HY000", Message:"No paths allowed for shared library ", Description:"", MySQLVersion:"5.6"},
    1125: definition.ErrorDefinition{ErrorNumber:1125, ErrorType:"ServerError", Symbol:"ER_UDF_EXISTS", SQLState:"HY000", Message:"Function '%s' already exists ", Description:"", MySQLVersion:"5.6"},
    1126: definition.ErrorDefinition{ErrorNumber:1126, ErrorType:"ServerError", Symbol:"ER_CANT_OPEN_LIBRARY", SQLState:"HY000", Message:"Can't open shared library '%s' (errno: %d %s) ", Description:"", MySQLVersion:"5.6"},
    1127: definition.ErrorDefinition{ErrorNumber:1127, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_DL_ENTRY", SQLState:"HY000", Message:"Can't find symbol '%s' in library ", Description:"", MySQLVersion:"5.6"},
    1128: definition.ErrorDefinition{ErrorNumber:1128, ErrorType:"ServerError", Symbol:"ER_FUNCTION_NOT_DEFINED", SQLState:"HY000", Message:"Function '%s' is not defined ", Description:"", MySQLVersion:"5.6"},
    1129: definition.ErrorDefinition{ErrorNumber:1129, ErrorType:"ServerError", Symbol:"ER_HOST_IS_BLOCKED", SQLState:"HY000", Message:"Host '%s' is blocked because of many connection errors", Description:"unblock with 'mysqladmin flush-hosts' ", MySQLVersion:"5.6"},
    1130: definition.ErrorDefinition{ErrorNumber:1130, ErrorType:"ServerError", Symbol:"ER_HOST_NOT_PRIVILEGED", SQLState:"HY000", Message:"Host '%s' is not allowed to connect to this MySQL server ", Description:"", MySQLVersion:"5.6"},
    1131: definition.ErrorDefinition{ErrorNumber:1131, ErrorType:"ServerError", Symbol:"ER_PASSWORD_ANONYMOUS_USER", SQLState:"42000", Message:"You are using MySQL as an anonymous user and anonymous users are not allowed to change passwords ", Description:"", MySQLVersion:"5.6"},
    1132: definition.ErrorDefinition{ErrorNumber:1132, ErrorType:"ServerError", Symbol:"ER_PASSWORD_NOT_ALLOWED", SQLState:"42000", Message:"You must have privileges to update tables in the mysql database to be able to change passwords for others ", Description:"", MySQLVersion:"5.6"},
    1133: definition.ErrorDefinition{ErrorNumber:1133, ErrorType:"ServerError", Symbol:"ER_PASSWORD_NO_MATCH", SQLState:"42000", Message:"Can't find any matching row in the user table ", Description:"", MySQLVersion:"5.6"},
    1134: definition.ErrorDefinition{ErrorNumber:1134, ErrorType:"ServerError", Symbol:"ER_UPDATE_INFO", SQLState:"HY000", Message:"Rows matched: %ld Changed: %ld Warnings: %ld ", Description:"", MySQLVersion:"5.6"},
    1135: definition.ErrorDefinition{ErrorNumber:1135, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_THREAD", SQLState:"HY000", Message:"Can't create a new thread (errno %d)", Description:"if you are not out of available memory, you can consult the manual for a possible OS-dependent bug ", MySQLVersion:"5.6"},
    1136: definition.ErrorDefinition{ErrorNumber:1136, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_COUNT_ON_ROW", SQLState:"21S01", Message:"Column count doesn't match value count at row %ld ", Description:"", MySQLVersion:"5.6"},
    1137: definition.ErrorDefinition{ErrorNumber:1137, ErrorType:"ServerError", Symbol:"ER_CANT_REOPEN_TABLE", SQLState:"HY000", Message:"Can't reopen table: '%s' ", Description:"", MySQLVersion:"5.6"},
    1138: definition.ErrorDefinition{ErrorNumber:1138, ErrorType:"ServerError", Symbol:"ER_INVALID_USE_OF_NULL", SQLState:"22004", Message:"Invalid use of NULL value ", Description:"", MySQLVersion:"5.6"},
    1139: definition.ErrorDefinition{ErrorNumber:1139, ErrorType:"ServerError", Symbol:"ER_REGEXP_ERROR", SQLState:"42000", Message:"Got error '%s' from regexp ", Description:"", MySQLVersion:"5.6"},
    1140: definition.ErrorDefinition{ErrorNumber:1140, ErrorType:"ServerError", Symbol:"ER_MIX_OF_GROUP_FUNC_AND_FIELDS", SQLState:"42000", Message:"Mixing of GROUP columns (MIN(),MAX(),COUNT(),...) with no GROUP columns is illegal if there is no GROUP BY clause ", Description:"", MySQLVersion:"5.6"},
    1141: definition.ErrorDefinition{ErrorNumber:1141, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s' ", Description:"", MySQLVersion:"5.6"},
    1142: definition.ErrorDefinition{ErrorNumber:1142, ErrorType:"ServerError", Symbol:"ER_TABLEACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for table '%s' ", Description:"", MySQLVersion:"5.6"},
    1143: definition.ErrorDefinition{ErrorNumber:1143, ErrorType:"ServerError", Symbol:"ER_COLUMNACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for column '%s' in table '%s' ", Description:"", MySQLVersion:"5.6"},
    1144: definition.ErrorDefinition{ErrorNumber:1144, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_GRANT_FOR_TABLE", SQLState:"42000", Message:"Illegal GRANT/REVOKE command", Description:"please consult the manual to see which privileges can be used ", MySQLVersion:"5.6"},
    1145: definition.ErrorDefinition{ErrorNumber:1145, ErrorType:"ServerError", Symbol:"ER_GRANT_WRONG_HOST_OR_USER", SQLState:"42000", Message:"The host or user argument to GRANT is too long ", Description:"", MySQLVersion:"5.6"},
    1146: definition.ErrorDefinition{ErrorNumber:1146, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_TABLE", SQLState:"42S02", Message:"Table '%s.%s' doesn't exist ", Description:"", MySQLVersion:"5.6"},
    1147: definition.ErrorDefinition{ErrorNumber:1147, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_TABLE_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s' on table '%s' ", Description:"", MySQLVersion:"5.6"},
    1148: definition.ErrorDefinition{ErrorNumber:1148, ErrorType:"ServerError", Symbol:"ER_NOT_ALLOWED_COMMAND", SQLState:"42000", Message:"The used command is not allowed with this MySQL version ", Description:"", MySQLVersion:"5.6"},
    1149: definition.ErrorDefinition{ErrorNumber:1149, ErrorType:"ServerError", Symbol:"ER_SYNTAX_ERROR", SQLState:"42000", Message:"You have an error in your SQL syntax", Description:"check the manual that corresponds to your MySQL server version for the right syntax to use ", MySQLVersion:"5.6"},
    1150: definition.ErrorDefinition{ErrorNumber:1150, ErrorType:"ServerError", Symbol:"ER_DELAYED_CANT_CHANGE_LOCK", SQLState:"HY000", Message:"Delayed insert thread couldn't get requested lock for table %s ", Description:"", MySQLVersion:"5.6"},
    1151: definition.ErrorDefinition{ErrorNumber:1151, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_DELAYED_THREADS", SQLState:"HY000", Message:"Too many delayed threads in use ", Description:"", MySQLVersion:"5.6"},
    1152: definition.ErrorDefinition{ErrorNumber:1152, ErrorType:"ServerError", Symbol:"ER_ABORTING_CONNECTION", SQLState:"08S01", Message:"Aborted connection %ld to db: '%s' user: '%s' (%s) ", Description:"", MySQLVersion:"5.6"},
    1153: definition.ErrorDefinition{ErrorNumber:1153, ErrorType:"ServerError", Symbol:"ER_NET_PACKET_TOO_LARGE", SQLState:"08S01", Message:"Got a packet bigger than 'max_allowed_packet' bytes ", Description:"", MySQLVersion:"5.6"},
    1154: definition.ErrorDefinition{ErrorNumber:1154, ErrorType:"ServerError", Symbol:"ER_NET_READ_ERROR_FROM_PIPE", SQLState:"08S01", Message:"Got a read error from the connection pipe ", Description:"", MySQLVersion:"5.6"},
    1155: definition.ErrorDefinition{ErrorNumber:1155, ErrorType:"ServerError", Symbol:"ER_NET_FCNTL_ERROR", SQLState:"08S01", Message:"Got an error from fcntl() ", Description:"", MySQLVersion:"5.6"},
    1156: definition.ErrorDefinition{ErrorNumber:1156, ErrorType:"ServerError", Symbol:"ER_NET_PACKETS_OUT_OF_ORDER", SQLState:"08S01", Message:"Got packets out of order ", Description:"", MySQLVersion:"5.6"},
    1157: definition.ErrorDefinition{ErrorNumber:1157, ErrorType:"ServerError", Symbol:"ER_NET_UNCOMPRESS_ERROR", SQLState:"08S01", Message:"Couldn't uncompress communication packet ", Description:"", MySQLVersion:"5.6"},
    1158: definition.ErrorDefinition{ErrorNumber:1158, ErrorType:"ServerError", Symbol:"ER_NET_READ_ERROR", SQLState:"08S01", Message:"Got an error reading communication packets ", Description:"", MySQLVersion:"5.6"},
    1159: definition.ErrorDefinition{ErrorNumber:1159, ErrorType:"ServerError", Symbol:"ER_NET_READ_INTERRUPTED", SQLState:"08S01", Message:"Got timeout reading communication packets ", Description:"", MySQLVersion:"5.6"},
    1160: definition.ErrorDefinition{ErrorNumber:1160, ErrorType:"ServerError", Symbol:"ER_NET_ERROR_ON_WRITE", SQLState:"08S01", Message:"Got an error writing communication packets ", Description:"", MySQLVersion:"5.6"},
    1161: definition.ErrorDefinition{ErrorNumber:1161, ErrorType:"ServerError", Symbol:"ER_NET_WRITE_INTERRUPTED", SQLState:"08S01", Message:"Got timeout writing communication packets ", Description:"", MySQLVersion:"5.6"},
    1162: definition.ErrorDefinition{ErrorNumber:1162, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_STRING", SQLState:"42000", Message:"Result string is longer than 'max_allowed_packet' bytes ", Description:"", MySQLVersion:"5.6"},
    1163: definition.ErrorDefinition{ErrorNumber:1163, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_BLOB", SQLState:"42000", Message:"The used table type doesn't support BLOB/TEXT columns ", Description:"", MySQLVersion:"5.6"},
    1164: definition.ErrorDefinition{ErrorNumber:1164, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_AUTO_INCREMENT", SQLState:"42000", Message:"The used table type doesn't support AUTO_INCREMENT columns ", Description:"", MySQLVersion:"5.6"},
    1165: definition.ErrorDefinition{ErrorNumber:1165, ErrorType:"ServerError", Symbol:"ER_DELAYED_INSERT_TABLE_LOCKED", SQLState:"HY000", Message:"INSERT DELAYED can't be used with table '%s' because it is locked with LOCK TABLES ", Description:"", MySQLVersion:"5.6"},
    1166: definition.ErrorDefinition{ErrorNumber:1166, ErrorType:"ServerError", Symbol:"ER_WRONG_COLUMN_NAME", SQLState:"42000", Message:"Incorrect column name '%s' ", Description:"", MySQLVersion:"5.6"},
    1167: definition.ErrorDefinition{ErrorNumber:1167, ErrorType:"ServerError", Symbol:"ER_WRONG_KEY_COLUMN", SQLState:"42000", Message:"The used storage engine can't index column '%s' ", Description:"", MySQLVersion:"5.6"},
    1168: definition.ErrorDefinition{ErrorNumber:1168, ErrorType:"ServerError", Symbol:"ER_WRONG_MRG_TABLE", SQLState:"HY000", Message:"Unable to open underlying table which is differently defined or of non-MyISAM type or doesn't exist ", Description:"", MySQLVersion:"5.6"},
    1169: definition.ErrorDefinition{ErrorNumber:1169, ErrorType:"ServerError", Symbol:"ER_DUP_UNIQUE", SQLState:"23000", Message:"Can't write, because of unique constraint, to table '%s' ", Description:"", MySQLVersion:"5.6"},
    1170: definition.ErrorDefinition{ErrorNumber:1170, ErrorType:"ServerError", Symbol:"ER_BLOB_KEY_WITHOUT_LENGTH", SQLState:"42000", Message:"BLOB/TEXT column '%s' used in key specification without a key length ", Description:"", MySQLVersion:"5.6"},
    1171: definition.ErrorDefinition{ErrorNumber:1171, ErrorType:"ServerError", Symbol:"ER_PRIMARY_CANT_HAVE_NULL", SQLState:"42000", Message:"All parts of a PRIMARY KEY must be NOT NULL", Description:"if you need NULL in a key, use UNIQUE instead ", MySQLVersion:"5.6"},
    1172: definition.ErrorDefinition{ErrorNumber:1172, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_ROWS", SQLState:"42000", Message:"Result consisted of more than one row ", Description:"", MySQLVersion:"5.6"},
    1173: definition.ErrorDefinition{ErrorNumber:1173, ErrorType:"ServerError", Symbol:"ER_REQUIRES_PRIMARY_KEY", SQLState:"42000", Message:"This table type requires a primary key ", Description:"", MySQLVersion:"5.6"},
    1174: definition.ErrorDefinition{ErrorNumber:1174, ErrorType:"ServerError", Symbol:"ER_NO_RAID_COMPILED", SQLState:"HY000", Message:"This version of MySQL is not compiled with RAID support ", Description:"", MySQLVersion:"5.6"},
    1175: definition.ErrorDefinition{ErrorNumber:1175, ErrorType:"ServerError", Symbol:"ER_UPDATE_WITHOUT_KEY_IN_SAFE_MODE", SQLState:"HY000", Message:"You are using safe update mode and you tried to update a table without a WHERE that uses a KEY column ", Description:"", MySQLVersion:"5.6"},
    1176: definition.ErrorDefinition{ErrorNumber:1176, ErrorType:"ServerError", Symbol:"ER_KEY_DOES_NOT_EXITS", SQLState:"42000", Message:"Key '%s' doesn't exist in table '%s' ", Description:"", MySQLVersion:"5.6"},
    1177: definition.ErrorDefinition{ErrorNumber:1177, ErrorType:"ServerError", Symbol:"ER_CHECK_NO_SUCH_TABLE", SQLState:"42000", Message:"Can't open table ", Description:"", MySQLVersion:"5.6"},
    1178: definition.ErrorDefinition{ErrorNumber:1178, ErrorType:"ServerError", Symbol:"ER_CHECK_NOT_IMPLEMENTED", SQLState:"42000", Message:"The storage engine for the table doesn't support %s ", Description:"", MySQLVersion:"5.6"},
    1179: definition.ErrorDefinition{ErrorNumber:1179, ErrorType:"ServerError", Symbol:"ER_CANT_DO_THIS_DURING_AN_TRANSACTION", SQLState:"25000", Message:"You are not allowed to execute this command in a transaction ", Description:"", MySQLVersion:"5.6"},
    1180: definition.ErrorDefinition{ErrorNumber:1180, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_COMMIT", SQLState:"HY000", Message:"Got error %d during COMMIT ", Description:"", MySQLVersion:"5.6"},
    1181: definition.ErrorDefinition{ErrorNumber:1181, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_ROLLBACK", SQLState:"HY000", Message:"Got error %d during ROLLBACK ", Description:"", MySQLVersion:"5.6"},
    1182: definition.ErrorDefinition{ErrorNumber:1182, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_FLUSH_LOGS", SQLState:"HY000", Message:"Got error %d during FLUSH_LOGS ", Description:"", MySQLVersion:"5.6"},
    1183: definition.ErrorDefinition{ErrorNumber:1183, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_CHECKPOINT", SQLState:"HY000", Message:"Got error %d during CHECKPOINT ", Description:"", MySQLVersion:"5.6"},
    1184: definition.ErrorDefinition{ErrorNumber:1184, ErrorType:"ServerError", Symbol:"ER_NEW_ABORTING_CONNECTION", SQLState:"08S01", Message:"Aborted connection %ld to db: '%s' user: '%s' host: '%s' (%s) ", Description:"", MySQLVersion:"5.6"},
    1185: definition.ErrorDefinition{ErrorNumber:1185, ErrorType:"ServerError", Symbol:"ER_DUMP_NOT_IMPLEMENTED", SQLState:"HY000", Message:"The storage engine for the table does not support binary table dump ", Description:"", MySQLVersion:"5.6"},
    1186: definition.ErrorDefinition{ErrorNumber:1186, ErrorType:"ServerError", Symbol:"ER_FLUSH_MASTER_BINLOG_CLOSED", SQLState:"HY000", Message:"Binlog closed, cannot RESET MASTER ", Description:"", MySQLVersion:"5.6"},
    1187: definition.ErrorDefinition{ErrorNumber:1187, ErrorType:"ServerError", Symbol:"ER_INDEX_REBUILD", SQLState:"HY000", Message:"Failed rebuilding the index of dumped table '%s' ", Description:"", MySQLVersion:"5.6"},
    1188: definition.ErrorDefinition{ErrorNumber:1188, ErrorType:"ServerError", Symbol:"ER_MASTER", SQLState:"HY000", Message:"Error from master: '%s' ", Description:"", MySQLVersion:"5.6"},
    1189: definition.ErrorDefinition{ErrorNumber:1189, ErrorType:"ServerError", Symbol:"ER_MASTER_NET_READ", SQLState:"08S01", Message:"Net error reading from master ", Description:"", MySQLVersion:"5.6"},
    1190: definition.ErrorDefinition{ErrorNumber:1190, ErrorType:"ServerError", Symbol:"ER_MASTER_NET_WRITE", SQLState:"08S01", Message:"Net error writing to master ", Description:"", MySQLVersion:"5.6"},
    1191: definition.ErrorDefinition{ErrorNumber:1191, ErrorType:"ServerError", Symbol:"ER_FT_MATCHING_KEY_NOT_FOUND", SQLState:"HY000", Message:"Can't find FULLTEXT index matching the column list ", Description:"", MySQLVersion:"5.6"},
    1192: definition.ErrorDefinition{ErrorNumber:1192, ErrorType:"ServerError", Symbol:"ER_LOCK_OR_ACTIVE_TRANSACTION", SQLState:"HY000", Message:"Can't execute the given command because you have active locked tables or an active transaction ", Description:"", MySQLVersion:"5.6"},
    1193: definition.ErrorDefinition{ErrorNumber:1193, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_SYSTEM_VARIABLE", SQLState:"HY000", Message:"Unknown system variable '%s' ", Description:"", MySQLVersion:"5.6"},
    1194: definition.ErrorDefinition{ErrorNumber:1194, ErrorType:"ServerError", Symbol:"ER_CRASHED_ON_USAGE", SQLState:"HY000", Message:"Table '%s' is marked as crashed and should be repaired ", Description:"", MySQLVersion:"5.6"},
    1195: definition.ErrorDefinition{ErrorNumber:1195, ErrorType:"ServerError", Symbol:"ER_CRASHED_ON_REPAIR", SQLState:"HY000", Message:"Table '%s' is marked as crashed and last (automatic?) repair failed ", Description:"", MySQLVersion:"5.6"},
    1196: definition.ErrorDefinition{ErrorNumber:1196, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK", SQLState:"HY000", Message:"Some non-transactional changed tables couldn't be rolled back ", Description:"", MySQLVersion:"5.6"},
    1197: definition.ErrorDefinition{ErrorNumber:1197, ErrorType:"ServerError", Symbol:"ER_TRANS_CACHE_FULL", SQLState:"HY000", Message:"Multi-statement transaction required more than 'max_binlog_cache_size' bytes of storage", Description:"increase this mysqld variable and try again ", MySQLVersion:"5.6"},
    1198: definition.ErrorDefinition{ErrorNumber:1198, ErrorType:"ServerError", Symbol:"ER_SLAVE_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slave", Description:"run STOP SLAVE first ", MySQLVersion:"5.6"},
    1199: definition.ErrorDefinition{ErrorNumber:1199, ErrorType:"ServerError", Symbol:"ER_SLAVE_NOT_RUNNING", SQLState:"HY000", Message:"This operation requires a running slave", Description:"configure slave and do START SLAVE ", MySQLVersion:"5.6"},
    1200: definition.ErrorDefinition{ErrorNumber:1200, ErrorType:"ServerError", Symbol:"ER_BAD_SLAVE", SQLState:"HY000", Message:"The server is not configured as slave", Description:"fix in config file or with CHANGE MASTER TO ", MySQLVersion:"5.6"},
    1201: definition.ErrorDefinition{ErrorNumber:1201, ErrorType:"ServerError", Symbol:"ER_MASTER_INFO", SQLState:"HY000", Message:"Could not initialize master info structure", Description:"more error messages can be found in the MySQL error log ", MySQLVersion:"5.6"},
    1202: definition.ErrorDefinition{ErrorNumber:1202, ErrorType:"ServerError", Symbol:"ER_SLAVE_THREAD", SQLState:"HY000", Message:"Could not create slave thread", Description:"check system resources ", MySQLVersion:"5.6"},
    1203: definition.ErrorDefinition{ErrorNumber:1203, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_USER_CONNECTIONS", SQLState:"42000", Message:"User %s already has more than 'max_user_connections' active connections ", Description:"", MySQLVersion:"5.6"},
    1204: definition.ErrorDefinition{ErrorNumber:1204, ErrorType:"ServerError", Symbol:"ER_SET_CONSTANTS_ONLY", SQLState:"HY000", Message:"You may only use constant expressions with SET ", Description:"", MySQLVersion:"5.6"},
    ...
    1206: definition.ErrorDefinition{ErrorNumber:1206, ErrorType:"ServerError", Symbol:"ER_LOCK_TABLE_FULL", SQLState:"HY000", Message:"The total number of locks exceeds the lock table size", Description:"InnoDB reports this error when the total number of locks exceeds the amount of memory devoted to managing locks. To avoid this error, increase the value of innodb_buffer_pool_size. Within an individual application, a workaround may be to break a large operation into smaller pieces. For example, if the error occurs for a large INSERT, perform several smaller INSERT operations. ", MySQLVersion:"5.6"},
    1207: definition.ErrorDefinition{ErrorNumber:1207, ErrorType:"ServerError", Symbol:"ER_READ_ONLY_TRANSACTION", SQLState:"25000", Message:"Update locks cannot be acquired during a READ UNCOMMITTED transaction ", Description:"", MySQLVersion:"5.6"},
    1208: definition.ErrorDefinition{ErrorNumber:1208, ErrorType:"ServerError", Symbol:"ER_DROP_DB_WITH_READ_LOCK", SQLState:"HY000", Message:"DROP DATABASE not allowed while thread is holding global read lock ", Description:"", MySQLVersion:"5.6"},
    1209: definition.ErrorDefinition{ErrorNumber:1209, ErrorType:"ServerError", Symbol:"ER_CREATE_DB_WITH_READ_LOCK", SQLState:"HY000", Message:"CREATE DATABASE not allowed while thread is holding global read lock ", Description:"", MySQLVersion:"5.6"},
    1210: definition.ErrorDefinition{ErrorNumber:1210, ErrorType:"ServerError", Symbol:"ER_WRONG_ARGUMENTS", SQLState:"HY000", Message:"Incorrect arguments to %s ", Description:"", MySQLVersion:"5.6"},
    1211: definition.ErrorDefinition{ErrorNumber:1211, ErrorType:"ServerError", Symbol:"ER_NO_PERMISSION_TO_CREATE_USER", SQLState:"42000", Message:"'%s'@'%s' is not allowed to create new users ", Description:"", MySQLVersion:"5.6"},
    1212: definition.ErrorDefinition{ErrorNumber:1212, ErrorType:"ServerError", Symbol:"ER_UNION_TABLES_IN_DIFFERENT_DIR", SQLState:"HY000", Message:"Incorrect table definition", Description:"all MERGE tables must be in the same database ", MySQLVersion:"5.6"},
    1213: definition.ErrorDefinition{ErrorNumber:1213, ErrorType:"ServerError", Symbol:"ER_LOCK_DEADLOCK", SQLState:"40001", Message:"Deadlock found when trying to get lock", Description:"InnoDB reports this error when a transaction encounters a deadlock and is automatically rolled back so that your application can take corrective action. To recover from this error, run all the operations in this transaction again. A deadlock occurs when requests for locks arrive in inconsistent order between transactions. The transaction that was rolled back released all its locks, and the other transaction can now get all the locks it requested. Thus, when you re-run the transaction that was rolled back, it might have to wait for other transactions to complete, but typically the deadlock does not recur. If you encounter frequent deadlocks, make the sequence of locking operations (LOCK TABLES, SELECT ... FOR UPDATE, and so on) consistent between the different transactions or applications that experience the issue. See Section\u00a014.7.5, “Deadlocks in InnoDB” for details. ", MySQLVersion:"5.6"},
    1214: definition.ErrorDefinition{ErrorNumber:1214, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_FT", SQLState:"HY000", Message:"The used table type doesn't support FULLTEXT indexes ", Description:"", MySQLVersion:"5.6"},
    1215: definition.ErrorDefinition{ErrorNumber:1215, ErrorType:"ServerError", Symbol:"ER_CANNOT_ADD_FOREIGN", SQLState:"HY000", Message:"Cannot add foreign key constraint ", Description:"", MySQLVersion:"5.6"},
    1216: definition.ErrorDefinition{ErrorNumber:1216, ErrorType:"ServerError", Symbol:"ER_NO_REFERENCED_ROW", SQLState:"23000", Message:"Cannot add or update a child row: a foreign key constraint fails", Description:"InnoDB reports this error when you try to add a row but there is no parent row, and a foreign key constraint fails. Add the parent row first. ", MySQLVersion:"5.6"},
    1217: definition.ErrorDefinition{ErrorNumber:1217, ErrorType:"ServerError", Symbol:"ER_ROW_IS_REFERENCED", SQLState:"23000", Message:"Cannot delete or update a parent row: a foreign key constraint fails", Description:"InnoDB reports this error when you try to delete a parent row that has children, and a foreign key constraint fails. Delete the children first. ", MySQLVersion:"5.6"},
    1218: definition.ErrorDefinition{ErrorNumber:1218, ErrorType:"ServerError", Symbol:"ER_CONNECT_TO_MASTER", SQLState:"08S01", Message:"Error connecting to master: %s ", Description:"", MySQLVersion:"5.6"},
    1219: definition.ErrorDefinition{ErrorNumber:1219, ErrorType:"ServerError", Symbol:"ER_QUERY_ON_MASTER", SQLState:"HY000", Message:"Error running query on master: %s ", Description:"", MySQLVersion:"5.6"},
    1220: definition.ErrorDefinition{ErrorNumber:1220, ErrorType:"ServerError", Symbol:"ER_ERROR_WHEN_EXECUTING_COMMAND", SQLState:"HY000", Message:"Error when executing command %s: %s ", Description:"", MySQLVersion:"5.6"},
    1221: definition.ErrorDefinition{ErrorNumber:1221, ErrorType:"ServerError", Symbol:"ER_WRONG_USAGE", SQLState:"HY000", Message:"Incorrect usage of %s and %s ", Description:"", MySQLVersion:"5.6"},
    1222: definition.ErrorDefinition{ErrorNumber:1222, ErrorType:"ServerError", Symbol:"ER_WRONG_NUMBER_OF_COLUMNS_IN_SELECT", SQLState:"21000", Message:"The used SELECT statements have a different number of columns ", Description:"", MySQLVersion:"5.6"},
    1223: definition.ErrorDefinition{ErrorNumber:1223, ErrorType:"ServerError", Symbol:"ER_CANT_UPDATE_WITH_READLOCK", SQLState:"HY000", Message:"Can't execute the query because you have a conflicting read lock ", Description:"", MySQLVersion:"5.6"},
    1224: definition.ErrorDefinition{ErrorNumber:1224, ErrorType:"ServerError", Symbol:"ER_MIXING_NOT_ALLOWED", SQLState:"HY000", Message:"Mixing of transactional and non-transactional tables is disabled ", Description:"", MySQLVersion:"5.6"},
    1225: definition.ErrorDefinition{ErrorNumber:1225, ErrorType:"ServerError", Symbol:"ER_DUP_ARGUMENT", SQLState:"HY000", Message:"Option '%s' used twice in statement ", Description:"", MySQLVersion:"5.6"},
    1226: definition.ErrorDefinition{ErrorNumber:1226, ErrorType:"ServerError", Symbol:"ER_USER_LIMIT_REACHED", SQLState:"42000", Message:"User '%s' has exceeded the '%s' resource (current value: %ld) ", Description:"", MySQLVersion:"5.6"},
    1227: definition.ErrorDefinition{ErrorNumber:1227, ErrorType:"ServerError", Symbol:"ER_SPECIFIC_ACCESS_DENIED_ERROR", SQLState:"42000", Message:"Access denied", Description:"you need (at least one of) the %s privilege(s) for this operation ", MySQLVersion:"5.6"},
    1228: definition.ErrorDefinition{ErrorNumber:1228, ErrorType:"ServerError", Symbol:"ER_LOCAL_VARIABLE", SQLState:"HY000", Message:"Variable '%s' is a SESSION variable and can't be used with SET GLOBAL ", Description:"", MySQLVersion:"5.6"},
    1229: definition.ErrorDefinition{ErrorNumber:1229, ErrorType:"ServerError", Symbol:"ER_GLOBAL_VARIABLE", SQLState:"HY000", Message:"Variable '%s' is a GLOBAL variable and should be set with SET GLOBAL ", Description:"", MySQLVersion:"5.6"},
    1230: definition.ErrorDefinition{ErrorNumber:1230, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT", SQLState:"42000", Message:"Variable '%s' doesn't have a default value ", Description:"", MySQLVersion:"5.6"},
    1231: definition.ErrorDefinition{ErrorNumber:1231, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_FOR_VAR", SQLState:"42000", Message:"Variable '%s' can't be set to the value of '%s' ", Description:"", MySQLVersion:"5.6"},
    1232: definition.ErrorDefinition{ErrorNumber:1232, ErrorType:"ServerError", Symbol:"ER_WRONG_TYPE_FOR_VAR", SQLState:"42000", Message:"Incorrect argument type to variable '%s' ", Description:"", MySQLVersion:"5.6"},
    1233: definition.ErrorDefinition{ErrorNumber:1233, ErrorType:"ServerError", Symbol:"ER_VAR_CANT_BE_READ", SQLState:"HY000", Message:"Variable '%s' can only be set, not read ", Description:"", MySQLVersion:"5.6"},
    1234: definition.ErrorDefinition{ErrorNumber:1234, ErrorType:"ServerError", Symbol:"ER_CANT_USE_OPTION_HERE", SQLState:"42000", Message:"Incorrect usage/placement of '%s' ", Description:"", MySQLVersion:"5.6"},
    1235: definition.ErrorDefinition{ErrorNumber:1235, ErrorType:"ServerError", Symbol:"ER_NOT_SUPPORTED_YET", SQLState:"42000", Message:"This version of MySQL doesn't yet support '%s' ", Description:"", MySQLVersion:"5.6"},
    1236: definition.ErrorDefinition{ErrorNumber:1236, ErrorType:"ServerError", Symbol:"ER_MASTER_FATAL_ERROR_READING_BINLOG", SQLState:"HY000", Message:"Got fatal error %d from master when reading data from binary log: '%s' ", Description:"", MySQLVersion:"5.6"},
    1237: definition.ErrorDefinition{ErrorNumber:1237, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORED_TABLE", SQLState:"HY000", Message:"Slave SQL thread ignored the query because of replicate-*-table rules ", Description:"", MySQLVersion:"5.6"},
    1238: definition.ErrorDefinition{ErrorNumber:1238, ErrorType:"ServerError", Symbol:"ER_INCORRECT_GLOBAL_LOCAL_VAR", SQLState:"HY000", Message:"Variable '%s' is a %s variable ", Description:"", MySQLVersion:"5.6"},
    1239: definition.ErrorDefinition{ErrorNumber:1239, ErrorType:"ServerError", Symbol:"ER_WRONG_FK_DEF", SQLState:"42000", Message:"Incorrect foreign key definition for '%s': %s ", Description:"", MySQLVersion:"5.6"},
    1240: definition.ErrorDefinition{ErrorNumber:1240, ErrorType:"ServerError", Symbol:"ER_KEY_REF_DO_NOT_MATCH_TABLE_REF", SQLState:"HY000", Message:"Key reference and table reference don't match ", Description:"", MySQLVersion:"5.6"},
    1241: definition.ErrorDefinition{ErrorNumber:1241, ErrorType:"ServerError", Symbol:"ER_OPERAND_COLUMNS", SQLState:"21000", Message:"Operand should contain %d column(s) ", Description:"", MySQLVersion:"5.6"},
    1242: definition.ErrorDefinition{ErrorNumber:1242, ErrorType:"ServerError", Symbol:"ER_SUBQUERY_NO_1_ROW", SQLState:"21000", Message:"Subquery returns more than 1 row ", Description:"", MySQLVersion:"5.6"},
    1243: definition.ErrorDefinition{ErrorNumber:1243, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_STMT_HANDLER", SQLState:"HY000", Message:"Unknown prepared statement handler (%.*s) given to %s ", Description:"", MySQLVersion:"5.6"},
    1244: definition.ErrorDefinition{ErrorNumber:1244, ErrorType:"ServerError", Symbol:"ER_CORRUPT_HELP_DB", SQLState:"HY000", Message:"Help database is corrupt or does not exist ", Description:"", MySQLVersion:"5.6"},
    1245: definition.ErrorDefinition{ErrorNumber:1245, ErrorType:"ServerError", Symbol:"ER_CYCLIC_REFERENCE", SQLState:"HY000", Message:"Cyclic reference on subqueries ", Description:"", MySQLVersion:"5.6"},
    1246: definition.ErrorDefinition{ErrorNumber:1246, ErrorType:"ServerError", Symbol:"ER_AUTO_CONVERT", SQLState:"HY000", Message:"Converting column '%s' from %s to %s ", Description:"", MySQLVersion:"5.6"},
    1247: definition.ErrorDefinition{ErrorNumber:1247, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_REFERENCE", SQLState:"42S22", Message:"Reference '%s' not supported (%s) ", Description:"", MySQLVersion:"5.6"},
    1248: definition.ErrorDefinition{ErrorNumber:1248, ErrorType:"ServerError", Symbol:"ER_DERIVED_MUST_HAVE_ALIAS", SQLState:"42000", Message:"Every derived table must have its own alias ", Description:"", MySQLVersion:"5.6"},
    1249: definition.ErrorDefinition{ErrorNumber:1249, ErrorType:"ServerError", Symbol:"ER_SELECT_REDUCED", SQLState:"01000", Message:"Select %u was reduced during optimization ", Description:"", MySQLVersion:"5.6"},
    1250: definition.ErrorDefinition{ErrorNumber:1250, ErrorType:"ServerError", Symbol:"ER_TABLENAME_NOT_ALLOWED_HERE", SQLState:"42000", Message:"Table '%s' from one of the SELECTs cannot be used in %s ", Description:"", MySQLVersion:"5.6"},
    1251: definition.ErrorDefinition{ErrorNumber:1251, ErrorType:"ServerError", Symbol:"ER_NOT_SUPPORTED_AUTH_MODE", SQLState:"08004", Message:"Client does not support authentication protocol requested by server", Description:"consider upgrading MySQL client ", MySQLVersion:"5.6"},
    1252: definition.ErrorDefinition{ErrorNumber:1252, ErrorType:"ServerError", Symbol:"ER_SPATIAL_CANT_HAVE_NULL", SQLState:"42000", Message:"All parts of a SPATIAL index must be NOT NULL ", Description:"", MySQLVersion:"5.6"},
    1253: definition.ErrorDefinition{ErrorNumber:1253, ErrorType:"ServerError", Symbol:"ER_COLLATION_CHARSET_MISMATCH", SQLState:"42000", Message:"COLLATION '%s' is not valid for CHARACTER SET '%s' ", Description:"", MySQLVersion:"5.6"},
    1254: definition.ErrorDefinition{ErrorNumber:1254, ErrorType:"ServerError", Symbol:"ER_SLAVE_WAS_RUNNING", SQLState:"HY000", Message:"Slave is already running ", Description:"", MySQLVersion:"5.6"},
    1255: definition.ErrorDefinition{ErrorNumber:1255, ErrorType:"ServerError", Symbol:"ER_SLAVE_WAS_NOT_RUNNING", SQLState:"HY000", Message:"Slave already has been stopped ", Description:"", MySQLVersion:"5.6"},
    1256: definition.ErrorDefinition{ErrorNumber:1256, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_FOR_UNCOMPRESS", SQLState:"HY000", Message:"Uncompressed data size too large", Description:"the maximum size is %d (probably, length of uncompressed data was corrupted) ", MySQLVersion:"5.6"},
    1257: definition.ErrorDefinition{ErrorNumber:1257, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_MEM_ERROR", SQLState:"HY000", Message:"ZLIB: Not enough memory ", Description:"", MySQLVersion:"5.6"},
    1258: definition.ErrorDefinition{ErrorNumber:1258, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_BUF_ERROR", SQLState:"HY000", Message:"ZLIB: Not enough room in the output buffer (probably, length of uncompressed data was corrupted) ", Description:"", MySQLVersion:"5.6"},
    1259: definition.ErrorDefinition{ErrorNumber:1259, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_DATA_ERROR", SQLState:"HY000", Message:"ZLIB: Input data corrupted ", Description:"", MySQLVersion:"5.6"},
    1260: definition.ErrorDefinition{ErrorNumber:1260, ErrorType:"ServerError", Symbol:"ER_CUT_VALUE_GROUP_CONCAT", SQLState:"HY000", Message:"Row %u was cut by GROUP_CONCAT() ", Description:"", MySQLVersion:"5.6"},
    1261: definition.ErrorDefinition{ErrorNumber:1261, ErrorType:"ServerError", Symbol:"ER_WARN_TOO_FEW_RECORDS", SQLState:"01000", Message:"Row %ld doesn't contain data for all columns ", Description:"", MySQLVersion:"5.6"},
    1262: definition.ErrorDefinition{ErrorNumber:1262, ErrorType:"ServerError", Symbol:"ER_WARN_TOO_MANY_RECORDS", SQLState:"01000", Message:"Row %ld was truncated", Description:"it contained more data than there were input columns ", MySQLVersion:"5.6"},
    1263: definition.ErrorDefinition{ErrorNumber:1263, ErrorType:"ServerError", Symbol:"ER_WARN_NULL_TO_NOTNULL", SQLState:"22004", Message:"Column set to default value", Description:"NULL supplied to NOT NULL column '%s' at row %ld ", MySQLVersion:"5.6"},
    1264: definition.ErrorDefinition{ErrorNumber:1264, ErrorType:"ServerError", Symbol:"ER_WARN_DATA_OUT_OF_RANGE", SQLState:"22003", Message:"Out of range value for column '%s' at row %ld ", Description:"", MySQLVersion:"5.6"},
    1265: definition.ErrorDefinition{ErrorNumber:1265, ErrorType:"ServerError", Symbol:"WARN_DATA_TRUNCATED", SQLState:"01000", Message:"Data truncated for column '%s' at row %ld ", Description:"", MySQLVersion:"5.6"},
    1266: definition.ErrorDefinition{ErrorNumber:1266, ErrorType:"ServerError", Symbol:"ER_WARN_USING_OTHER_HANDLER", SQLState:"HY000", Message:"Using storage engine %s for table '%s' ", Description:"", MySQLVersion:"5.6"},
    1267: definition.ErrorDefinition{ErrorNumber:1267, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_2COLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations (%s,%s) and (%s,%s) for operation '%s' ", Description:"", MySQLVersion:"5.6"},
    1268: definition.ErrorDefinition{ErrorNumber:1268, ErrorType:"ServerError", Symbol:"ER_DROP_USER", SQLState:"HY000", Message:"Cannot drop one or more of the requested users ", Description:"", MySQLVersion:"5.6"},
    1269: definition.ErrorDefinition{ErrorNumber:1269, ErrorType:"ServerError", Symbol:"ER_REVOKE_GRANTS", SQLState:"HY000", Message:"Can't revoke all privileges for one or more of the requested users ", Description:"", MySQLVersion:"5.6"},
    1270: definition.ErrorDefinition{ErrorNumber:1270, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_3COLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations (%s,%s), (%s,%s), (%s,%s) for operation '%s' ", Description:"", MySQLVersion:"5.6"},
    1271: definition.ErrorDefinition{ErrorNumber:1271, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_NCOLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations for operation '%s' ", Description:"", MySQLVersion:"5.6"},
    1272: definition.ErrorDefinition{ErrorNumber:1272, ErrorType:"ServerError", Symbol:"ER_VARIABLE_IS_NOT_STRUCT", SQLState:"HY000", Message:"Variable '%s' is not a variable component (can't be used as XXXX.variable_name) ", Description:"", MySQLVersion:"5.6"},
    1273: definition.ErrorDefinition{ErrorNumber:1273, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_COLLATION", SQLState:"HY000", Message:"Unknown collation: '%s' ", Description:"", MySQLVersion:"5.6"},
    1274: definition.ErrorDefinition{ErrorNumber:1274, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORED_SSL_PARAMS", SQLState:"HY000", Message:"SSL parameters in CHANGE MASTER are ignored because this MySQL slave was compiled without SSL support", Description:"they can be used later if MySQL slave with SSL is started ", MySQLVersion:"5.6"},
    1275: definition.ErrorDefinition{ErrorNumber:1275, ErrorType:"ServerError", Symbol:"ER_SERVER_IS_IN_SECURE_AUTH_MODE", SQLState:"HY000", Message:"Server is running in --secure-auth mode, but '%s'@'%s' has a password in the old format", Description:"please change the password to the new format ", MySQLVersion:"5.6"},
    1276: definition.ErrorDefinition{ErrorNumber:1276, ErrorType:"ServerError", Symbol:"ER_WARN_FIELD_RESOLVED", SQLState:"HY000", Message:"Field or reference '%s%s%s%s%s' of SELECT #%d was resolved in SELECT #%d ", Description:"", MySQLVersion:"5.6"},
    1277: definition.ErrorDefinition{ErrorNumber:1277, ErrorType:"ServerError", Symbol:"ER_BAD_SLAVE_UNTIL_COND", SQLState:"HY000", Message:"Incorrect parameter or combination of parameters for START SLAVE UNTIL ", Description:"", MySQLVersion:"5.6"},
    1278: definition.ErrorDefinition{ErrorNumber:1278, ErrorType:"ServerError", Symbol:"ER_MISSING_SKIP_SLAVE", SQLState:"HY000", Message:"It is recommended to use --skip-slave-start when doing step-by-step replication with START SLAVE UNTIL", Description:"otherwise, you will get problems if you get an unexpected slave's mysqld restart ", MySQLVersion:"5.6"},
    1279: definition.ErrorDefinition{ErrorNumber:1279, ErrorType:"ServerError", Symbol:"ER_UNTIL_COND_IGNORED", SQLState:"HY000", Message:"SQL thread is not to be started so UNTIL options are ignored ", Description:"", MySQLVersion:"5.6"},
    1280: definition.ErrorDefinition{ErrorNumber:1280, ErrorType:"ServerError", Symbol:"ER_WRONG_NAME_FOR_INDEX", SQLState:"42000", Message:"Incorrect index name '%s' ", Description:"", MySQLVersion:"5.6"},
    1281: definition.ErrorDefinition{ErrorNumber:1281, ErrorType:"ServerError", Symbol:"ER_WRONG_NAME_FOR_CATALOG", SQLState:"42000", Message:"Incorrect catalog name '%s' ", Description:"", MySQLVersion:"5.6"},
    1282: definition.ErrorDefinition{ErrorNumber:1282, ErrorType:"ServerError", Symbol:"ER_WARN_QC_RESIZE", SQLState:"HY000", Message:"Query cache failed to set size %lu", Description:"new query cache size is %lu ", MySQLVersion:"5.6"},
    1283: definition.ErrorDefinition{ErrorNumber:1283, ErrorType:"ServerError", Symbol:"ER_BAD_FT_COLUMN", SQLState:"HY000", Message:"Column '%s' cannot be part of FULLTEXT index ", Description:"", MySQLVersion:"5.6"},
    1284: definition.ErrorDefinition{ErrorNumber:1284, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_KEY_CACHE", SQLState:"HY000", Message:"Unknown key cache '%s' ", Description:"", MySQLVersion:"5.6"},
    1285: definition.ErrorDefinition{ErrorNumber:1285, ErrorType:"ServerError", Symbol:"ER_WARN_HOSTNAME_WONT_WORK", SQLState:"HY000", Message:"MySQL is started in --skip-name-resolve mode", Description:"you must restart it without this switch for this grant to work ", MySQLVersion:"5.6"},
    1286: definition.ErrorDefinition{ErrorNumber:1286, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_STORAGE_ENGINE", SQLState:"42000", Message:"Unknown storage engine '%s' ", Description:"", MySQLVersion:"5.6"},
    1287: definition.ErrorDefinition{ErrorNumber:1287, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYNTAX", SQLState:"HY000", Message:"'%s' is deprecated and will be removed in a future release. Please use %s instead ", Description:"", MySQLVersion:"5.6"},
    1288: definition.ErrorDefinition{ErrorNumber:1288, ErrorType:"ServerError", Symbol:"ER_NON_UPDATABLE_TABLE", SQLState:"HY000", Message:"The target table %s of the %s is not updatable ", Description:"", MySQLVersion:"5.6"},
    1289: definition.ErrorDefinition{ErrorNumber:1289, ErrorType:"ServerError", Symbol:"ER_FEATURE_DISABLED", SQLState:"HY000", Message:"The '%s' feature is disabled", Description:"you need MySQL built with '%s' to have it working ", MySQLVersion:"5.6"},
    1290: definition.ErrorDefinition{ErrorNumber:1290, ErrorType:"ServerError", Symbol:"ER_OPTION_PREVENTS_STATEMENT", SQLState:"HY000", Message:"The MySQL server is running with the %s option so it cannot execute this statement ", Description:"", MySQLVersion:"5.6"},
    1291: definition.ErrorDefinition{ErrorNumber:1291, ErrorType:"ServerError", Symbol:"ER_DUPLICATED_VALUE_IN_TYPE", SQLState:"HY000", Message:"Column '%s' has duplicated value '%s' in %s ", Description:"", MySQLVersion:"5.6"},
    1292: definition.ErrorDefinition{ErrorNumber:1292, ErrorType:"ServerError", Symbol:"ER_TRUNCATED_WRONG_VALUE", SQLState:"22007", Message:"Truncated incorrect %s value: '%s' ", Description:"", MySQLVersion:"5.6"},
    1293: definition.ErrorDefinition{ErrorNumber:1293, ErrorType:"ServerError", Symbol:"ER_TOO_MUCH_AUTO_TIMESTAMP_COLS", SQLState:"HY000", Message:"Incorrect table definition", Description:"there can be only one TIMESTAMP column with CURRENT_TIMESTAMP in DEFAULT or ON UPDATE clause ", MySQLVersion:"5.6"},
    1294: definition.ErrorDefinition{ErrorNumber:1294, ErrorType:"ServerError", Symbol:"ER_INVALID_ON_UPDATE", SQLState:"HY000", Message:"Invalid ON UPDATE clause for '%s' column ", Description:"", MySQLVersion:"5.6"},
    1295: definition.ErrorDefinition{ErrorNumber:1295, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_PS", SQLState:"HY000", Message:"This command is not supported in the prepared statement protocol yet ", Description:"", MySQLVersion:"5.6"},
    1296: definition.ErrorDefinition{ErrorNumber:1296, ErrorType:"ServerError", Symbol:"ER_GET_ERRMSG", SQLState:"HY000", Message:"Got error %d '%s' from %s ", Description:"", MySQLVersion:"5.6"},
    1297: definition.ErrorDefinition{ErrorNumber:1297, ErrorType:"ServerError", Symbol:"ER_GET_TEMPORARY_ERRMSG", SQLState:"HY000", Message:"Got temporary error %d '%s' from %s ", Description:"", MySQLVersion:"5.6"},
    1298: definition.ErrorDefinition{ErrorNumber:1298, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TIME_ZONE", SQLState:"HY000", Message:"Unknown or incorrect time zone: '%s' ", Description:"", MySQLVersion:"5.6"},
    1299: definition.ErrorDefinition{ErrorNumber:1299, ErrorType:"ServerError", Symbol:"ER_WARN_INVALID_TIMESTAMP", SQLState:"HY000", Message:"Invalid TIMESTAMP value in column '%s' at row %ld ", Description:"", MySQLVersion:"5.6"},
    1300: definition.ErrorDefinition{ErrorNumber:1300, ErrorType:"ServerError", Symbol:"ER_INVALID_CHARACTER_STRING", SQLState:"HY000", Message:"Invalid %s character string: '%s' ", Description:"", MySQLVersion:"5.6"},
    1301: definition.ErrorDefinition{ErrorNumber:1301, ErrorType:"ServerError", Symbol:"ER_WARN_ALLOWED_PACKET_OVERFLOWED", SQLState:"HY000", Message:"Result of %s() was larger than max_allowed_packet (%ld) - truncated ", Description:"", MySQLVersion:"5.6"},
    1302: definition.ErrorDefinition{ErrorNumber:1302, ErrorType:"ServerError", Symbol:"ER_CONFLICTING_DECLARATIONS", SQLState:"HY000", Message:"Conflicting declarations: '%s%s' and '%s%s' ", Description:"", MySQLVersion:"5.6"},
    1303: definition.ErrorDefinition{ErrorNumber:1303, ErrorType:"ServerError", Symbol:"ER_SP_NO_RECURSIVE_CREATE", SQLState:"2F003", Message:"Can't create a %s from within another stored routine ", Description:"", MySQLVersion:"5.6"},
    1304: definition.ErrorDefinition{ErrorNumber:1304, ErrorType:"ServerError", Symbol:"ER_SP_ALREADY_EXISTS", SQLState:"42000", Message:"%s %s already exists ", Description:"", MySQLVersion:"5.6"},
    1305: definition.ErrorDefinition{ErrorNumber:1305, ErrorType:"ServerError", Symbol:"ER_SP_DOES_NOT_EXIST", SQLState:"42000", Message:"%s %s does not exist ", Description:"", MySQLVersion:"5.6"},
    1306: definition.ErrorDefinition{ErrorNumber:1306, ErrorType:"ServerError", Symbol:"ER_SP_DROP_FAILED", SQLState:"HY000", Message:"Failed to DROP %s %s ", Description:"", MySQLVersion:"5.6"},
    1307: definition.ErrorDefinition{ErrorNumber:1307, ErrorType:"ServerError", Symbol:"ER_SP_STORE_FAILED", SQLState:"HY000", Message:"Failed to CREATE %s %s ", Description:"", MySQLVersion:"5.6"},
    1308: definition.ErrorDefinition{ErrorNumber:1308, ErrorType:"ServerError", Symbol:"ER_SP_LILABEL_MISMATCH", SQLState:"42000", Message:"%s with no matching label: %s ", Description:"", MySQLVersion:"5.6"},
    1309: definition.ErrorDefinition{ErrorNumber:1309, ErrorType:"ServerError", Symbol:"ER_SP_LABEL_REDEFINE", SQLState:"42000", Message:"Redefining label %s ", Description:"", MySQLVersion:"5.6"},
    1310: definition.ErrorDefinition{ErrorNumber:1310, ErrorType:"ServerError", Symbol:"ER_SP_LABEL_MISMATCH", SQLState:"42000", Message:"End-label %s without match ", Description:"", MySQLVersion:"5.6"},
    1311: definition.ErrorDefinition{ErrorNumber:1311, ErrorType:"ServerError", Symbol:"ER_SP_UNINIT_VAR", SQLState:"01000", Message:"Referring to uninitialized variable %s ", Description:"", MySQLVersion:"5.6"},
    1312: definition.ErrorDefinition{ErrorNumber:1312, ErrorType:"ServerError", Symbol:"ER_SP_BADSELECT", SQLState:"0A000", Message:"PROCEDURE %s can't return a result set in the given context ", Description:"", MySQLVersion:"5.6"},
    1313: definition.ErrorDefinition{ErrorNumber:1313, ErrorType:"ServerError", Symbol:"ER_SP_BADRETURN", SQLState:"42000", Message:"RETURN is only allowed in a FUNCTION ", Description:"", MySQLVersion:"5.6"},
    1314: definition.ErrorDefinition{ErrorNumber:1314, ErrorType:"ServerError", Symbol:"ER_SP_BADSTATEMENT", SQLState:"0A000", Message:"%s is not allowed in stored procedures ", Description:"", MySQLVersion:"5.6"},
    1315: definition.ErrorDefinition{ErrorNumber:1315, ErrorType:"ServerError", Symbol:"ER_UPDATE_LOG_DEPRECATED_IGNORED", SQLState:"42000", Message:"The update log is deprecated and replaced by the binary log", Description:"SET SQL_LOG_UPDATE has been ignored. ", MySQLVersion:"5.6"},
    1316: definition.ErrorDefinition{ErrorNumber:1316, ErrorType:"ServerError", Symbol:"ER_UPDATE_LOG_DEPRECATED_TRANSLATED", SQLState:"42000", Message:"The update log is deprecated and replaced by the binary log", Description:"SET SQL_LOG_UPDATE has been translated to SET SQL_LOG_BIN. ", MySQLVersion:"5.6"},
    1317: definition.ErrorDefinition{ErrorNumber:1317, ErrorType:"ServerError", Symbol:"ER_QUERY_INTERRUPTED", SQLState:"70100", Message:"Query execution was interrupted ", Description:"", MySQLVersion:"5.6"},
    1318: definition.ErrorDefinition{ErrorNumber:1318, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NO_OF_ARGS", SQLState:"42000", Message:"Incorrect number of arguments for %s %s", Description:"expected %u, got %u ", MySQLVersion:"5.6"},
    1319: definition.ErrorDefinition{ErrorNumber:1319, ErrorType:"ServerError", Symbol:"ER_SP_COND_MISMATCH", SQLState:"42000", Message:"Undefined CONDITION: %s ", Description:"", MySQLVersion:"5.6"},
    1320: definition.ErrorDefinition{ErrorNumber:1320, ErrorType:"ServerError", Symbol:"ER_SP_NORETURN", SQLState:"42000", Message:"No RETURN found in FUNCTION %s ", Description:"", MySQLVersion:"5.6"},
    1321: definition.ErrorDefinition{ErrorNumber:1321, ErrorType:"ServerError", Symbol:"ER_SP_NORETURNEND", SQLState:"2F005", Message:"FUNCTION %s ended without RETURN ", Description:"", MySQLVersion:"5.6"},
    1322: definition.ErrorDefinition{ErrorNumber:1322, ErrorType:"ServerError", Symbol:"ER_SP_BAD_CURSOR_QUERY", SQLState:"42000", Message:"Cursor statement must be a SELECT ", Description:"", MySQLVersion:"5.6"},
    1323: definition.ErrorDefinition{ErrorNumber:1323, ErrorType:"ServerError", Symbol:"ER_SP_BAD_CURSOR_SELECT", SQLState:"42000", Message:"Cursor SELECT must not have INTO ", Description:"", MySQLVersion:"5.6"},
    1324: definition.ErrorDefinition{ErrorNumber:1324, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_MISMATCH", SQLState:"42000", Message:"Undefined CURSOR: %s ", Description:"", MySQLVersion:"5.6"},
    1325: definition.ErrorDefinition{ErrorNumber:1325, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_ALREADY_OPEN", SQLState:"24000", Message:"Cursor is already open ", Description:"", MySQLVersion:"5.6"},
    1326: definition.ErrorDefinition{ErrorNumber:1326, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_NOT_OPEN", SQLState:"24000", Message:"Cursor is not open ", Description:"", MySQLVersion:"5.6"},
    1327: definition.ErrorDefinition{ErrorNumber:1327, ErrorType:"ServerError", Symbol:"ER_SP_UNDECLARED_VAR", SQLState:"42000", Message:"Undeclared variable: %s ", Description:"", MySQLVersion:"5.6"},
    1328: definition.ErrorDefinition{ErrorNumber:1328, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NO_OF_FETCH_ARGS", SQLState:"HY000", Message:"Incorrect number of FETCH variables ", Description:"", MySQLVersion:"5.6"},
    1329: definition.ErrorDefinition{ErrorNumber:1329, ErrorType:"ServerError", Symbol:"ER_SP_FETCH_NO_DATA", SQLState:"02000", Message:"No data - zero rows fetched, selected, or processed ", Description:"", MySQLVersion:"5.6"},
    1330: definition.ErrorDefinition{ErrorNumber:1330, ErrorType:"ServerError", Symbol:"ER_SP_DUP_PARAM", SQLState:"42000", Message:"Duplicate parameter: %s ", Description:"", MySQLVersion:"5.6"},
    1331: definition.ErrorDefinition{ErrorNumber:1331, ErrorType:"ServerError", Symbol:"ER_SP_DUP_VAR", SQLState:"42000", Message:"Duplicate variable: %s ", Description:"", MySQLVersion:"5.6"},
    1332: definition.ErrorDefinition{ErrorNumber:1332, ErrorType:"ServerError", Symbol:"ER_SP_DUP_COND", SQLState:"42000", Message:"Duplicate condition: %s ", Description:"", MySQLVersion:"5.6"},
    1333: definition.ErrorDefinition{ErrorNumber:1333, ErrorType:"ServerError", Symbol:"ER_SP_DUP_CURS", SQLState:"42000", Message:"Duplicate cursor: %s ", Description:"", MySQLVersion:"5.6"},
    1334: definition.ErrorDefinition{ErrorNumber:1334, ErrorType:"ServerError", Symbol:"ER_SP_CANT_ALTER", SQLState:"HY000", Message:"Failed to ALTER %s %s ", Description:"", MySQLVersion:"5.6"},
    1335: definition.ErrorDefinition{ErrorNumber:1335, ErrorType:"ServerError", Symbol:"ER_SP_SUBSELECT_NYI", SQLState:"0A000", Message:"Subquery value not supported ", Description:"", MySQLVersion:"5.6"},
    1336: definition.ErrorDefinition{ErrorNumber:1336, ErrorType:"ServerError", Symbol:"ER_STMT_NOT_ALLOWED_IN_SF_OR_TRG", SQLState:"0A000", Message:"%s is not allowed in stored function or trigger ", Description:"", MySQLVersion:"5.6"},
    1337: definition.ErrorDefinition{ErrorNumber:1337, ErrorType:"ServerError", Symbol:"ER_SP_VARCOND_AFTER_CURSHNDLR", SQLState:"42000", Message:"Variable or condition declaration after cursor or handler declaration ", Description:"", MySQLVersion:"5.6"},
    1338: definition.ErrorDefinition{ErrorNumber:1338, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_AFTER_HANDLER", SQLState:"42000", Message:"Cursor declaration after handler declaration ", Description:"", MySQLVersion:"5.6"},
    1339: definition.ErrorDefinition{ErrorNumber:1339, ErrorType:"ServerError", Symbol:"ER_SP_CASE_NOT_FOUND", SQLState:"20000", Message:"Case not found for CASE statement ", Description:"", MySQLVersion:"5.6"},
    1340: definition.ErrorDefinition{ErrorNumber:1340, ErrorType:"ServerError", Symbol:"ER_FPARSER_TOO_BIG_FILE", SQLState:"HY000", Message:"Configuration file '%s' is too big ", Description:"", MySQLVersion:"5.6"},
    1341: definition.ErrorDefinition{ErrorNumber:1341, ErrorType:"ServerError", Symbol:"ER_FPARSER_BAD_HEADER", SQLState:"HY000", Message:"Malformed file type header in file '%s' ", Description:"", MySQLVersion:"5.6"},
    1342: definition.ErrorDefinition{ErrorNumber:1342, ErrorType:"ServerError", Symbol:"ER_FPARSER_EOF_IN_COMMENT", SQLState:"HY000", Message:"Unexpected end of file while parsing comment '%s' ", Description:"", MySQLVersion:"5.6"},
    1343: definition.ErrorDefinition{ErrorNumber:1343, ErrorType:"ServerError", Symbol:"ER_FPARSER_ERROR_IN_PARAMETER", SQLState:"HY000", Message:"Error while parsing parameter '%s' (line: '%s') ", Description:"", MySQLVersion:"5.6"},
    1344: definition.ErrorDefinition{ErrorNumber:1344, ErrorType:"ServerError", Symbol:"ER_FPARSER_EOF_IN_UNKNOWN_PARAMETER", SQLState:"HY000", Message:"Unexpected end of file while skipping unknown parameter '%s' ", Description:"", MySQLVersion:"5.6"},
    1345: definition.ErrorDefinition{ErrorNumber:1345, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_EXPLAIN", SQLState:"HY000", Message:"EXPLAIN/SHOW can not be issued", Description:"lacking privileges for underlying table ", MySQLVersion:"5.6"},
    1346: definition.ErrorDefinition{ErrorNumber:1346, ErrorType:"ServerError", Symbol:"ER_FRM_UNKNOWN_TYPE", SQLState:"HY000", Message:"File '%s' has unknown type '%s' in its header ", Description:"", MySQLVersion:"5.6"},
    1347: definition.ErrorDefinition{ErrorNumber:1347, ErrorType:"ServerError", Symbol:"ER_WRONG_OBJECT", SQLState:"HY000", Message:"'%s.%s' is not %s", Description:"The named object is incorrect for the type of operation attempted on it. It must be an object of the named type. ", MySQLVersion:"5.6"},
    1348: definition.ErrorDefinition{ErrorNumber:1348, ErrorType:"ServerError", Symbol:"ER_NONUPDATEABLE_COLUMN", SQLState:"HY000", Message:"Column '%s' is not updatable ", Description:"", MySQLVersion:"5.6"},
    1349: definition.ErrorDefinition{ErrorNumber:1349, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_DERIVED", SQLState:"HY000", Message:"View's SELECT contains a subquery in the FROM clause ", Description:"", MySQLVersion:"5.6"},
    1350: definition.ErrorDefinition{ErrorNumber:1350, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_CLAUSE", SQLState:"HY000", Message:"View's SELECT contains a '%s' clause ", Description:"", MySQLVersion:"5.6"},
    1351: definition.ErrorDefinition{ErrorNumber:1351, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_VARIABLE", SQLState:"HY000", Message:"View's SELECT contains a variable or parameter ", Description:"", MySQLVersion:"5.6"},
    1352: definition.ErrorDefinition{ErrorNumber:1352, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_TMPTABLE", SQLState:"HY000", Message:"View's SELECT refers to a temporary table '%s' ", Description:"", MySQLVersion:"5.6"},
    1353: definition.ErrorDefinition{ErrorNumber:1353, ErrorType:"ServerError", Symbol:"ER_VIEW_WRONG_LIST", SQLState:"HY000", Message:"View's SELECT and view's field list have different column counts ", Description:"", MySQLVersion:"5.6"},
    1354: definition.ErrorDefinition{ErrorNumber:1354, ErrorType:"ServerError", Symbol:"ER_WARN_VIEW_MERGE", SQLState:"HY000", Message:"View merge algorithm can't be used here for now (assumed undefined algorithm) ", Description:"", MySQLVersion:"5.6"},
    1355: definition.ErrorDefinition{ErrorNumber:1355, ErrorType:"ServerError", Symbol:"ER_WARN_VIEW_WITHOUT_KEY", SQLState:"HY000", Message:"View being updated does not have complete key of underlying table in it ", Description:"", MySQLVersion:"5.6"},
    1356: definition.ErrorDefinition{ErrorNumber:1356, ErrorType:"ServerError", Symbol:"ER_VIEW_INVALID", SQLState:"HY000", Message:"View '%s.%s' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them ", Description:"", MySQLVersion:"5.6"},
    1357: definition.ErrorDefinition{ErrorNumber:1357, ErrorType:"ServerError", Symbol:"ER_SP_NO_DROP_SP", SQLState:"HY000", Message:"Can't drop or alter a %s from within another stored routine ", Description:"", MySQLVersion:"5.6"},
    1358: definition.ErrorDefinition{ErrorNumber:1358, ErrorType:"ServerError", Symbol:"ER_SP_GOTO_IN_HNDLR", SQLState:"HY000", Message:"GOTO is not allowed in a stored procedure handler ", Description:"", MySQLVersion:"5.6"},
    1359: definition.ErrorDefinition{ErrorNumber:1359, ErrorType:"ServerError", Symbol:"ER_TRG_ALREADY_EXISTS", SQLState:"HY000", Message:"Trigger already exists ", Description:"", MySQLVersion:"5.6"},
    1360: definition.ErrorDefinition{ErrorNumber:1360, ErrorType:"ServerError", Symbol:"ER_TRG_DOES_NOT_EXIST", SQLState:"HY000", Message:"Trigger does not exist ", Description:"", MySQLVersion:"5.6"},
    1361: definition.ErrorDefinition{ErrorNumber:1361, ErrorType:"ServerError", Symbol:"ER_TRG_ON_VIEW_OR_TEMP_TABLE", SQLState:"HY000", Message:"Trigger's '%s' is view or temporary table ", Description:"", MySQLVersion:"5.6"},
    1362: definition.ErrorDefinition{ErrorNumber:1362, ErrorType:"ServerError", Symbol:"ER_TRG_CANT_CHANGE_ROW", SQLState:"HY000", Message:"Updating of %s row is not allowed in %strigger ", Description:"", MySQLVersion:"5.6"},
    1363: definition.ErrorDefinition{ErrorNumber:1363, ErrorType:"ServerError", Symbol:"ER_TRG_NO_SUCH_ROW_IN_TRG", SQLState:"HY000", Message:"There is no %s row in %s trigger ", Description:"", MySQLVersion:"5.6"},
    1364: definition.ErrorDefinition{ErrorNumber:1364, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT_FOR_FIELD", SQLState:"HY000", Message:"Field '%s' doesn't have a default value ", Description:"", MySQLVersion:"5.6"},
    1365: definition.ErrorDefinition{ErrorNumber:1365, ErrorType:"ServerError", Symbol:"ER_DIVISION_BY_ZERO", SQLState:"22012", Message:"Division by 0 ", Description:"", MySQLVersion:"5.6"},
    1366: definition.ErrorDefinition{ErrorNumber:1366, ErrorType:"ServerError", Symbol:"ER_TRUNCATED_WRONG_VALUE_FOR_FIELD", SQLState:"HY000", Message:"Incorrect %s value: '%s' for column '%s' at row %ld ", Description:"", MySQLVersion:"5.6"},
    1367: definition.ErrorDefinition{ErrorNumber:1367, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_VALUE_FOR_TYPE", SQLState:"22007", Message:"Illegal %s '%s' value found during parsing ", Description:"", MySQLVersion:"5.6"},
    1368: definition.ErrorDefinition{ErrorNumber:1368, ErrorType:"ServerError", Symbol:"ER_VIEW_NONUPD_CHECK", SQLState:"HY000", Message:"CHECK OPTION on non-updatable view '%s.%s' ", Description:"", MySQLVersion:"5.6"},
    1369: definition.ErrorDefinition{ErrorNumber:1369, ErrorType:"ServerError", Symbol:"ER_VIEW_CHECK_FAILED", SQLState:"HY000", Message:"CHECK OPTION failed '%s.%s' ", Description:"", MySQLVersion:"5.6"},
    1370: definition.ErrorDefinition{ErrorNumber:1370, ErrorType:"ServerError", Symbol:"ER_PROCACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for routine '%s' ", Description:"", MySQLVersion:"5.6"},
    1371: definition.ErrorDefinition{ErrorNumber:1371, ErrorType:"ServerError", Symbol:"ER_RELAY_LOG_FAIL", SQLState:"HY000", Message:"Failed purging old relay logs: %s ", Description:"", MySQLVersion:"5.6"},
    1372: definition.ErrorDefinition{ErrorNumber:1372, ErrorType:"ServerError", Symbol:"ER_PASSWD_LENGTH", SQLState:"HY000", Message:"Password hash should be a %d-digit hexadecimal number ", Description:"", MySQLVersion:"5.6"},
    1373: definition.ErrorDefinition{ErrorNumber:1373, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TARGET_BINLOG", SQLState:"HY000", Message:"Target log not found in binlog index ", Description:"", MySQLVersion:"5.6"},
    1374: definition.ErrorDefinition{ErrorNumber:1374, ErrorType:"ServerError", Symbol:"ER_IO_ERR_LOG_INDEX_READ", SQLState:"HY000", Message:"I/O error reading log index file ", Description:"", MySQLVersion:"5.6"},
    1375: definition.ErrorDefinition{ErrorNumber:1375, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_PROHIBITED", SQLState:"HY000", Message:"Server configuration does not permit binlog purge ", Description:"", MySQLVersion:"5.6"},
    1376: definition.ErrorDefinition{ErrorNumber:1376, ErrorType:"ServerError", Symbol:"ER_FSEEK_FAIL", SQLState:"HY000", Message:"Failed on fseek() ", Description:"", MySQLVersion:"5.6"},
    1377: definition.ErrorDefinition{ErrorNumber:1377, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_FATAL_ERR", SQLState:"HY000", Message:"Fatal error during log purge ", Description:"", MySQLVersion:"5.6"},
    1378: definition.ErrorDefinition{ErrorNumber:1378, ErrorType:"ServerError", Symbol:"ER_LOG_IN_USE", SQLState:"HY000", Message:"A purgeable log is in use, will not purge ", Description:"", MySQLVersion:"5.6"},
    1379: definition.ErrorDefinition{ErrorNumber:1379, ErrorType:"ServerError", Symbol:"ER_LOG_PURGE_UNKNOWN_ERR", SQLState:"HY000", Message:"Unknown error during log purge ", Description:"", MySQLVersion:"5.6"},
    1380: definition.ErrorDefinition{ErrorNumber:1380, ErrorType:"ServerError", Symbol:"ER_RELAY_LOG_INIT", SQLState:"HY000", Message:"Failed initializing relay log position: %s ", Description:"", MySQLVersion:"5.6"},
    1381: definition.ErrorDefinition{ErrorNumber:1381, ErrorType:"ServerError", Symbol:"ER_NO_BINARY_LOGGING", SQLState:"HY000", Message:"You are not using binary logging ", Description:"", MySQLVersion:"5.6"},
    1382: definition.ErrorDefinition{ErrorNumber:1382, ErrorType:"ServerError", Symbol:"ER_RESERVED_SYNTAX", SQLState:"HY000", Message:"The '%s' syntax is reserved for purposes internal to the MySQL server ", Description:"", MySQLVersion:"5.6"},
    1383: definition.ErrorDefinition{ErrorNumber:1383, ErrorType:"ServerError", Symbol:"ER_WSAS_FAILED", SQLState:"HY000", Message:"WSAStartup Failed ", Description:"", MySQLVersion:"5.6"},
    1384: definition.ErrorDefinition{ErrorNumber:1384, ErrorType:"ServerError", Symbol:"ER_DIFF_GROUPS_PROC", SQLState:"HY000", Message:"Can't handle procedures with different groups yet ", Description:"", MySQLVersion:"5.6"},
    1385: definition.ErrorDefinition{ErrorNumber:1385, ErrorType:"ServerError", Symbol:"ER_NO_GROUP_FOR_PROC", SQLState:"HY000", Message:"Select must have a group with this procedure ", Description:"", MySQLVersion:"5.6"},
    1386: definition.ErrorDefinition{ErrorNumber:1386, ErrorType:"ServerError", Symbol:"ER_ORDER_WITH_PROC", SQLState:"HY000", Message:"Can't use ORDER clause with this procedure ", Description:"", MySQLVersion:"5.6"},
    1387: definition.ErrorDefinition{ErrorNumber:1387, ErrorType:"ServerError", Symbol:"ER_LOGGING_PROHIBIT_CHANGING_OF", SQLState:"HY000", Message:"Binary logging and replication forbid changing the global server %s ", Description:"", MySQLVersion:"5.6"},
    1388: definition.ErrorDefinition{ErrorNumber:1388, ErrorType:"ServerError", Symbol:"ER_NO_FILE_MAPPING", SQLState:"HY000", Message:"Can't map file: %s, errno: %d ", Description:"", MySQLVersion:"5.6"},
    1389: definition.ErrorDefinition{ErrorNumber:1389, ErrorType:"ServerError", Symbol:"ER_WRONG_MAGIC", SQLState:"HY000", Message:"Wrong magic in %s ", Description:"", MySQLVersion:"5.6"},
    1390: definition.ErrorDefinition{ErrorNumber:1390, ErrorType:"ServerError", Symbol:"ER_PS_MANY_PARAM", SQLState:"HY000", Message:"Prepared statement contains too many placeholders ", Description:"", MySQLVersion:"5.6"},
    1391: definition.ErrorDefinition{ErrorNumber:1391, ErrorType:"ServerError", Symbol:"ER_KEY_PART_0", SQLState:"HY000", Message:"Key part '%s' length cannot be 0 ", Description:"", MySQLVersion:"5.6"},
    1392: definition.ErrorDefinition{ErrorNumber:1392, ErrorType:"ServerError", Symbol:"ER_VIEW_CHECKSUM", SQLState:"HY000", Message:"View text checksum failed ", Description:"", MySQLVersion:"5.6"},
    1393: definition.ErrorDefinition{ErrorNumber:1393, ErrorType:"ServerError", Symbol:"ER_VIEW_MULTIUPDATE", SQLState:"HY000", Message:"Can not modify more than one base table through a join view '%s.%s' ", Description:"", MySQLVersion:"5.6"},
    1394: definition.ErrorDefinition{ErrorNumber:1394, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_INSERT_FIELD_LIST", SQLState:"HY000", Message:"Can not insert into join view '%s.%s' without fields list ", Description:"", MySQLVersion:"5.6"},
    1395: definition.ErrorDefinition{ErrorNumber:1395, ErrorType:"ServerError", Symbol:"ER_VIEW_DELETE_MERGE_VIEW", SQLState:"HY000", Message:"Can not delete from join view '%s.%s' ", Description:"", MySQLVersion:"5.6"},
    1396: definition.ErrorDefinition{ErrorNumber:1396, ErrorType:"ServerError", Symbol:"ER_CANNOT_USER", SQLState:"HY000", Message:"Operation %s failed for %s ", Description:"", MySQLVersion:"5.6"},
    1397: definition.ErrorDefinition{ErrorNumber:1397, ErrorType:"ServerError", Symbol:"ER_XAER_NOTA", SQLState:"XAE04", Message:"XAER_NOTA: Unknown XID ", Description:"", MySQLVersion:"5.6"},
    1398: definition.ErrorDefinition{ErrorNumber:1398, ErrorType:"ServerError", Symbol:"ER_XAER_INVAL", SQLState:"XAE05", Message:"XAER_INVAL: Invalid arguments (or unsupported command) ", Description:"", MySQLVersion:"5.6"},
    1399: definition.ErrorDefinition{ErrorNumber:1399, ErrorType:"ServerError", Symbol:"ER_XAER_RMFAIL", SQLState:"XAE07", Message:"XAER_RMFAIL: The command cannot be executed when global transaction is in the %s state ", Description:"", MySQLVersion:"5.6"},
    1400: definition.ErrorDefinition{ErrorNumber:1400, ErrorType:"ServerError", Symbol:"ER_XAER_OUTSIDE", SQLState:"XAE09", Message:"XAER_OUTSIDE: Some work is done outside global transaction ", Description:"", MySQLVersion:"5.6"},
    1401: definition.ErrorDefinition{ErrorNumber:1401, ErrorType:"ServerError", Symbol:"ER_XAER_RMERR", SQLState:"XAE03", Message:"XAER_RMERR: Fatal error occurred in the transaction branch - check your data for consistency ", Description:"", MySQLVersion:"5.6"},
    1402: definition.ErrorDefinition{ErrorNumber:1402, ErrorType:"ServerError", Symbol:"ER_XA_RBROLLBACK", SQLState:"XA100", Message:"XA_RBROLLBACK: Transaction branch was rolled back ", Description:"", MySQLVersion:"5.6"},
    1403: definition.ErrorDefinition{ErrorNumber:1403, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_PROC_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s' on routine '%s' ", Description:"", MySQLVersion:"5.6"},
    1404: definition.ErrorDefinition{ErrorNumber:1404, ErrorType:"ServerError", Symbol:"ER_PROC_AUTO_GRANT_FAIL", SQLState:"HY000", Message:"Failed to grant EXECUTE and ALTER ROUTINE privileges ", Description:"", MySQLVersion:"5.6"},
    1405: definition.ErrorDefinition{ErrorNumber:1405, ErrorType:"ServerError", Symbol:"ER_PROC_AUTO_REVOKE_FAIL", SQLState:"HY000", Message:"Failed to revoke all privileges to dropped routine ", Description:"", MySQLVersion:"5.6"},
    1406: definition.ErrorDefinition{ErrorNumber:1406, ErrorType:"ServerError", Symbol:"ER_DATA_TOO_LONG", SQLState:"22001", Message:"Data too long for column '%s' at row %ld ", Description:"", MySQLVersion:"5.6"},
    1407: definition.ErrorDefinition{ErrorNumber:1407, ErrorType:"ServerError", Symbol:"ER_SP_BAD_SQLSTATE", SQLState:"42000", Message:"Bad SQLSTATE: '%s' ", Description:"", MySQLVersion:"5.6"},
    1408: definition.ErrorDefinition{ErrorNumber:1408, ErrorType:"ServerError", Symbol:"ER_STARTUP", SQLState:"HY000", Message:"%s: ready for connections. Version: '%s' socket: '%s' port: %d %s ", Description:"", MySQLVersion:"5.6"},
    1409: definition.ErrorDefinition{ErrorNumber:1409, ErrorType:"ServerError", Symbol:"ER_LOAD_FROM_FIXED_SIZE_ROWS_TO_VAR", SQLState:"HY000", Message:"Can't load value from file with fixed size rows to variable ", Description:"", MySQLVersion:"5.6"},
    1410: definition.ErrorDefinition{ErrorNumber:1410, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_USER_WITH_GRANT", SQLState:"42000", Message:"You are not allowed to create a user with GRANT ", Description:"", MySQLVersion:"5.6"},
    1411: definition.ErrorDefinition{ErrorNumber:1411, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_FOR_TYPE", SQLState:"HY000", Message:"Incorrect %s value: '%s' for function %s ", Description:"", MySQLVersion:"5.6"},
    1412: definition.ErrorDefinition{ErrorNumber:1412, ErrorType:"ServerError", Symbol:"ER_TABLE_DEF_CHANGED", SQLState:"HY000", Message:"Table definition has changed, please retry transaction ", Description:"", MySQLVersion:"5.6"},
    1413: definition.ErrorDefinition{ErrorNumber:1413, ErrorType:"ServerError", Symbol:"ER_SP_DUP_HANDLER", SQLState:"42000", Message:"Duplicate handler declared in the same block ", Description:"", MySQLVersion:"5.6"},
    1414: definition.ErrorDefinition{ErrorNumber:1414, ErrorType:"ServerError", Symbol:"ER_SP_NOT_VAR_ARG", SQLState:"42000", Message:"OUT or INOUT argument %d for routine %s is not a variable or NEW pseudo-variable in BEFORE trigger ", Description:"", MySQLVersion:"5.6"},
    1415: definition.ErrorDefinition{ErrorNumber:1415, ErrorType:"ServerError", Symbol:"ER_SP_NO_RETSET", SQLState:"0A000", Message:"Not allowed to return a result set from a %s ", Description:"", MySQLVersion:"5.6"},
    1416: definition.ErrorDefinition{ErrorNumber:1416, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_GEOMETRY_OBJECT", SQLState:"22003", Message:"Cannot get geometry object from data you send to the GEOMETRY field ", Description:"", MySQLVersion:"5.6"},
    1417: definition.ErrorDefinition{ErrorNumber:1417, ErrorType:"ServerError", Symbol:"ER_FAILED_ROUTINE_BREAK_BINLOG", SQLState:"HY000", Message:"A routine failed and has neither NO SQL nor READS SQL DATA in its declaration and binary logging is enabled", Description:"if non-transactional tables were updated, the binary log will miss their changes ", MySQLVersion:"5.6"},
    ...
    1420: definition.ErrorDefinition{ErrorNumber:1420, ErrorType:"ServerError", Symbol:"ER_EXEC_STMT_WITH_OPEN_CURSOR", SQLState:"HY000", Message:"You can't execute a prepared statement which has an open cursor associated with it. Reset the statement to re-execute it. ", Description:"", MySQLVersion:"5.6"},
    1421: definition.ErrorDefinition{ErrorNumber:1421, ErrorType:"ServerError", Symbol:"ER_STMT_HAS_NO_OPEN_CURSOR", SQLState:"HY000", Message:"The statement (%lu) has no open cursor. ", Description:"", MySQLVersion:"5.6"},
    1422: definition.ErrorDefinition{ErrorNumber:1422, ErrorType:"ServerError", Symbol:"ER_COMMIT_NOT_ALLOWED_IN_SF_OR_TRG", SQLState:"HY000", Message:"Explicit or implicit commit is not allowed in stored function or trigger. ", Description:"", MySQLVersion:"5.6"},
    1423: definition.ErrorDefinition{ErrorNumber:1423, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT_FOR_VIEW_FIELD", SQLState:"HY000", Message:"Field of view '%s.%s' underlying table doesn't have a default value ", Description:"", MySQLVersion:"5.6"},
    1424: definition.ErrorDefinition{ErrorNumber:1424, ErrorType:"ServerError", Symbol:"ER_SP_NO_RECURSION", SQLState:"HY000", Message:"Recursive stored functions and triggers are not allowed. ", Description:"", MySQLVersion:"5.6"},
    1425: definition.ErrorDefinition{ErrorNumber:1425, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SCALE", SQLState:"42000", Message:"Too big scale %d specified for column '%s'. Maximum is %lu. ", Description:"", MySQLVersion:"5.6"},
    1426: definition.ErrorDefinition{ErrorNumber:1426, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_PRECISION", SQLState:"42000", Message:"Too big precision %d specified for column '%s'. Maximum is %lu. ", Description:"", MySQLVersion:"5.6"},
    1427: definition.ErrorDefinition{ErrorNumber:1427, ErrorType:"ServerError", Symbol:"ER_M_BIGGER_THAN_D", SQLState:"42000", Message:"For float(M,D), double(M,D) or decimal(M,D), M must be >= D (column '%s'). ", Description:"", MySQLVersion:"5.6"},
    1428: definition.ErrorDefinition{ErrorNumber:1428, ErrorType:"ServerError", Symbol:"ER_WRONG_LOCK_OF_SYSTEM_TABLE", SQLState:"HY000", Message:"You can't combine write-locking of system tables with other tables or lock types ", Description:"", MySQLVersion:"5.6"},
    1429: definition.ErrorDefinition{ErrorNumber:1429, ErrorType:"ServerError", Symbol:"ER_CONNECT_TO_FOREIGN_DATA_SOURCE", SQLState:"HY000", Message:"Unable to connect to foreign data source: %s ", Description:"", MySQLVersion:"5.6"},
    1430: definition.ErrorDefinition{ErrorNumber:1430, ErrorType:"ServerError", Symbol:"ER_QUERY_ON_FOREIGN_DATA_SOURCE", SQLState:"HY000", Message:"There was a problem processing the query on the foreign data source. Data source error: %s ", Description:"", MySQLVersion:"5.6"},
    1431: definition.ErrorDefinition{ErrorNumber:1431, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_SOURCE_DOESNT_EXIST", SQLState:"HY000", Message:"The foreign data source you are trying to reference does not exist. Data source error: %s ", Description:"", MySQLVersion:"5.6"},
    1432: definition.ErrorDefinition{ErrorNumber:1432, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE", SQLState:"HY000", Message:"Can't create federated table. The data source connection string '%s' is not in the correct format ", Description:"", MySQLVersion:"5.6"},
    1433: definition.ErrorDefinition{ErrorNumber:1433, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_STRING_INVALID", SQLState:"HY000", Message:"The data source connection string '%s' is not in the correct format ", Description:"", MySQLVersion:"5.6"},
    1434: definition.ErrorDefinition{ErrorNumber:1434, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_FEDERATED_TABLE", SQLState:"HY000", Message:"Can't create federated table. Foreign data src error: %s ", Description:"", MySQLVersion:"5.6"},
    1435: definition.ErrorDefinition{ErrorNumber:1435, ErrorType:"ServerError", Symbol:"ER_TRG_IN_WRONG_SCHEMA", SQLState:"HY000", Message:"Trigger in wrong schema ", Description:"", MySQLVersion:"5.6"},
    1436: definition.ErrorDefinition{ErrorNumber:1436, ErrorType:"ServerError", Symbol:"ER_STACK_OVERRUN_NEED_MORE", SQLState:"HY000", Message:"Thread stack overrun: %ld bytes used of a %ld byte stack, and %ld bytes needed. Use 'mysqld --thread_stack=#' to specify a bigger stack. ", Description:"", MySQLVersion:"5.6"},
    1437: definition.ErrorDefinition{ErrorNumber:1437, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_BODY", SQLState:"42000", Message:"Routine body for '%s' is too long ", Description:"", MySQLVersion:"5.6"},
    1438: definition.ErrorDefinition{ErrorNumber:1438, ErrorType:"ServerError", Symbol:"ER_WARN_CANT_DROP_DEFAULT_KEYCACHE", SQLState:"HY000", Message:"Cannot drop default keycache ", Description:"", MySQLVersion:"5.6"},
    1439: definition.ErrorDefinition{ErrorNumber:1439, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_DISPLAYWIDTH", SQLState:"42000", Message:"Display width out of range for column '%s' (max = %lu) ", Description:"", MySQLVersion:"5.6"},
    1440: definition.ErrorDefinition{ErrorNumber:1440, ErrorType:"ServerError", Symbol:"ER_XAER_DUPID", SQLState:"XAE08", Message:"XAER_DUPID: The XID already exists ", Description:"", MySQLVersion:"5.6"},
    1441: definition.ErrorDefinition{ErrorNumber:1441, ErrorType:"ServerError", Symbol:"ER_DATETIME_FUNCTION_OVERFLOW", SQLState:"22008", Message:"Datetime function: %s field overflow ", Description:"", MySQLVersion:"5.6"},
    1442: definition.ErrorDefinition{ErrorNumber:1442, ErrorType:"ServerError", Symbol:"ER_CANT_UPDATE_USED_TABLE_IN_SF_OR_TRG", SQLState:"HY000", Message:"Can't update table '%s' in stored function/trigger because it is already used by statement which invoked this stored function/trigger. ", Description:"", MySQLVersion:"5.6"},
    1443: definition.ErrorDefinition{ErrorNumber:1443, ErrorType:"ServerError", Symbol:"ER_VIEW_PREVENT_UPDATE", SQLState:"HY000", Message:"The definition of table '%s' prevents operation %s on table '%s'. ", Description:"", MySQLVersion:"5.6"},
    1444: definition.ErrorDefinition{ErrorNumber:1444, ErrorType:"ServerError", Symbol:"ER_PS_NO_RECURSION", SQLState:"HY000", Message:"The prepared statement contains a stored routine call that refers to that same statement. It's not allowed to execute a prepared statement in such a recursive manner ", Description:"", MySQLVersion:"5.6"},
    1445: definition.ErrorDefinition{ErrorNumber:1445, ErrorType:"ServerError", Symbol:"ER_SP_CANT_SET_AUTOCOMMIT", SQLState:"HY000", Message:"Not allowed to set autocommit from a stored function or trigger ", Description:"", MySQLVersion:"5.6"},
    1446: definition.ErrorDefinition{ErrorNumber:1446, ErrorType:"ServerError", Symbol:"ER_MALFORMED_DEFINER", SQLState:"HY000", Message:"Definer is not fully qualified ", Description:"", MySQLVersion:"5.6"},
    1447: definition.ErrorDefinition{ErrorNumber:1447, ErrorType:"ServerError", Symbol:"ER_VIEW_FRM_NO_USER", SQLState:"HY000", Message:"View '%s'.'%s' has no definer information (old table format). Current user is used as definer. Please recreate the view! ", Description:"", MySQLVersion:"5.6"},
    1448: definition.ErrorDefinition{ErrorNumber:1448, ErrorType:"ServerError", Symbol:"ER_VIEW_OTHER_USER", SQLState:"HY000", Message:"You need the SUPER privilege for creation view with '%s'@'%s' definer ", Description:"", MySQLVersion:"5.6"},
    1449: definition.ErrorDefinition{ErrorNumber:1449, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_USER", SQLState:"HY000", Message:"The user specified as a definer ('%s'@'%s') does not exist ", Description:"", MySQLVersion:"5.6"},
    1450: definition.ErrorDefinition{ErrorNumber:1450, ErrorType:"ServerError", Symbol:"ER_FORBID_SCHEMA_CHANGE", SQLState:"HY000", Message:"Changing schema from '%s' to '%s' is not allowed. ", Description:"", MySQLVersion:"5.6"},
    1451: definition.ErrorDefinition{ErrorNumber:1451, ErrorType:"ServerError", Symbol:"ER_ROW_IS_REFERENCED_2", SQLState:"23000", Message:"Cannot delete or update a parent row: a foreign key constraint fails (%s)", Description:"InnoDB reports this error when you try to delete a parent row that has children, and a foreign key constraint fails. Delete the children first. ", MySQLVersion:"5.6"},
    1452: definition.ErrorDefinition{ErrorNumber:1452, ErrorType:"ServerError", Symbol:"ER_NO_REFERENCED_ROW_2", SQLState:"23000", Message:"Cannot add or update a child row: a foreign key constraint fails (%s)", Description:"InnoDB reports this error when you try to add a row but there is no parent row, and a foreign key constraint fails. Add the parent row first. ", MySQLVersion:"5.6"},
    1453: definition.ErrorDefinition{ErrorNumber:1453, ErrorType:"ServerError", Symbol:"ER_SP_BAD_VAR_SHADOW", SQLState:"42000", Message:"Variable '%s' must be quoted with `...`, or renamed ", Description:"", MySQLVersion:"5.6"},
    1454: definition.ErrorDefinition{ErrorNumber:1454, ErrorType:"ServerError", Symbol:"ER_TRG_NO_DEFINER", SQLState:"HY000", Message:"No definer attribute for trigger '%s'.'%s'. The trigger will be activated under the authorization of the invoker, which may have insufficient privileges. Please recreate the trigger. ", Description:"", MySQLVersion:"5.6"},
    1455: definition.ErrorDefinition{ErrorNumber:1455, ErrorType:"ServerError", Symbol:"ER_OLD_FILE_FORMAT", SQLState:"HY000", Message:"'%s' has an old format, you should re-create the '%s' object(s) ", Description:"", MySQLVersion:"5.6"},
    1456: definition.ErrorDefinition{ErrorNumber:1456, ErrorType:"ServerError", Symbol:"ER_SP_RECURSION_LIMIT", SQLState:"HY000", Message:"Recursive limit %d (as set by the max_sp_recursion_depth variable) was exceeded for routine %s ", Description:"", MySQLVersion:"5.6"},
    1457: definition.ErrorDefinition{ErrorNumber:1457, ErrorType:"ServerError", Symbol:"ER_SP_PROC_TABLE_CORRUPT", SQLState:"HY000", Message:"Failed to load routine %s. The table mysql.proc is missing, corrupt, or contains bad data (internal code %d) ", Description:"", MySQLVersion:"5.6"},
    1458: definition.ErrorDefinition{ErrorNumber:1458, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NAME", SQLState:"42000", Message:"Incorrect routine name '%s' ", Description:"", MySQLVersion:"5.6"},
    1459: definition.ErrorDefinition{ErrorNumber:1459, ErrorType:"ServerError", Symbol:"ER_TABLE_NEEDS_UPGRADE", SQLState:"HY000", Message:"Table upgrade required. Please do \"REPAIR TABLE `%s`\" or dump/reload to fix it! ", Description:"", MySQLVersion:"5.6"},
    1460: definition.ErrorDefinition{ErrorNumber:1460, ErrorType:"ServerError", Symbol:"ER_SP_NO_AGGREGATE", SQLState:"42000", Message:"AGGREGATE is not supported for stored functions ", Description:"", MySQLVersion:"5.6"},
    1461: definition.ErrorDefinition{ErrorNumber:1461, ErrorType:"ServerError", Symbol:"ER_MAX_PREPARED_STMT_COUNT_REACHED", SQLState:"42000", Message:"Can't create more than max_prepared_stmt_count statements (current value: %lu) ", Description:"", MySQLVersion:"5.6"},
    1462: definition.ErrorDefinition{ErrorNumber:1462, ErrorType:"ServerError", Symbol:"ER_VIEW_RECURSIVE", SQLState:"HY000", Message:"`%s`.`%s` contains view recursion ", Description:"", MySQLVersion:"5.6"},
    1463: definition.ErrorDefinition{ErrorNumber:1463, ErrorType:"ServerError", Symbol:"ER_NON_GROUPING_FIELD_USED", SQLState:"42000", Message:"Non-grouping field '%s' is used in %s clause ", Description:"", MySQLVersion:"5.6"},
    1464: definition.ErrorDefinition{ErrorNumber:1464, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_SPKEYS", SQLState:"HY000", Message:"The used table type doesn't support SPATIAL indexes ", Description:"", MySQLVersion:"5.6"},
    1465: definition.ErrorDefinition{ErrorNumber:1465, ErrorType:"ServerError", Symbol:"ER_NO_TRIGGERS_ON_SYSTEM_SCHEMA", SQLState:"HY000", Message:"Triggers can not be created on system tables ", Description:"", MySQLVersion:"5.6"},
    1466: definition.ErrorDefinition{ErrorNumber:1466, ErrorType:"ServerError", Symbol:"ER_REMOVED_SPACES", SQLState:"HY000", Message:"Leading spaces are removed from name '%s' ", Description:"", MySQLVersion:"5.6"},
    1467: definition.ErrorDefinition{ErrorNumber:1467, ErrorType:"ServerError", Symbol:"ER_AUTOINC_READ_FAILED", SQLState:"HY000", Message:"Failed to read auto-increment value from storage engine ", Description:"", MySQLVersion:"5.6"},
    1468: definition.ErrorDefinition{ErrorNumber:1468, ErrorType:"ServerError", Symbol:"ER_USERNAME", SQLState:"HY000", Message:"user name ", Description:"", MySQLVersion:"5.6"},
    1469: definition.ErrorDefinition{ErrorNumber:1469, ErrorType:"ServerError", Symbol:"ER_HOSTNAME", SQLState:"HY000", Message:"host name ", Description:"", MySQLVersion:"5.6"},
    1470: definition.ErrorDefinition{ErrorNumber:1470, ErrorType:"ServerError", Symbol:"ER_WRONG_STRING_LENGTH", SQLState:"HY000", Message:"String '%s' is too long for %s (should be no longer than %d) ", Description:"", MySQLVersion:"5.6"},
    1471: definition.ErrorDefinition{ErrorNumber:1471, ErrorType:"ServerError", Symbol:"ER_NON_INSERTABLE_TABLE", SQLState:"HY000", Message:"The target table %s of the %s is not insertable-into ", Description:"", MySQLVersion:"5.6"},
    1472: definition.ErrorDefinition{ErrorNumber:1472, ErrorType:"ServerError", Symbol:"ER_ADMIN_WRONG_MRG_TABLE", SQLState:"HY000", Message:"Table '%s' is differently defined or of non-MyISAM type or doesn't exist ", Description:"", MySQLVersion:"5.6"},
    1473: definition.ErrorDefinition{ErrorNumber:1473, ErrorType:"ServerError", Symbol:"ER_TOO_HIGH_LEVEL_OF_NESTING_FOR_SELECT", SQLState:"HY000", Message:"Too high level of nesting for select ", Description:"", MySQLVersion:"5.6"},
    1474: definition.ErrorDefinition{ErrorNumber:1474, ErrorType:"ServerError", Symbol:"ER_NAME_BECOMES_EMPTY", SQLState:"HY000", Message:"Name '%s' has become '' ", Description:"", MySQLVersion:"5.6"},
    1475: definition.ErrorDefinition{ErrorNumber:1475, ErrorType:"ServerError", Symbol:"ER_AMBIGUOUS_FIELD_TERM", SQLState:"HY000", Message:"First character of the FIELDS TERMINATED string is ambiguous", Description:"please use non-optional and non-empty FIELDS ENCLOSED BY ", MySQLVersion:"5.6"},
    1476: definition.ErrorDefinition{ErrorNumber:1476, ErrorType:"ServerError", Symbol:"ER_FOREIGN_SERVER_EXISTS", SQLState:"HY000", Message:"The foreign server, %s, you are trying to create already exists. ", Description:"", MySQLVersion:"5.6"},
    1477: definition.ErrorDefinition{ErrorNumber:1477, ErrorType:"ServerError", Symbol:"ER_FOREIGN_SERVER_DOESNT_EXIST", SQLState:"HY000", Message:"The foreign server name you are trying to reference does not exist. Data source error: %s ", Description:"", MySQLVersion:"5.6"},
    1478: definition.ErrorDefinition{ErrorNumber:1478, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_HA_CREATE_OPTION", SQLState:"HY000", Message:"Table storage engine '%s' does not support the create option '%s' ", Description:"", MySQLVersion:"5.6"},
    1479: definition.ErrorDefinition{ErrorNumber:1479, ErrorType:"ServerError", Symbol:"ER_PARTITION_REQUIRES_VALUES_ERROR", SQLState:"HY000", Message:"Syntax error: %s PARTITIONING requires definition of VALUES %s for each partition ", Description:"", MySQLVersion:"5.6"},
    1480: definition.ErrorDefinition{ErrorNumber:1480, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_VALUES_ERROR", SQLState:"HY000", Message:"Only %s PARTITIONING can use VALUES %s in partition definition ", Description:"", MySQLVersion:"5.6"},
    1481: definition.ErrorDefinition{ErrorNumber:1481, ErrorType:"ServerError", Symbol:"ER_PARTITION_MAXVALUE_ERROR", SQLState:"HY000", Message:"MAXVALUE can only be used in last partition definition ", Description:"", MySQLVersion:"5.6"},
    1482: definition.ErrorDefinition{ErrorNumber:1482, ErrorType:"ServerError", Symbol:"ER_PARTITION_SUBPARTITION_ERROR", SQLState:"HY000", Message:"Subpartitions can only be hash partitions and by key ", Description:"", MySQLVersion:"5.6"},
    1483: definition.ErrorDefinition{ErrorNumber:1483, ErrorType:"ServerError", Symbol:"ER_PARTITION_SUBPART_MIX_ERROR", SQLState:"HY000", Message:"Must define subpartitions on all partitions if on one partition ", Description:"", MySQLVersion:"5.6"},
    1484: definition.ErrorDefinition{ErrorNumber:1484, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_NO_PART_ERROR", SQLState:"HY000", Message:"Wrong number of partitions defined, mismatch with previous setting ", Description:"", MySQLVersion:"5.6"},
    1485: definition.ErrorDefinition{ErrorNumber:1485, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_NO_SUBPART_ERROR", SQLState:"HY000", Message:"Wrong number of subpartitions defined, mismatch with previous setting ", Description:"", MySQLVersion:"5.6"},
    1486: definition.ErrorDefinition{ErrorNumber:1486, ErrorType:"ServerError", Symbol:"ER_WRONG_EXPR_IN_PARTITION_FUNC_ERROR", SQLState:"HY000", Message:"Constant, random or timezone-dependent expressions in (sub)partitioning function are not allowed ", Description:"", MySQLVersion:"5.6"},
    1487: definition.ErrorDefinition{ErrorNumber:1487, ErrorType:"ServerError", Symbol:"ER_NO_CONST_EXPR_IN_RANGE_OR_LIST_ERROR", SQLState:"HY000", Message:"Expression in RANGE/LIST VALUES must be constant ", Description:"", MySQLVersion:"5.6"},
    1488: definition.ErrorDefinition{ErrorNumber:1488, ErrorType:"ServerError", Symbol:"ER_FIELD_NOT_FOUND_PART_ERROR", SQLState:"HY000", Message:"Field in list of fields for partition function not found in table ", Description:"", MySQLVersion:"5.6"},
    1489: definition.ErrorDefinition{ErrorNumber:1489, ErrorType:"ServerError", Symbol:"ER_LIST_OF_FIELDS_ONLY_IN_HASH_ERROR", SQLState:"HY000", Message:"List of fields is only allowed in KEY partitions ", Description:"", MySQLVersion:"5.6"},
    1490: definition.ErrorDefinition{ErrorNumber:1490, ErrorType:"ServerError", Symbol:"ER_INCONSISTENT_PARTITION_INFO_ERROR", SQLState:"HY000", Message:"The partition info in the frm file is not consistent with what can be written into the frm file ", Description:"", MySQLVersion:"5.6"},
    1491: definition.ErrorDefinition{ErrorNumber:1491, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNC_NOT_ALLOWED_ERROR", SQLState:"HY000", Message:"The %s function returns the wrong type ", Description:"", MySQLVersion:"5.6"},
    1492: definition.ErrorDefinition{ErrorNumber:1492, ErrorType:"ServerError", Symbol:"ER_PARTITIONS_MUST_BE_DEFINED_ERROR", SQLState:"HY000", Message:"For %s partitions each partition must be defined ", Description:"", MySQLVersion:"5.6"},
    1493: definition.ErrorDefinition{ErrorNumber:1493, ErrorType:"ServerError", Symbol:"ER_RANGE_NOT_INCREASING_ERROR", SQLState:"HY000", Message:"VALUES LESS THAN value must be strictly increasing for each partition ", Description:"", MySQLVersion:"5.6"},
    1494: definition.ErrorDefinition{ErrorNumber:1494, ErrorType:"ServerError", Symbol:"ER_INCONSISTENT_TYPE_OF_FUNCTIONS_ERROR", SQLState:"HY000", Message:"VALUES value must be of same type as partition function ", Description:"", MySQLVersion:"5.6"},
    1495: definition.ErrorDefinition{ErrorNumber:1495, ErrorType:"ServerError", Symbol:"ER_MULTIPLE_DEF_CONST_IN_LIST_PART_ERROR", SQLState:"HY000", Message:"Multiple definition of same constant in list partitioning ", Description:"", MySQLVersion:"5.6"},
    1496: definition.ErrorDefinition{ErrorNumber:1496, ErrorType:"ServerError", Symbol:"ER_PARTITION_ENTRY_ERROR", SQLState:"HY000", Message:"Partitioning can not be used stand-alone in query ", Description:"", MySQLVersion:"5.6"},
    1497: definition.ErrorDefinition{ErrorNumber:1497, ErrorType:"ServerError", Symbol:"ER_MIX_HANDLER_ERROR", SQLState:"HY000", Message:"The mix of handlers in the partitions is not allowed in this version of MySQL ", Description:"", MySQLVersion:"5.6"},
    1498: definition.ErrorDefinition{ErrorNumber:1498, ErrorType:"ServerError", Symbol:"ER_PARTITION_NOT_DEFINED_ERROR", SQLState:"HY000", Message:"For the partitioned engine it is necessary to define all %s ", Description:"", MySQLVersion:"5.6"},
    1499: definition.ErrorDefinition{ErrorNumber:1499, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_PARTITIONS_ERROR", SQLState:"HY000", Message:"Too many partitions (including subpartitions) were defined ", Description:"", MySQLVersion:"5.6"},
    1500: definition.ErrorDefinition{ErrorNumber:1500, ErrorType:"ServerError", Symbol:"ER_SUBPARTITION_ERROR", SQLState:"HY000", Message:"It is only possible to mix RANGE/LIST partitioning with HASH/KEY partitioning for subpartitioning ", Description:"", MySQLVersion:"5.6"},
    1501: definition.ErrorDefinition{ErrorNumber:1501, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_HANDLER_FILE", SQLState:"HY000", Message:"Failed to create specific handler file ", Description:"", MySQLVersion:"5.6"},
    1502: definition.ErrorDefinition{ErrorNumber:1502, ErrorType:"ServerError", Symbol:"ER_BLOB_FIELD_IN_PART_FUNC_ERROR", SQLState:"HY000", Message:"A BLOB field is not allowed in partition function ", Description:"", MySQLVersion:"5.6"},
    1503: definition.ErrorDefinition{ErrorNumber:1503, ErrorType:"ServerError", Symbol:"ER_UNIQUE_KEY_NEED_ALL_FIELDS_IN_PF", SQLState:"HY000", Message:"A %s must include all columns in the table's partitioning function ", Description:"", MySQLVersion:"5.6"},
    1504: definition.ErrorDefinition{ErrorNumber:1504, ErrorType:"ServerError", Symbol:"ER_NO_PARTS_ERROR", SQLState:"HY000", Message:"Number of %s = 0 is not an allowed value ", Description:"", MySQLVersion:"5.6"},
    1505: definition.ErrorDefinition{ErrorNumber:1505, ErrorType:"ServerError", Symbol:"ER_PARTITION_MGMT_ON_NONPARTITIONED", SQLState:"HY000", Message:"Partition management on a not partitioned table is not possible ", Description:"", MySQLVersion:"5.6"},
    1506: definition.ErrorDefinition{ErrorNumber:1506, ErrorType:"ServerError", Symbol:"ER_FOREIGN_KEY_ON_PARTITIONED", SQLState:"HY000", Message:"Foreign key clause is not yet supported in conjunction with partitioning ", Description:"", MySQLVersion:"5.6"},
    1507: definition.ErrorDefinition{ErrorNumber:1507, ErrorType:"ServerError", Symbol:"ER_DROP_PARTITION_NON_EXISTENT", SQLState:"HY000", Message:"Error in list of partitions to %s ", Description:"", MySQLVersion:"5.6"},
    1508: definition.ErrorDefinition{ErrorNumber:1508, ErrorType:"ServerError", Symbol:"ER_DROP_LAST_PARTITION", SQLState:"HY000", Message:"Cannot remove all partitions, use DROP TABLE instead ", Description:"", MySQLVersion:"5.6"},
    1509: definition.ErrorDefinition{ErrorNumber:1509, ErrorType:"ServerError", Symbol:"ER_COALESCE_ONLY_ON_HASH_PARTITION", SQLState:"HY000", Message:"COALESCE PARTITION can only be used on HASH/KEY partitions ", Description:"", MySQLVersion:"5.6"},
    1510: definition.ErrorDefinition{ErrorNumber:1510, ErrorType:"ServerError", Symbol:"ER_REORG_HASH_ONLY_ON_SAME_NO", SQLState:"HY000", Message:"REORGANIZE PARTITION can only be used to reorganize partitions not to change their numbers ", Description:"", MySQLVersion:"5.6"},
    1511: definition.ErrorDefinition{ErrorNumber:1511, ErrorType:"ServerError", Symbol:"ER_REORG_NO_PARAM_ERROR", SQLState:"HY000", Message:"REORGANIZE PARTITION without parameters can only be used on auto-partitioned tables using HASH PARTITIONs ", Description:"", MySQLVersion:"5.6"},
    1512: definition.ErrorDefinition{ErrorNumber:1512, ErrorType:"ServerError", Symbol:"ER_ONLY_ON_RANGE_LIST_PARTITION", SQLState:"HY000", Message:"%s PARTITION can only be used on RANGE/LIST partitions ", Description:"", MySQLVersion:"5.6"},
    1513: definition.ErrorDefinition{ErrorNumber:1513, ErrorType:"ServerError", Symbol:"ER_ADD_PARTITION_SUBPART_ERROR", SQLState:"HY000", Message:"Trying to Add partition(s) with wrong number of subpartitions ", Description:"", MySQLVersion:"5.6"},
    1514: definition.ErrorDefinition{ErrorNumber:1514, ErrorType:"ServerError", Symbol:"ER_ADD_PARTITION_NO_NEW_PARTITION", SQLState:"HY000", Message:"At least one partition must be added ", Description:"", MySQLVersion:"5.6"},
    1515: definition.ErrorDefinition{ErrorNumber:1515, ErrorType:"ServerError", Symbol:"ER_COALESCE_PARTITION_NO_PARTITION", SQLState:"HY000", Message:"At least one partition must be coalesced ", Description:"", MySQLVersion:"5.6"},
    1516: definition.ErrorDefinition{ErrorNumber:1516, ErrorType:"ServerError", Symbol:"ER_REORG_PARTITION_NOT_EXIST", SQLState:"HY000", Message:"More partitions to reorganize than there are partitions ", Description:"", MySQLVersion:"5.6"},
    1517: definition.ErrorDefinition{ErrorNumber:1517, ErrorType:"ServerError", Symbol:"ER_SAME_NAME_PARTITION", SQLState:"HY000", Message:"Duplicate partition name %s ", Description:"", MySQLVersion:"5.6"},
    1518: definition.ErrorDefinition{ErrorNumber:1518, ErrorType:"ServerError", Symbol:"ER_NO_BINLOG_ERROR", SQLState:"HY000", Message:"It is not allowed to shut off binlog on this command ", Description:"", MySQLVersion:"5.6"},
    1519: definition.ErrorDefinition{ErrorNumber:1519, ErrorType:"ServerError", Symbol:"ER_CONSECUTIVE_REORG_PARTITIONS", SQLState:"HY000", Message:"When reorganizing a set of partitions they must be in consecutive order ", Description:"", MySQLVersion:"5.6"},
    1520: definition.ErrorDefinition{ErrorNumber:1520, ErrorType:"ServerError", Symbol:"ER_REORG_OUTSIDE_RANGE", SQLState:"HY000", Message:"Reorganize of range partitions cannot change total ranges except for last partition where it can extend the range ", Description:"", MySQLVersion:"5.6"},
    1521: definition.ErrorDefinition{ErrorNumber:1521, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNCTION_FAILURE", SQLState:"HY000", Message:"Partition function not supported in this version for this handler ", Description:"", MySQLVersion:"5.6"},
    1522: definition.ErrorDefinition{ErrorNumber:1522, ErrorType:"ServerError", Symbol:"ER_PART_STATE_ERROR", SQLState:"HY000", Message:"Partition state cannot be defined from CREATE/ALTER TABLE ", Description:"", MySQLVersion:"5.6"},
    1523: definition.ErrorDefinition{ErrorNumber:1523, ErrorType:"ServerError", Symbol:"ER_LIMITED_PART_RANGE", SQLState:"HY000", Message:"The %s handler only supports 32 bit integers in VALUES ", Description:"", MySQLVersion:"5.6"},
    1524: definition.ErrorDefinition{ErrorNumber:1524, ErrorType:"ServerError", Symbol:"ER_PLUGIN_IS_NOT_LOADED", SQLState:"HY000", Message:"Plugin '%s' is not loaded ", Description:"", MySQLVersion:"5.6"},
    1525: definition.ErrorDefinition{ErrorNumber:1525, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE", SQLState:"HY000", Message:"Incorrect %s value: '%s' ", Description:"", MySQLVersion:"5.6"},
    1526: definition.ErrorDefinition{ErrorNumber:1526, ErrorType:"ServerError", Symbol:"ER_NO_PARTITION_FOR_GIVEN_VALUE", SQLState:"HY000", Message:"Table has no partition for value %s ", Description:"", MySQLVersion:"5.6"},
    1527: definition.ErrorDefinition{ErrorNumber:1527, ErrorType:"ServerError", Symbol:"ER_FILEGROUP_OPTION_ONLY_ONCE", SQLState:"HY000", Message:"It is not allowed to specify %s more than once ", Description:"", MySQLVersion:"5.6"},
    1528: definition.ErrorDefinition{ErrorNumber:1528, ErrorType:"ServerError", Symbol:"ER_CREATE_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to create %s ", Description:"", MySQLVersion:"5.6"},
    1529: definition.ErrorDefinition{ErrorNumber:1529, ErrorType:"ServerError", Symbol:"ER_DROP_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to drop %s ", Description:"", MySQLVersion:"5.6"},
    1530: definition.ErrorDefinition{ErrorNumber:1530, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_AUTO_EXTEND_ERROR", SQLState:"HY000", Message:"The handler doesn't support autoextend of tablespaces ", Description:"", MySQLVersion:"5.6"},
    1531: definition.ErrorDefinition{ErrorNumber:1531, ErrorType:"ServerError", Symbol:"ER_WRONG_SIZE_NUMBER", SQLState:"HY000", Message:"A size parameter was incorrectly specified, either number or on the form 10M ", Description:"", MySQLVersion:"5.6"},
    1532: definition.ErrorDefinition{ErrorNumber:1532, ErrorType:"ServerError", Symbol:"ER_SIZE_OVERFLOW_ERROR", SQLState:"HY000", Message:"The size number was correct but we don't allow the digit part to be more than 2 billion ", Description:"", MySQLVersion:"5.6"},
    1533: definition.ErrorDefinition{ErrorNumber:1533, ErrorType:"ServerError", Symbol:"ER_ALTER_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to alter: %s ", Description:"", MySQLVersion:"5.6"},
    1534: definition.ErrorDefinition{ErrorNumber:1534, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_LOGGING_FAILED", SQLState:"HY000", Message:"Writing one row to the row-based binary log failed ", Description:"", MySQLVersion:"5.6"},
    1535: definition.ErrorDefinition{ErrorNumber:1535, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_WRONG_TABLE_DEF", SQLState:"HY000", Message:"Table definition on master and slave does not match: %s ", Description:"", MySQLVersion:"5.6"},
    1536: definition.ErrorDefinition{ErrorNumber:1536, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_RBR_TO_SBR", SQLState:"HY000", Message:"Slave running with --log-slave-updates must use row-based binary logging to be able to replicate row-based binary log events ", Description:"", MySQLVersion:"5.6"},
    1537: definition.ErrorDefinition{ErrorNumber:1537, ErrorType:"ServerError", Symbol:"ER_EVENT_ALREADY_EXISTS", SQLState:"HY000", Message:"Event '%s' already exists ", Description:"", MySQLVersion:"5.6"},
    1538: definition.ErrorDefinition{ErrorNumber:1538, ErrorType:"ServerError", Symbol:"ER_EVENT_STORE_FAILED", SQLState:"HY000", Message:"Failed to store event %s. Error code %d from storage engine. ", Description:"", MySQLVersion:"5.6"},
    1539: definition.ErrorDefinition{ErrorNumber:1539, ErrorType:"ServerError", Symbol:"ER_EVENT_DOES_NOT_EXIST", SQLState:"HY000", Message:"Unknown event '%s' ", Description:"", MySQLVersion:"5.6"},
    1540: definition.ErrorDefinition{ErrorNumber:1540, ErrorType:"ServerError", Symbol:"ER_EVENT_CANT_ALTER", SQLState:"HY000", Message:"Failed to alter event '%s' ", Description:"", MySQLVersion:"5.6"},
    1541: definition.ErrorDefinition{ErrorNumber:1541, ErrorType:"ServerError", Symbol:"ER_EVENT_DROP_FAILED", SQLState:"HY000", Message:"Failed to drop %s ", Description:"", MySQLVersion:"5.6"},
    1542: definition.ErrorDefinition{ErrorNumber:1542, ErrorType:"ServerError", Symbol:"ER_EVENT_INTERVAL_NOT_POSITIVE_OR_TOO_BIG", SQLState:"HY000", Message:"INTERVAL is either not positive or too big ", Description:"", MySQLVersion:"5.6"},
    1543: definition.ErrorDefinition{ErrorNumber:1543, ErrorType:"ServerError", Symbol:"ER_EVENT_ENDS_BEFORE_STARTS", SQLState:"HY000", Message:"ENDS is either invalid or before STARTS ", Description:"", MySQLVersion:"5.6"},
    1544: definition.ErrorDefinition{ErrorNumber:1544, ErrorType:"ServerError", Symbol:"ER_EVENT_EXEC_TIME_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past. Event has been disabled ", Description:"", MySQLVersion:"5.6"},
    1545: definition.ErrorDefinition{ErrorNumber:1545, ErrorType:"ServerError", Symbol:"ER_EVENT_OPEN_TABLE_FAILED", SQLState:"HY000", Message:"Failed to open mysql.event ", Description:"", MySQLVersion:"5.6"},
    1546: definition.ErrorDefinition{ErrorNumber:1546, ErrorType:"ServerError", Symbol:"ER_EVENT_NEITHER_M_EXPR_NOR_M_AT", SQLState:"HY000", Message:"No datetime expression provided ", Description:"", MySQLVersion:"5.6"},
    1547: definition.ErrorDefinition{ErrorNumber:1547, ErrorType:"ServerError", Symbol:"ER_OBSOLETE_COL_COUNT_DOESNT_MATCH_CORRUPTED", SQLState:"HY000", Message:"Column count of mysql.%s is wrong. Expected %d, found %d. The table is probably corrupted ", Description:"", MySQLVersion:"5.6"},
    1548: definition.ErrorDefinition{ErrorNumber:1548, ErrorType:"ServerError", Symbol:"ER_OBSOLETE_CANNOT_LOAD_FROM_TABLE", SQLState:"HY000", Message:"Cannot load from mysql.%s. The table is probably corrupted ", Description:"", MySQLVersion:"5.6"},
    1549: definition.ErrorDefinition{ErrorNumber:1549, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_DELETE", SQLState:"HY000", Message:"Failed to delete the event from mysql.event ", Description:"", MySQLVersion:"5.6"},
    1550: definition.ErrorDefinition{ErrorNumber:1550, ErrorType:"ServerError", Symbol:"ER_EVENT_COMPILE_ERROR", SQLState:"HY000", Message:"Error during compilation of event's body ", Description:"", MySQLVersion:"5.6"},
    1551: definition.ErrorDefinition{ErrorNumber:1551, ErrorType:"ServerError", Symbol:"ER_EVENT_SAME_NAME", SQLState:"HY000", Message:"Same old and new event name ", Description:"", MySQLVersion:"5.6"},
    1552: definition.ErrorDefinition{ErrorNumber:1552, ErrorType:"ServerError", Symbol:"ER_EVENT_DATA_TOO_LONG", SQLState:"HY000", Message:"Data for column '%s' too long ", Description:"", MySQLVersion:"5.6"},
    1553: definition.ErrorDefinition{ErrorNumber:1553, ErrorType:"ServerError", Symbol:"ER_DROP_INDEX_FK", SQLState:"HY000", Message:"Cannot drop index '%s': needed in a foreign key constraint", Description:"When you drop an index, InnoDB checks if the index is used for checking a foreign key constraint. It is still OK to drop the index if there is another index that can be used to enforce the same constraint. InnoDB prevents you from dropping the last index that can enforce a particular referential constraint. ", MySQLVersion:"5.6"},
    ...
    1560: definition.ErrorDefinition{ErrorNumber:1560, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"Cannot change the binary logging format inside a stored function or trigger ", Description:"", MySQLVersion:"5.6"},
    1561: definition.ErrorDefinition{ErrorNumber:1561, ErrorType:"ServerError", Symbol:"ER_NDB_CANT_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"The NDB cluster engine does not support changing the binlog format on the fly yet ", Description:"", MySQLVersion:"5.6"},
    1562: definition.ErrorDefinition{ErrorNumber:1562, ErrorType:"ServerError", Symbol:"ER_PARTITION_NO_TEMPORARY", SQLState:"HY000", Message:"Cannot create temporary table with partitions ", Description:"", MySQLVersion:"5.6"},
    1563: definition.ErrorDefinition{ErrorNumber:1563, ErrorType:"ServerError", Symbol:"ER_PARTITION_CONST_DOMAIN_ERROR", SQLState:"HY000", Message:"Partition constant is out of partition function domain ", Description:"", MySQLVersion:"5.6"},
    1564: definition.ErrorDefinition{ErrorNumber:1564, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNCTION_IS_NOT_ALLOWED", SQLState:"HY000", Message:"This partition function is not allowed ", Description:"", MySQLVersion:"5.6"},
    ...
    1571: definition.ErrorDefinition{ErrorNumber:1571, ErrorType:"ServerError", Symbol:"ER_EVENT_SET_VAR_ERROR", SQLState:"HY000", Message:"Error during starting/stopping of the scheduler. Error code %u ", Description:"", MySQLVersion:"5.6"},
    1572: definition.ErrorDefinition{ErrorNumber:1572, ErrorType:"ServerError", Symbol:"ER_PARTITION_MERGE_ERROR", SQLState:"HY000", Message:"Engine cannot be used in partitioned tables ", Description:"", MySQLVersion:"5.6"},
    1573: definition.ErrorDefinition{ErrorNumber:1573, ErrorType:"ServerError", Symbol:"ER_CANT_ACTIVATE_LOG", SQLState:"HY000", Message:"Cannot activate '%s' log ", Description:"", MySQLVersion:"5.6"},
    1574: definition.ErrorDefinition{ErrorNumber:1574, ErrorType:"ServerError", Symbol:"ER_RBR_NOT_AVAILABLE", SQLState:"HY000", Message:"The server was not built with row-based replication ", Description:"", MySQLVersion:"5.6"},
    1575: definition.ErrorDefinition{ErrorNumber:1575, ErrorType:"ServerError", Symbol:"ER_BASE64_DECODE_ERROR", SQLState:"HY000", Message:"Decoding of base64 string failed ", Description:"", MySQLVersion:"5.6"},
    1576: definition.ErrorDefinition{ErrorNumber:1576, ErrorType:"ServerError", Symbol:"ER_EVENT_RECURSION_FORBIDDEN", SQLState:"HY000", Message:"Recursion of EVENT DDL statements is forbidden when body is present ", Description:"", MySQLVersion:"5.6"},
    1577: definition.ErrorDefinition{ErrorNumber:1577, ErrorType:"ServerError", Symbol:"ER_EVENTS_DB_ERROR", SQLState:"HY000", Message:"Cannot proceed because system tables used by Event Scheduler were found damaged at server start", Description:"To address this issue, try running mysql_upgrade. ", MySQLVersion:"5.6"},
    1578: definition.ErrorDefinition{ErrorNumber:1578, ErrorType:"ServerError", Symbol:"ER_ONLY_INTEGERS_ALLOWED", SQLState:"HY000", Message:"Only integers allowed as number here ", Description:"", MySQLVersion:"5.6"},
    1579: definition.ErrorDefinition{ErrorNumber:1579, ErrorType:"ServerError", Symbol:"ER_UNSUPORTED_LOG_ENGINE", SQLState:"HY000", Message:"This storage engine cannot be used for log tables\" ", Description:"", MySQLVersion:"5.6"},
    1580: definition.ErrorDefinition{ErrorNumber:1580, ErrorType:"ServerError", Symbol:"ER_BAD_LOG_STATEMENT", SQLState:"HY000", Message:"You cannot '%s' a log table if logging is enabled ", Description:"", MySQLVersion:"5.6"},
    1581: definition.ErrorDefinition{ErrorNumber:1581, ErrorType:"ServerError", Symbol:"ER_CANT_RENAME_LOG_TABLE", SQLState:"HY000", Message:"Cannot rename '%s'. When logging enabled, rename to/from log table must rename two tables: the log table to an archive table and another table back to '%s' ", Description:"", MySQLVersion:"5.6"},
    1582: definition.ErrorDefinition{ErrorNumber:1582, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT", SQLState:"42000", Message:"Incorrect parameter count in the call to native function '%s' ", Description:"", MySQLVersion:"5.6"},
    1583: definition.ErrorDefinition{ErrorNumber:1583, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_NATIVE_FCT", SQLState:"42000", Message:"Incorrect parameters in the call to native function '%s' ", Description:"", MySQLVersion:"5.6"},
    1584: definition.ErrorDefinition{ErrorNumber:1584, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_STORED_FCT", SQLState:"42000", Message:"Incorrect parameters in the call to stored function '%s' ", Description:"", MySQLVersion:"5.6"},
    1585: definition.ErrorDefinition{ErrorNumber:1585, ErrorType:"ServerError", Symbol:"ER_NATIVE_FCT_NAME_COLLISION", SQLState:"HY000", Message:"This function '%s' has the same name as a native function ", Description:"", MySQLVersion:"5.6"},
    1586: definition.ErrorDefinition{ErrorNumber:1586, ErrorType:"ServerError", Symbol:"ER_DUP_ENTRY_WITH_KEY_NAME", SQLState:"23000", Message:"Duplicate entry '%s' for key '%s'", Description:"The format string for this error is also used with ER_DUP_ENTRY. ", MySQLVersion:"5.6"},
    1587: definition.ErrorDefinition{ErrorNumber:1587, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_EMFILE", SQLState:"HY000", Message:"Too many files opened, please execute the command again ", Description:"", MySQLVersion:"5.6"},
    1588: definition.ErrorDefinition{ErrorNumber:1588, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_CREATE_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past and ON COMPLETION NOT PRESERVE is set. The event was dropped immediately after creation. ", Description:"", MySQLVersion:"5.6"},
    1589: definition.ErrorDefinition{ErrorNumber:1589, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_ALTER_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past and ON COMPLETION NOT PRESERVE is set. The event was not changed. Specify a time in the future. ", Description:"", MySQLVersion:"5.6"},
    1590: definition.ErrorDefinition{ErrorNumber:1590, ErrorType:"ServerError", Symbol:"ER_SLAVE_INCIDENT", SQLState:"HY000", Message:"The incident %s occured on the master. Message: %s ", Description:"", MySQLVersion:"5.6"},
    1591: definition.ErrorDefinition{ErrorNumber:1591, ErrorType:"ServerError", Symbol:"ER_NO_PARTITION_FOR_GIVEN_VALUE_SILENT", SQLState:"HY000", Message:"Table has no partition for some existing values ", Description:"", MySQLVersion:"5.6"},
    1592: definition.ErrorDefinition{ErrorNumber:1592, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_STATEMENT", SQLState:"HY000", Message:"Unsafe statement written to the binary log using statement format since BINLOG_FORMAT = STATEMENT. %s ", Description:"", MySQLVersion:"5.6"},
    1593: definition.ErrorDefinition{ErrorNumber:1593, ErrorType:"ServerError", Symbol:"ER_SLAVE_FATAL_ERROR", SQLState:"HY000", Message:"Fatal error: %s ", Description:"", MySQLVersion:"5.6"},
    1594: definition.ErrorDefinition{ErrorNumber:1594, ErrorType:"ServerError", Symbol:"ER_SLAVE_RELAY_LOG_READ_FAILURE", SQLState:"HY000", Message:"Relay log read failure: %s ", Description:"", MySQLVersion:"5.6"},
    1595: definition.ErrorDefinition{ErrorNumber:1595, ErrorType:"ServerError", Symbol:"ER_SLAVE_RELAY_LOG_WRITE_FAILURE", SQLState:"HY000", Message:"Relay log write failure: %s ", Description:"", MySQLVersion:"5.6"},
    1596: definition.ErrorDefinition{ErrorNumber:1596, ErrorType:"ServerError", Symbol:"ER_SLAVE_CREATE_EVENT_FAILURE", SQLState:"HY000", Message:"Failed to create %s ", Description:"", MySQLVersion:"5.6"},
    1597: definition.ErrorDefinition{ErrorNumber:1597, ErrorType:"ServerError", Symbol:"ER_SLAVE_MASTER_COM_FAILURE", SQLState:"HY000", Message:"Master command %s failed: %s ", Description:"", MySQLVersion:"5.6"},
    1598: definition.ErrorDefinition{ErrorNumber:1598, ErrorType:"ServerError", Symbol:"ER_BINLOG_LOGGING_IMPOSSIBLE", SQLState:"HY000", Message:"Binary logging not possible. Message: %s ", Description:"", MySQLVersion:"5.6"},
    1599: definition.ErrorDefinition{ErrorNumber:1599, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_CREATION_CTX", SQLState:"HY000", Message:"View `%s`.`%s` has no creation context ", Description:"", MySQLVersion:"5.6"},
    1600: definition.ErrorDefinition{ErrorNumber:1600, ErrorType:"ServerError", Symbol:"ER_VIEW_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of view `%s`.`%s' is invalid ", Description:"", MySQLVersion:"5.6"},
    1601: definition.ErrorDefinition{ErrorNumber:1601, ErrorType:"ServerError", Symbol:"ER_SR_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of stored routine `%s`.`%s` is invalid ", Description:"", MySQLVersion:"5.6"},
    1602: definition.ErrorDefinition{ErrorNumber:1602, ErrorType:"ServerError", Symbol:"ER_TRG_CORRUPTED_FILE", SQLState:"HY000", Message:"Corrupted TRG file for table `%s`.`%s` ", Description:"", MySQLVersion:"5.6"},
    1603: definition.ErrorDefinition{ErrorNumber:1603, ErrorType:"ServerError", Symbol:"ER_TRG_NO_CREATION_CTX", SQLState:"HY000", Message:"Triggers for table `%s`.`%s` have no creation context ", Description:"", MySQLVersion:"5.6"},
    1604: definition.ErrorDefinition{ErrorNumber:1604, ErrorType:"ServerError", Symbol:"ER_TRG_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Trigger creation context of table `%s`.`%s` is invalid ", Description:"", MySQLVersion:"5.6"},
    1605: definition.ErrorDefinition{ErrorNumber:1605, ErrorType:"ServerError", Symbol:"ER_EVENT_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of event `%s`.`%s` is invalid ", Description:"", MySQLVersion:"5.6"},
    1606: definition.ErrorDefinition{ErrorNumber:1606, ErrorType:"ServerError", Symbol:"ER_TRG_CANT_OPEN_TABLE", SQLState:"HY000", Message:"Cannot open table for trigger `%s`.`%s` ", Description:"", MySQLVersion:"5.6"},
    1607: definition.ErrorDefinition{ErrorNumber:1607, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_SROUTINE", SQLState:"HY000", Message:"Cannot create stored routine `%s`. Check warnings ", Description:"", MySQLVersion:"5.6"},
    1608: definition.ErrorDefinition{ErrorNumber:1608, ErrorType:"ServerError", Symbol:"ER_NEVER_USED", SQLState:"HY000", Message:"Ambiguous slave modes combination. %s ", Description:"", MySQLVersion:"5.6"},
    1609: definition.ErrorDefinition{ErrorNumber:1609, ErrorType:"ServerError", Symbol:"ER_NO_FORMAT_DESCRIPTION_EVENT_BEFORE_BINLOG_STATEMENT", SQLState:"HY000", Message:"The BINLOG statement of type `%s` was not preceded by a format description BINLOG statement. ", Description:"", MySQLVersion:"5.6"},
    1610: definition.ErrorDefinition{ErrorNumber:1610, ErrorType:"ServerError", Symbol:"ER_SLAVE_CORRUPT_EVENT", SQLState:"HY000", Message:"Corrupted replication event was detected ", Description:"", MySQLVersion:"5.6"},
    1611: definition.ErrorDefinition{ErrorNumber:1611, ErrorType:"ServerError", Symbol:"ER_LOAD_DATA_INVALID_COLUMN", SQLState:"HY000", Message:"Invalid column reference (%s) in LOAD DATA ", Description:"", MySQLVersion:"5.6"},
    1612: definition.ErrorDefinition{ErrorNumber:1612, ErrorType:"ServerError", Symbol:"ER_LOG_PURGE_NO_FILE", SQLState:"HY000", Message:"Being purged log %s was not found ", Description:"", MySQLVersion:"5.6"},
    1613: definition.ErrorDefinition{ErrorNumber:1613, ErrorType:"ServerError", Symbol:"ER_XA_RBTIMEOUT", SQLState:"XA106", Message:"XA_RBTIMEOUT: Transaction branch was rolled back: took too long ", Description:"", MySQLVersion:"5.6"},
    1614: definition.ErrorDefinition{ErrorNumber:1614, ErrorType:"ServerError", Symbol:"ER_XA_RBDEADLOCK", SQLState:"XA102", Message:"XA_RBDEADLOCK: Transaction branch was rolled back: deadlock was detected ", Description:"", MySQLVersion:"5.6"},
    1615: definition.ErrorDefinition{ErrorNumber:1615, ErrorType:"ServerError", Symbol:"ER_NEED_REPREPARE", SQLState:"HY000", Message:"Prepared statement needs to be re-prepared ", Description:"", MySQLVersion:"5.6"},
    1616: definition.ErrorDefinition{ErrorNumber:1616, ErrorType:"ServerError", Symbol:"ER_DELAYED_NOT_SUPPORTED", SQLState:"HY000", Message:"DELAYED option not supported for table '%s' ", Description:"", MySQLVersion:"5.6"},
    1617: definition.ErrorDefinition{ErrorNumber:1617, ErrorType:"ServerError", Symbol:"WARN_NO_MASTER_INFO", SQLState:"HY000", Message:"The master info structure does not exist ", Description:"", MySQLVersion:"5.6"},
    1618: definition.ErrorDefinition{ErrorNumber:1618, ErrorType:"ServerError", Symbol:"WARN_OPTION_IGNORED", SQLState:"HY000", Message:"<%s> option ignored ", Description:"", MySQLVersion:"5.6"},
    1619: definition.ErrorDefinition{ErrorNumber:1619, ErrorType:"ServerError", Symbol:"WARN_PLUGIN_DELETE_BUILTIN", SQLState:"HY000", Message:"Built-in plugins cannot be deleted ", Description:"", MySQLVersion:"5.6"},
    1620: definition.ErrorDefinition{ErrorNumber:1620, ErrorType:"ServerError", Symbol:"WARN_PLUGIN_BUSY", SQLState:"HY000", Message:"Plugin is busy and will be uninstalled on shutdown ", Description:"", MySQLVersion:"5.6"},
    1621: definition.ErrorDefinition{ErrorNumber:1621, ErrorType:"ServerError", Symbol:"ER_VARIABLE_IS_READONLY", SQLState:"HY000", Message:"%s variable '%s' is read-only. Use SET %s to assign the value ", Description:"", MySQLVersion:"5.6"},
    1622: definition.ErrorDefinition{ErrorNumber:1622, ErrorType:"ServerError", Symbol:"ER_WARN_ENGINE_TRANSACTION_ROLLBACK", SQLState:"HY000", Message:"Storage engine %s does not support rollback for this statement. Transaction rolled back and must be restarted ", Description:"", MySQLVersion:"5.6"},
    1623: definition.ErrorDefinition{ErrorNumber:1623, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_FAILURE", SQLState:"HY000", Message:"Unexpected master's heartbeat data: %s ", Description:"", MySQLVersion:"5.6"},
    1624: definition.ErrorDefinition{ErrorNumber:1624, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE", SQLState:"HY000", Message:"The requested value for the heartbeat period is either negative or exceeds the maximum allowed (%s seconds). ", Description:"", MySQLVersion:"5.6"},
    1625: definition.ErrorDefinition{ErrorNumber:1625, ErrorType:"ServerError", Symbol:"ER_NDB_REPLICATION_SCHEMA_ERROR", SQLState:"HY000", Message:"Bad schema for mysql.ndb_replication table. Message: %s ", Description:"", MySQLVersion:"5.6"},
    1626: definition.ErrorDefinition{ErrorNumber:1626, ErrorType:"ServerError", Symbol:"ER_CONFLICT_FN_PARSE_ERROR", SQLState:"HY000", Message:"Error in parsing conflict function. Message: %s ", Description:"", MySQLVersion:"5.6"},
    1627: definition.ErrorDefinition{ErrorNumber:1627, ErrorType:"ServerError", Symbol:"ER_EXCEPTIONS_WRITE_ERROR", SQLState:"HY000", Message:"Write to exceptions table failed. Message: %s\" ", Description:"", MySQLVersion:"5.6"},
    1628: definition.ErrorDefinition{ErrorNumber:1628, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_TABLE_COMMENT", SQLState:"HY000", Message:"Comment for table '%s' is too long (max = %lu) ", Description:"", MySQLVersion:"5.6"},
    1629: definition.ErrorDefinition{ErrorNumber:1629, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_FIELD_COMMENT", SQLState:"HY000", Message:"Comment for field '%s' is too long (max = %lu) ", Description:"", MySQLVersion:"5.6"},
    1630: definition.ErrorDefinition{ErrorNumber:1630, ErrorType:"ServerError", Symbol:"ER_FUNC_INEXISTENT_NAME_COLLISION", SQLState:"42000", Message:"FUNCTION %s does not exist. Check the 'Function Name Parsing and Resolution' section in the Reference Manual ", Description:"", MySQLVersion:"5.6"},
    1631: definition.ErrorDefinition{ErrorNumber:1631, ErrorType:"ServerError", Symbol:"ER_DATABASE_NAME", SQLState:"HY000", Message:"Database ", Description:"", MySQLVersion:"5.6"},
    1632: definition.ErrorDefinition{ErrorNumber:1632, ErrorType:"ServerError", Symbol:"ER_TABLE_NAME", SQLState:"HY000", Message:"Table ", Description:"", MySQLVersion:"5.6"},
    1633: definition.ErrorDefinition{ErrorNumber:1633, ErrorType:"ServerError", Symbol:"ER_PARTITION_NAME", SQLState:"HY000", Message:"Partition ", Description:"", MySQLVersion:"5.6"},
    1634: definition.ErrorDefinition{ErrorNumber:1634, ErrorType:"ServerError", Symbol:"ER_SUBPARTITION_NAME", SQLState:"HY000", Message:"Subpartition ", Description:"", MySQLVersion:"5.6"},
    1635: definition.ErrorDefinition{ErrorNumber:1635, ErrorType:"ServerError", Symbol:"ER_TEMPORARY_NAME", SQLState:"HY000", Message:"Temporary ", Description:"", MySQLVersion:"5.6"},
    1636: definition.ErrorDefinition{ErrorNumber:1636, ErrorType:"ServerError", Symbol:"ER_RENAMED_NAME", SQLState:"HY000", Message:"Renamed ", Description:"", MySQLVersion:"5.6"},
    1637: definition.ErrorDefinition{ErrorNumber:1637, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_CONCURRENT_TRXS", SQLState:"HY000", Message:"Too many active concurrent transactions ", Description:"", MySQLVersion:"5.6"},
    1638: definition.ErrorDefinition{ErrorNumber:1638, ErrorType:"ServerError", Symbol:"WARN_NON_ASCII_SEPARATOR_NOT_IMPLEMENTED", SQLState:"HY000", Message:"Non-ASCII separator arguments are not fully supported ", Description:"", MySQLVersion:"5.6"},
    1639: definition.ErrorDefinition{ErrorNumber:1639, ErrorType:"ServerError", Symbol:"ER_DEBUG_SYNC_TIMEOUT", SQLState:"HY000", Message:"debug sync point wait timed out ", Description:"", MySQLVersion:"5.6"},
    1640: definition.ErrorDefinition{ErrorNumber:1640, ErrorType:"ServerError", Symbol:"ER_DEBUG_SYNC_HIT_LIMIT", SQLState:"HY000", Message:"debug sync point hit limit reached ", Description:"", MySQLVersion:"5.6"},
    1641: definition.ErrorDefinition{ErrorNumber:1641, ErrorType:"ServerError", Symbol:"ER_DUP_SIGNAL_SET", SQLState:"42000", Message:"Duplicate condition information item '%s' ", Description:"", MySQLVersion:"5.6"},
    1642: definition.ErrorDefinition{ErrorNumber:1642, ErrorType:"ServerError", Symbol:"ER_SIGNAL_WARN", SQLState:"01000", Message:"Unhandled user-defined warning condition ", Description:"", MySQLVersion:"5.6"},
    1643: definition.ErrorDefinition{ErrorNumber:1643, ErrorType:"ServerError", Symbol:"ER_SIGNAL_NOT_FOUND", SQLState:"02000", Message:"Unhandled user-defined not found condition ", Description:"", MySQLVersion:"5.6"},
    1644: definition.ErrorDefinition{ErrorNumber:1644, ErrorType:"ServerError", Symbol:"ER_SIGNAL_EXCEPTION", SQLState:"HY000", Message:"Unhandled user-defined exception condition ", Description:"", MySQLVersion:"5.6"},
    1645: definition.ErrorDefinition{ErrorNumber:1645, ErrorType:"ServerError", Symbol:"ER_RESIGNAL_WITHOUT_ACTIVE_HANDLER", SQLState:"0K000", Message:"RESIGNAL when handler not active ", Description:"", MySQLVersion:"5.6"},
    1646: definition.ErrorDefinition{ErrorNumber:1646, ErrorType:"ServerError", Symbol:"ER_SIGNAL_BAD_CONDITION_TYPE", SQLState:"HY000", Message:"SIGNAL/RESIGNAL can only use a CONDITION defined with SQLSTATE ", Description:"", MySQLVersion:"5.6"},
    1647: definition.ErrorDefinition{ErrorNumber:1647, ErrorType:"ServerError", Symbol:"WARN_COND_ITEM_TRUNCATED", SQLState:"HY000", Message:"Data truncated for condition item '%s' ", Description:"", MySQLVersion:"5.6"},
    1648: definition.ErrorDefinition{ErrorNumber:1648, ErrorType:"ServerError", Symbol:"ER_COND_ITEM_TOO_LONG", SQLState:"HY000", Message:"Data too long for condition item '%s' ", Description:"", MySQLVersion:"5.6"},
    1649: definition.ErrorDefinition{ErrorNumber:1649, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_LOCALE", SQLState:"HY000", Message:"Unknown locale: '%s' ", Description:"", MySQLVersion:"5.6"},
    1650: definition.ErrorDefinition{ErrorNumber:1650, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORE_SERVER_IDS", SQLState:"HY000", Message:"The requested server id %d clashes with the slave startup option --replicate-same-server-id ", Description:"", MySQLVersion:"5.6"},
    1651: definition.ErrorDefinition{ErrorNumber:1651, ErrorType:"ServerError", Symbol:"ER_QUERY_CACHE_DISABLED", SQLState:"HY000", Message:"Query cache is disabled", Description:"restart the server with query_cache_type=1 to enable it ", MySQLVersion:"5.6"},
    1652: definition.ErrorDefinition{ErrorNumber:1652, ErrorType:"ServerError", Symbol:"ER_SAME_NAME_PARTITION_FIELD", SQLState:"HY000", Message:"Duplicate partition field name '%s' ", Description:"", MySQLVersion:"5.6"},
    1653: definition.ErrorDefinition{ErrorNumber:1653, ErrorType:"ServerError", Symbol:"ER_PARTITION_COLUMN_LIST_ERROR", SQLState:"HY000", Message:"Inconsistency in usage of column lists for partitioning ", Description:"", MySQLVersion:"5.6"},
    1654: definition.ErrorDefinition{ErrorNumber:1654, ErrorType:"ServerError", Symbol:"ER_WRONG_TYPE_COLUMN_VALUE_ERROR", SQLState:"HY000", Message:"Partition column values of incorrect type ", Description:"", MySQLVersion:"5.6"},
    1655: definition.ErrorDefinition{ErrorNumber:1655, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_PARTITION_FUNC_FIELDS_ERROR", SQLState:"HY000", Message:"Too many fields in '%s' ", Description:"", MySQLVersion:"5.6"},
    1656: definition.ErrorDefinition{ErrorNumber:1656, ErrorType:"ServerError", Symbol:"ER_MAXVALUE_IN_VALUES_IN", SQLState:"HY000", Message:"Cannot use MAXVALUE as value in VALUES IN ", Description:"", MySQLVersion:"5.6"},
    1657: definition.ErrorDefinition{ErrorNumber:1657, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_VALUES_ERROR", SQLState:"HY000", Message:"Cannot have more than one value for this type of %s partitioning ", Description:"", MySQLVersion:"5.6"},
    1658: definition.ErrorDefinition{ErrorNumber:1658, ErrorType:"ServerError", Symbol:"ER_ROW_SINGLE_PARTITION_FIELD_ERROR", SQLState:"HY000", Message:"Row expressions in VALUES IN only allowed for multi-field column partitioning ", Description:"", MySQLVersion:"5.6"},
    1659: definition.ErrorDefinition{ErrorNumber:1659, ErrorType:"ServerError", Symbol:"ER_FIELD_TYPE_NOT_ALLOWED_AS_PARTITION_FIELD", SQLState:"HY000", Message:"Field '%s' is of a not allowed type for this type of partitioning ", Description:"", MySQLVersion:"5.6"},
    1660: definition.ErrorDefinition{ErrorNumber:1660, ErrorType:"ServerError", Symbol:"ER_PARTITION_FIELDS_TOO_LONG", SQLState:"HY000", Message:"The total length of the partitioning fields is too large ", Description:"", MySQLVersion:"5.6"},
    1661: definition.ErrorDefinition{ErrorNumber:1661, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_ENGINE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since both row-incapable engines and statement-incapable engines are involved. ", Description:"", MySQLVersion:"5.6"},
    1662: definition.ErrorDefinition{ErrorNumber:1662, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_MODE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since BINLOG_FORMAT = ROW and at least one table uses a storage engine limited to statement-based logging. ", Description:"", MySQLVersion:"5.6"},
    1663: definition.ErrorDefinition{ErrorNumber:1663, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since statement is unsafe, storage engine is limited to statement-based logging, and BINLOG_FORMAT = MIXED. %s ", Description:"", MySQLVersion:"5.6"},
    1664: definition.ErrorDefinition{ErrorNumber:1664, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_INJECTION_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since statement is in row format and at least one table uses a storage engine limited to statement-based logging. ", Description:"", MySQLVersion:"5.6"},
    1665: definition.ErrorDefinition{ErrorNumber:1665, ErrorType:"ServerError", Symbol:"ER_BINLOG_STMT_MODE_AND_ROW_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since BINLOG_FORMAT = STATEMENT and at least one table uses a storage engine limited to row-based logging.%s ", Description:"", MySQLVersion:"5.6"},
    1666: definition.ErrorDefinition{ErrorNumber:1666, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_INJECTION_AND_STMT_MODE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since statement is in row format and BINLOG_FORMAT = STATEMENT. ", Description:"", MySQLVersion:"5.6"},
    1667: definition.ErrorDefinition{ErrorNumber:1667, ErrorType:"ServerError", Symbol:"ER_BINLOG_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since more than one engine is involved and at least one engine is self-logging. ", Description:"", MySQLVersion:"5.6"},
    1668: definition.ErrorDefinition{ErrorNumber:1668, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_LIMIT", SQLState:"HY000", Message:"The statement is unsafe because it uses a LIMIT clause. This is unsafe because the set of rows included cannot be predicted. ", Description:"", MySQLVersion:"5.6"},
    1669: definition.ErrorDefinition{ErrorNumber:1669, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_DELAYED", SQLState:"HY000", Message:"The statement is unsafe because it uses INSERT DELAYED. This is unsafe because the times when rows are inserted cannot be predicted. ", Description:"", MySQLVersion:"5.6"},
    1670: definition.ErrorDefinition{ErrorNumber:1670, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_TABLE", SQLState:"HY000", Message:"The statement is unsafe because it uses the general log, slow query log, or performance_schema table(s). This is unsafe because system tables may differ on slaves. ", Description:"", MySQLVersion:"5.6"},
    1671: definition.ErrorDefinition{ErrorNumber:1671, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AUTOINC_COLUMNS", SQLState:"HY000", Message:"Statement is unsafe because it invokes a trigger or a stored function that inserts into an AUTO_INCREMENT column. Inserted values cannot be logged correctly. ", Description:"", MySQLVersion:"5.6"},
    1672: definition.ErrorDefinition{ErrorNumber:1672, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_UDF", SQLState:"HY000", Message:"Statement is unsafe because it uses a UDF which may not return the same value on the slave. ", Description:"", MySQLVersion:"5.6"},
    1673: definition.ErrorDefinition{ErrorNumber:1673, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_VARIABLE", SQLState:"HY000", Message:"Statement is unsafe because it uses a system variable that may have a different value on the slave. ", Description:"", MySQLVersion:"5.6"},
    1674: definition.ErrorDefinition{ErrorNumber:1674, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_FUNCTION", SQLState:"HY000", Message:"Statement is unsafe because it uses a system function that may return a different value on the slave. ", Description:"", MySQLVersion:"5.6"},
    1675: definition.ErrorDefinition{ErrorNumber:1675, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_NONTRANS_AFTER_TRANS", SQLState:"HY000", Message:"Statement is unsafe because it accesses a non-transactional table after accessing a transactional table within the same transaction. ", Description:"", MySQLVersion:"5.6"},
    1676: definition.ErrorDefinition{ErrorNumber:1676, ErrorType:"ServerError", Symbol:"ER_MESSAGE_AND_STATEMENT", SQLState:"HY000", Message:"%s Statement: %s ", Description:"", MySQLVersion:"5.6"},
    1677: definition.ErrorDefinition{ErrorNumber:1677, ErrorType:"ServerError", Symbol:"ER_SLAVE_CONVERSION_FAILED", SQLState:"HY000", Message:"Column %d of table '%s.%s' cannot be converted from type '%s' to type '%s' ", Description:"", MySQLVersion:"5.6"},
    1678: definition.ErrorDefinition{ErrorNumber:1678, ErrorType:"ServerError", Symbol:"ER_SLAVE_CANT_CREATE_CONVERSION", SQLState:"HY000", Message:"Can't create conversion table for table '%s.%s' ", Description:"", MySQLVersion:"5.6"},
    1679: definition.ErrorDefinition{ErrorNumber:1679, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"Cannot modify @@session.binlog_format inside a transaction ", Description:"", MySQLVersion:"5.6"},
    1680: definition.ErrorDefinition{ErrorNumber:1680, ErrorType:"ServerError", Symbol:"ER_PATH_LENGTH", SQLState:"HY000", Message:"The path specified for %s is too long. ", Description:"", MySQLVersion:"5.6"},
    1681: definition.ErrorDefinition{ErrorNumber:1681, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYNTAX_NO_REPLACEMENT", SQLState:"HY000", Message:"'%s' is deprecated and will be removed in a future release. ", Description:"", MySQLVersion:"5.6"},
    1682: definition.ErrorDefinition{ErrorNumber:1682, ErrorType:"ServerError", Symbol:"ER_WRONG_NATIVE_TABLE_STRUCTURE", SQLState:"HY000", Message:"Native table '%s'.'%s' has the wrong structure ", Description:"", MySQLVersion:"5.6"},
    1683: definition.ErrorDefinition{ErrorNumber:1683, ErrorType:"ServerError", Symbol:"ER_WRONG_PERFSCHEMA_USAGE", SQLState:"HY000", Message:"Invalid performance_schema usage. ", Description:"", MySQLVersion:"5.6"},
    1684: definition.ErrorDefinition{ErrorNumber:1684, ErrorType:"ServerError", Symbol:"ER_WARN_I_S_SKIPPED_TABLE", SQLState:"HY000", Message:"Table '%s'.'%s' was skipped since its definition is being modified by concurrent DDL statement ", Description:"", MySQLVersion:"5.6"},
    1685: definition.ErrorDefinition{ErrorNumber:1685, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_BINLOG_DIRECT", SQLState:"HY000", Message:"Cannot modify @@session.binlog_direct_non_transactional_updates inside a transaction ", Description:"", MySQLVersion:"5.6"},
    1686: definition.ErrorDefinition{ErrorNumber:1686, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_DIRECT", SQLState:"HY000", Message:"Cannot change the binlog direct flag inside a stored function or trigger ", Description:"", MySQLVersion:"5.6"},
    1687: definition.ErrorDefinition{ErrorNumber:1687, ErrorType:"ServerError", Symbol:"ER_SPATIAL_MUST_HAVE_GEOM_COL", SQLState:"42000", Message:"A SPATIAL index may only contain a geometrical type column ", Description:"", MySQLVersion:"5.6"},
    1688: definition.ErrorDefinition{ErrorNumber:1688, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_INDEX_COMMENT", SQLState:"HY000", Message:"Comment for index '%s' is too long (max = %lu) ", Description:"", MySQLVersion:"5.6"},
    1689: definition.ErrorDefinition{ErrorNumber:1689, ErrorType:"ServerError", Symbol:"ER_LOCK_ABORTED", SQLState:"HY000", Message:"Wait on a lock was aborted due to a pending exclusive lock ", Description:"", MySQLVersion:"5.6"},
    1690: definition.ErrorDefinition{ErrorNumber:1690, ErrorType:"ServerError", Symbol:"ER_DATA_OUT_OF_RANGE", SQLState:"22003", Message:"%s value is out of range in '%s' ", Description:"", MySQLVersion:"5.6"},
    1691: definition.ErrorDefinition{ErrorNumber:1691, ErrorType:"ServerError", Symbol:"ER_WRONG_SPVAR_TYPE_IN_LIMIT", SQLState:"HY000", Message:"A variable of a non-integer based type in LIMIT clause ", Description:"", MySQLVersion:"5.6"},
    1692: definition.ErrorDefinition{ErrorNumber:1692, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE", SQLState:"HY000", Message:"Mixing self-logging and non-self-logging engines in a statement is unsafe. ", Description:"", MySQLVersion:"5.6"},
    1693: definition.ErrorDefinition{ErrorNumber:1693, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_MIXED_STATEMENT", SQLState:"HY000", Message:"Statement accesses nontransactional table as well as transactional or temporary table, and writes to any of them. ", Description:"", MySQLVersion:"5.6"},
    1694: definition.ErrorDefinition{ErrorNumber:1694, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_SQL_LOG_BIN", SQLState:"HY000", Message:"Cannot modify @@session.sql_log_bin inside a transaction ", Description:"", MySQLVersion:"5.6"},
    1695: definition.ErrorDefinition{ErrorNumber:1695, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_SQL_LOG_BIN", SQLState:"HY000", Message:"Cannot change the sql_log_bin inside a stored function or trigger ", Description:"", MySQLVersion:"5.6"},
    1696: definition.ErrorDefinition{ErrorNumber:1696, ErrorType:"ServerError", Symbol:"ER_FAILED_READ_FROM_PAR_FILE", SQLState:"HY000", Message:"Failed to read from the .par file ", Description:"", MySQLVersion:"5.6"},
    1697: definition.ErrorDefinition{ErrorNumber:1697, ErrorType:"ServerError", Symbol:"ER_VALUES_IS_NOT_INT_TYPE_ERROR", SQLState:"HY000", Message:"VALUES value for partition '%s' must have type INT", Description:"ER_VALUES_IS_NOT_INT_TYPE_ERROR was added in 5.6.1. ", MySQLVersion:"5.6"},
    1698: definition.ErrorDefinition{ErrorNumber:1698, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_NO_PASSWORD_ERROR", SQLState:"28000", Message:"Access denied for user '%s'@'%s'", Description:"ER_ACCESS_DENIED_NO_PASSWORD_ERROR was added in 5.6.1. ", MySQLVersion:"5.6"},
    1699: definition.ErrorDefinition{ErrorNumber:1699, ErrorType:"ServerError", Symbol:"ER_SET_PASSWORD_AUTH_PLUGIN", SQLState:"HY000", Message:"SET PASSWORD has no significance for users authenticating via plugins", Description:"ER_SET_PASSWORD_AUTH_PLUGIN was added in 5.6.1. ", MySQLVersion:"5.6"},
    1700: definition.ErrorDefinition{ErrorNumber:1700, ErrorType:"ServerError", Symbol:"ER_GRANT_PLUGIN_USER_EXISTS", SQLState:"HY000", Message:"GRANT with IDENTIFIED WITH is illegal because the user %-.*s already exists", Description:"ER_GRANT_PLUGIN_USER_EXISTS was added in 5.6.1. ", MySQLVersion:"5.6"},
    1701: definition.ErrorDefinition{ErrorNumber:1701, ErrorType:"ServerError", Symbol:"ER_TRUNCATE_ILLEGAL_FK", SQLState:"42000", Message:"Cannot truncate a table referenced in a foreign key constraint (%s)", Description:"ER_TRUNCATE_ILLEGAL_FK was added in 5.6.1. ", MySQLVersion:"5.6"},
    1702: definition.ErrorDefinition{ErrorNumber:1702, ErrorType:"ServerError", Symbol:"ER_PLUGIN_IS_PERMANENT", SQLState:"HY000", Message:"Plugin '%s' is force_plus_permanent and can not be unloaded", Description:"ER_PLUGIN_IS_PERMANENT was added in 5.6.1. ", MySQLVersion:"5.6"},
    1703: definition.ErrorDefinition{ErrorNumber:1703, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN", SQLState:"HY000", Message:"The requested value for the heartbeat period is less than 1 millisecond. The value is reset to 0, meaning that heartbeating will effectively be disabled.", Description:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN was added in 5.6.1. ", MySQLVersion:"5.6"},
    1704: definition.ErrorDefinition{ErrorNumber:1704, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX", SQLState:"HY000", Message:"The requested value for the heartbeat period exceeds the value of `slave_net_timeout' seconds. A sensible value for the period should be less than the timeout.", Description:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX was added in 5.6.1. ", MySQLVersion:"5.6"},
    1705: definition.ErrorDefinition{ErrorNumber:1705, ErrorType:"ServerError", Symbol:"ER_STMT_CACHE_FULL", SQLState:"HY000", Message:"Multi-row statements required more than 'max_binlog_stmt_cache_size' bytes of storage", Description:"ER_STMT_CACHE_FULL was added in 5.6.1. ", MySQLVersion:"5.6"},
    1706: definition.ErrorDefinition{ErrorNumber:1706, ErrorType:"ServerError", Symbol:"ER_MULTI_UPDATE_KEY_CONFLICT", SQLState:"HY000", Message:"Primary key/partition key update is not allowed since the table is updated both as '%s' and '%s'.", Description:"ER_MULTI_UPDATE_KEY_CONFLICT was added in 5.6.2. ", MySQLVersion:"5.6"},
    1707: definition.ErrorDefinition{ErrorNumber:1707, ErrorType:"ServerError", Symbol:"ER_TABLE_NEEDS_REBUILD", SQLState:"HY000", Message:"Table rebuild required. Please do \"ALTER TABLE `%s` FORCE\" or dump/reload to fix it!", Description:"ER_TABLE_NEEDS_REBUILD was added in 5.6.3. ", MySQLVersion:"5.6"},
    1708: definition.ErrorDefinition{ErrorNumber:1708, ErrorType:"ServerError", Symbol:"WARN_OPTION_BELOW_LIMIT", SQLState:"HY000", Message:"The value of '%s' should be no less than the value of '%s'", Description:"WARN_OPTION_BELOW_LIMIT was added in 5.6.3. ", MySQLVersion:"5.6"},
    1709: definition.ErrorDefinition{ErrorNumber:1709, ErrorType:"ServerError", Symbol:"ER_INDEX_COLUMN_TOO_LONG", SQLState:"HY000", Message:"Index column size too large. The maximum column size is %lu bytes.", Description:"ER_INDEX_COLUMN_TOO_LONG was added in 5.6.3. ", MySQLVersion:"5.6"},
    1710: definition.ErrorDefinition{ErrorNumber:1710, ErrorType:"ServerError", Symbol:"ER_ERROR_IN_TRIGGER_BODY", SQLState:"HY000", Message:"Trigger '%s' has an error in its body: '%s'", Description:"ER_ERROR_IN_TRIGGER_BODY was added in 5.6.3. ", MySQLVersion:"5.6"},
    1711: definition.ErrorDefinition{ErrorNumber:1711, ErrorType:"ServerError", Symbol:"ER_ERROR_IN_UNKNOWN_TRIGGER_BODY", SQLState:"HY000", Message:"Unknown trigger has an error in its body: '%s'", Description:"ER_ERROR_IN_UNKNOWN_TRIGGER_BODY was added in 5.6.3. ", MySQLVersion:"5.6"},
    1712: definition.ErrorDefinition{ErrorNumber:1712, ErrorType:"ServerError", Symbol:"ER_INDEX_CORRUPT", SQLState:"HY000", Message:"Index %s is corrupted", Description:"ER_INDEX_CORRUPT was added in 5.6.3. ", MySQLVersion:"5.6"},
    1713: definition.ErrorDefinition{ErrorNumber:1713, ErrorType:"ServerError", Symbol:"ER_UNDO_RECORD_TOO_BIG", SQLState:"HY000", Message:"Undo log record is too big.", Description:"ER_UNDO_RECORD_TOO_BIG was added in 5.6.4. ", MySQLVersion:"5.6"},
    1714: definition.ErrorDefinition{ErrorNumber:1714, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_IGNORE_SELECT", SQLState:"HY000", Message:"INSERT IGNORE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on master and the slave.", Description:"ER_BINLOG_UNSAFE_INSERT_IGNORE_SELECT was added in 5.6.4. ", MySQLVersion:"5.6"},
    1715: definition.ErrorDefinition{ErrorNumber:1715, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_SELECT_UPDATE", SQLState:"HY000", Message:"INSERT... SELECT... ON DUPLICATE KEY UPDATE is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are updated. This order cannot be predicted and may differ on master and the slave.", Description:"ER_BINLOG_UNSAFE_INSERT_SELECT_UPDATE was added in 5.6.4. ", MySQLVersion:"5.6"},
    1716: definition.ErrorDefinition{ErrorNumber:1716, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_REPLACE_SELECT", SQLState:"HY000", Message:"REPLACE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are replaced. This order cannot be predicted and may differ on master and the slave.", Description:"ER_BINLOG_UNSAFE_REPLACE_SELECT was added in 5.6.4. ", MySQLVersion:"5.6"},
    1717: definition.ErrorDefinition{ErrorNumber:1717, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_CREATE_IGNORE_SELECT", SQLState:"HY000", Message:"CREATE... IGNORE SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on master and the slave.", Description:"ER_BINLOG_UNSAFE_CREATE_IGNORE_SELECT was added in 5.6.4. ", MySQLVersion:"5.6"},
    ...
    1724: definition.ErrorDefinition{ErrorNumber:1724, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_TWO_KEYS", SQLState:"HY000", Message:"INSERT... ON DUPLICATE KEY UPDATE on a table with more than one UNIQUE KEY is unsafe", Description:"ER_BINLOG_UNSAFE_INSERT_TWO_KEYS was added in 5.6.6. ", MySQLVersion:"5.6"},
    1725: definition.ErrorDefinition{ErrorNumber:1725, ErrorType:"ServerError", Symbol:"ER_TABLE_IN_FK_CHECK", SQLState:"HY000", Message:"Table is being used in foreign key check.", Description:"ER_TABLE_IN_FK_CHECK was added in 5.6.6. ", MySQLVersion:"5.6"},
    1726: definition.ErrorDefinition{ErrorNumber:1726, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ENGINE", SQLState:"HY000", Message:"Storage engine '%s' does not support system tables. [%s.%s]", Description:"ER_UNSUPPORTED_ENGINE was added in 5.6.6. ", MySQLVersion:"5.6"},
    1727: definition.ErrorDefinition{ErrorNumber:1727, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST", SQLState:"HY000", Message:"INSERT into autoincrement field which is not the first part in the composed primary key is unsafe.", Description:"ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST was added in 5.6.6. ", MySQLVersion:"5.6"},
    1728: definition.ErrorDefinition{ErrorNumber:1728, ErrorType:"ServerError", Symbol:"ER_CANNOT_LOAD_FROM_TABLE_V2", SQLState:"HY000", Message:"Cannot load from %s.%s. The table is probably corrupted ", Description:"", MySQLVersion:"5.6"},
    1729: definition.ErrorDefinition{ErrorNumber:1729, ErrorType:"ServerError", Symbol:"ER_MASTER_DELAY_VALUE_OUT_OF_RANGE", SQLState:"HY000", Message:"The requested value %s for the master delay exceeds the maximum %u ", Description:"", MySQLVersion:"5.6"},
    1730: definition.ErrorDefinition{ErrorNumber:1730, ErrorType:"ServerError", Symbol:"ER_ONLY_FD_AND_RBR_EVENTS_ALLOWED_IN_BINLOG_STATEMENT", SQLState:"HY000", Message:"Only Format_description_log_event and row events are allowed in BINLOG statements (but %s was provided) ", Description:"", MySQLVersion:"5.6"},
    1731: definition.ErrorDefinition{ErrorNumber:1731, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_DIFFERENT_OPTION", SQLState:"HY000", Message:"Non matching attribute '%s' between partition and table ", Description:"", MySQLVersion:"5.6"},
    1732: definition.ErrorDefinition{ErrorNumber:1732, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_PART_TABLE", SQLState:"HY000", Message:"Table to exchange with partition is partitioned: '%s' ", Description:"", MySQLVersion:"5.6"},
    1733: definition.ErrorDefinition{ErrorNumber:1733, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_TEMP_TABLE", SQLState:"HY000", Message:"Table to exchange with partition is temporary: '%s' ", Description:"", MySQLVersion:"5.6"},
    1734: definition.ErrorDefinition{ErrorNumber:1734, ErrorType:"ServerError", Symbol:"ER_PARTITION_INSTEAD_OF_SUBPARTITION", SQLState:"HY000", Message:"Subpartitioned table, use subpartition instead of partition ", Description:"", MySQLVersion:"5.6"},
    1735: definition.ErrorDefinition{ErrorNumber:1735, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_PARTITION", SQLState:"HY000", Message:"Unknown partition '%s' in table '%s' ", Description:"", MySQLVersion:"5.6"},
    1736: definition.ErrorDefinition{ErrorNumber:1736, ErrorType:"ServerError", Symbol:"ER_TABLES_DIFFERENT_METADATA", SQLState:"HY000", Message:"Tables have different definitions ", Description:"", MySQLVersion:"5.6"},
    1737: definition.ErrorDefinition{ErrorNumber:1737, ErrorType:"ServerError", Symbol:"ER_ROW_DOES_NOT_MATCH_PARTITION", SQLState:"HY000", Message:"Found a row that does not match the partition ", Description:"", MySQLVersion:"5.6"},
    1738: definition.ErrorDefinition{ErrorNumber:1738, ErrorType:"ServerError", Symbol:"ER_BINLOG_CACHE_SIZE_GREATER_THAN_MAX", SQLState:"HY000", Message:"Option binlog_cache_size (%lu) is greater than max_binlog_cache_size (%lu)", Description:"ER_BINLOG_CACHE_SIZE_GREATER_THAN_MAX was added in 5.6.1. ", MySQLVersion:"5.6"},
    1739: definition.ErrorDefinition{ErrorNumber:1739, ErrorType:"ServerError", Symbol:"ER_WARN_INDEX_NOT_APPLICABLE", SQLState:"HY000", Message:"Cannot use %s access on index '%s' due to type or collation conversion on field '%s'", Description:"ER_WARN_INDEX_NOT_APPLICABLE was added in 5.6.1. ", MySQLVersion:"5.6"},
    1740: definition.ErrorDefinition{ErrorNumber:1740, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_FOREIGN_KEY", SQLState:"HY000", Message:"Table to exchange with partition has foreign key references: '%s'", Description:"ER_PARTITION_EXCHANGE_FOREIGN_KEY was added in 5.6.1. ", MySQLVersion:"5.6"},
    1741: definition.ErrorDefinition{ErrorNumber:1741, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_KEY_VALUE", SQLState:"HY000", Message:"Key value '%s' was not found in table '%s.%s'", Description:"ER_NO_SUCH_KEY_VALUE was added in 5.6.1. ", MySQLVersion:"5.6"},
    1742: definition.ErrorDefinition{ErrorNumber:1742, ErrorType:"ServerError", Symbol:"ER_RPL_INFO_DATA_TOO_LONG", SQLState:"HY000", Message:"Data for column '%s' too long", Description:"ER_RPL_INFO_DATA_TOO_LONG was added in 5.6.1. ", MySQLVersion:"5.6"},
    ...
    1749: definition.ErrorDefinition{ErrorNumber:1749, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_PARTITION__UNUSED", SQLState:"HY000", Message:"partition '%s' doesn't exist", Description:"ER_NO_SUCH_PARTITION__UNUSED was added in 5.6.6. ", MySQLVersion:"5.6"},
    1750: definition.ErrorDefinition{ErrorNumber:1750, ErrorType:"ServerError", Symbol:"ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE", SQLState:"HY000", Message:"Failure while changing the type of replication repository: %s.", Description:"ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE was added in 5.6.3. ", MySQLVersion:"5.6"},
    1751: definition.ErrorDefinition{ErrorNumber:1751, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_CREATED_TEMP_TABLE", SQLState:"HY000", Message:"The creation of some temporary tables could not be rolled back.", Description:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_CREATED_TEMP_TABLE was added in 5.6.3. ", MySQLVersion:"5.6"},
    1752: definition.ErrorDefinition{ErrorNumber:1752, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_DROPPED_TEMP_TABLE", SQLState:"HY000", Message:"Some temporary tables were dropped, but these operations could not be rolled back.", Description:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_DROPPED_TEMP_TABLE was added in 5.6.3. ", MySQLVersion:"5.6"},
    1753: definition.ErrorDefinition{ErrorNumber:1753, ErrorType:"ServerError", Symbol:"ER_MTS_FEATURE_IS_NOT_SUPPORTED", SQLState:"HY000", Message:"%s is not supported in multi-threaded slave mode. %s", Description:"ER_MTS_FEATURE_IS_NOT_SUPPORTED was added in 5.6.3. ", MySQLVersion:"5.6"},
    1754: definition.ErrorDefinition{ErrorNumber:1754, ErrorType:"ServerError", Symbol:"ER_MTS_UPDATED_DBS_GREATER_MAX", SQLState:"HY000", Message:"The number of modified databases exceeds the maximum %d", Description:"ER_MTS_UPDATED_DBS_GREATER_MAX was added in 5.6.3. ", MySQLVersion:"5.6"},
    1755: definition.ErrorDefinition{ErrorNumber:1755, ErrorType:"ServerError", Symbol:"ER_MTS_CANT_PARALLEL", SQLState:"HY000", Message:"Cannot execute the current event group in the parallel mode. Encountered event %s, relay-log name %s, position %s which prevents execution of this event group in parallel mode. Reason: %s.", Description:"ER_MTS_CANT_PARALLEL was added in 5.6.3. ", MySQLVersion:"5.6"},
    1756: definition.ErrorDefinition{ErrorNumber:1756, ErrorType:"ServerError", Symbol:"ER_MTS_INCONSISTENT_DATA", SQLState:"HY000", Message:"%s", Description:"ER_MTS_INCONSISTENT_DATA was added in 5.6.3. ", MySQLVersion:"5.6"},
    1757: definition.ErrorDefinition{ErrorNumber:1757, ErrorType:"ServerError", Symbol:"ER_FULLTEXT_NOT_SUPPORTED_WITH_PARTITIONING", SQLState:"HY000", Message:"FULLTEXT index is not supported for partitioned tables.", Description:"ER_FULLTEXT_NOT_SUPPORTED_WITH_PARTITIONING was added in 5.6.4. ", MySQLVersion:"5.6"},
    1758: definition.ErrorDefinition{ErrorNumber:1758, ErrorType:"ServerError", Symbol:"ER_DA_INVALID_CONDITION_NUMBER", SQLState:"35000", Message:"Invalid condition number", Description:"ER_DA_INVALID_CONDITION_NUMBER was added in 5.6.4. ", MySQLVersion:"5.6"},
    1759: definition.ErrorDefinition{ErrorNumber:1759, ErrorType:"ServerError", Symbol:"ER_INSECURE_PLAIN_TEXT", SQLState:"HY000", Message:"Sending passwords in plain text without SSL/TLS is extremely insecure.", Description:"ER_INSECURE_PLAIN_TEXT was added in 5.6.4. ", MySQLVersion:"5.6"},
    1760: definition.ErrorDefinition{ErrorNumber:1760, ErrorType:"ServerError", Symbol:"ER_INSECURE_CHANGE_MASTER", SQLState:"HY000", Message:"Storing MySQL user name or password information in the master info repository is not secure and is therefore not recommended. Please consider using the USER and PASSWORD connection options for START SLAVE", Description:"ER_INSECURE_CHANGE_MASTER was added in 5.6.4. ", MySQLVersion:"5.6"},
    1761: definition.ErrorDefinition{ErrorNumber:1761, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DUPLICATE_KEY_WITH_CHILD_INFO", SQLState:"23000", Message:"Foreign key constraint for table '%s', record '%s' would lead to a duplicate entry in table '%s', key '%s'", Description:"ER_FOREIGN_DUPLICATE_KEY_WITH_CHILD_INFO was added in 5.6.4. ", MySQLVersion:"5.6"},
    1762: definition.ErrorDefinition{ErrorNumber:1762, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DUPLICATE_KEY_WITHOUT_CHILD_INFO", SQLState:"23000", Message:"Foreign key constraint for table '%s', record '%s' would lead to a duplicate entry in a child table", Description:"ER_FOREIGN_DUPLICATE_KEY_WITHOUT_CHILD_INFO was added in 5.6.4. ", MySQLVersion:"5.6"},
    1763: definition.ErrorDefinition{ErrorNumber:1763, ErrorType:"ServerError", Symbol:"ER_SQLTHREAD_WITH_SECURE_SLAVE", SQLState:"HY000", Message:"Setting authentication options is not possible when only the Slave SQL Thread is being started.", Description:"ER_SQLTHREAD_WITH_SECURE_SLAVE was added in 5.6.4. ", MySQLVersion:"5.6"},
    1764: definition.ErrorDefinition{ErrorNumber:1764, ErrorType:"ServerError", Symbol:"ER_TABLE_HAS_NO_FT", SQLState:"HY000", Message:"The table does not have FULLTEXT index to support this query", Description:"ER_TABLE_HAS_NO_FT was added in 5.6.4. ", MySQLVersion:"5.6"},
    1765: definition.ErrorDefinition{ErrorNumber:1765, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_SF_OR_TRIGGER", SQLState:"HY000", Message:"The system variable %s cannot be set in stored functions or triggers.", Description:"ER_VARIABLE_NOT_SETTABLE_IN_SF_OR_TRIGGER was added in 5.6.5. ", MySQLVersion:"5.6"},
    1766: definition.ErrorDefinition{ErrorNumber:1766, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_TRANSACTION", SQLState:"HY000", Message:"The system variable %s cannot be set when there is an ongoing transaction.", Description:"ER_VARIABLE_NOT_SETTABLE_IN_TRANSACTION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1767: definition.ErrorDefinition{ErrorNumber:1767, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_IS_NOT_IN_GTID_NEXT_LIST", SQLState:"HY000", Message:"The system variable @@SESSION.GTID_NEXT has the value %s, which is not listed in @@SESSION.GTID_NEXT_LIST.", Description:"ER_GTID_NEXT_IS_NOT_IN_GTID_NEXT_LIST was added in 5.6.5. ", MySQLVersion:"5.6"},
    ...
    1769: definition.ErrorDefinition{ErrorNumber:1769, ErrorType:"ServerError", Symbol:"ER_SET_STATEMENT_CANNOT_INVOKE_FUNCTION", SQLState:"HY000", Message:"The statement 'SET %s' cannot invoke a stored function.", Description:"ER_SET_STATEMENT_CANNOT_INVOKE_FUNCTION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1770: definition.ErrorDefinition{ErrorNumber:1770, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_CANT_BE_AUTOMATIC_IF_GTID_NEXT_LIST_IS_NON_NULL", SQLState:"HY000", Message:"The system variable @@SESSION.GTID_NEXT cannot be 'AUTOMATIC' when @@SESSION.GTID_NEXT_LIST is non-NULL.", Description:"ER_GTID_NEXT_CANT_BE_AUTOMATIC_IF_GTID_NEXT_LIST_IS_NON_NULL was added in 5.6.5. ", MySQLVersion:"5.6"},
    1771: definition.ErrorDefinition{ErrorNumber:1771, ErrorType:"ServerError", Symbol:"ER_SKIPPING_LOGGED_TRANSACTION", SQLState:"HY000", Message:"Skipping transaction %s because it has already been executed and logged.", Description:"ER_SKIPPING_LOGGED_TRANSACTION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1772: definition.ErrorDefinition{ErrorNumber:1772, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SET_SPECIFICATION", SQLState:"HY000", Message:"Malformed GTID set specification '%s'.", Description:"ER_MALFORMED_GTID_SET_SPECIFICATION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1773: definition.ErrorDefinition{ErrorNumber:1773, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SET_ENCODING", SQLState:"HY000", Message:"Malformed GTID set encoding.", Description:"ER_MALFORMED_GTID_SET_ENCODING was added in 5.6.5. ", MySQLVersion:"5.6"},
    1774: definition.ErrorDefinition{ErrorNumber:1774, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SPECIFICATION", SQLState:"HY000", Message:"Malformed GTID specification '%s'.", Description:"ER_MALFORMED_GTID_SPECIFICATION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1775: definition.ErrorDefinition{ErrorNumber:1775, ErrorType:"ServerError", Symbol:"ER_GNO_EXHAUSTED", SQLState:"HY000", Message:"Impossible to generate Global Transaction Identifier: the integer component reached the maximal value. Restart the server with a new server_uuid.", Description:"ER_GNO_EXHAUSTED was added in 5.6.5. ", MySQLVersion:"5.6"},
    ...
    1782: definition.ErrorDefinition{ErrorNumber:1782, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_TO_ANONYMOUS_WHEN_GTID_MODE_IS_ON", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT cannot be set to ANONYMOUS when @@GLOBAL.GTID_MODE = ON.", Description:"ER_CANT_SET_GTID_NEXT_TO_ANONYMOUS_WHEN_GTID_MODE_IS_ON was added in 5.6.5. ", MySQLVersion:"5.6"},
    1783: definition.ErrorDefinition{ErrorNumber:1783, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_LIST_TO_NON_NULL_WHEN_GTID_MODE_IS_OFF", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT_LIST cannot be set to a non-NULL value when @@GLOBAL.GTID_MODE = OFF.", Description:"ER_CANT_SET_GTID_NEXT_LIST_TO_NON_NULL_WHEN_GTID_MODE_IS_OFF was added in 5.6.5. ", MySQLVersion:"5.6"},
    ...
    1785: definition.ErrorDefinition{ErrorNumber:1785, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_NON_TRANSACTIONAL_TABLE", SQLState:"HY000", Message:"When @@GLOBAL.ENFORCE_GTID_CONSISTENCY = 1, updates to non-transactional tables can only be done in either autocommitted statements or single-statement transactions, and never in the same statement as updates to transactional tables.", Description:"ER_GTID_UNSAFE_NON_TRANSACTIONAL_TABLE was added in 5.6.5. ", MySQLVersion:"5.6"},
    1786: definition.ErrorDefinition{ErrorNumber:1786, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_CREATE_SELECT", SQLState:"HY000", Message:"CREATE TABLE ... SELECT is forbidden when @@GLOBAL.ENFORCE_GTID_CONSISTENCY = 1.", Description:"ER_GTID_UNSAFE_CREATE_SELECT was added in 5.6.5. ", MySQLVersion:"5.6"},
    ...
    1788: definition.ErrorDefinition{ErrorNumber:1788, ErrorType:"ServerError", Symbol:"ER_GTID_MODE_CAN_ONLY_CHANGE_ONE_STEP_AT_A_TIME", SQLState:"HY000", Message:"The value of @@GLOBAL.GTID_MODE can only change one step at a time: OFF <-> UPGRADE_STEP_1 <-> UPGRADE_STEP_2 <-> ON. Also note that this value must be stepped up or down simultaneously on all servers", Description:"ER_GTID_MODE_CAN_ONLY_CHANGE_ONE_STEP_AT_A_TIME was added in 5.6.5. ", MySQLVersion:"5.6"},
    1789: definition.ErrorDefinition{ErrorNumber:1789, ErrorType:"ServerError", Symbol:"ER_MASTER_HAS_PURGED_REQUIRED_GTIDS", SQLState:"HY000", Message:"The slave is connecting using CHANGE MASTER TO MASTER_AUTO_POSITION = 1, but the master has purged binary logs containing GTIDs that the slave requires. Replicate the missing transactions from elsewhere, or provision a new slave from backup. Consider increasing the master's binary log expiration period. %s.", Description:"ER_MASTER_HAS_PURGED_REQUIRED_GTIDS was added in 5.6.5. ", MySQLVersion:"5.6"},
    1790: definition.ErrorDefinition{ErrorNumber:1790, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_WHEN_OWNING_GTID", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT cannot be changed by a client that owns a GTID. The client owns %s. Ownership is released on COMMIT or ROLLBACK.", Description:"ER_CANT_SET_GTID_NEXT_WHEN_OWNING_GTID was added in 5.6.5. ", MySQLVersion:"5.6"},
    1791: definition.ErrorDefinition{ErrorNumber:1791, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_EXPLAIN_FORMAT", SQLState:"HY000", Message:"Unknown EXPLAIN format name: '%s'", Description:"ER_UNKNOWN_EXPLAIN_FORMAT was added in 5.6.5. ", MySQLVersion:"5.6"},
    1792: definition.ErrorDefinition{ErrorNumber:1792, ErrorType:"ServerError", Symbol:"ER_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION", SQLState:"25006", Message:"Cannot execute statement in a READ ONLY transaction.", Description:"ER_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION was added in 5.6.5. ", MySQLVersion:"5.6"},
    1793: definition.ErrorDefinition{ErrorNumber:1793, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_TABLE_PARTITION_COMMENT", SQLState:"HY000", Message:"Comment for table partition '%s' is too long (max = %lu)", Description:"ER_TOO_LONG_TABLE_PARTITION_COMMENT was added in 5.6.6. ", MySQLVersion:"5.6"},
    1794: definition.ErrorDefinition{ErrorNumber:1794, ErrorType:"ServerError", Symbol:"ER_SLAVE_CONFIGURATION", SQLState:"HY000", Message:"Slave is not configured or failed to initialize properly. You must at least set --server-id to enable either a master or a slave. Additional error messages can be found in the MySQL error log.", Description:"ER_SLAVE_CONFIGURATION was added in 5.6.6. ", MySQLVersion:"5.6"},
    1795: definition.ErrorDefinition{ErrorNumber:1795, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_LIMIT", SQLState:"HY000", Message:"InnoDB presently supports one FULLTEXT index creation at a time", Description:"ER_INNODB_FT_LIMIT was added in 5.6.4. ", MySQLVersion:"5.6"},
    1796: definition.ErrorDefinition{ErrorNumber:1796, ErrorType:"ServerError", Symbol:"ER_INNODB_NO_FT_TEMP_TABLE", SQLState:"HY000", Message:"Cannot create FULLTEXT index on temporary InnoDB table", Description:"ER_INNODB_NO_FT_TEMP_TABLE was added in 5.6.4. ", MySQLVersion:"5.6"},
    1797: definition.ErrorDefinition{ErrorNumber:1797, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_WRONG_DOCID_COLUMN", SQLState:"HY000", Message:"Column '%s' is of wrong type for an InnoDB FULLTEXT index", Description:"ER_INNODB_FT_WRONG_DOCID_COLUMN was added in 5.6.6. ", MySQLVersion:"5.6"},
    1798: definition.ErrorDefinition{ErrorNumber:1798, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_WRONG_DOCID_INDEX", SQLState:"HY000", Message:"Index '%s' is of wrong type for an InnoDB FULLTEXT index", Description:"ER_INNODB_FT_WRONG_DOCID_INDEX was added in 5.6.6. ", MySQLVersion:"5.6"},
    1799: definition.ErrorDefinition{ErrorNumber:1799, ErrorType:"ServerError", Symbol:"ER_INNODB_ONLINE_LOG_TOO_BIG", SQLState:"HY000", Message:"Creating index '%s' required more than 'innodb_online_alter_log_max_size' bytes of modification log. Please try again.", Description:"ER_INNODB_ONLINE_LOG_TOO_BIG was added in 5.6.6. ", MySQLVersion:"5.6"},
    1800: definition.ErrorDefinition{ErrorNumber:1800, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ALTER_ALGORITHM", SQLState:"HY000", Message:"Unknown ALGORITHM '%s'", Description:"ER_UNKNOWN_ALTER_ALGORITHM was added in 5.6.6. ", MySQLVersion:"5.6"},
    1801: definition.ErrorDefinition{ErrorNumber:1801, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ALTER_LOCK", SQLState:"HY000", Message:"Unknown LOCK type '%s'", Description:"ER_UNKNOWN_ALTER_LOCK was added in 5.6.6. ", MySQLVersion:"5.6"},
    1802: definition.ErrorDefinition{ErrorNumber:1802, ErrorType:"ServerError", Symbol:"ER_MTS_CHANGE_MASTER_CANT_RUN_WITH_GAPS", SQLState:"HY000", Message:"CHANGE MASTER cannot be executed when the slave was stopped with an error or killed in MTS mode. Consider using RESET SLAVE or START SLAVE UNTIL.", Description:"ER_MTS_CHANGE_MASTER_CANT_RUN_WITH_GAPS was added in 5.6.6. ", MySQLVersion:"5.6"},
    1803: definition.ErrorDefinition{ErrorNumber:1803, ErrorType:"ServerError", Symbol:"ER_MTS_RECOVERY_FAILURE", SQLState:"HY000", Message:"Cannot recover after SLAVE errored out in parallel execution mode. Additional error messages can be found in the MySQL error log.", Description:"ER_MTS_RECOVERY_FAILURE was added in 5.6.6. ", MySQLVersion:"5.6"},
    1804: definition.ErrorDefinition{ErrorNumber:1804, ErrorType:"ServerError", Symbol:"ER_MTS_RESET_WORKERS", SQLState:"HY000", Message:"Cannot clean up worker info tables. Additional error messages can be found in the MySQL error log.", Description:"ER_MTS_RESET_WORKERS was added in 5.6.6. ", MySQLVersion:"5.6"},
    1805: definition.ErrorDefinition{ErrorNumber:1805, ErrorType:"ServerError", Symbol:"ER_COL_COUNT_DOESNT_MATCH_CORRUPTED_V2", SQLState:"HY000", Message:"Column count of %s.%s is wrong. Expected %d, found %d. The table is probably corrupted ", Description:"", MySQLVersion:"5.6"},
    1806: definition.ErrorDefinition{ErrorNumber:1806, ErrorType:"ServerError", Symbol:"ER_SLAVE_SILENT_RETRY_TRANSACTION", SQLState:"HY000", Message:"Slave must silently retry current transaction", Description:"ER_SLAVE_SILENT_RETRY_TRANSACTION was added in 5.6.6. ", MySQLVersion:"5.6"},
    1807: definition.ErrorDefinition{ErrorNumber:1807, ErrorType:"ServerError", Symbol:"ER_DISCARD_FK_CHECKS_RUNNING", SQLState:"HY000", Message:"There is a foreign key check running on table '%s'. Cannot discard the table.", Description:"ER_DISCARD_FK_CHECKS_RUNNING was added in 5.6.6. ", MySQLVersion:"5.6"},
    1808: definition.ErrorDefinition{ErrorNumber:1808, ErrorType:"ServerError", Symbol:"ER_TABLE_SCHEMA_MISMATCH", SQLState:"HY000", Message:"Schema mismatch (%s)", Description:"ER_TABLE_SCHEMA_MISMATCH was added in 5.6.6. ", MySQLVersion:"5.6"},
    1809: definition.ErrorDefinition{ErrorNumber:1809, ErrorType:"ServerError", Symbol:"ER_TABLE_IN_SYSTEM_TABLESPACE", SQLState:"HY000", Message:"Table '%s' in system tablespace", Description:"ER_TABLE_IN_SYSTEM_TABLESPACE was added in 5.6.6. ", MySQLVersion:"5.6"},
    1810: definition.ErrorDefinition{ErrorNumber:1810, ErrorType:"ServerError", Symbol:"ER_IO_READ_ERROR", SQLState:"HY000", Message:"IO Read error: (%lu, %s) %s", Description:"ER_IO_READ_ERROR was added in 5.6.6. ", MySQLVersion:"5.6"},
    1811: definition.ErrorDefinition{ErrorNumber:1811, ErrorType:"ServerError", Symbol:"ER_IO_WRITE_ERROR", SQLState:"HY000", Message:"IO Write error: (%lu, %s) %s", Description:"ER_IO_WRITE_ERROR was added in 5.6.6. ", MySQLVersion:"5.6"},
    1812: definition.ErrorDefinition{ErrorNumber:1812, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_MISSING", SQLState:"HY000", Message:"Tablespace is missing for table '%s'", Description:"ER_TABLESPACE_MISSING was added in 5.6.6. ", MySQLVersion:"5.6"},
    1813: definition.ErrorDefinition{ErrorNumber:1813, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_EXISTS", SQLState:"HY000", Message:"Tablespace for table '%s' exists. Please DISCARD the tablespace before IMPORT.", Description:"ER_TABLESPACE_EXISTS was added in 5.6.6. ", MySQLVersion:"5.6"},
    1814: definition.ErrorDefinition{ErrorNumber:1814, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_DISCARDED", SQLState:"HY000", Message:"Tablespace has been discarded for table '%s'", Description:"ER_TABLESPACE_DISCARDED was added in 5.6.6. ", MySQLVersion:"5.6"},
    1815: definition.ErrorDefinition{ErrorNumber:1815, ErrorType:"ServerError", Symbol:"ER_INTERNAL_ERROR", SQLState:"HY000", Message:"Internal error: %s", Description:"ER_INTERNAL_ERROR was added in 5.6.6. ", MySQLVersion:"5.6"},
    1816: definition.ErrorDefinition{ErrorNumber:1816, ErrorType:"ServerError", Symbol:"ER_INNODB_IMPORT_ERROR", SQLState:"HY000", Message:"ALTER TABLE '%s' IMPORT TABLESPACE failed with error %lu : '%s'", Description:"ER_INNODB_IMPORT_ERROR was added in 5.6.6. ", MySQLVersion:"5.6"},
    1817: definition.ErrorDefinition{ErrorNumber:1817, ErrorType:"ServerError", Symbol:"ER_INNODB_INDEX_CORRUPT", SQLState:"HY000", Message:"Index corrupt: %s", Description:"ER_INNODB_INDEX_CORRUPT was added in 5.6.6. ", MySQLVersion:"5.6"},
    1818: definition.ErrorDefinition{ErrorNumber:1818, ErrorType:"ServerError", Symbol:"ER_INVALID_YEAR_COLUMN_LENGTH", SQLState:"HY000", Message:"YEAR(%lu) column type is deprecated. Creating YEAR(4) column instead.", Description:"ER_INVALID_YEAR_COLUMN_LENGTH was added in 5.6.6. ", MySQLVersion:"5.6"},
    1819: definition.ErrorDefinition{ErrorNumber:1819, ErrorType:"ServerError", Symbol:"ER_NOT_VALID_PASSWORD", SQLState:"HY000", Message:"Your password does not satisfy the current policy requirements", Description:"ER_NOT_VALID_PASSWORD was added in 5.6.6. ", MySQLVersion:"5.6"},
    1820: definition.ErrorDefinition{ErrorNumber:1820, ErrorType:"ServerError", Symbol:"ER_MUST_CHANGE_PASSWORD", SQLState:"HY000", Message:"You must SET PASSWORD before executing this statement", Description:"ER_MUST_CHANGE_PASSWORD was added in 5.6.6. ", MySQLVersion:"5.6"},
    1821: definition.ErrorDefinition{ErrorNumber:1821, ErrorType:"ServerError", Symbol:"ER_FK_NO_INDEX_CHILD", SQLState:"HY000", Message:"Failed to add the foreign key constaint. Missing index for constraint '%s' in the foreign table '%s'", Description:"ER_FK_NO_INDEX_CHILD was added in 5.6.6. ", MySQLVersion:"5.6"},
    1822: definition.ErrorDefinition{ErrorNumber:1822, ErrorType:"ServerError", Symbol:"ER_FK_NO_INDEX_PARENT", SQLState:"HY000", Message:"Failed to add the foreign key constaint. Missing index for constraint '%s' in the referenced table '%s'", Description:"ER_FK_NO_INDEX_PARENT was added in 5.6.6. ", MySQLVersion:"5.6"},
    1823: definition.ErrorDefinition{ErrorNumber:1823, ErrorType:"ServerError", Symbol:"ER_FK_FAIL_ADD_SYSTEM", SQLState:"HY000", Message:"Failed to add the foreign key constraint '%s' to system tables", Description:"ER_FK_FAIL_ADD_SYSTEM was added in 5.6.6. ", MySQLVersion:"5.6"},
    1824: definition.ErrorDefinition{ErrorNumber:1824, ErrorType:"ServerError", Symbol:"ER_FK_CANNOT_OPEN_PARENT", SQLState:"HY000", Message:"Failed to open the referenced table '%s'", Description:"ER_FK_CANNOT_OPEN_PARENT was added in 5.6.6. ", MySQLVersion:"5.6"},
    1825: definition.ErrorDefinition{ErrorNumber:1825, ErrorType:"ServerError", Symbol:"ER_FK_INCORRECT_OPTION", SQLState:"HY000", Message:"Failed to add the foreign key constraint on table '%s'. Incorrect options in FOREIGN KEY constraint '%s'", Description:"ER_FK_INCORRECT_OPTION was added in 5.6.6. ", MySQLVersion:"5.6"},
    1826: definition.ErrorDefinition{ErrorNumber:1826, ErrorType:"ServerError", Symbol:"ER_FK_DUP_NAME", SQLState:"HY000", Message:"Duplicate foreign key constraint name '%s'", Description:"ER_FK_DUP_NAME was added in 5.6.6. ", MySQLVersion:"5.6"},
    1827: definition.ErrorDefinition{ErrorNumber:1827, ErrorType:"ServerError", Symbol:"ER_PASSWORD_FORMAT", SQLState:"HY000", Message:"The password hash doesn't have the expected format. Check if the correct password algorithm is being used with the PASSWORD() function.", Description:"ER_PASSWORD_FORMAT was added in 5.6.6. ", MySQLVersion:"5.6"},
    1828: definition.ErrorDefinition{ErrorNumber:1828, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_DROP", SQLState:"HY000", Message:"Cannot drop column '%s': needed in a foreign key constraint '%s'", Description:"ER_FK_COLUMN_CANNOT_DROP was added in 5.6.6. ", MySQLVersion:"5.6"},
    1829: definition.ErrorDefinition{ErrorNumber:1829, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_DROP_CHILD", SQLState:"HY000", Message:"Cannot drop column '%s': needed in a foreign key constraint '%s' of table '%s'", Description:"ER_FK_COLUMN_CANNOT_DROP_CHILD was added in 5.6.6. ", MySQLVersion:"5.6"},
    1830: definition.ErrorDefinition{ErrorNumber:1830, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_NOT_NULL", SQLState:"HY000", Message:"Column '%s' cannot be NOT NULL: needed in a foreign key constraint '%s' SET NULL", Description:"ER_FK_COLUMN_NOT_NULL was added in 5.6.6. ", MySQLVersion:"5.6"},
    1831: definition.ErrorDefinition{ErrorNumber:1831, ErrorType:"ServerError", Symbol:"ER_DUP_INDEX", SQLState:"HY000", Message:"Duplicate index '%s' defined on the table '%s.%s'. This is deprecated and will be disallowed in a future release.", Description:"ER_DUP_INDEX was added in 5.6.7. ", MySQLVersion:"5.6"},
    1832: definition.ErrorDefinition{ErrorNumber:1832, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_CHANGE", SQLState:"HY000", Message:"Cannot change column '%s': used in a foreign key constraint '%s'", Description:"ER_FK_COLUMN_CANNOT_CHANGE was added in 5.6.7. ", MySQLVersion:"5.6"},
    1833: definition.ErrorDefinition{ErrorNumber:1833, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_CHANGE_CHILD", SQLState:"HY000", Message:"Cannot change column '%s': used in a foreign key constraint '%s' of table '%s'", Description:"ER_FK_COLUMN_CANNOT_CHANGE_CHILD was added in 5.6.7. ", MySQLVersion:"5.6"},
    1834: definition.ErrorDefinition{ErrorNumber:1834, ErrorType:"ServerError", Symbol:"ER_FK_CANNOT_DELETE_PARENT", SQLState:"HY000", Message:"Cannot delete rows from table which is parent in a foreign key constraint '%s' of table '%s'", Description:"ER_FK_CANNOT_DELETE_PARENT was added in 5.6.7. ", MySQLVersion:"5.6"},
    1835: definition.ErrorDefinition{ErrorNumber:1835, ErrorType:"ServerError", Symbol:"ER_MALFORMED_PACKET", SQLState:"HY000", Message:"Malformed communication packet.", Description:"ER_MALFORMED_PACKET was added in 5.6.7. ", MySQLVersion:"5.6"},
    1836: definition.ErrorDefinition{ErrorNumber:1836, ErrorType:"ServerError", Symbol:"ER_READ_ONLY_MODE", SQLState:"HY000", Message:"Running in read-only mode", Description:"ER_READ_ONLY_MODE was added in 5.6.8. ", MySQLVersion:"5.6"},
    1837: definition.ErrorDefinition{ErrorNumber:1837, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_TYPE_UNDEFINED_GROUP", SQLState:"HY000", Message:"When @@SESSION.GTID_NEXT is set to a GTID, you must explicitly set it to a different value after a COMMIT or ROLLBACK. Please check GTID_NEXT variable manual page for detailed explanation. Current @@SESSION.GTID_NEXT is '%s'.", Description:"ER_GTID_NEXT_TYPE_UNDEFINED_GROUP was added in 5.6.9. ", MySQLVersion:"5.6"},
    1838: definition.ErrorDefinition{ErrorNumber:1838, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_SP", SQLState:"HY000", Message:"The system variable %s cannot be set in stored procedures.", Description:"ER_VARIABLE_NOT_SETTABLE_IN_SP was added in 5.6.9. ", MySQLVersion:"5.6"},
    1839: definition.ErrorDefinition{ErrorNumber:1839, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_MODE_IS_OFF", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when @@GLOBAL.GTID_MODE = ON.", Description:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_MODE_IS_OFF was added in 5.6.9. ", MySQLVersion:"5.6"},
    1840: definition.ErrorDefinition{ErrorNumber:1840, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_EXECUTED_IS_NOT_EMPTY", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when @@GLOBAL.GTID_EXECUTED is empty.", Description:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_EXECUTED_IS_NOT_EMPTY was added in 5.6.9. ", MySQLVersion:"5.6"},
    1841: definition.ErrorDefinition{ErrorNumber:1841, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_OWNED_GTIDS_IS_NOT_EMPTY", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when there are no ongoing transactions (not even in other clients).", Description:"ER_CANT_SET_GTID_PURGED_WHEN_OWNED_GTIDS_IS_NOT_EMPTY was added in 5.6.9. ", MySQLVersion:"5.6"},
    1842: definition.ErrorDefinition{ErrorNumber:1842, ErrorType:"ServerError", Symbol:"ER_GTID_PURGED_WAS_CHANGED", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED was changed from '%s' to '%s'.", Description:"ER_GTID_PURGED_WAS_CHANGED was added in 5.6.9. ", MySQLVersion:"5.6"},
    1843: definition.ErrorDefinition{ErrorNumber:1843, ErrorType:"ServerError", Symbol:"ER_GTID_EXECUTED_WAS_CHANGED", SQLState:"HY000", Message:"@@GLOBAL.GTID_EXECUTED was changed from '%s' to '%s'.", Description:"ER_GTID_EXECUTED_WAS_CHANGED was added in 5.6.9. ", MySQLVersion:"5.6"},
    1844: definition.ErrorDefinition{ErrorNumber:1844, ErrorType:"ServerError", Symbol:"ER_BINLOG_STMT_MODE_AND_NO_REPL_TABLES", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binary log since BINLOG_FORMAT = STATEMENT, and both replicated and non replicated tables are written to.", Description:"ER_BINLOG_STMT_MODE_AND_NO_REPL_TABLES was added in 5.6.9. ", MySQLVersion:"5.6"},
    1845: definition.ErrorDefinition{ErrorNumber:1845, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED", SQLState:"0A000", Message:"%s is not supported for this operation. Try %s.", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED was added in 5.6.10. ", MySQLVersion:"5.6"},
    1846: definition.ErrorDefinition{ErrorNumber:1846, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON", SQLState:"0A000", Message:"%s is not supported. Reason: %s. Try %s.", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON was added in 5.6.10. ", MySQLVersion:"5.6"},
    1847: definition.ErrorDefinition{ErrorNumber:1847, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COPY", SQLState:"HY000", Message:"COPY algorithm requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COPY was added in 5.6.10. ", MySQLVersion:"5.6"},
    1848: definition.ErrorDefinition{ErrorNumber:1848, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_PARTITION", SQLState:"HY000", Message:"Partition specific operations do not yet support LOCK/ALGORITHM", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_PARTITION was added in 5.6.10. ", MySQLVersion:"5.6"},
    1849: definition.ErrorDefinition{ErrorNumber:1849, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_RENAME", SQLState:"HY000", Message:"Columns participating in a foreign key are renamed", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_RENAME was added in 5.6.10. ", MySQLVersion:"5.6"},
    1850: definition.ErrorDefinition{ErrorNumber:1850, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COLUMN_TYPE", SQLState:"HY000", Message:"Cannot change column type INPLACE", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COLUMN_TYPE was added in 5.6.10. ", MySQLVersion:"5.6"},
    1851: definition.ErrorDefinition{ErrorNumber:1851, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_CHECK", SQLState:"HY000", Message:"Adding foreign keys needs foreign_key_checks=OFF", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_CHECK was added in 5.6.10. ", MySQLVersion:"5.6"},
    1852: definition.ErrorDefinition{ErrorNumber:1852, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_IGNORE", SQLState:"HY000", Message:"Creating unique indexes with IGNORE requires COPY algorithm to remove duplicate rows", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_IGNORE was added in 5.6.10. ", MySQLVersion:"5.6"},
    ...
    1854: definition.ErrorDefinition{ErrorNumber:1854, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_AUTOINC", SQLState:"HY000", Message:"Adding an auto-increment column requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_AUTOINC was added in 5.6.10. ", MySQLVersion:"5.6"},
    ...
    1856: definition.ErrorDefinition{ErrorNumber:1856, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTS", SQLState:"HY000", Message:"Cannot drop or rename FTS_DOC_ID", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTS was added in 5.6.10. ", MySQLVersion:"5.6"},
    1857: definition.ErrorDefinition{ErrorNumber:1857, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTS", SQLState:"HY000", Message:"Fulltext index creation requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTS was added in 5.6.10. ", MySQLVersion:"5.6"},
    1858: definition.ErrorDefinition{ErrorNumber:1858, ErrorType:"ServerError", Symbol:"ER_SQL_SLAVE_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODE", SQLState:"HY000", Message:"sql_slave_skip_counter can not be set when the server is running with @@GLOBAL.GTID_MODE = ON. Instead, for each transaction that you want to skip, generate an empty transaction with the same GTID as the transaction", Description:"ER_SQL_SLAVE_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODE was added in 5.6.10. ", MySQLVersion:"5.6"},
    1859: definition.ErrorDefinition{ErrorNumber:1859, ErrorType:"ServerError", Symbol:"ER_DUP_UNKNOWN_IN_INDEX", SQLState:"23000", Message:"Duplicate entry for key '%s'", Description:"ER_DUP_UNKNOWN_IN_INDEX was added in 5.6.10. ", MySQLVersion:"5.6"},
    1860: definition.ErrorDefinition{ErrorNumber:1860, ErrorType:"ServerError", Symbol:"ER_IDENT_CAUSES_TOO_LONG_PATH", SQLState:"HY000", Message:"Long database name and identifier for object resulted in path length exceeding %d characters. Path: '%s'.", Description:"ER_IDENT_CAUSES_TOO_LONG_PATH was added in 5.6.10. ", MySQLVersion:"5.6"},
    ...
    1862: definition.ErrorDefinition{ErrorNumber:1862, ErrorType:"ServerError", Symbol:"ER_MUST_CHANGE_PASSWORD_LOGIN", SQLState:"HY000", Message:"Your password has expired. To log in you must change it using a client that supports expired passwords.", Description:"ER_MUST_CHANGE_PASSWORD_LOGIN was added in 5.6.11. ", MySQLVersion:"5.6"},
    1863: definition.ErrorDefinition{ErrorNumber:1863, ErrorType:"ServerError", Symbol:"ER_ROW_IN_WRONG_PARTITION", SQLState:"HY000", Message:"Found a row in wrong partition %s", Description:"ER_ROW_IN_WRONG_PARTITION was added in 5.6.11. ", MySQLVersion:"5.6"},
    1864: definition.ErrorDefinition{ErrorNumber:1864, ErrorType:"ServerError", Symbol:"ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAX", SQLState:"HY000", Message:"Cannot schedule event %s, relay-log name %s, position %s to Worker thread because its size %lu exceeds %lu of slave_pending_jobs_size_max.", Description:"ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAX was added in 5.6.12. ", MySQLVersion:"5.6"},
    1865: definition.ErrorDefinition{ErrorNumber:1865, ErrorType:"ServerError", Symbol:"ER_INNODB_NO_FT_USES_PARSER", SQLState:"HY000", Message:"Cannot CREATE FULLTEXT INDEX WITH PARSER on InnoDB table", Description:"ER_INNODB_NO_FT_USES_PARSER was added in 5.6.12. ", MySQLVersion:"5.6"},
    1866: definition.ErrorDefinition{ErrorNumber:1866, ErrorType:"ServerError", Symbol:"ER_BINLOG_LOGICAL_CORRUPTION", SQLState:"HY000", Message:"The binary log file '%s' is logically corrupted: %s", Description:"ER_BINLOG_LOGICAL_CORRUPTION was added in 5.6.12. ", MySQLVersion:"5.6"},
    1867: definition.ErrorDefinition{ErrorNumber:1867, ErrorType:"ServerError", Symbol:"ER_WARN_PURGE_LOG_IN_USE", SQLState:"HY000", Message:"file %s was not purged because it was being read by %d thread(s), purged only %d out of %d files.", Description:"ER_WARN_PURGE_LOG_IN_USE was added in 5.6.12. ", MySQLVersion:"5.6"},
    1868: definition.ErrorDefinition{ErrorNumber:1868, ErrorType:"ServerError", Symbol:"ER_WARN_PURGE_LOG_IS_ACTIVE", SQLState:"HY000", Message:"file %s was not purged because it is the active log file.", Description:"ER_WARN_PURGE_LOG_IS_ACTIVE was added in 5.6.12. ", MySQLVersion:"5.6"},
    1869: definition.ErrorDefinition{ErrorNumber:1869, ErrorType:"ServerError", Symbol:"ER_AUTO_INCREMENT_CONFLICT", SQLState:"HY000", Message:"Auto-increment value in UPDATE conflicts with internally generated values", Description:"ER_AUTO_INCREMENT_CONFLICT was added in 5.6.12. ", MySQLVersion:"5.6"},
    1870: definition.ErrorDefinition{ErrorNumber:1870, ErrorType:"ServerError", Symbol:"WARN_ON_BLOCKHOLE_IN_RBR", SQLState:"HY000", Message:"Row events are not logged for %s statements that modify BLACKHOLE tables in row format. Table(s): '%s'", Description:"WARN_ON_BLOCKHOLE_IN_RBR was added in 5.6.12. ", MySQLVersion:"5.6"},
    1871: definition.ErrorDefinition{ErrorNumber:1871, ErrorType:"ServerError", Symbol:"ER_SLAVE_MI_INIT_REPOSITORY", SQLState:"HY000", Message:"Slave failed to initialize master info structure from the repository", Description:"ER_SLAVE_MI_INIT_REPOSITORY was added in 5.6.12. ", MySQLVersion:"5.6"},
    1872: definition.ErrorDefinition{ErrorNumber:1872, ErrorType:"ServerError", Symbol:"ER_SLAVE_RLI_INIT_REPOSITORY", SQLState:"HY000", Message:"Slave failed to initialize relay log info structure from the repository", Description:"ER_SLAVE_RLI_INIT_REPOSITORY was added in 5.6.12. ", MySQLVersion:"5.6"},
    1873: definition.ErrorDefinition{ErrorNumber:1873, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_CHANGE_USER_ERROR", SQLState:"28000", Message:"Access denied trying to change to user '%s'@'%s' (using password: %s). Disconnecting.", Description:"ER_ACCESS_DENIED_CHANGE_USER_ERROR was added in 5.6.13. ", MySQLVersion:"5.6"},
    1874: definition.ErrorDefinition{ErrorNumber:1874, ErrorType:"ServerError", Symbol:"ER_INNODB_READ_ONLY", SQLState:"HY000", Message:"InnoDB is in read only mode.", Description:"ER_INNODB_READ_ONLY was added in 5.6.13. ", MySQLVersion:"5.6"},
    1875: definition.ErrorDefinition{ErrorNumber:1875, ErrorType:"ServerError", Symbol:"ER_STOP_SLAVE_SQL_THREAD_TIMEOUT", SQLState:"HY000", Message:"STOP SLAVE command execution is incomplete: Slave SQL thread got the stop signal, thread is busy, SQL thread will stop once the current task is complete.", Description:"ER_STOP_SLAVE_SQL_THREAD_TIMEOUT was added in 5.6.13. ", MySQLVersion:"5.6"},
    1876: definition.ErrorDefinition{ErrorNumber:1876, ErrorType:"ServerError", Symbol:"ER_STOP_SLAVE_IO_THREAD_TIMEOUT", SQLState:"HY000", Message:"STOP SLAVE command execution is incomplete: Slave IO thread got the stop signal, thread is busy, IO thread will stop once the current task is complete.", Description:"ER_STOP_SLAVE_IO_THREAD_TIMEOUT was added in 5.6.13. ", MySQLVersion:"5.6"},
    1877: definition.ErrorDefinition{ErrorNumber:1877, ErrorType:"ServerError", Symbol:"ER_TABLE_CORRUPT", SQLState:"HY000", Message:"Operation cannot be performed. The table '%s.%s' is missing, corrupt or contains bad data.", Description:"ER_TABLE_CORRUPT was added in 5.6.14. ", MySQLVersion:"5.6"},
    1878: definition.ErrorDefinition{ErrorNumber:1878, ErrorType:"ServerError", Symbol:"ER_TEMP_FILE_WRITE_FAILURE", SQLState:"HY000", Message:"Temporary file write failure.", Description:"ER_TEMP_FILE_WRITE_FAILURE was added in 5.6.15. ", MySQLVersion:"5.6"},
    1879: definition.ErrorDefinition{ErrorNumber:1879, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_AUX_NOT_HEX_ID", SQLState:"HY000", Message:"Upgrade index name failed, please use create index(alter table) algorithm copy to rebuild index.", Description:"ER_INNODB_FT_AUX_NOT_HEX_ID was added in 5.6.16. ", MySQLVersion:"5.6"},
    1880: definition.ErrorDefinition{ErrorNumber:1880, ErrorType:"ServerError", Symbol:"ER_OLD_TEMPORALS_UPGRADED", SQLState:"HY000", Message:"TIME/TIMESTAMP/DATETIME columns of old format have been upgraded to the new format.", Description:"ER_OLD_TEMPORALS_UPGRADED was added in 5.6.16. ", MySQLVersion:"5.6"},
    1881: definition.ErrorDefinition{ErrorNumber:1881, ErrorType:"ServerError", Symbol:"ER_INNODB_FORCED_RECOVERY", SQLState:"HY000", Message:"Operation not allowed when innodb_forced_recovery > 0.", Description:"ER_INNODB_FORCED_RECOVERY was added in 5.6.16. ", MySQLVersion:"5.6"},
    1882: definition.ErrorDefinition{ErrorNumber:1882, ErrorType:"ServerError", Symbol:"ER_AES_INVALID_IV", SQLState:"HY000", Message:"The initialization vector supplied to %s is too short. Must be at least %d bytes long", Description:"ER_AES_INVALID_IV was added in 5.6.17. ", MySQLVersion:"5.6"},
    1883: definition.ErrorDefinition{ErrorNumber:1883, ErrorType:"ServerError", Symbol:"ER_PLUGIN_CANNOT_BE_UNINSTALLED", SQLState:"HY000", Message:"Plugin '%s' cannot be uninstalled now. %s", Description:"ER_PLUGIN_CANNOT_BE_UNINSTALLED was added in 5.6.20. ", MySQLVersion:"5.6"},
    1884: definition.ErrorDefinition{ErrorNumber:1884, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_BINLOG_SPLITTABLE_STATEMENT_AND_GTID_GROUP", SQLState:"HY000", Message:"Cannot execute statement because it needs to be written to the binary log as multiple statements, and this is not allowed when @@SESSION.GTID_NEXT == 'UUID:NUMBER'.", Description:"ER_GTID_UNSAFE_BINLOG_SPLITTABLE_STATEMENT_AND_GTID_GROUP was added in 5.6.20. ", MySQLVersion:"5.6"},
    1885: definition.ErrorDefinition{ErrorNumber:1885, ErrorType:"ServerError", Symbol:"ER_SLAVE_HAS_MORE_GTIDS_THAN_MASTER", SQLState:"HY000", Message:"Slave has more GTIDs than the master has, using the master's SERVER_UUID. This may indicate that the end of the binary log was truncated or that the last binary log file was lost, e.g., after a power or disk failure when sync_binlog != 1. The master may or may not have rolled back transactions that were already replicated to the slave. Suggest to replicate any transactions that master has rolled back from slave to master, and/or commit empty transactions on master to account for transactions that have been committed on master but are not included in GTID_EXECUTED.", Description:"ER_SLAVE_HAS_MORE_GTIDS_THAN_MASTER was added in 5.6.23. ", MySQLVersion:"5.6"},
    1886: definition.ErrorDefinition{ErrorNumber:1886, ErrorType:"ServerError", Symbol:"ER_MISSING_KEY", SQLState:"HY000", Message:"The table '%s.%s' does not have the necessary key(s) defined on it. Please check the table definition and create index(s) accordingly.", Description:"ER_MISSING_KEY was added in 5.6.40. ", MySQLVersion:"5.6"},
    1887: definition.ErrorDefinition{ErrorNumber:1887, ErrorType:"ServerError", Symbol:"WARN_NAMED_PIPE_ACCESS_EVERYONE", SQLState:"HY000", Message:"Setting named_pipe_full_access_group='%s' is insecure. Consider using a Windows group with fewer members.", Description:"WARN_NAMED_PIPE_ACCESS_EVERYONE was added in 5.6.45. ", MySQLVersion:"5.6"},
    1888: definition.ErrorDefinition{ErrorNumber:1888, ErrorType:"ServerError", Symbol:"ER_FOUND_MISSING_GTIDS", SQLState:"HY000", Message:"Cannot replicate to server with server_uuid='%s' because the present server has purged required binary logs. The connecting server needs to replicate the missing transactions from elsewhere, or be replaced by a new server created from a more recent backup. To prevent this error in the future, consider increasing the binary log expiration period on the present server. %s.", Description:"ER_FOUND_MISSING_GTIDS was added in 5.6.47.", MySQLVersion:"5.6"},
    2000: definition.ErrorDefinition{ErrorNumber:2000, ErrorType:"ClientError", Symbol:"CR_UNKNOWN_ERROR", SQLState:"", Message:"Unknown MySQL error ", Description:"", MySQLVersion:"5.6"},
    2001: definition.ErrorDefinition{ErrorNumber:2001, ErrorType:"ClientError", Symbol:"CR_SOCKET_CREATE_ERROR", SQLState:"", Message:"Can't create UNIX socket (%d) ", Description:"", MySQLVersion:"5.6"},
    2002: definition.ErrorDefinition{ErrorNumber:2002, ErrorType:"ClientError", Symbol:"CR_CONNECTION_ERROR", SQLState:"", Message:"Can't connect to local MySQL server through socket '%s' (%d) ", Description:"", MySQLVersion:"5.6"},
    2003: definition.ErrorDefinition{ErrorNumber:2003, ErrorType:"ClientError", Symbol:"CR_CONN_HOST_ERROR", SQLState:"", Message:"Can't connect to MySQL server on '%s' (%d) ", Description:"", MySQLVersion:"5.6"},
    2004: definition.ErrorDefinition{ErrorNumber:2004, ErrorType:"ClientError", Symbol:"CR_IPSOCK_ERROR", SQLState:"", Message:"Can't create TCP/IP socket (%d) ", Description:"", MySQLVersion:"5.6"},
    2005: definition.ErrorDefinition{ErrorNumber:2005, ErrorType:"ClientError", Symbol:"CR_UNKNOWN_HOST", SQLState:"", Message:"Unknown MySQL server host '%s' (%d) ", Description:"", MySQLVersion:"5.6"},
    2006: definition.ErrorDefinition{ErrorNumber:2006, ErrorType:"ClientError", Symbol:"CR_SERVER_GONE_ERROR", SQLState:"", Message:"MySQL server has gone away ", Description:"", MySQLVersion:"5.6"},
    2007: definition.ErrorDefinition{ErrorNumber:2007, ErrorType:"ClientError", Symbol:"CR_VERSION_ERROR", SQLState:"", Message:"Protocol mismatch", Description:"server version = %d, client version = %d ", MySQLVersion:"5.6"},
    2008: definition.ErrorDefinition{ErrorNumber:2008, ErrorType:"ClientError", Symbol:"CR_OUT_OF_MEMORY", SQLState:"", Message:"MySQL client ran out of memory ", Description:"", MySQLVersion:"5.6"},
    2009: definition.ErrorDefinition{ErrorNumber:2009, ErrorType:"ClientError", Symbol:"CR_WRONG_HOST_INFO", SQLState:"", Message:"Wrong host info ", Description:"", MySQLVersion:"5.6"},
    2010: definition.ErrorDefinition{ErrorNumber:2010, ErrorType:"ClientError", Symbol:"CR_LOCALHOST_CONNECTION", SQLState:"", Message:"Localhost via UNIX socket ", Description:"", MySQLVersion:"5.6"},
    2011: definition.ErrorDefinition{ErrorNumber:2011, ErrorType:"ClientError", Symbol:"CR_TCP_CONNECTION", SQLState:"", Message:"%s via TCP/IP ", Description:"", MySQLVersion:"5.6"},
    2012: definition.ErrorDefinition{ErrorNumber:2012, ErrorType:"ClientError", Symbol:"CR_SERVER_HANDSHAKE_ERR", SQLState:"", Message:"Error in server handshake ", Description:"", MySQLVersion:"5.6"},
    2013: definition.ErrorDefinition{ErrorNumber:2013, ErrorType:"ClientError", Symbol:"CR_SERVER_LOST", SQLState:"", Message:"Lost connection to MySQL server during query ", Description:"", MySQLVersion:"5.6"},
    ...
    2015: definition.ErrorDefinition{ErrorNumber:2015, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPE_CONNECTION", SQLState:"", Message:"Named pipe: %s ", Description:"", MySQLVersion:"5.6"},
    2016: definition.ErrorDefinition{ErrorNumber:2016, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPEWAIT_ERROR", SQLState:"", Message:"Can't wait for named pipe to host: %s pipe: %s (%lu) ", Description:"", MySQLVersion:"5.6"},
    2017: definition.ErrorDefinition{ErrorNumber:2017, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPEOPEN_ERROR", SQLState:"", Message:"Can't open named pipe to host: %s pipe: %s (%lu) ", Description:"", MySQLVersion:"5.6"},
    2018: definition.ErrorDefinition{ErrorNumber:2018, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPESETSTATE_ERROR", SQLState:"", Message:"Can't set state of named pipe to host: %s pipe: %s (%lu) ", Description:"", MySQLVersion:"5.6"},
    2019: definition.ErrorDefinition{ErrorNumber:2019, ErrorType:"ClientError", Symbol:"CR_CANT_READ_CHARSET", SQLState:"", Message:"Can't initialize character set %s (path: %s) ", Description:"", MySQLVersion:"5.6"},
    2020: definition.ErrorDefinition{ErrorNumber:2020, ErrorType:"ClientError", Symbol:"CR_NET_PACKET_TOO_LARGE", SQLState:"", Message:"Got packet bigger than 'max_allowed_packet' bytes ", Description:"", MySQLVersion:"5.6"},
    2021: definition.ErrorDefinition{ErrorNumber:2021, ErrorType:"ClientError", Symbol:"CR_EMBEDDED_CONNECTION", SQLState:"", Message:"Embedded server ", Description:"", MySQLVersion:"5.6"},
    2022: definition.ErrorDefinition{ErrorNumber:2022, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_STATUS", SQLState:"", Message:"Error on SHOW SLAVE STATUS: ", Description:"", MySQLVersion:"5.6"},
    2023: definition.ErrorDefinition{ErrorNumber:2023, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_HOSTS", SQLState:"", Message:"Error on SHOW SLAVE HOSTS: ", Description:"", MySQLVersion:"5.6"},
    2024: definition.ErrorDefinition{ErrorNumber:2024, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_CONNECT", SQLState:"", Message:"Error connecting to slave: ", Description:"", MySQLVersion:"5.6"},
    2025: definition.ErrorDefinition{ErrorNumber:2025, ErrorType:"ClientError", Symbol:"CR_PROBE_MASTER_CONNECT", SQLState:"", Message:"Error connecting to master: ", Description:"", MySQLVersion:"5.6"},
    2026: definition.ErrorDefinition{ErrorNumber:2026, ErrorType:"ClientError", Symbol:"CR_SSL_CONNECTION_ERROR", SQLState:"", Message:"SSL connection error: %s ", Description:"", MySQLVersion:"5.6"},
    2027: definition.ErrorDefinition{ErrorNumber:2027, ErrorType:"ClientError", Symbol:"CR_MALFORMED_PACKET", SQLState:"", Message:"Malformed packet ", Description:"", MySQLVersion:"5.6"},
    2028: definition.ErrorDefinition{ErrorNumber:2028, ErrorType:"ClientError", Symbol:"CR_WRONG_LICENSE", SQLState:"", Message:"This client library is licensed only for use with MySQL servers having '%s' license ", Description:"", MySQLVersion:"5.6"},
    2029: definition.ErrorDefinition{ErrorNumber:2029, ErrorType:"ClientError", Symbol:"CR_NULL_POINTER", SQLState:"", Message:"Invalid use of null pointer ", Description:"", MySQLVersion:"5.6"},
    2030: definition.ErrorDefinition{ErrorNumber:2030, ErrorType:"ClientError", Symbol:"CR_NO_PREPARE_STMT", SQLState:"", Message:"Statement not prepared ", Description:"", MySQLVersion:"5.6"},
    2031: definition.ErrorDefinition{ErrorNumber:2031, ErrorType:"ClientError", Symbol:"CR_PARAMS_NOT_BOUND", SQLState:"", Message:"No data supplied for parameters in prepared statement ", Description:"", MySQLVersion:"5.6"},
    2032: definition.ErrorDefinition{ErrorNumber:2032, ErrorType:"ClientError", Symbol:"CR_DATA_TRUNCATED", SQLState:"", Message:"Data truncated ", Description:"", MySQLVersion:"5.6"},
    2033: definition.ErrorDefinition{ErrorNumber:2033, ErrorType:"ClientError", Symbol:"CR_NO_PARAMETERS_EXISTS", SQLState:"", Message:"No parameters exist in the statement ", Description:"", MySQLVersion:"5.6"},
    2034: definition.ErrorDefinition{ErrorNumber:2034, ErrorType:"ClientError", Symbol:"CR_INVALID_PARAMETER_NO", SQLState:"", Message:"Invalid parameter number", Description:"From 5.6.6: A key name was empty or the amount of connection attribute data for mysql_options4() exceeds the 64KB limit. ", MySQLVersion:"5.6"},
    2035: definition.ErrorDefinition{ErrorNumber:2035, ErrorType:"ClientError", Symbol:"CR_INVALID_BUFFER_USE", SQLState:"", Message:"Can't send long data for non-string/non-binary data types (parameter: %d) ", Description:"", MySQLVersion:"5.6"},
    2036: definition.ErrorDefinition{ErrorNumber:2036, ErrorType:"ClientError", Symbol:"CR_UNSUPPORTED_PARAM_TYPE", SQLState:"", Message:"Using unsupported buffer type: %d (parameter: %d) ", Description:"", MySQLVersion:"5.6"},
    2037: definition.ErrorDefinition{ErrorNumber:2037, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECTION", SQLState:"", Message:"Shared memory: %s ", Description:"", MySQLVersion:"5.6"},
    2038: definition.ErrorDefinition{ErrorNumber:2038, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_REQUEST_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not create request event (%lu) ", MySQLVersion:"5.6"},
    2039: definition.ErrorDefinition{ErrorNumber:2039, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_ANSWER_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"no answer event received from server (%lu) ", MySQLVersion:"5.6"},
    2040: definition.ErrorDefinition{ErrorNumber:2040, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_FILE_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"server could not allocate file mapping (%lu) ", MySQLVersion:"5.6"},
    2041: definition.ErrorDefinition{ErrorNumber:2041, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"server could not get pointer to file mapping (%lu) ", MySQLVersion:"5.6"},
    2042: definition.ErrorDefinition{ErrorNumber:2042, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_FILE_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not allocate file mapping (%lu) ", MySQLVersion:"5.6"},
    2043: definition.ErrorDefinition{ErrorNumber:2043, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not get pointer to file mapping (%lu) ", MySQLVersion:"5.6"},
    2044: definition.ErrorDefinition{ErrorNumber:2044, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_EVENT_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not create %s event (%lu) ", MySQLVersion:"5.6"},
    2045: definition.ErrorDefinition{ErrorNumber:2045, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_ABANDONED_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"no answer from server (%lu) ", MySQLVersion:"5.6"},
    2046: definition.ErrorDefinition{ErrorNumber:2046, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_SET_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"cannot send request event to server (%lu) ", MySQLVersion:"5.6"},
    2047: definition.ErrorDefinition{ErrorNumber:2047, ErrorType:"ClientError", Symbol:"CR_CONN_UNKNOW_PROTOCOL", SQLState:"", Message:"Wrong or unknown protocol ", Description:"", MySQLVersion:"5.6"},
    2048: definition.ErrorDefinition{ErrorNumber:2048, ErrorType:"ClientError", Symbol:"CR_INVALID_CONN_HANDLE", SQLState:"", Message:"Invalid connection handle ", Description:"", MySQLVersion:"5.6"},
    2049: definition.ErrorDefinition{ErrorNumber:2049, ErrorType:"ClientError", Symbol:"CR_SECURE_AUTH", SQLState:"", Message:"Connection using old (pre-4.1.1) authentication protocol refused (client option 'secure_auth' enabled) ", Description:"", MySQLVersion:"5.6"},
    2050: definition.ErrorDefinition{ErrorNumber:2050, ErrorType:"ClientError", Symbol:"CR_FETCH_CANCELED", SQLState:"", Message:"Row retrieval was canceled by mysql_stmt_close() call ", Description:"", MySQLVersion:"5.6"},
    2051: definition.ErrorDefinition{ErrorNumber:2051, ErrorType:"ClientError", Symbol:"CR_NO_DATA", SQLState:"", Message:"Attempt to read column without prior row fetch ", Description:"", MySQLVersion:"5.6"},
    2052: definition.ErrorDefinition{ErrorNumber:2052, ErrorType:"ClientError", Symbol:"CR_NO_STMT_METADATA", SQLState:"", Message:"Prepared statement contains no metadata ", Description:"", MySQLVersion:"5.6"},
    2053: definition.ErrorDefinition{ErrorNumber:2053, ErrorType:"ClientError", Symbol:"CR_NO_RESULT_SET", SQLState:"", Message:"Attempt to read a row while there is no result set associated with the statement ", Description:"", MySQLVersion:"5.6"},
    2054: definition.ErrorDefinition{ErrorNumber:2054, ErrorType:"ClientError", Symbol:"CR_NOT_IMPLEMENTED", SQLState:"", Message:"This feature is not implemented yet ", Description:"", MySQLVersion:"5.6"},
    2055: definition.ErrorDefinition{ErrorNumber:2055, ErrorType:"ClientError", Symbol:"CR_SERVER_LOST_EXTENDED", SQLState:"", Message:"Lost connection to MySQL server at '%s', system error: %d ", Description:"", MySQLVersion:"5.6"},
    2056: definition.ErrorDefinition{ErrorNumber:2056, ErrorType:"ClientError", Symbol:"CR_STMT_CLOSED", SQLState:"", Message:"Statement closed indirectly because of a preceeding %s() call ", Description:"", MySQLVersion:"5.6"},
    2057: definition.ErrorDefinition{ErrorNumber:2057, ErrorType:"ClientError", Symbol:"CR_NEW_STMT_METADATA", SQLState:"", Message:"The number of columns in the result set differs from the number of bound buffers. You must reset the statement, rebind the result set columns, and execute the statement again ", Description:"", MySQLVersion:"5.6"},
    2058: definition.ErrorDefinition{ErrorNumber:2058, ErrorType:"ClientError", Symbol:"CR_ALREADY_CONNECTED", SQLState:"", Message:"This handle is already connected. Use a separate handle for each connection. ", Description:"", MySQLVersion:"5.6"},
    2059: definition.ErrorDefinition{ErrorNumber:2059, ErrorType:"ClientError", Symbol:"CR_AUTH_PLUGIN_CANNOT_LOAD", SQLState:"", Message:"Authentication plugin '%s' cannot be loaded: %s", Description:"CR_AUTH_PLUGIN_CANNOT_LOAD was added in 5.6.1. ", MySQLVersion:"5.6"},
    2060: definition.ErrorDefinition{ErrorNumber:2060, ErrorType:"ClientError", Symbol:"CR_DUPLICATE_CONNECTION_ATTR", SQLState:"", Message:"There is an attribute with the same name already", Description:"CR_DUPLICATE_CONNECTION_ATTR was added in 5.6.6. ", MySQLVersion:"5.6"},
    2061: definition.ErrorDefinition{ErrorNumber:2061, ErrorType:"ClientError", Symbol:"CR_AUTH_PLUGIN_ERR", SQLState:"", Message:"Authentication plugin '%s' reported error: %s", Description:"CR_AUTH_PLUGIN_ERR was added in 5.6.10.", MySQLVersion:"5.6"},
    1: definition.ErrorDefinition{ErrorNumber:1, ErrorType:"GlobalError", Symbol:"EE_CANTCREATEFILE", SQLState:"", Message:"Can't create/write to file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    2: definition.ErrorDefinition{ErrorNumber:2, ErrorType:"GlobalError", Symbol:"EE_READ", SQLState:"", Message:"Error reading file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    3: definition.ErrorDefinition{ErrorNumber:3, ErrorType:"GlobalError", Symbol:"EE_WRITE", SQLState:"", Message:"Error writing file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    4: definition.ErrorDefinition{ErrorNumber:4, ErrorType:"GlobalError", Symbol:"EE_BADCLOSE", SQLState:"", Message:"Error on close of '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    5: definition.ErrorDefinition{ErrorNumber:5, ErrorType:"GlobalError", Symbol:"EE_OUTOFMEMORY", SQLState:"", Message:"Out of memory (Needed %u bytes) ", Description:"", MySQLVersion:"5.6"},
    6: definition.ErrorDefinition{ErrorNumber:6, ErrorType:"GlobalError", Symbol:"EE_DELETE", SQLState:"", Message:"Error on delete of '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    7: definition.ErrorDefinition{ErrorNumber:7, ErrorType:"GlobalError", Symbol:"EE_LINK", SQLState:"", Message:"Error on rename of '%s' to '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    9: definition.ErrorDefinition{ErrorNumber:9, ErrorType:"GlobalError", Symbol:"EE_EOFERR", SQLState:"", Message:"Unexpected EOF found when reading file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    10: definition.ErrorDefinition{ErrorNumber:10, ErrorType:"GlobalError", Symbol:"EE_CANTLOCK", SQLState:"", Message:"Can't lock file (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    11: definition.ErrorDefinition{ErrorNumber:11, ErrorType:"GlobalError", Symbol:"EE_CANTUNLOCK", SQLState:"", Message:"Can't unlock file (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    12: definition.ErrorDefinition{ErrorNumber:12, ErrorType:"GlobalError", Symbol:"EE_DIR", SQLState:"", Message:"Can't read dir of '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    13: definition.ErrorDefinition{ErrorNumber:13, ErrorType:"GlobalError", Symbol:"EE_STAT", SQLState:"", Message:"Can't get stat of '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    14: definition.ErrorDefinition{ErrorNumber:14, ErrorType:"GlobalError", Symbol:"EE_CANT_CHSIZE", SQLState:"", Message:"Can't change size of file (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    15: definition.ErrorDefinition{ErrorNumber:15, ErrorType:"GlobalError", Symbol:"EE_CANT_OPEN_STREAM", SQLState:"", Message:"Can't open stream from handle (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    16: definition.ErrorDefinition{ErrorNumber:16, ErrorType:"GlobalError", Symbol:"EE_GETWD", SQLState:"", Message:"Can't get working directory (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    17: definition.ErrorDefinition{ErrorNumber:17, ErrorType:"GlobalError", Symbol:"EE_SETWD", SQLState:"", Message:"Can't change dir to '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    18: definition.ErrorDefinition{ErrorNumber:18, ErrorType:"GlobalError", Symbol:"EE_LINK_WARNING", SQLState:"", Message:"Warning: '%s' had %d links ", Description:"", MySQLVersion:"5.6"},
    19: definition.ErrorDefinition{ErrorNumber:19, ErrorType:"GlobalError", Symbol:"EE_OPEN_WARNING", SQLState:"", Message:"Warning: %d files and %d streams is left open ", Description:"", MySQLVersion:"5.6"},
    20: definition.ErrorDefinition{ErrorNumber:20, ErrorType:"GlobalError", Symbol:"EE_DISK_FULL", SQLState:"", Message:"Disk is full writing '%s' (Errcode: %d - %s). Waiting for someone to free space... ", Description:"", MySQLVersion:"5.6"},
    21: definition.ErrorDefinition{ErrorNumber:21, ErrorType:"GlobalError", Symbol:"EE_CANT_MKDIR", SQLState:"", Message:"Can't create directory '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    22: definition.ErrorDefinition{ErrorNumber:22, ErrorType:"GlobalError", Symbol:"EE_UNKNOWN_CHARSET", SQLState:"", Message:"Character set '%s' is not a compiled character set and is not specified in the '%s' file ", Description:"", MySQLVersion:"5.6"},
    23: definition.ErrorDefinition{ErrorNumber:23, ErrorType:"GlobalError", Symbol:"EE_OUT_OF_FILERESOURCES", SQLState:"", Message:"Out of resources when opening file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    24: definition.ErrorDefinition{ErrorNumber:24, ErrorType:"GlobalError", Symbol:"EE_CANT_READLINK", SQLState:"", Message:"Can't read value for symlink '%s' (Error %d - %s) ", Description:"", MySQLVersion:"5.6"},
    25: definition.ErrorDefinition{ErrorNumber:25, ErrorType:"GlobalError", Symbol:"EE_CANT_SYMLINK", SQLState:"", Message:"Can't create symlink '%s' pointing at '%s' (Error %d - %s) ", Description:"", MySQLVersion:"5.6"},
    26: definition.ErrorDefinition{ErrorNumber:26, ErrorType:"GlobalError", Symbol:"EE_REALPATH", SQLState:"", Message:"Error on realpath() on '%s' (Error %d - %s) ", Description:"", MySQLVersion:"5.6"},
    27: definition.ErrorDefinition{ErrorNumber:27, ErrorType:"GlobalError", Symbol:"EE_SYNC", SQLState:"", Message:"Can't sync file '%s' to disk (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    28: definition.ErrorDefinition{ErrorNumber:28, ErrorType:"GlobalError", Symbol:"EE_UNKNOWN_COLLATION", SQLState:"", Message:"Collation '%s' is not a compiled collation and is not specified in the '%s' file ", Description:"", MySQLVersion:"5.6"},
    29: definition.ErrorDefinition{ErrorNumber:29, ErrorType:"GlobalError", Symbol:"EE_FILENOTFOUND", SQLState:"", Message:"File '%s' not found (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    30: definition.ErrorDefinition{ErrorNumber:30, ErrorType:"GlobalError", Symbol:"EE_FILE_NOT_CLOSED", SQLState:"", Message:"File '%s' (fileno: %d) was not closed ", Description:"", MySQLVersion:"5.6"},
    31: definition.ErrorDefinition{ErrorNumber:31, ErrorType:"GlobalError", Symbol:"EE_CHANGE_OWNERSHIP", SQLState:"", Message:"Can't change ownership of the file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    32: definition.ErrorDefinition{ErrorNumber:32, ErrorType:"GlobalError", Symbol:"EE_CHANGE_PERMISSIONS", SQLState:"", Message:"Can't change permissions of the file '%s' (Errcode: %d - %s) ", Description:"", MySQLVersion:"5.6"},
    33: definition.ErrorDefinition{ErrorNumber:33, ErrorType:"GlobalError", Symbol:"EE_CANT_SEEK", SQLState:"", Message:"Can't seek in file '%s' (Errcode: %d - %s)", Description:"EE_CANT_SEEK was added in 5.6.1.", MySQLVersion:"5.6"},
}
...
ER_HASHCHK int = 1000
    ...
    ER_DELAYED_CANT_CHANGE_LOCK int = 1150
    ER_TOO_MANY_DELAYED_THREADS int = 1151
    ...
    ER_DELAYED_INSERT_TABLE_LOCKED int = 1165
    ...
    ER_BINLOG_UNSAFE_INSERT_DELAYED int = 1669
...
// IsServerErrorDelayedCantChangeLock check mysql error is "Delayed insert thread couldn't get requested lock for table %s " 
...
// IsServerErrorDelayedInsertTableLocked check mysql error is "INSERT DELAYED can't be used with table '%s' because it is locked with LOCK TABLES " 
...
// IsServerErrorUpdateWithoutKeyInSafeMode check mysql error is "You are using safe update mode and you tried to update a table without a WHERE that uses a KEY column " 
...
// IsServerErrorTooBigPrecision check mysql error is "Too big precision %d specified for column '%s'. Maximum is %lu. " 
...
// IsServerErrorForeignKeyOnPartitioned check mysql error is "Foreign key clause is not yet supported in conjunction with partitioning " 
...
// IsServerErrorBinlogUnsafeInsertDelayed check mysql error is "The statement is unsafe because it uses INSERT DELAYED. This is unsafe because the times when rows are inserted cannot be predicted. " 
...
// IsServerErrorGtidModeRequiresBinlog check mysql error is "@@GLOBAL.GTID_MODE = ON or UPGRADE_STEP_1 or UPGRADE_STEP_2 requires --log-bin and --log-slave-updates." 
...
// IsServerErrorGtidUnsafeNonTransactionalTable check mysql error is "When @@GLOBAL.ENFORCE_GTID_CONSISTENCY = 1, updates to non-transactional tables can only be done in either autocommitted statements or single-statement transactions, and never in the same statement as updates to transactional tables." 
...
// IsServerErrorGtidUnsafeCreateDropTemporaryTableInTransaction check mysql error is "When @@GLOBAL.ENFORCE_GTID_CONSISTENCY = 1, the statements CREATE TEMPORARY TABLE and DROP TEMPORARY TABLE can be executed in a non-transactional context only, and require that AUTOCOMMIT = 1. These statements are also not allowed in a function or trigger because functions and triggers are also considered to be multi-statement transactions." 
...
// IsServerErrorGtidModeCanOnlyChangeOneStepAtATime check mysql error is "The value of @@GLOBAL.GTID_MODE can only change one step at a time: OFF <-> UPGRADE_STEP_1 <-> UPGRADE_STEP_2 <-> ON. Also note that this value must be stepped up or down simultaneously on all servers" 
...
// IsServerErrorTablespaceExists check mysql error is "Tablespace for table '%s' exists. Please DISCARD the tablespace before IMPORT." 
