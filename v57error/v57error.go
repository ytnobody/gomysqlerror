...
var ErrorMap = map[int64]definition.ErrorDefinition{
    1000: {ErrorNumber:1000, ErrorType:"ServerError", Symbol:"ER_HASHCHK", SQLState:"HY000", Message:"hashchk", Description:"Unused.", MySQLVersion:"5.7"},
    1001: {ErrorNumber:1001, ErrorType:"ServerError", Symbol:"ER_NISAMCHK", SQLState:"HY000", Message:"isamchk", Description:"Unused.", MySQLVersion:"5.7"},
    1002: {ErrorNumber:1002, ErrorType:"ServerError", Symbol:"ER_NO", SQLState:"HY000", Message:"NO", Description:"Used in the construction of other messages.", MySQLVersion:"5.7"},
    1003: {ErrorNumber:1003, ErrorType:"ServerError", Symbol:"ER_YES", SQLState:"HY000", Message:"YES", Description:"Extended EXPLAIN format generatesNote messages. ER_YES is used inthe Code column for these messages insubsequent SHOW WARNINGS output.", MySQLVersion:"5.7"},
    1004: {ErrorNumber:1004, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_FILE", SQLState:"HY000", Message:"Can't create file '%s' (errno: %d - %s)", Description:"destinationfile already exists but is not writeable.", MySQLVersion:"5.7"},
    1005: {ErrorNumber:1005, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_TABLE", SQLState:"HY000", Message:"Can't create table '%s' (errno: %d)", Description:"InnoDB reports this error when a table cannotbe created. If the error message refers to error 150, tablecreation failed because aforeign keyconstraint was not correctly formed. If the error messagerefers to error −1, table creation probably failed becausethe table includes a column name that matched the name of aninternal InnoDB table.", MySQLVersion:"5.7"},
    1006: {ErrorNumber:1006, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_DB", SQLState:"HY000", Message:"Can't create database '%s' (errno: %d)", Description:"", MySQLVersion:"5.7"},
    ...
    1008: {ErrorNumber:1008, ErrorType:"ServerError", Symbol:"ER_DB_DROP_EXISTS", SQLState:"HY000", Message:"Can't drop database '%s'", Description:"database doesn't exist", MySQLVersion:"5.7"},
    1009: {ErrorNumber:1009, ErrorType:"ServerError", Symbol:"ER_DB_DROP_DELETE", SQLState:"HY000", Message:"Error dropping database (can't delete '%s', errno: %d)", Description:"", MySQLVersion:"5.7"},
    1010: {ErrorNumber:1010, ErrorType:"ServerError", Symbol:"ER_DB_DROP_RMDIR", SQLState:"HY000", Message:"Error dropping database (can't rmdir '%s', errno: %d)", Description:"", MySQLVersion:"5.7"},
    1011: {ErrorNumber:1011, ErrorType:"ServerError", Symbol:"ER_CANT_DELETE_FILE", SQLState:"HY000", Message:"Error on delete of '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1012: {ErrorNumber:1012, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_SYSTEM_REC", SQLState:"HY000", Message:"Can't read record in system table", Description:"Returned by InnoDB for attempts to accessInnoDB INFORMATION_SCHEMAtables when InnoDB is unavailable.", MySQLVersion:"5.7"},
    1013: {ErrorNumber:1013, ErrorType:"ServerError", Symbol:"ER_CANT_GET_STAT", SQLState:"HY000", Message:"Can't get status of '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1014: {ErrorNumber:1014, ErrorType:"ServerError", Symbol:"ER_CANT_GET_WD", SQLState:"HY000", Message:"Can't get working directory (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1015: {ErrorNumber:1015, ErrorType:"ServerError", Symbol:"ER_CANT_LOCK", SQLState:"HY000", Message:"Can't lock file (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1016: {ErrorNumber:1016, ErrorType:"ServerError", Symbol:"ER_CANT_OPEN_FILE", SQLState:"HY000", Message:"Can't open file: '%s' (errno: %d - %s)", Description:"InnoDB reports this error when the table fromthe InnoDB datafiles cannot be found, even though the.frm file for the table exists. SeeTroubleshooting InnoDB Data Dictionary Operations.", MySQLVersion:"5.7"},
    1017: {ErrorNumber:1017, ErrorType:"ServerError", Symbol:"ER_FILE_NOT_FOUND", SQLState:"HY000", Message:"Can't find file: '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1018: {ErrorNumber:1018, ErrorType:"ServerError", Symbol:"ER_CANT_READ_DIR", SQLState:"HY000", Message:"Can't read dir of '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1019: {ErrorNumber:1019, ErrorType:"ServerError", Symbol:"ER_CANT_SET_WD", SQLState:"HY000", Message:"Can't change dir to '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1020: {ErrorNumber:1020, ErrorType:"ServerError", Symbol:"ER_CHECKREAD", SQLState:"HY000", Message:"Record has changed since last read in table '%s'", Description:"", MySQLVersion:"5.7"},
    1021: {ErrorNumber:1021, ErrorType:"ServerError", Symbol:"ER_DISK_FULL", SQLState:"HY000", Message:"Disk full (%s)", Description:"waiting for someone to free some space...(errno: %d - %s)", MySQLVersion:"5.7"},
    1022: {ErrorNumber:1022, ErrorType:"ServerError", Symbol:"ER_DUP_KEY", SQLState:"23000", Message:"Can't write", Description:"duplicate key in table '%s'", MySQLVersion:"5.7"},
    1023: {ErrorNumber:1023, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_CLOSE", SQLState:"HY000", Message:"Error on close of '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1024: {ErrorNumber:1024, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_READ", SQLState:"HY000", Message:"Error reading file '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1025: {ErrorNumber:1025, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_RENAME", SQLState:"HY000", Message:"Error on rename of '%s' to '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1026: {ErrorNumber:1026, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_WRITE", SQLState:"HY000", Message:"Error writing file '%s' (errno: %d - %s)", Description:"", MySQLVersion:"5.7"},
    1027: {ErrorNumber:1027, ErrorType:"ServerError", Symbol:"ER_FILE_USED", SQLState:"HY000", Message:"'%s' is locked against change", Description:"", MySQLVersion:"5.7"},
    1028: {ErrorNumber:1028, ErrorType:"ServerError", Symbol:"ER_FILSORT_ABORT", SQLState:"HY000", Message:"Sort aborted", Description:"", MySQLVersion:"5.7"},
    1029: {ErrorNumber:1029, ErrorType:"ServerError", Symbol:"ER_FORM_NOT_FOUND", SQLState:"HY000", Message:"View '%s' doesn't exist for '%s'", Description:"", MySQLVersion:"5.7"},
    1030: {ErrorNumber:1030, ErrorType:"ServerError", Symbol:"ER_GET_ERRNO", SQLState:"HY000", Message:"Got error %d from storage engine", Description:"Check the %d value to see what the OS errormeans. For example, 28 indicates that you have run out of diskspace.", MySQLVersion:"5.7"},
    1031: {ErrorNumber:1031, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_HA", SQLState:"HY000", Message:"Table storage engine for '%s' doesn't have this option", Description:"", MySQLVersion:"5.7"},
    1032: {ErrorNumber:1032, ErrorType:"ServerError", Symbol:"ER_KEY_NOT_FOUND", SQLState:"HY000", Message:"Can't find record in '%s'", Description:"", MySQLVersion:"5.7"},
    1033: {ErrorNumber:1033, ErrorType:"ServerError", Symbol:"ER_NOT_FORM_FILE", SQLState:"HY000", Message:"Incorrect information in file: '%s'", Description:"", MySQLVersion:"5.7"},
    1034: {ErrorNumber:1034, ErrorType:"ServerError", Symbol:"ER_NOT_KEYFILE", SQLState:"HY000", Message:"Incorrect key file for table '%s'", Description:"try to repair it", MySQLVersion:"5.7"},
    1035: {ErrorNumber:1035, ErrorType:"ServerError", Symbol:"ER_OLD_KEYFILE", SQLState:"HY000", Message:"Old key file for table '%s'", Description:"repair it!", MySQLVersion:"5.7"},
    1036: {ErrorNumber:1036, ErrorType:"ServerError", Symbol:"ER_OPEN_AS_READONLY", SQLState:"HY000", Message:"Table '%s' is read only", Description:"", MySQLVersion:"5.7"},
    1037: {ErrorNumber:1037, ErrorType:"ServerError", Symbol:"ER_OUTOFMEMORY", SQLState:"HY001", Message:"Out of memory", Description:"restart server and try again (needed %dbytes)", MySQLVersion:"5.7"},
    1038: {ErrorNumber:1038, ErrorType:"ServerError", Symbol:"ER_OUT_OF_SORTMEMORY", SQLState:"HY001", Message:"Out of sort memory, consider increasing server sortbuffer size", Description:"", MySQLVersion:"5.7"},
    1039: {ErrorNumber:1039, ErrorType:"ServerError", Symbol:"ER_UNEXPECTED_EOF", SQLState:"HY000", Message:"Unexpected EOF found when reading file '%s' (errno: %d -%s)", Description:"", MySQLVersion:"5.7"},
    1040: {ErrorNumber:1040, ErrorType:"ServerError", Symbol:"ER_CON_COUNT_ERROR", SQLState:"08004", Message:"Too many connections", Description:"", MySQLVersion:"5.7"},
    1041: {ErrorNumber:1041, ErrorType:"ServerError", Symbol:"ER_OUT_OF_RESOURCES", SQLState:"HY000", Message:"Out of memory", Description:"if not, you may have to use 'ulimit' toallow mysqld to use more memory or you can add more swap space", MySQLVersion:"5.7"},
    1042: {ErrorNumber:1042, ErrorType:"ServerError", Symbol:"ER_BAD_HOST_ERROR", SQLState:"08S01", Message:"Can't get hostname for your address", Description:"", MySQLVersion:"5.7"},
    1043: {ErrorNumber:1043, ErrorType:"ServerError", Symbol:"ER_HANDSHAKE_ERROR", SQLState:"08S01", Message:"Bad handshake", Description:"", MySQLVersion:"5.7"},
    1044: {ErrorNumber:1044, ErrorType:"ServerError", Symbol:"ER_DBACCESS_DENIED_ERROR", SQLState:"42000", Message:"Access denied for user '%s'@'%s' to database '%s'", Description:"", MySQLVersion:"5.7"},
    1045: {ErrorNumber:1045, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_ERROR", SQLState:"28000", Message:"Access denied for user '%s'@'%s' (using password: %s)", Description:"", MySQLVersion:"5.7"},
    1046: {ErrorNumber:1046, ErrorType:"ServerError", Symbol:"ER_NO_DB_ERROR", SQLState:"3D000", Message:"No database selected", Description:"", MySQLVersion:"5.7"},
    1047: {ErrorNumber:1047, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_COM_ERROR", SQLState:"08S01", Message:"Unknown command", Description:"", MySQLVersion:"5.7"},
    1048: {ErrorNumber:1048, ErrorType:"ServerError", Symbol:"ER_BAD_NULL_ERROR", SQLState:"23000", Message:"Column '%s' cannot be null", Description:"", MySQLVersion:"5.7"},
    1049: {ErrorNumber:1049, ErrorType:"ServerError", Symbol:"ER_BAD_DB_ERROR", SQLState:"42000", Message:"Unknown database '%s'", Description:"", MySQLVersion:"5.7"},
    1050: {ErrorNumber:1050, ErrorType:"ServerError", Symbol:"ER_TABLE_EXISTS_ERROR", SQLState:"42S01", Message:"Table '%s' already exists", Description:"", MySQLVersion:"5.7"},
    1051: {ErrorNumber:1051, ErrorType:"ServerError", Symbol:"ER_BAD_TABLE_ERROR", SQLState:"42S02", Message:"Unknown table '%s'", Description:"", MySQLVersion:"5.7"},
    1052: {ErrorNumber:1052, ErrorType:"ServerError", Symbol:"ER_NON_UNIQ_ERROR", SQLState:"23000", Message:"Column '%s' in %s is ambiguous", Description:"Resolution:", MySQLVersion:"5.7"},
    1053: {ErrorNumber:1053, ErrorType:"ServerError", Symbol:"ER_SERVER_SHUTDOWN", SQLState:"08S01", Message:"Server shutdown in progress", Description:"", MySQLVersion:"5.7"},
    1054: {ErrorNumber:1054, ErrorType:"ServerError", Symbol:"ER_BAD_FIELD_ERROR", SQLState:"42S22", Message:"Unknown column '%s' in '%s'", Description:"", MySQLVersion:"5.7"},
    1055: {ErrorNumber:1055, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_WITH_GROUP", SQLState:"42000", Message:"'%s' isn't in GROUP BY", Description:"", MySQLVersion:"5.7"},
    1056: {ErrorNumber:1056, ErrorType:"ServerError", Symbol:"ER_WRONG_GROUP_FIELD", SQLState:"42000", Message:"Can't group on '%s'", Description:"", MySQLVersion:"5.7"},
    1057: {ErrorNumber:1057, ErrorType:"ServerError", Symbol:"ER_WRONG_SUM_SELECT", SQLState:"42000", Message:"Statement has sum functions and columns in same statement", Description:"", MySQLVersion:"5.7"},
    1058: {ErrorNumber:1058, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_COUNT", SQLState:"21S01", Message:"Column count doesn't match value count", Description:"", MySQLVersion:"5.7"},
    1059: {ErrorNumber:1059, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_IDENT", SQLState:"42000", Message:"Identifier name '%s' is too long", Description:"", MySQLVersion:"5.7"},
    1060: {ErrorNumber:1060, ErrorType:"ServerError", Symbol:"ER_DUP_FIELDNAME", SQLState:"42S21", Message:"Duplicate column name '%s'", Description:"", MySQLVersion:"5.7"},
    1061: {ErrorNumber:1061, ErrorType:"ServerError", Symbol:"ER_DUP_KEYNAME", SQLState:"42000", Message:"Duplicate key name '%s'", Description:"", MySQLVersion:"5.7"},
    1062: {ErrorNumber:1062, ErrorType:"ServerError", Symbol:"ER_DUP_ENTRY", SQLState:"23000", Message:"Duplicate entry '%s' for key %d", Description:"The message returned with this error uses the format string forER_DUP_ENTRY_WITH_KEY_NAME.", MySQLVersion:"5.7"},
    1063: {ErrorNumber:1063, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_SPEC", SQLState:"42000", Message:"Incorrect column specifier for column '%s'", Description:"", MySQLVersion:"5.7"},
    1064: {ErrorNumber:1064, ErrorType:"ServerError", Symbol:"ER_PARSE_ERROR", SQLState:"42000", Message:"%s near '%s' at line %d", Description:"", MySQLVersion:"5.7"},
    1065: {ErrorNumber:1065, ErrorType:"ServerError", Symbol:"ER_EMPTY_QUERY", SQLState:"42000", Message:"Query was empty", Description:"", MySQLVersion:"5.7"},
    1066: {ErrorNumber:1066, ErrorType:"ServerError", Symbol:"ER_NONUNIQ_TABLE", SQLState:"42000", Message:"Not unique table/alias: '%s'", Description:"", MySQLVersion:"5.7"},
    1067: {ErrorNumber:1067, ErrorType:"ServerError", Symbol:"ER_INVALID_DEFAULT", SQLState:"42000", Message:"Invalid default value for '%s'", Description:"", MySQLVersion:"5.7"},
    1068: {ErrorNumber:1068, ErrorType:"ServerError", Symbol:"ER_MULTIPLE_PRI_KEY", SQLState:"42000", Message:"Multiple primary key defined", Description:"", MySQLVersion:"5.7"},
    1069: {ErrorNumber:1069, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_KEYS", SQLState:"42000", Message:"Too many keys specified", Description:"max %d keys allowed", MySQLVersion:"5.7"},
    1070: {ErrorNumber:1070, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_KEY_PARTS", SQLState:"42000", Message:"Too many key parts specified", Description:"max %d parts allowed", MySQLVersion:"5.7"},
    1071: {ErrorNumber:1071, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_KEY", SQLState:"42000", Message:"Specified key was too long", Description:"max key length is %d bytes", MySQLVersion:"5.7"},
    1072: {ErrorNumber:1072, ErrorType:"ServerError", Symbol:"ER_KEY_COLUMN_DOES_NOT_EXITS", SQLState:"42000", Message:"Key column '%s' doesn't exist in table", Description:"", MySQLVersion:"5.7"},
    1073: {ErrorNumber:1073, ErrorType:"ServerError", Symbol:"ER_BLOB_USED_AS_KEY", SQLState:"42000", Message:"BLOB column '%s' can't be used in key specification withthe used table type", Description:"", MySQLVersion:"5.7"},
    1074: {ErrorNumber:1074, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_FIELDLENGTH", SQLState:"42000", Message:"Column length too big for column '%s' (max = %lu)", Description:"useBLOB or TEXT instead", MySQLVersion:"5.7"},
    1075: {ErrorNumber:1075, ErrorType:"ServerError", Symbol:"ER_WRONG_AUTO_KEY", SQLState:"42000", Message:"Incorrect table definition", Description:"there can be only one autocolumn and it must be defined as a key", MySQLVersion:"5.7"},
    1076: {ErrorNumber:1076, ErrorType:"ServerError", Symbol:"ER_READY", SQLState:"HY000", Message:"%s: ready for connections. Version: '%s' socket: '%s'port: %d", Description:"", MySQLVersion:"5.7"},
    1077: {ErrorNumber:1077, ErrorType:"ServerError", Symbol:"ER_NORMAL_SHUTDOWN", SQLState:"HY000", Message:"%s: Normal shutdown", Description:"", MySQLVersion:"5.7"},
    1078: {ErrorNumber:1078, ErrorType:"ServerError", Symbol:"ER_GOT_SIGNAL", SQLState:"HY000", Message:"%s: Got signal %d. Aborting!", Description:"", MySQLVersion:"5.7"},
    1079: {ErrorNumber:1079, ErrorType:"ServerError", Symbol:"ER_SHUTDOWN_COMPLETE", SQLState:"HY000", Message:"%s: Shutdown complete", Description:"", MySQLVersion:"5.7"},
    1080: {ErrorNumber:1080, ErrorType:"ServerError", Symbol:"ER_FORCING_CLOSE", SQLState:"08S01", Message:"%s: Forcing close of thread %ld user: '%s'", Description:"", MySQLVersion:"5.7"},
    1081: {ErrorNumber:1081, ErrorType:"ServerError", Symbol:"ER_IPSOCK_ERROR", SQLState:"08S01", Message:"Can't create IP socket", Description:"", MySQLVersion:"5.7"},
    1082: {ErrorNumber:1082, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_INDEX", SQLState:"42S12", Message:"Table '%s' has no index like the one used in CREATEINDEX", Description:"recreate the table", MySQLVersion:"5.7"},
    1083: {ErrorNumber:1083, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_TERMINATORS", SQLState:"42000", Message:"Field separator argument is not what is expected", Description:"checkthe manual", MySQLVersion:"5.7"},
    1084: {ErrorNumber:1084, ErrorType:"ServerError", Symbol:"ER_BLOBS_AND_NO_TERMINATED", SQLState:"42000", Message:"You can't use fixed rowlength with BLOBs", Description:"please use'fields terminated by'", MySQLVersion:"5.7"},
    1085: {ErrorNumber:1085, ErrorType:"ServerError", Symbol:"ER_TEXTFILE_NOT_READABLE", SQLState:"HY000", Message:"The file '%s' must be in the database directory or bereadable by all", Description:"", MySQLVersion:"5.7"},
    1086: {ErrorNumber:1086, ErrorType:"ServerError", Symbol:"ER_FILE_EXISTS_ERROR", SQLState:"HY000", Message:"File '%s' already exists", Description:"", MySQLVersion:"5.7"},
    1087: {ErrorNumber:1087, ErrorType:"ServerError", Symbol:"ER_LOAD_INFO", SQLState:"HY000", Message:"Records: %ld Deleted: %ld Skipped: %ld Warnings: %ld", Description:"", MySQLVersion:"5.7"},
    1088: {ErrorNumber:1088, ErrorType:"ServerError", Symbol:"ER_ALTER_INFO", SQLState:"HY000", Message:"Records: %ld Duplicates: %ld", Description:"", MySQLVersion:"5.7"},
    1089: {ErrorNumber:1089, ErrorType:"ServerError", Symbol:"ER_WRONG_SUB_KEY", SQLState:"HY000", Message:"Incorrect prefix key", Description:"the used key part isn't a string,the used length is longer than the key part, or the storage enginedoesn't support unique prefix keys", MySQLVersion:"5.7"},
    1090: {ErrorNumber:1090, ErrorType:"ServerError", Symbol:"ER_CANT_REMOVE_ALL_FIELDS", SQLState:"42000", Message:"You can't delete all columns with ALTER TABLE", Description:"use DROPTABLE instead", MySQLVersion:"5.7"},
    1091: {ErrorNumber:1091, ErrorType:"ServerError", Symbol:"ER_CANT_DROP_FIELD_OR_KEY", SQLState:"42000", Message:"Can't DROP '%s'", Description:"check that column/key exists", MySQLVersion:"5.7"},
    1092: {ErrorNumber:1092, ErrorType:"ServerError", Symbol:"ER_INSERT_INFO", SQLState:"HY000", Message:"Records: %ld Duplicates: %ld Warnings: %ld", Description:"", MySQLVersion:"5.7"},
    1093: {ErrorNumber:1093, ErrorType:"ServerError", Symbol:"ER_UPDATE_TABLE_USED", SQLState:"HY000", Message:"You can't specify target table '%s' for update in FROMclause", Description:"This error occurs for attempts to select from and modify the sametable within a single statement. If the select attempt occurswithin a derived table, you can avoid this error by setting thederived_merge flag of theoptimizer_switch system variableto force the subquery to be materialized into a temporary table,which effectively causes it to be a different table from the onemodified. See Optimizing Derived Tables and View References with Merging or Materialization.", MySQLVersion:"5.7"},
    1094: {ErrorNumber:1094, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_THREAD", SQLState:"HY000", Message:"Unknown thread id: %lu", Description:"", MySQLVersion:"5.7"},
    1095: {ErrorNumber:1095, ErrorType:"ServerError", Symbol:"ER_KILL_DENIED_ERROR", SQLState:"HY000", Message:"You are not owner of thread %lu", Description:"", MySQLVersion:"5.7"},
    1096: {ErrorNumber:1096, ErrorType:"ServerError", Symbol:"ER_NO_TABLES_USED", SQLState:"HY000", Message:"No tables used", Description:"", MySQLVersion:"5.7"},
    1097: {ErrorNumber:1097, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SET", SQLState:"HY000", Message:"Too many strings for column %s and SET", Description:"", MySQLVersion:"5.7"},
    1098: {ErrorNumber:1098, ErrorType:"ServerError", Symbol:"ER_NO_UNIQUE_LOGFILE", SQLState:"HY000", Message:"Can't generate a unique log-filename %s.(1-999)", Description:"", MySQLVersion:"5.7"},
    1099: {ErrorNumber:1099, ErrorType:"ServerError", Symbol:"ER_TABLE_NOT_LOCKED_FOR_WRITE", SQLState:"HY000", Message:"Table '%s' was locked with a READ lock and can't beupdated", Description:"", MySQLVersion:"5.7"},
    1100: {ErrorNumber:1100, ErrorType:"ServerError", Symbol:"ER_TABLE_NOT_LOCKED", SQLState:"HY000", Message:"Table '%s' was not locked with LOCK TABLES", Description:"", MySQLVersion:"5.7"},
    1101: {ErrorNumber:1101, ErrorType:"ServerError", Symbol:"ER_BLOB_CANT_HAVE_DEFAULT", SQLState:"42000", Message:"BLOB, TEXT, GEOMETRY or JSON column '%s' can't have adefault value", Description:"", MySQLVersion:"5.7"},
    1102: {ErrorNumber:1102, ErrorType:"ServerError", Symbol:"ER_WRONG_DB_NAME", SQLState:"42000", Message:"Incorrect database name '%s'", Description:"", MySQLVersion:"5.7"},
    1103: {ErrorNumber:1103, ErrorType:"ServerError", Symbol:"ER_WRONG_TABLE_NAME", SQLState:"42000", Message:"Incorrect table name '%s'", Description:"", MySQLVersion:"5.7"},
    1104: {ErrorNumber:1104, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SELECT", SQLState:"42000", Message:"The SELECT would examine more than MAX_JOIN_SIZE rows", Description:"check your WHERE and use SET SQL_BIG_SELECTS=1 or SETMAX_JOIN_SIZE=# if the SELECT is okay", MySQLVersion:"5.7"},
    1105: {ErrorNumber:1105, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ERROR", SQLState:"HY000", Message:"Unknown error", Description:"", MySQLVersion:"5.7"},
    1106: {ErrorNumber:1106, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_PROCEDURE", SQLState:"42000", Message:"Unknown procedure '%s'", Description:"", MySQLVersion:"5.7"},
    1107: {ErrorNumber:1107, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMCOUNT_TO_PROCEDURE", SQLState:"42000", Message:"Incorrect parameter count to procedure '%s'", Description:"", MySQLVersion:"5.7"},
    1108: {ErrorNumber:1108, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_PROCEDURE", SQLState:"HY000", Message:"Incorrect parameters to procedure '%s'", Description:"", MySQLVersion:"5.7"},
    1109: {ErrorNumber:1109, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TABLE", SQLState:"42S02", Message:"Unknown table '%s' in %s", Description:"", MySQLVersion:"5.7"},
    1110: {ErrorNumber:1110, ErrorType:"ServerError", Symbol:"ER_FIELD_SPECIFIED_TWICE", SQLState:"42000", Message:"Column '%s' specified twice", Description:"", MySQLVersion:"5.7"},
    1111: {ErrorNumber:1111, ErrorType:"ServerError", Symbol:"ER_INVALID_GROUP_FUNC_USE", SQLState:"HY000", Message:"Invalid use of group function", Description:"", MySQLVersion:"5.7"},
    1112: {ErrorNumber:1112, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_EXTENSION", SQLState:"42000", Message:"Table '%s' uses an extension that doesn't exist in thisMySQL version", Description:"", MySQLVersion:"5.7"},
    1113: {ErrorNumber:1113, ErrorType:"ServerError", Symbol:"ER_TABLE_MUST_HAVE_COLUMNS", SQLState:"42000", Message:"A table must have at least 1 column", Description:"", MySQLVersion:"5.7"},
    1114: {ErrorNumber:1114, ErrorType:"ServerError", Symbol:"ER_RECORD_FILE_FULL", SQLState:"HY000", Message:"The table '%s' is full", Description:"InnoDB reports this error when the systemtablespace runs out of free space. Reconfigure the systemtablespace to add a new data file.", MySQLVersion:"5.7"},
    1115: {ErrorNumber:1115, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_CHARACTER_SET", SQLState:"42000", Message:"Unknown character set: '%s'", Description:"", MySQLVersion:"5.7"},
    1116: {ErrorNumber:1116, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_TABLES", SQLState:"HY000", Message:"Too many tables", Description:"MySQL can only use %d tables in a join", MySQLVersion:"5.7"},
    1117: {ErrorNumber:1117, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_FIELDS", SQLState:"HY000", Message:"Too many columns", Description:"", MySQLVersion:"5.7"},
    1118: {ErrorNumber:1118, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_ROWSIZE", SQLState:"42000", Message:"Row size too large. The maximum row size for the usedtable type, not counting BLOBs, is %ld. This includes storageoverhead, check the manual. You have to change some columns toTEXT or BLOBs", Description:"", MySQLVersion:"5.7"},
    1119: {ErrorNumber:1119, ErrorType:"ServerError", Symbol:"ER_STACK_OVERRUN", SQLState:"HY000", Message:"Thread stack overrun: Used: %ld of a %ld stack. Use'mysqld --thread_stack=#' to specify a bigger stack if needed", Description:"", MySQLVersion:"5.7"},
    1120: {ErrorNumber:1120, ErrorType:"ServerError", Symbol:"ER_WRONG_OUTER_JOIN", SQLState:"42000", Message:"Cross dependency found in OUTER JOIN", Description:"examine your ONconditions", MySQLVersion:"5.7"},
    1121: {ErrorNumber:1121, ErrorType:"ServerError", Symbol:"ER_NULL_COLUMN_IN_INDEX", SQLState:"42000", Message:"Table handler doesn't support NULL in given index. Pleasechange column '%s' to be NOT NULL or use another handler", Description:"", MySQLVersion:"5.7"},
    1122: {ErrorNumber:1122, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_UDF", SQLState:"HY000", Message:"Can't load function '%s'", Description:"", MySQLVersion:"5.7"},
    1123: {ErrorNumber:1123, ErrorType:"ServerError", Symbol:"ER_CANT_INITIALIZE_UDF", SQLState:"HY000", Message:"Can't initialize function '%s'", Description:"%s", MySQLVersion:"5.7"},
    1124: {ErrorNumber:1124, ErrorType:"ServerError", Symbol:"ER_UDF_NO_PATHS", SQLState:"HY000", Message:"No paths allowed for shared library", Description:"", MySQLVersion:"5.7"},
    1125: {ErrorNumber:1125, ErrorType:"ServerError", Symbol:"ER_UDF_EXISTS", SQLState:"HY000", Message:"Function '%s' already exists", Description:"", MySQLVersion:"5.7"},
    1126: {ErrorNumber:1126, ErrorType:"ServerError", Symbol:"ER_CANT_OPEN_LIBRARY", SQLState:"HY000", Message:"Can't open shared library '%s' (errno: %d %s)", Description:"", MySQLVersion:"5.7"},
    1127: {ErrorNumber:1127, ErrorType:"ServerError", Symbol:"ER_CANT_FIND_DL_ENTRY", SQLState:"HY000", Message:"Can't find symbol '%s' in library", Description:"", MySQLVersion:"5.7"},
    1128: {ErrorNumber:1128, ErrorType:"ServerError", Symbol:"ER_FUNCTION_NOT_DEFINED", SQLState:"HY000", Message:"Function '%s' is not defined", Description:"", MySQLVersion:"5.7"},
    1129: {ErrorNumber:1129, ErrorType:"ServerError", Symbol:"ER_HOST_IS_BLOCKED", SQLState:"HY000", Message:"Host '%s' is blocked because of many connection errors", Description:"unblock with 'mysqladmin flush-hosts'", MySQLVersion:"5.7"},
    1130: {ErrorNumber:1130, ErrorType:"ServerError", Symbol:"ER_HOST_NOT_PRIVILEGED", SQLState:"HY000", Message:"Host '%s' is not allowed to connect to this MySQL server", Description:"", MySQLVersion:"5.7"},
    1131: {ErrorNumber:1131, ErrorType:"ServerError", Symbol:"ER_PASSWORD_ANONYMOUS_USER", SQLState:"42000", Message:"You are using MySQL as an anonymous user and anonymoususers are not allowed to change passwords", Description:"", MySQLVersion:"5.7"},
    1132: {ErrorNumber:1132, ErrorType:"ServerError", Symbol:"ER_PASSWORD_NOT_ALLOWED", SQLState:"42000", Message:"You must have privileges to update tables in the mysqldatabase to be able to change passwords for others", Description:"", MySQLVersion:"5.7"},
    1133: {ErrorNumber:1133, ErrorType:"ServerError", Symbol:"ER_PASSWORD_NO_MATCH", SQLState:"42000", Message:"Can't find any matching row in the user table", Description:"", MySQLVersion:"5.7"},
    1134: {ErrorNumber:1134, ErrorType:"ServerError", Symbol:"ER_UPDATE_INFO", SQLState:"HY000", Message:"Rows matched: %ld Changed: %ld Warnings: %ld", Description:"", MySQLVersion:"5.7"},
    1135: {ErrorNumber:1135, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_THREAD", SQLState:"HY000", Message:"Can't create a new thread (errno %d)", Description:"if you are not outof available memory, you can consult the manual for a possibleOS-dependent bug", MySQLVersion:"5.7"},
    1136: {ErrorNumber:1136, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_COUNT_ON_ROW", SQLState:"21S01", Message:"Column count doesn't match value count at row %ld", Description:"", MySQLVersion:"5.7"},
    1137: {ErrorNumber:1137, ErrorType:"ServerError", Symbol:"ER_CANT_REOPEN_TABLE", SQLState:"HY000", Message:"Can't reopen table: '%s'", Description:"", MySQLVersion:"5.7"},
    1138: {ErrorNumber:1138, ErrorType:"ServerError", Symbol:"ER_INVALID_USE_OF_NULL", SQLState:"22004", Message:"Invalid use of NULL value", Description:"", MySQLVersion:"5.7"},
    1139: {ErrorNumber:1139, ErrorType:"ServerError", Symbol:"ER_REGEXP_ERROR", SQLState:"42000", Message:"Got error '%s' from regexp", Description:"", MySQLVersion:"5.7"},
    1140: {ErrorNumber:1140, ErrorType:"ServerError", Symbol:"ER_MIX_OF_GROUP_FUNC_AND_FIELDS", SQLState:"42000", Message:"Mixing of GROUP columns (MIN(),MAX(),COUNT(),...) with noGROUP columns is illegal if there is no GROUP BY clause", Description:"", MySQLVersion:"5.7"},
    1141: {ErrorNumber:1141, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s'", Description:"", MySQLVersion:"5.7"},
    1142: {ErrorNumber:1142, ErrorType:"ServerError", Symbol:"ER_TABLEACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for table '%s'", Description:"", MySQLVersion:"5.7"},
    1143: {ErrorNumber:1143, ErrorType:"ServerError", Symbol:"ER_COLUMNACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for column '%s' intable '%s'", Description:"", MySQLVersion:"5.7"},
    1144: {ErrorNumber:1144, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_GRANT_FOR_TABLE", SQLState:"42000", Message:"Illegal GRANT/REVOKE command", Description:"please consult the manualto see which privileges can be used", MySQLVersion:"5.7"},
    1145: {ErrorNumber:1145, ErrorType:"ServerError", Symbol:"ER_GRANT_WRONG_HOST_OR_USER", SQLState:"42000", Message:"The host or user argument to GRANT is too long", Description:"", MySQLVersion:"5.7"},
    1146: {ErrorNumber:1146, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_TABLE", SQLState:"42S02", Message:"Table '%s.%s' doesn't exist", Description:"", MySQLVersion:"5.7"},
    1147: {ErrorNumber:1147, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_TABLE_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s'on table '%s'", Description:"", MySQLVersion:"5.7"},
    1148: {ErrorNumber:1148, ErrorType:"ServerError", Symbol:"ER_NOT_ALLOWED_COMMAND", SQLState:"42000", Message:"The used command is not allowed with this MySQL version", Description:"", MySQLVersion:"5.7"},
    1149: {ErrorNumber:1149, ErrorType:"ServerError", Symbol:"ER_SYNTAX_ERROR", SQLState:"42000", Message:"You have an error in your SQL syntax", Description:"check the manualthat corresponds to your MySQL server version for the right syntaxto use", MySQLVersion:"5.7"},
    1150: {ErrorNumber:1150, ErrorType:"ServerError", Symbol:"ER_UNUSED1", SQLState:"HY000", Message:"Delayed insert thread couldn't get requested lock fortable %s", Description:"", MySQLVersion:"5.7"},
    1151: {ErrorNumber:1151, ErrorType:"ServerError", Symbol:"ER_UNUSED2", SQLState:"HY000", Message:"Too many delayed threads in use", Description:"", MySQLVersion:"5.7"},
    1152: {ErrorNumber:1152, ErrorType:"ServerError", Symbol:"ER_ABORTING_CONNECTION", SQLState:"08S01", Message:"Aborted connection %ld to db: '%s' user: '%s' (%s)", Description:"", MySQLVersion:"5.7"},
    1153: {ErrorNumber:1153, ErrorType:"ServerError", Symbol:"ER_NET_PACKET_TOO_LARGE", SQLState:"08S01", Message:"Got a packet bigger than 'max_allowed_packet' bytes", Description:"", MySQLVersion:"5.7"},
    1154: {ErrorNumber:1154, ErrorType:"ServerError", Symbol:"ER_NET_READ_ERROR_FROM_PIPE", SQLState:"08S01", Message:"Got a read error from the connection pipe", Description:"", MySQLVersion:"5.7"},
    1155: {ErrorNumber:1155, ErrorType:"ServerError", Symbol:"ER_NET_FCNTL_ERROR", SQLState:"08S01", Message:"Got an error from fcntl()", Description:"", MySQLVersion:"5.7"},
    1156: {ErrorNumber:1156, ErrorType:"ServerError", Symbol:"ER_NET_PACKETS_OUT_OF_ORDER", SQLState:"08S01", Message:"Got packets out of order", Description:"", MySQLVersion:"5.7"},
    1157: {ErrorNumber:1157, ErrorType:"ServerError", Symbol:"ER_NET_UNCOMPRESS_ERROR", SQLState:"08S01", Message:"Couldn't uncompress communication packet", Description:"", MySQLVersion:"5.7"},
    1158: {ErrorNumber:1158, ErrorType:"ServerError", Symbol:"ER_NET_READ_ERROR", SQLState:"08S01", Message:"Got an error reading communication packets", Description:"", MySQLVersion:"5.7"},
    1159: {ErrorNumber:1159, ErrorType:"ServerError", Symbol:"ER_NET_READ_INTERRUPTED", SQLState:"08S01", Message:"Got timeout reading communication packets", Description:"", MySQLVersion:"5.7"},
    1160: {ErrorNumber:1160, ErrorType:"ServerError", Symbol:"ER_NET_ERROR_ON_WRITE", SQLState:"08S01", Message:"Got an error writing communication packets", Description:"", MySQLVersion:"5.7"},
    1161: {ErrorNumber:1161, ErrorType:"ServerError", Symbol:"ER_NET_WRITE_INTERRUPTED", SQLState:"08S01", Message:"Got timeout writing communication packets", Description:"", MySQLVersion:"5.7"},
    1162: {ErrorNumber:1162, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_STRING", SQLState:"42000", Message:"Result string is longer than 'max_allowed_packet' bytes", Description:"", MySQLVersion:"5.7"},
    1163: {ErrorNumber:1163, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_BLOB", SQLState:"42000", Message:"The used table type doesn't support BLOB/TEXT columns", Description:"", MySQLVersion:"5.7"},
    1164: {ErrorNumber:1164, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_AUTO_INCREMENT", SQLState:"42000", Message:"The used table type doesn't support AUTO_INCREMENTcolumns", Description:"", MySQLVersion:"5.7"},
    1165: {ErrorNumber:1165, ErrorType:"ServerError", Symbol:"ER_UNUSED3", SQLState:"HY000", Message:"INSERT DELAYED can't be used with table '%s' because itis locked with LOCK TABLES", Description:"", MySQLVersion:"5.7"},
    1166: {ErrorNumber:1166, ErrorType:"ServerError", Symbol:"ER_WRONG_COLUMN_NAME", SQLState:"42000", Message:"Incorrect column name '%s'", Description:"", MySQLVersion:"5.7"},
    1167: {ErrorNumber:1167, ErrorType:"ServerError", Symbol:"ER_WRONG_KEY_COLUMN", SQLState:"42000", Message:"The used storage engine can't index column '%s'", Description:"", MySQLVersion:"5.7"},
    1168: {ErrorNumber:1168, ErrorType:"ServerError", Symbol:"ER_WRONG_MRG_TABLE", SQLState:"HY000", Message:"Unable to open underlying table which is differentlydefined or of non-MyISAM type or doesn't exist", Description:"", MySQLVersion:"5.7"},
    1169: {ErrorNumber:1169, ErrorType:"ServerError", Symbol:"ER_DUP_UNIQUE", SQLState:"23000", Message:"Can't write, because of unique constraint, to table '%s'", Description:"", MySQLVersion:"5.7"},
    1170: {ErrorNumber:1170, ErrorType:"ServerError", Symbol:"ER_BLOB_KEY_WITHOUT_LENGTH", SQLState:"42000", Message:"BLOB/TEXT column '%s' used in key specification without akey length", Description:"", MySQLVersion:"5.7"},
    1171: {ErrorNumber:1171, ErrorType:"ServerError", Symbol:"ER_PRIMARY_CANT_HAVE_NULL", SQLState:"42000", Message:"All parts of a PRIMARY KEY must be NOT NULL", Description:"if you needNULL in a key, use UNIQUE instead", MySQLVersion:"5.7"},
    1172: {ErrorNumber:1172, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_ROWS", SQLState:"42000", Message:"Result consisted of more than one row", Description:"", MySQLVersion:"5.7"},
    1173: {ErrorNumber:1173, ErrorType:"ServerError", Symbol:"ER_REQUIRES_PRIMARY_KEY", SQLState:"42000", Message:"This table type requires a primary key", Description:"", MySQLVersion:"5.7"},
    1174: {ErrorNumber:1174, ErrorType:"ServerError", Symbol:"ER_NO_RAID_COMPILED", SQLState:"HY000", Message:"This version of MySQL is not compiled with RAID support", Description:"", MySQLVersion:"5.7"},
    1175: {ErrorNumber:1175, ErrorType:"ServerError", Symbol:"ER_UPDATE_WITHOUT_KEY_IN_SAFE_MODE", SQLState:"HY000", Message:"You are using safe update mode and you tried to update atable without a WHERE that uses a KEY column. %s", Description:"", MySQLVersion:"5.7"},
    1176: {ErrorNumber:1176, ErrorType:"ServerError", Symbol:"ER_KEY_DOES_NOT_EXITS", SQLState:"42000", Message:"Key '%s' doesn't exist in table '%s'", Description:"", MySQLVersion:"5.7"},
    1177: {ErrorNumber:1177, ErrorType:"ServerError", Symbol:"ER_CHECK_NO_SUCH_TABLE", SQLState:"42000", Message:"Can't open table", Description:"", MySQLVersion:"5.7"},
    1178: {ErrorNumber:1178, ErrorType:"ServerError", Symbol:"ER_CHECK_NOT_IMPLEMENTED", SQLState:"42000", Message:"The storage engine for the table doesn't support %s", Description:"", MySQLVersion:"5.7"},
    1179: {ErrorNumber:1179, ErrorType:"ServerError", Symbol:"ER_CANT_DO_THIS_DURING_AN_TRANSACTION", SQLState:"25000", Message:"You are not allowed to execute this command in atransaction", Description:"", MySQLVersion:"5.7"},
    1180: {ErrorNumber:1180, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_COMMIT", SQLState:"HY000", Message:"Got error %d during COMMIT", Description:"", MySQLVersion:"5.7"},
    1181: {ErrorNumber:1181, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_ROLLBACK", SQLState:"HY000", Message:"Got error %d during ROLLBACK", Description:"", MySQLVersion:"5.7"},
    1182: {ErrorNumber:1182, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_FLUSH_LOGS", SQLState:"HY000", Message:"Got error %d during FLUSH_LOGS", Description:"", MySQLVersion:"5.7"},
    1183: {ErrorNumber:1183, ErrorType:"ServerError", Symbol:"ER_ERROR_DURING_CHECKPOINT", SQLState:"HY000", Message:"Got error %d during CHECKPOINT", Description:"", MySQLVersion:"5.7"},
    1184: {ErrorNumber:1184, ErrorType:"ServerError", Symbol:"ER_NEW_ABORTING_CONNECTION", SQLState:"08S01", Message:"Aborted connection %u to db: '%s' user: '%s' host: '%s'(%s)", Description:"", MySQLVersion:"5.7"},
    1185: {ErrorNumber:1185, ErrorType:"ServerError", Symbol:"ER_DUMP_NOT_IMPLEMENTED", SQLState:"HY000", Message:"The storage engine for the table does not support binarytable dump", Description:"", MySQLVersion:"5.7"},
    1186: {ErrorNumber:1186, ErrorType:"ServerError", Symbol:"ER_FLUSH_MASTER_BINLOG_CLOSED", SQLState:"HY000", Message:"Binlog closed, cannot RESET MASTER", Description:"", MySQLVersion:"5.7"},
    1187: {ErrorNumber:1187, ErrorType:"ServerError", Symbol:"ER_INDEX_REBUILD", SQLState:"HY000", Message:"Failed rebuilding the index of dumped table '%s'", Description:"", MySQLVersion:"5.7"},
    1188: {ErrorNumber:1188, ErrorType:"ServerError", Symbol:"ER_MASTER", SQLState:"HY000", Message:"Error from master: '%s'", Description:"", MySQLVersion:"5.7"},
    1189: {ErrorNumber:1189, ErrorType:"ServerError", Symbol:"ER_MASTER_NET_READ", SQLState:"08S01", Message:"Net error reading from master", Description:"", MySQLVersion:"5.7"},
    1190: {ErrorNumber:1190, ErrorType:"ServerError", Symbol:"ER_MASTER_NET_WRITE", SQLState:"08S01", Message:"Net error writing to master", Description:"", MySQLVersion:"5.7"},
    1191: {ErrorNumber:1191, ErrorType:"ServerError", Symbol:"ER_FT_MATCHING_KEY_NOT_FOUND", SQLState:"HY000", Message:"Can't find FULLTEXT index matching the column list", Description:"", MySQLVersion:"5.7"},
    1192: {ErrorNumber:1192, ErrorType:"ServerError", Symbol:"ER_LOCK_OR_ACTIVE_TRANSACTION", SQLState:"HY000", Message:"Can't execute the given command because you have activelocked tables or an active transaction", Description:"", MySQLVersion:"5.7"},
    1193: {ErrorNumber:1193, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_SYSTEM_VARIABLE", SQLState:"HY000", Message:"Unknown system variable '%s'", Description:"", MySQLVersion:"5.7"},
    1194: {ErrorNumber:1194, ErrorType:"ServerError", Symbol:"ER_CRASHED_ON_USAGE", SQLState:"HY000", Message:"Table '%s' is marked as crashed and should be repaired", Description:"", MySQLVersion:"5.7"},
    1195: {ErrorNumber:1195, ErrorType:"ServerError", Symbol:"ER_CRASHED_ON_REPAIR", SQLState:"HY000", Message:"Table '%s' is marked as crashed and last (automatic?)repair failed", Description:"", MySQLVersion:"5.7"},
    1196: {ErrorNumber:1196, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK", SQLState:"HY000", Message:"Some non-transactional changed tables couldn't be rolledback", Description:"", MySQLVersion:"5.7"},
    1197: {ErrorNumber:1197, ErrorType:"ServerError", Symbol:"ER_TRANS_CACHE_FULL", SQLState:"HY000", Message:"Multi-statement transaction required more than'max_binlog_cache_size' bytes of storage", Description:"increase this mysqldvariable and try again", MySQLVersion:"5.7"},
    1198: {ErrorNumber:1198, ErrorType:"ServerError", Symbol:"ER_SLAVE_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slave", Description:"run STOP SLAVE first", MySQLVersion:"5.7"},
    1199: {ErrorNumber:1199, ErrorType:"ServerError", Symbol:"ER_SLAVE_NOT_RUNNING", SQLState:"HY000", Message:"This operation requires a running slave", Description:"configure slaveand do START SLAVE", MySQLVersion:"5.7"},
    1200: {ErrorNumber:1200, ErrorType:"ServerError", Symbol:"ER_BAD_SLAVE", SQLState:"HY000", Message:"The server is not configured as slave", Description:"fix in config fileor with CHANGE MASTER TO", MySQLVersion:"5.7"},
    1201: {ErrorNumber:1201, ErrorType:"ServerError", Symbol:"ER_MASTER_INFO", SQLState:"HY000", Message:"Could not initialize master info structure", Description:"more errormessages can be found in the MySQL error log", MySQLVersion:"5.7"},
    1202: {ErrorNumber:1202, ErrorType:"ServerError", Symbol:"ER_SLAVE_THREAD", SQLState:"HY000", Message:"Could not create slave thread", Description:"check system resources", MySQLVersion:"5.7"},
    1203: {ErrorNumber:1203, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_USER_CONNECTIONS", SQLState:"42000", Message:"User %s already has more than 'max_user_connections'active connections", Description:"", MySQLVersion:"5.7"},
    1204: {ErrorNumber:1204, ErrorType:"ServerError", Symbol:"ER_SET_CONSTANTS_ONLY", SQLState:"HY000", Message:"You may only use constant expressions with SET", Description:"", MySQLVersion:"5.7"},
    1205: {ErrorNumber:1205, ErrorType:"ServerError", Symbol:"ER_LOCK_WAIT_TIMEOUT", SQLState:"HY000", Message:"Lock wait timeout exceeded", Description:"InnoDB reports this error when lock waittimeout expires. The statement that waited too long wasrolled back (not the entiretransaction). You canincrease the value of theinnodb_lock_wait_timeoutconfiguration option if SQL statements should wait longer forother transactions to complete, or decrease it if too manylong-running transactions are causinglocking problems and reducingconcurrency on a busysystem.", MySQLVersion:"5.7"},
    1206: {ErrorNumber:1206, ErrorType:"ServerError", Symbol:"ER_LOCK_TABLE_FULL", SQLState:"HY000", Message:"The total number of locks exceeds the lock table size", Description:"InnoDB reports this error when the total numberof locks exceeds the amount of memory devoted to managing locks.To avoid this error, increase the value ofinnodb_buffer_pool_size. Withinan individual application, a workaround may be to break a largeoperation into smaller pieces. For example, if the error occursfor a large INSERT, perform severalsmaller INSERT operations.", MySQLVersion:"5.7"},
    1207: {ErrorNumber:1207, ErrorType:"ServerError", Symbol:"ER_READ_ONLY_TRANSACTION", SQLState:"25000", Message:"Update locks cannot be acquired during a READ UNCOMMITTEDtransaction", Description:"", MySQLVersion:"5.7"},
    1208: {ErrorNumber:1208, ErrorType:"ServerError", Symbol:"ER_DROP_DB_WITH_READ_LOCK", SQLState:"HY000", Message:"DROP DATABASE not allowed while thread is holding globalread lock", Description:"", MySQLVersion:"5.7"},
    1209: {ErrorNumber:1209, ErrorType:"ServerError", Symbol:"ER_CREATE_DB_WITH_READ_LOCK", SQLState:"HY000", Message:"CREATE DATABASE not allowed while thread is holdingglobal read lock", Description:"", MySQLVersion:"5.7"},
    1210: {ErrorNumber:1210, ErrorType:"ServerError", Symbol:"ER_WRONG_ARGUMENTS", SQLState:"HY000", Message:"Incorrect arguments to %s", Description:"", MySQLVersion:"5.7"},
    1211: {ErrorNumber:1211, ErrorType:"ServerError", Symbol:"ER_NO_PERMISSION_TO_CREATE_USER", SQLState:"42000", Message:"'%s'@'%s' is not allowed to create new users", Description:"", MySQLVersion:"5.7"},
    1212: {ErrorNumber:1212, ErrorType:"ServerError", Symbol:"ER_UNION_TABLES_IN_DIFFERENT_DIR", SQLState:"HY000", Message:"Incorrect table definition", Description:"all MERGE tables must be inthe same database", MySQLVersion:"5.7"},
    1213: {ErrorNumber:1213, ErrorType:"ServerError", Symbol:"ER_LOCK_DEADLOCK", SQLState:"40001", Message:"Deadlock found when trying to get lock", Description:"InnoDB reports this error when atransaction encounters adeadlock and is automaticallyrolled back so that yourapplication can take corrective action. To recover from thiserror, run all the operations in this transaction again. Adeadlock occurs when requests for locks arrive in inconsistentorder between transactions. The transaction that was rolled backreleased all its locks, and the other transaction can now get allthe locks it requested. Thus, when you re-run the transaction thatwas rolled back, it might have to wait for other transactions tocomplete, but typically the deadlock does not recur. If youencounter frequent deadlocks, make the sequence of lockingoperations (LOCK TABLES, SELECT ...FOR UPDATE, and so on) consistent between the differenttransactions or applications that experience the issue. SeeDeadlocks in InnoDB for details.", MySQLVersion:"5.7"},
    1214: {ErrorNumber:1214, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_FT", SQLState:"HY000", Message:"The used table type doesn't support FULLTEXT indexes", Description:"", MySQLVersion:"5.7"},
    1215: {ErrorNumber:1215, ErrorType:"ServerError", Symbol:"ER_CANNOT_ADD_FOREIGN", SQLState:"HY000", Message:"Cannot add foreign key constraint", Description:"", MySQLVersion:"5.7"},
    1216: {ErrorNumber:1216, ErrorType:"ServerError", Symbol:"ER_NO_REFERENCED_ROW", SQLState:"23000", Message:"Cannot add or update a child row: a foreign keyconstraint fails", Description:"InnoDB reports this error when you try to add arow but there is no parent row, and aforeign keyconstraint fails. Add the parent row first.", MySQLVersion:"5.7"},
    1217: {ErrorNumber:1217, ErrorType:"ServerError", Symbol:"ER_ROW_IS_REFERENCED", SQLState:"23000", Message:"Cannot delete or update a parent row: a foreign keyconstraint fails", Description:"InnoDB reports this error when you try todelete a parent row that has children, and aforeign keyconstraint fails. Delete the children first.", MySQLVersion:"5.7"},
    1218: {ErrorNumber:1218, ErrorType:"ServerError", Symbol:"ER_CONNECT_TO_MASTER", SQLState:"08S01", Message:"Error connecting to master: %s", Description:"", MySQLVersion:"5.7"},
    1219: {ErrorNumber:1219, ErrorType:"ServerError", Symbol:"ER_QUERY_ON_MASTER", SQLState:"HY000", Message:"Error running query on master: %s", Description:"", MySQLVersion:"5.7"},
    1220: {ErrorNumber:1220, ErrorType:"ServerError", Symbol:"ER_ERROR_WHEN_EXECUTING_COMMAND", SQLState:"HY000", Message:"Error when executing command %s: %s", Description:"", MySQLVersion:"5.7"},
    1221: {ErrorNumber:1221, ErrorType:"ServerError", Symbol:"ER_WRONG_USAGE", SQLState:"HY000", Message:"Incorrect usage of %s and %s", Description:"", MySQLVersion:"5.7"},
    1222: {ErrorNumber:1222, ErrorType:"ServerError", Symbol:"ER_WRONG_NUMBER_OF_COLUMNS_IN_SELECT", SQLState:"21000", Message:"The used SELECT statements have a different number ofcolumns", Description:"", MySQLVersion:"5.7"},
    1223: {ErrorNumber:1223, ErrorType:"ServerError", Symbol:"ER_CANT_UPDATE_WITH_READLOCK", SQLState:"HY000", Message:"Can't execute the query because you have a conflictingread lock", Description:"", MySQLVersion:"5.7"},
    1224: {ErrorNumber:1224, ErrorType:"ServerError", Symbol:"ER_MIXING_NOT_ALLOWED", SQLState:"HY000", Message:"Mixing of transactional and non-transactional tables isdisabled", Description:"", MySQLVersion:"5.7"},
    1225: {ErrorNumber:1225, ErrorType:"ServerError", Symbol:"ER_DUP_ARGUMENT", SQLState:"HY000", Message:"Option '%s' used twice in statement", Description:"", MySQLVersion:"5.7"},
    1226: {ErrorNumber:1226, ErrorType:"ServerError", Symbol:"ER_USER_LIMIT_REACHED", SQLState:"42000", Message:"User '%s' has exceeded the '%s' resource (current value:%ld)", Description:"", MySQLVersion:"5.7"},
    1227: {ErrorNumber:1227, ErrorType:"ServerError", Symbol:"ER_SPECIFIC_ACCESS_DENIED_ERROR", SQLState:"42000", Message:"Access denied", Description:"you need (at least one of) the %sprivilege(s) for this operation", MySQLVersion:"5.7"},
    1228: {ErrorNumber:1228, ErrorType:"ServerError", Symbol:"ER_LOCAL_VARIABLE", SQLState:"HY000", Message:"Variable '%s' is a SESSION variable and can't be usedwith SET GLOBAL", Description:"", MySQLVersion:"5.7"},
    1229: {ErrorNumber:1229, ErrorType:"ServerError", Symbol:"ER_GLOBAL_VARIABLE", SQLState:"HY000", Message:"Variable '%s' is a GLOBAL variable and should be set withSET GLOBAL", Description:"", MySQLVersion:"5.7"},
    1230: {ErrorNumber:1230, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT", SQLState:"42000", Message:"Variable '%s' doesn't have a default value", Description:"", MySQLVersion:"5.7"},
    1231: {ErrorNumber:1231, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_FOR_VAR", SQLState:"42000", Message:"Variable '%s' can't be set to the value of '%s'", Description:"", MySQLVersion:"5.7"},
    1232: {ErrorNumber:1232, ErrorType:"ServerError", Symbol:"ER_WRONG_TYPE_FOR_VAR", SQLState:"42000", Message:"Incorrect argument type to variable '%s'", Description:"", MySQLVersion:"5.7"},
    1233: {ErrorNumber:1233, ErrorType:"ServerError", Symbol:"ER_VAR_CANT_BE_READ", SQLState:"HY000", Message:"Variable '%s' can only be set, not read", Description:"", MySQLVersion:"5.7"},
    1234: {ErrorNumber:1234, ErrorType:"ServerError", Symbol:"ER_CANT_USE_OPTION_HERE", SQLState:"42000", Message:"Incorrect usage/placement of '%s'", Description:"", MySQLVersion:"5.7"},
    1235: {ErrorNumber:1235, ErrorType:"ServerError", Symbol:"ER_NOT_SUPPORTED_YET", SQLState:"42000", Message:"This version of MySQL doesn't yet support '%s'", Description:"", MySQLVersion:"5.7"},
    1236: {ErrorNumber:1236, ErrorType:"ServerError", Symbol:"ER_MASTER_FATAL_ERROR_READING_BINLOG", SQLState:"HY000", Message:"Got fatal error %d from master when reading data frombinary log: '%s'", Description:"", MySQLVersion:"5.7"},
    1237: {ErrorNumber:1237, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORED_TABLE", SQLState:"HY000", Message:"Slave SQL thread ignored the query because ofreplicate-*-table rules", Description:"", MySQLVersion:"5.7"},
    1238: {ErrorNumber:1238, ErrorType:"ServerError", Symbol:"ER_INCORRECT_GLOBAL_LOCAL_VAR", SQLState:"HY000", Message:"Variable '%s' is a %s variable", Description:"", MySQLVersion:"5.7"},
    1239: {ErrorNumber:1239, ErrorType:"ServerError", Symbol:"ER_WRONG_FK_DEF", SQLState:"42000", Message:"Incorrect foreign key definition for '%s': %s", Description:"", MySQLVersion:"5.7"},
    1240: {ErrorNumber:1240, ErrorType:"ServerError", Symbol:"ER_KEY_REF_DO_NOT_MATCH_TABLE_REF", SQLState:"HY000", Message:"Key reference and table reference don't match", Description:"", MySQLVersion:"5.7"},
    1241: {ErrorNumber:1241, ErrorType:"ServerError", Symbol:"ER_OPERAND_COLUMNS", SQLState:"21000", Message:"Operand should contain %d column(s)", Description:"", MySQLVersion:"5.7"},
    1242: {ErrorNumber:1242, ErrorType:"ServerError", Symbol:"ER_SUBQUERY_NO_1_ROW", SQLState:"21000", Message:"Subquery returns more than 1 row", Description:"", MySQLVersion:"5.7"},
    1243: {ErrorNumber:1243, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_STMT_HANDLER", SQLState:"HY000", Message:"Unknown prepared statement handler (%.*s) given to %s", Description:"", MySQLVersion:"5.7"},
    1244: {ErrorNumber:1244, ErrorType:"ServerError", Symbol:"ER_CORRUPT_HELP_DB", SQLState:"HY000", Message:"Help database is corrupt or does not exist", Description:"", MySQLVersion:"5.7"},
    1245: {ErrorNumber:1245, ErrorType:"ServerError", Symbol:"ER_CYCLIC_REFERENCE", SQLState:"HY000", Message:"Cyclic reference on subqueries", Description:"", MySQLVersion:"5.7"},
    1246: {ErrorNumber:1246, ErrorType:"ServerError", Symbol:"ER_AUTO_CONVERT", SQLState:"HY000", Message:"Converting column '%s' from %s to %s", Description:"", MySQLVersion:"5.7"},
    1247: {ErrorNumber:1247, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_REFERENCE", SQLState:"42S22", Message:"Reference '%s' not supported (%s)", Description:"", MySQLVersion:"5.7"},
    1248: {ErrorNumber:1248, ErrorType:"ServerError", Symbol:"ER_DERIVED_MUST_HAVE_ALIAS", SQLState:"42000", Message:"Every derived table must have its own alias", Description:"", MySQLVersion:"5.7"},
    1249: {ErrorNumber:1249, ErrorType:"ServerError", Symbol:"ER_SELECT_REDUCED", SQLState:"01000", Message:"Select %u was reduced during optimization", Description:"", MySQLVersion:"5.7"},
    1250: {ErrorNumber:1250, ErrorType:"ServerError", Symbol:"ER_TABLENAME_NOT_ALLOWED_HERE", SQLState:"42000", Message:"Table '%s' from one of the SELECTs cannot be used in %s", Description:"", MySQLVersion:"5.7"},
    1251: {ErrorNumber:1251, ErrorType:"ServerError", Symbol:"ER_NOT_SUPPORTED_AUTH_MODE", SQLState:"08004", Message:"Client does not support authentication protocol requestedby server", Description:"consider upgrading MySQL client", MySQLVersion:"5.7"},
    1252: {ErrorNumber:1252, ErrorType:"ServerError", Symbol:"ER_SPATIAL_CANT_HAVE_NULL", SQLState:"42000", Message:"All parts of a SPATIAL index must be NOT NULL", Description:"", MySQLVersion:"5.7"},
    1253: {ErrorNumber:1253, ErrorType:"ServerError", Symbol:"ER_COLLATION_CHARSET_MISMATCH", SQLState:"42000", Message:"COLLATION '%s' is not valid for CHARACTER SET '%s'", Description:"", MySQLVersion:"5.7"},
    1254: {ErrorNumber:1254, ErrorType:"ServerError", Symbol:"ER_SLAVE_WAS_RUNNING", SQLState:"HY000", Message:"Slave is already running", Description:"", MySQLVersion:"5.7"},
    1255: {ErrorNumber:1255, ErrorType:"ServerError", Symbol:"ER_SLAVE_WAS_NOT_RUNNING", SQLState:"HY000", Message:"Slave already has been stopped", Description:"", MySQLVersion:"5.7"},
    1256: {ErrorNumber:1256, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_FOR_UNCOMPRESS", SQLState:"HY000", Message:"Uncompressed data size too large", Description:"the maximum size is %d(probably, length of uncompressed data was corrupted)", MySQLVersion:"5.7"},
    1257: {ErrorNumber:1257, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_MEM_ERROR", SQLState:"HY000", Message:"ZLIB: Not enough memory", Description:"", MySQLVersion:"5.7"},
    1258: {ErrorNumber:1258, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_BUF_ERROR", SQLState:"HY000", Message:"ZLIB: Not enough room in the output buffer (probably,length of uncompressed data was corrupted)", Description:"", MySQLVersion:"5.7"},
    1259: {ErrorNumber:1259, ErrorType:"ServerError", Symbol:"ER_ZLIB_Z_DATA_ERROR", SQLState:"HY000", Message:"ZLIB: Input data corrupted", Description:"", MySQLVersion:"5.7"},
    1260: {ErrorNumber:1260, ErrorType:"ServerError", Symbol:"ER_CUT_VALUE_GROUP_CONCAT", SQLState:"HY000", Message:"Row %u was cut by GROUP_CONCAT()", Description:"", MySQLVersion:"5.7"},
    1261: {ErrorNumber:1261, ErrorType:"ServerError", Symbol:"ER_WARN_TOO_FEW_RECORDS", SQLState:"01000", Message:"Row %ld doesn't contain data for all columns", Description:"", MySQLVersion:"5.7"},
    1262: {ErrorNumber:1262, ErrorType:"ServerError", Symbol:"ER_WARN_TOO_MANY_RECORDS", SQLState:"01000", Message:"Row %ld was truncated", Description:"it contained more data than therewere input columns", MySQLVersion:"5.7"},
    1263: {ErrorNumber:1263, ErrorType:"ServerError", Symbol:"ER_WARN_NULL_TO_NOTNULL", SQLState:"22004", Message:"Column set to default value", Description:"NULL supplied to NOT NULLcolumn '%s' at row %ld", MySQLVersion:"5.7"},
    1264: {ErrorNumber:1264, ErrorType:"ServerError", Symbol:"ER_WARN_DATA_OUT_OF_RANGE", SQLState:"22003", Message:"Out of range value for column '%s' at row %ld", Description:"", MySQLVersion:"5.7"},
    1265: {ErrorNumber:1265, ErrorType:"ServerError", Symbol:"WARN_DATA_TRUNCATED", SQLState:"01000", Message:"Data truncated for column '%s' at row %ld", Description:"", MySQLVersion:"5.7"},
    1266: {ErrorNumber:1266, ErrorType:"ServerError", Symbol:"ER_WARN_USING_OTHER_HANDLER", SQLState:"HY000", Message:"Using storage engine %s for table '%s'", Description:"", MySQLVersion:"5.7"},
    1267: {ErrorNumber:1267, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_2COLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations (%s,%s) and (%s,%s) foroperation '%s'", Description:"", MySQLVersion:"5.7"},
    1268: {ErrorNumber:1268, ErrorType:"ServerError", Symbol:"ER_DROP_USER", SQLState:"HY000", Message:"Cannot drop one or more of the requested users", Description:"", MySQLVersion:"5.7"},
    1269: {ErrorNumber:1269, ErrorType:"ServerError", Symbol:"ER_REVOKE_GRANTS", SQLState:"HY000", Message:"Can't revoke all privileges for one or more of therequested users", Description:"", MySQLVersion:"5.7"},
    1270: {ErrorNumber:1270, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_3COLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations (%s,%s), (%s,%s), (%s,%s) foroperation '%s'", Description:"", MySQLVersion:"5.7"},
    1271: {ErrorNumber:1271, ErrorType:"ServerError", Symbol:"ER_CANT_AGGREGATE_NCOLLATIONS", SQLState:"HY000", Message:"Illegal mix of collations for operation '%s'", Description:"", MySQLVersion:"5.7"},
    1272: {ErrorNumber:1272, ErrorType:"ServerError", Symbol:"ER_VARIABLE_IS_NOT_STRUCT", SQLState:"HY000", Message:"Variable '%s' is not a variable component (can't be usedas XXXX.variable_name)", Description:"", MySQLVersion:"5.7"},
    1273: {ErrorNumber:1273, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_COLLATION", SQLState:"HY000", Message:"Unknown collation: '%s'", Description:"", MySQLVersion:"5.7"},
    1274: {ErrorNumber:1274, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORED_SSL_PARAMS", SQLState:"HY000", Message:"SSL parameters in CHANGE MASTER are ignored because thisMySQL slave was compiled without SSL support", Description:"they can be usedlater if MySQL slave with SSL is started", MySQLVersion:"5.7"},
    1275: {ErrorNumber:1275, ErrorType:"ServerError", Symbol:"ER_SERVER_IS_IN_SECURE_AUTH_MODE", SQLState:"HY000", Message:"Server is running in --secure-auth mode, but '%s'@'%s'has a password in the old format", Description:"please change the password tothe new format", MySQLVersion:"5.7"},
    1276: {ErrorNumber:1276, ErrorType:"ServerError", Symbol:"ER_WARN_FIELD_RESOLVED", SQLState:"HY000", Message:"Field or reference '%s%s%s%s%s' of SELECT #%d wasresolved in SELECT #%d", Description:"", MySQLVersion:"5.7"},
    1277: {ErrorNumber:1277, ErrorType:"ServerError", Symbol:"ER_BAD_SLAVE_UNTIL_COND", SQLState:"HY000", Message:"Incorrect parameter or combination of parameters forSTART SLAVE UNTIL", Description:"", MySQLVersion:"5.7"},
    1278: {ErrorNumber:1278, ErrorType:"ServerError", Symbol:"ER_MISSING_SKIP_SLAVE", SQLState:"HY000", Message:"It is recommended to use --skip-slave-start when doingstep-by-step replication with START SLAVE UNTIL", Description:"otherwise, youwill get problems if you get an unexpected slave's mysqld restart", MySQLVersion:"5.7"},
    1279: {ErrorNumber:1279, ErrorType:"ServerError", Symbol:"ER_UNTIL_COND_IGNORED", SQLState:"HY000", Message:"SQL thread is not to be started so UNTIL options areignored", Description:"", MySQLVersion:"5.7"},
    1280: {ErrorNumber:1280, ErrorType:"ServerError", Symbol:"ER_WRONG_NAME_FOR_INDEX", SQLState:"42000", Message:"Incorrect index name '%s'", Description:"", MySQLVersion:"5.7"},
    1281: {ErrorNumber:1281, ErrorType:"ServerError", Symbol:"ER_WRONG_NAME_FOR_CATALOG", SQLState:"42000", Message:"Incorrect catalog name '%s'", Description:"", MySQLVersion:"5.7"},
    1282: {ErrorNumber:1282, ErrorType:"ServerError", Symbol:"ER_WARN_QC_RESIZE", SQLState:"HY000", Message:"Query cache failed to set size %lu", Description:"new query cache sizeis %lu", MySQLVersion:"5.7"},
    1283: {ErrorNumber:1283, ErrorType:"ServerError", Symbol:"ER_BAD_FT_COLUMN", SQLState:"HY000", Message:"Column '%s' cannot be part of FULLTEXT index", Description:"", MySQLVersion:"5.7"},
    1284: {ErrorNumber:1284, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_KEY_CACHE", SQLState:"HY000", Message:"Unknown key cache '%s'", Description:"", MySQLVersion:"5.7"},
    1285: {ErrorNumber:1285, ErrorType:"ServerError", Symbol:"ER_WARN_HOSTNAME_WONT_WORK", SQLState:"HY000", Message:"MySQL is started in --skip-name-resolve mode", Description:"you mustrestart it without this switch for this grant to work", MySQLVersion:"5.7"},
    1286: {ErrorNumber:1286, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_STORAGE_ENGINE", SQLState:"42000", Message:"Unknown storage engine '%s'", Description:"", MySQLVersion:"5.7"},
    1287: {ErrorNumber:1287, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYNTAX", SQLState:"HY000", Message:"'%s' is deprecated and will be removed in a futurerelease. Please use %s instead", Description:"", MySQLVersion:"5.7"},
    1288: {ErrorNumber:1288, ErrorType:"ServerError", Symbol:"ER_NON_UPDATABLE_TABLE", SQLState:"HY000", Message:"The target table %s of the %s is not updatable", Description:"", MySQLVersion:"5.7"},
    1289: {ErrorNumber:1289, ErrorType:"ServerError", Symbol:"ER_FEATURE_DISABLED", SQLState:"HY000", Message:"The '%s' feature is disabled", Description:"you need MySQL built with'%s' to have it working", MySQLVersion:"5.7"},
    1290: {ErrorNumber:1290, ErrorType:"ServerError", Symbol:"ER_OPTION_PREVENTS_STATEMENT", SQLState:"HY000", Message:"The MySQL server is running with the %s option so itcannot execute this statement", Description:"", MySQLVersion:"5.7"},
    1291: {ErrorNumber:1291, ErrorType:"ServerError", Symbol:"ER_DUPLICATED_VALUE_IN_TYPE", SQLState:"HY000", Message:"Column '%s' has duplicated value '%s' in %s", Description:"", MySQLVersion:"5.7"},
    1292: {ErrorNumber:1292, ErrorType:"ServerError", Symbol:"ER_TRUNCATED_WRONG_VALUE", SQLState:"22007", Message:"Truncated incorrect %s value: '%s'", Description:"", MySQLVersion:"5.7"},
    1293: {ErrorNumber:1293, ErrorType:"ServerError", Symbol:"ER_TOO_MUCH_AUTO_TIMESTAMP_COLS", SQLState:"HY000", Message:"Incorrect table definition", Description:"there can be only oneTIMESTAMP column with CURRENT_TIMESTAMP in DEFAULT or ON UPDATEclause", MySQLVersion:"5.7"},
    1294: {ErrorNumber:1294, ErrorType:"ServerError", Symbol:"ER_INVALID_ON_UPDATE", SQLState:"HY000", Message:"Invalid ON UPDATE clause for '%s' column", Description:"", MySQLVersion:"5.7"},
    1295: {ErrorNumber:1295, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_PS", SQLState:"HY000", Message:"This command is not supported in the prepared statementprotocol yet", Description:"", MySQLVersion:"5.7"},
    1296: {ErrorNumber:1296, ErrorType:"ServerError", Symbol:"ER_GET_ERRMSG", SQLState:"HY000", Message:"Got error %d '%s' from %s", Description:"", MySQLVersion:"5.7"},
    1297: {ErrorNumber:1297, ErrorType:"ServerError", Symbol:"ER_GET_TEMPORARY_ERRMSG", SQLState:"HY000", Message:"Got temporary error %d '%s' from %s", Description:"", MySQLVersion:"5.7"},
    1298: {ErrorNumber:1298, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TIME_ZONE", SQLState:"HY000", Message:"Unknown or incorrect time zone: '%s'", Description:"", MySQLVersion:"5.7"},
    1299: {ErrorNumber:1299, ErrorType:"ServerError", Symbol:"ER_WARN_INVALID_TIMESTAMP", SQLState:"HY000", Message:"Invalid TIMESTAMP value in column '%s' at row %ld", Description:"", MySQLVersion:"5.7"},
    1300: {ErrorNumber:1300, ErrorType:"ServerError", Symbol:"ER_INVALID_CHARACTER_STRING", SQLState:"HY000", Message:"Invalid %s character string: '%s'", Description:"", MySQLVersion:"5.7"},
    1301: {ErrorNumber:1301, ErrorType:"ServerError", Symbol:"ER_WARN_ALLOWED_PACKET_OVERFLOWED", SQLState:"HY000", Message:"Result of %s() was larger than max_allowed_packet (%ld) -truncated", Description:"", MySQLVersion:"5.7"},
    1302: {ErrorNumber:1302, ErrorType:"ServerError", Symbol:"ER_CONFLICTING_DECLARATIONS", SQLState:"HY000", Message:"Conflicting declarations: '%s%s' and '%s%s'", Description:"", MySQLVersion:"5.7"},
    1303: {ErrorNumber:1303, ErrorType:"ServerError", Symbol:"ER_SP_NO_RECURSIVE_CREATE", SQLState:"2F003", Message:"Can't create a %s from within another stored routine", Description:"", MySQLVersion:"5.7"},
    1304: {ErrorNumber:1304, ErrorType:"ServerError", Symbol:"ER_SP_ALREADY_EXISTS", SQLState:"42000", Message:"%s %s already exists", Description:"", MySQLVersion:"5.7"},
    1305: {ErrorNumber:1305, ErrorType:"ServerError", Symbol:"ER_SP_DOES_NOT_EXIST", SQLState:"42000", Message:"%s %s does not exist", Description:"", MySQLVersion:"5.7"},
    1306: {ErrorNumber:1306, ErrorType:"ServerError", Symbol:"ER_SP_DROP_FAILED", SQLState:"HY000", Message:"Failed to DROP %s %s", Description:"", MySQLVersion:"5.7"},
    1307: {ErrorNumber:1307, ErrorType:"ServerError", Symbol:"ER_SP_STORE_FAILED", SQLState:"HY000", Message:"Failed to CREATE %s %s", Description:"", MySQLVersion:"5.7"},
    1308: {ErrorNumber:1308, ErrorType:"ServerError", Symbol:"ER_SP_LILABEL_MISMATCH", SQLState:"42000", Message:"%s with no matching label: %s", Description:"", MySQLVersion:"5.7"},
    1309: {ErrorNumber:1309, ErrorType:"ServerError", Symbol:"ER_SP_LABEL_REDEFINE", SQLState:"42000", Message:"Redefining label %s", Description:"", MySQLVersion:"5.7"},
    1310: {ErrorNumber:1310, ErrorType:"ServerError", Symbol:"ER_SP_LABEL_MISMATCH", SQLState:"42000", Message:"End-label %s without match", Description:"", MySQLVersion:"5.7"},
    1311: {ErrorNumber:1311, ErrorType:"ServerError", Symbol:"ER_SP_UNINIT_VAR", SQLState:"01000", Message:"Referring to uninitialized variable %s", Description:"", MySQLVersion:"5.7"},
    1312: {ErrorNumber:1312, ErrorType:"ServerError", Symbol:"ER_SP_BADSELECT", SQLState:"0A000", Message:"PROCEDURE %s can't return a result set in the givencontext", Description:"", MySQLVersion:"5.7"},
    1313: {ErrorNumber:1313, ErrorType:"ServerError", Symbol:"ER_SP_BADRETURN", SQLState:"42000", Message:"RETURN is only allowed in a FUNCTION", Description:"", MySQLVersion:"5.7"},
    1314: {ErrorNumber:1314, ErrorType:"ServerError", Symbol:"ER_SP_BADSTATEMENT", SQLState:"0A000", Message:"%s is not allowed in stored procedures", Description:"", MySQLVersion:"5.7"},
    1315: {ErrorNumber:1315, ErrorType:"ServerError", Symbol:"ER_UPDATE_LOG_DEPRECATED_IGNORED", SQLState:"42000", Message:"The update log is deprecated and replaced by the binarylog", Description:"SET SQL_LOG_UPDATE has been ignored.", MySQLVersion:"5.7"},
    1316: {ErrorNumber:1316, ErrorType:"ServerError", Symbol:"ER_UPDATE_LOG_DEPRECATED_TRANSLATED", SQLState:"42000", Message:"The update log is deprecated and replaced by the binarylog", Description:"SET SQL_LOG_UPDATE has been translated to SET SQL_LOG_BIN.", MySQLVersion:"5.7"},
    1317: {ErrorNumber:1317, ErrorType:"ServerError", Symbol:"ER_QUERY_INTERRUPTED", SQLState:"70100", Message:"Query execution was interrupted", Description:"", MySQLVersion:"5.7"},
    1318: {ErrorNumber:1318, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NO_OF_ARGS", SQLState:"42000", Message:"Incorrect number of arguments for %s %s", Description:"expected %u, got%u", MySQLVersion:"5.7"},
    1319: {ErrorNumber:1319, ErrorType:"ServerError", Symbol:"ER_SP_COND_MISMATCH", SQLState:"42000", Message:"Undefined CONDITION: %s", Description:"", MySQLVersion:"5.7"},
    1320: {ErrorNumber:1320, ErrorType:"ServerError", Symbol:"ER_SP_NORETURN", SQLState:"42000", Message:"No RETURN found in FUNCTION %s", Description:"", MySQLVersion:"5.7"},
    1321: {ErrorNumber:1321, ErrorType:"ServerError", Symbol:"ER_SP_NORETURNEND", SQLState:"2F005", Message:"FUNCTION %s ended without RETURN", Description:"", MySQLVersion:"5.7"},
    1322: {ErrorNumber:1322, ErrorType:"ServerError", Symbol:"ER_SP_BAD_CURSOR_QUERY", SQLState:"42000", Message:"Cursor statement must be a SELECT", Description:"", MySQLVersion:"5.7"},
    1323: {ErrorNumber:1323, ErrorType:"ServerError", Symbol:"ER_SP_BAD_CURSOR_SELECT", SQLState:"42000", Message:"Cursor SELECT must not have INTO", Description:"", MySQLVersion:"5.7"},
    1324: {ErrorNumber:1324, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_MISMATCH", SQLState:"42000", Message:"Undefined CURSOR: %s", Description:"", MySQLVersion:"5.7"},
    1325: {ErrorNumber:1325, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_ALREADY_OPEN", SQLState:"24000", Message:"Cursor is already open", Description:"", MySQLVersion:"5.7"},
    1326: {ErrorNumber:1326, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_NOT_OPEN", SQLState:"24000", Message:"Cursor is not open", Description:"", MySQLVersion:"5.7"},
    1327: {ErrorNumber:1327, ErrorType:"ServerError", Symbol:"ER_SP_UNDECLARED_VAR", SQLState:"42000", Message:"Undeclared variable: %s", Description:"", MySQLVersion:"5.7"},
    1328: {ErrorNumber:1328, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NO_OF_FETCH_ARGS", SQLState:"HY000", Message:"Incorrect number of FETCH variables", Description:"", MySQLVersion:"5.7"},
    1329: {ErrorNumber:1329, ErrorType:"ServerError", Symbol:"ER_SP_FETCH_NO_DATA", SQLState:"02000", Message:"No data - zero rows fetched, selected, or processed", Description:"", MySQLVersion:"5.7"},
    1330: {ErrorNumber:1330, ErrorType:"ServerError", Symbol:"ER_SP_DUP_PARAM", SQLState:"42000", Message:"Duplicate parameter: %s", Description:"", MySQLVersion:"5.7"},
    1331: {ErrorNumber:1331, ErrorType:"ServerError", Symbol:"ER_SP_DUP_VAR", SQLState:"42000", Message:"Duplicate variable: %s", Description:"", MySQLVersion:"5.7"},
    1332: {ErrorNumber:1332, ErrorType:"ServerError", Symbol:"ER_SP_DUP_COND", SQLState:"42000", Message:"Duplicate condition: %s", Description:"", MySQLVersion:"5.7"},
    1333: {ErrorNumber:1333, ErrorType:"ServerError", Symbol:"ER_SP_DUP_CURS", SQLState:"42000", Message:"Duplicate cursor: %s", Description:"", MySQLVersion:"5.7"},
    1334: {ErrorNumber:1334, ErrorType:"ServerError", Symbol:"ER_SP_CANT_ALTER", SQLState:"HY000", Message:"Failed to ALTER %s %s", Description:"", MySQLVersion:"5.7"},
    1335: {ErrorNumber:1335, ErrorType:"ServerError", Symbol:"ER_SP_SUBSELECT_NYI", SQLState:"0A000", Message:"Subquery value not supported", Description:"", MySQLVersion:"5.7"},
    1336: {ErrorNumber:1336, ErrorType:"ServerError", Symbol:"ER_STMT_NOT_ALLOWED_IN_SF_OR_TRG", SQLState:"0A000", Message:"%s is not allowed in stored function or trigger", Description:"", MySQLVersion:"5.7"},
    1337: {ErrorNumber:1337, ErrorType:"ServerError", Symbol:"ER_SP_VARCOND_AFTER_CURSHNDLR", SQLState:"42000", Message:"Variable or condition declaration after cursor or handlerdeclaration", Description:"", MySQLVersion:"5.7"},
    1338: {ErrorNumber:1338, ErrorType:"ServerError", Symbol:"ER_SP_CURSOR_AFTER_HANDLER", SQLState:"42000", Message:"Cursor declaration after handler declaration", Description:"", MySQLVersion:"5.7"},
    1339: {ErrorNumber:1339, ErrorType:"ServerError", Symbol:"ER_SP_CASE_NOT_FOUND", SQLState:"20000", Message:"Case not found for CASE statement", Description:"", MySQLVersion:"5.7"},
    1340: {ErrorNumber:1340, ErrorType:"ServerError", Symbol:"ER_FPARSER_TOO_BIG_FILE", SQLState:"HY000", Message:"Configuration file '%s' is too big", Description:"", MySQLVersion:"5.7"},
    1341: {ErrorNumber:1341, ErrorType:"ServerError", Symbol:"ER_FPARSER_BAD_HEADER", SQLState:"HY000", Message:"Malformed file type header in file '%s'", Description:"", MySQLVersion:"5.7"},
    1342: {ErrorNumber:1342, ErrorType:"ServerError", Symbol:"ER_FPARSER_EOF_IN_COMMENT", SQLState:"HY000", Message:"Unexpected end of file while parsing comment '%s'", Description:"", MySQLVersion:"5.7"},
    1343: {ErrorNumber:1343, ErrorType:"ServerError", Symbol:"ER_FPARSER_ERROR_IN_PARAMETER", SQLState:"HY000", Message:"Error while parsing parameter '%s' (line: '%s')", Description:"", MySQLVersion:"5.7"},
    1344: {ErrorNumber:1344, ErrorType:"ServerError", Symbol:"ER_FPARSER_EOF_IN_UNKNOWN_PARAMETER", SQLState:"HY000", Message:"Unexpected end of file while skipping unknown parameter'%s'", Description:"", MySQLVersion:"5.7"},
    1345: {ErrorNumber:1345, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_EXPLAIN", SQLState:"HY000", Message:"EXPLAIN/SHOW can not be issued", Description:"lacking privileges forunderlying table", MySQLVersion:"5.7"},
    1346: {ErrorNumber:1346, ErrorType:"ServerError", Symbol:"ER_FRM_UNKNOWN_TYPE", SQLState:"HY000", Message:"File '%s' has unknown type '%s' in its header", Description:"", MySQLVersion:"5.7"},
    1347: {ErrorNumber:1347, ErrorType:"ServerError", Symbol:"ER_WRONG_OBJECT", SQLState:"HY000", Message:"'%s.%s' is not %s", Description:"The named object is incorrect for the type of operation attemptedon it. It must be an object of the named type.", MySQLVersion:"5.7"},
    1348: {ErrorNumber:1348, ErrorType:"ServerError", Symbol:"ER_NONUPDATEABLE_COLUMN", SQLState:"HY000", Message:"Column '%s' is not updatable", Description:"", MySQLVersion:"5.7"},
    1349: {ErrorNumber:1349, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_DERIVED_UNUSED", SQLState:"HY000", Message:"View's SELECT contains a subquery in the FROM clause", Description:"ER_VIEW_SELECT_DERIVED_UNUSED wasadded in 5.7.7.", MySQLVersion:"5.7"},
    1350: {ErrorNumber:1350, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_CLAUSE", SQLState:"HY000", Message:"View's SELECT contains a '%s' clause", Description:"", MySQLVersion:"5.7"},
    1351: {ErrorNumber:1351, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_VARIABLE", SQLState:"HY000", Message:"View's SELECT contains a variable or parameter", Description:"", MySQLVersion:"5.7"},
    1352: {ErrorNumber:1352, ErrorType:"ServerError", Symbol:"ER_VIEW_SELECT_TMPTABLE", SQLState:"HY000", Message:"View's SELECT refers to a temporary table '%s'", Description:"", MySQLVersion:"5.7"},
    1353: {ErrorNumber:1353, ErrorType:"ServerError", Symbol:"ER_VIEW_WRONG_LIST", SQLState:"HY000", Message:"View's SELECT and view's field list have different columncounts", Description:"", MySQLVersion:"5.7"},
    1354: {ErrorNumber:1354, ErrorType:"ServerError", Symbol:"ER_WARN_VIEW_MERGE", SQLState:"HY000", Message:"View merge algorithm can't be used here for now (assumedundefined algorithm)", Description:"", MySQLVersion:"5.7"},
    1355: {ErrorNumber:1355, ErrorType:"ServerError", Symbol:"ER_WARN_VIEW_WITHOUT_KEY", SQLState:"HY000", Message:"View being updated does not have complete key ofunderlying table in it", Description:"", MySQLVersion:"5.7"},
    1356: {ErrorNumber:1356, ErrorType:"ServerError", Symbol:"ER_VIEW_INVALID", SQLState:"HY000", Message:"View '%s.%s' references invalid table(s) or column(s) orfunction(s) or definer/invoker of view lack rights to use them", Description:"", MySQLVersion:"5.7"},
    1357: {ErrorNumber:1357, ErrorType:"ServerError", Symbol:"ER_SP_NO_DROP_SP", SQLState:"HY000", Message:"Can't drop or alter a %s from within another storedroutine", Description:"", MySQLVersion:"5.7"},
    1358: {ErrorNumber:1358, ErrorType:"ServerError", Symbol:"ER_SP_GOTO_IN_HNDLR", SQLState:"HY000", Message:"GOTO is not allowed in a stored procedure handler", Description:"", MySQLVersion:"5.7"},
    1359: {ErrorNumber:1359, ErrorType:"ServerError", Symbol:"ER_TRG_ALREADY_EXISTS", SQLState:"HY000", Message:"Trigger already exists", Description:"", MySQLVersion:"5.7"},
    1360: {ErrorNumber:1360, ErrorType:"ServerError", Symbol:"ER_TRG_DOES_NOT_EXIST", SQLState:"HY000", Message:"Trigger does not exist", Description:"", MySQLVersion:"5.7"},
    1361: {ErrorNumber:1361, ErrorType:"ServerError", Symbol:"ER_TRG_ON_VIEW_OR_TEMP_TABLE", SQLState:"HY000", Message:"Trigger's '%s' is view or temporary table", Description:"", MySQLVersion:"5.7"},
    1362: {ErrorNumber:1362, ErrorType:"ServerError", Symbol:"ER_TRG_CANT_CHANGE_ROW", SQLState:"HY000", Message:"Updating of %s row is not allowed in %strigger", Description:"", MySQLVersion:"5.7"},
    1363: {ErrorNumber:1363, ErrorType:"ServerError", Symbol:"ER_TRG_NO_SUCH_ROW_IN_TRG", SQLState:"HY000", Message:"There is no %s row in %s trigger", Description:"", MySQLVersion:"5.7"},
    1364: {ErrorNumber:1364, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT_FOR_FIELD", SQLState:"HY000", Message:"Field '%s' doesn't have a default value", Description:"", MySQLVersion:"5.7"},
    1365: {ErrorNumber:1365, ErrorType:"ServerError", Symbol:"ER_DIVISION_BY_ZERO", SQLState:"22012", Message:"Division by 0", Description:"", MySQLVersion:"5.7"},
    1366: {ErrorNumber:1366, ErrorType:"ServerError", Symbol:"ER_TRUNCATED_WRONG_VALUE_FOR_FIELD", SQLState:"HY000", Message:"Incorrect %s value: '%s' for column '%s' at row %ld", Description:"", MySQLVersion:"5.7"},
    1367: {ErrorNumber:1367, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_VALUE_FOR_TYPE", SQLState:"22007", Message:"Illegal %s '%s' value found during parsing", Description:"", MySQLVersion:"5.7"},
    1368: {ErrorNumber:1368, ErrorType:"ServerError", Symbol:"ER_VIEW_NONUPD_CHECK", SQLState:"HY000", Message:"CHECK OPTION on non-updatable view '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1369: {ErrorNumber:1369, ErrorType:"ServerError", Symbol:"ER_VIEW_CHECK_FAILED", SQLState:"HY000", Message:"CHECK OPTION failed '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1370: {ErrorNumber:1370, ErrorType:"ServerError", Symbol:"ER_PROCACCESS_DENIED_ERROR", SQLState:"42000", Message:"%s command denied to user '%s'@'%s' for routine '%s'", Description:"", MySQLVersion:"5.7"},
    1371: {ErrorNumber:1371, ErrorType:"ServerError", Symbol:"ER_RELAY_LOG_FAIL", SQLState:"HY000", Message:"Failed purging old relay logs: %s", Description:"", MySQLVersion:"5.7"},
    1372: {ErrorNumber:1372, ErrorType:"ServerError", Symbol:"ER_PASSWD_LENGTH", SQLState:"HY000", Message:"Password hash should be a %d-digit hexadecimal number", Description:"", MySQLVersion:"5.7"},
    1373: {ErrorNumber:1373, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_TARGET_BINLOG", SQLState:"HY000", Message:"Target log not found in binlog index", Description:"", MySQLVersion:"5.7"},
    1374: {ErrorNumber:1374, ErrorType:"ServerError", Symbol:"ER_IO_ERR_LOG_INDEX_READ", SQLState:"HY000", Message:"I/O error reading log index file", Description:"", MySQLVersion:"5.7"},
    1375: {ErrorNumber:1375, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_PROHIBITED", SQLState:"HY000", Message:"Server configuration does not permit binlog purge", Description:"", MySQLVersion:"5.7"},
    1376: {ErrorNumber:1376, ErrorType:"ServerError", Symbol:"ER_FSEEK_FAIL", SQLState:"HY000", Message:"Failed on fseek()", Description:"", MySQLVersion:"5.7"},
    1377: {ErrorNumber:1377, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_FATAL_ERR", SQLState:"HY000", Message:"Fatal error during log purge", Description:"", MySQLVersion:"5.7"},
    1378: {ErrorNumber:1378, ErrorType:"ServerError", Symbol:"ER_LOG_IN_USE", SQLState:"HY000", Message:"A purgeable log is in use, will not purge", Description:"", MySQLVersion:"5.7"},
    1379: {ErrorNumber:1379, ErrorType:"ServerError", Symbol:"ER_LOG_PURGE_UNKNOWN_ERR", SQLState:"HY000", Message:"Unknown error during log purge", Description:"", MySQLVersion:"5.7"},
    1380: {ErrorNumber:1380, ErrorType:"ServerError", Symbol:"ER_RELAY_LOG_INIT", SQLState:"HY000", Message:"Failed initializing relay log position: %s", Description:"", MySQLVersion:"5.7"},
    1381: {ErrorNumber:1381, ErrorType:"ServerError", Symbol:"ER_NO_BINARY_LOGGING", SQLState:"HY000", Message:"You are not using binary logging", Description:"", MySQLVersion:"5.7"},
    1382: {ErrorNumber:1382, ErrorType:"ServerError", Symbol:"ER_RESERVED_SYNTAX", SQLState:"HY000", Message:"The '%s' syntax is reserved for purposes internal to theMySQL server", Description:"", MySQLVersion:"5.7"},
    1383: {ErrorNumber:1383, ErrorType:"ServerError", Symbol:"ER_WSAS_FAILED", SQLState:"HY000", Message:"WSAStartup Failed", Description:"", MySQLVersion:"5.7"},
    1384: {ErrorNumber:1384, ErrorType:"ServerError", Symbol:"ER_DIFF_GROUPS_PROC", SQLState:"HY000", Message:"Can't handle procedures with different groups yet", Description:"", MySQLVersion:"5.7"},
    1385: {ErrorNumber:1385, ErrorType:"ServerError", Symbol:"ER_NO_GROUP_FOR_PROC", SQLState:"HY000", Message:"Select must have a group with this procedure", Description:"", MySQLVersion:"5.7"},
    1386: {ErrorNumber:1386, ErrorType:"ServerError", Symbol:"ER_ORDER_WITH_PROC", SQLState:"HY000", Message:"Can't use ORDER clause with this procedure", Description:"", MySQLVersion:"5.7"},
    1387: {ErrorNumber:1387, ErrorType:"ServerError", Symbol:"ER_LOGGING_PROHIBIT_CHANGING_OF", SQLState:"HY000", Message:"Binary logging and replication forbid changing the globalserver %s", Description:"", MySQLVersion:"5.7"},
    1388: {ErrorNumber:1388, ErrorType:"ServerError", Symbol:"ER_NO_FILE_MAPPING", SQLState:"HY000", Message:"Can't map file: %s, errno: %d", Description:"", MySQLVersion:"5.7"},
    1389: {ErrorNumber:1389, ErrorType:"ServerError", Symbol:"ER_WRONG_MAGIC", SQLState:"HY000", Message:"Wrong magic in %s", Description:"", MySQLVersion:"5.7"},
    1390: {ErrorNumber:1390, ErrorType:"ServerError", Symbol:"ER_PS_MANY_PARAM", SQLState:"HY000", Message:"Prepared statement contains too many placeholders", Description:"", MySQLVersion:"5.7"},
    1391: {ErrorNumber:1391, ErrorType:"ServerError", Symbol:"ER_KEY_PART_0", SQLState:"HY000", Message:"Key part '%s' length cannot be 0", Description:"", MySQLVersion:"5.7"},
    1392: {ErrorNumber:1392, ErrorType:"ServerError", Symbol:"ER_VIEW_CHECKSUM", SQLState:"HY000", Message:"View text checksum failed", Description:"", MySQLVersion:"5.7"},
    1393: {ErrorNumber:1393, ErrorType:"ServerError", Symbol:"ER_VIEW_MULTIUPDATE", SQLState:"HY000", Message:"Can not modify more than one base table through a joinview '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1394: {ErrorNumber:1394, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_INSERT_FIELD_LIST", SQLState:"HY000", Message:"Can not insert into join view '%s.%s' without fields list", Description:"", MySQLVersion:"5.7"},
    1395: {ErrorNumber:1395, ErrorType:"ServerError", Symbol:"ER_VIEW_DELETE_MERGE_VIEW", SQLState:"HY000", Message:"Can not delete from join view '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1396: {ErrorNumber:1396, ErrorType:"ServerError", Symbol:"ER_CANNOT_USER", SQLState:"HY000", Message:"Operation %s failed for %s", Description:"", MySQLVersion:"5.7"},
    1397: {ErrorNumber:1397, ErrorType:"ServerError", Symbol:"ER_XAER_NOTA", SQLState:"XAE04", Message:"XAER_NOTA: Unknown XID", Description:"", MySQLVersion:"5.7"},
    1398: {ErrorNumber:1398, ErrorType:"ServerError", Symbol:"ER_XAER_INVAL", SQLState:"XAE05", Message:"XAER_INVAL: Invalid arguments (or unsupported command)", Description:"", MySQLVersion:"5.7"},
    1399: {ErrorNumber:1399, ErrorType:"ServerError", Symbol:"ER_XAER_RMFAIL", SQLState:"XAE07", Message:"XAER_RMFAIL: The command cannot be executed when globaltransaction is in the %s state", Description:"", MySQLVersion:"5.7"},
    1400: {ErrorNumber:1400, ErrorType:"ServerError", Symbol:"ER_XAER_OUTSIDE", SQLState:"XAE09", Message:"XAER_OUTSIDE: Some work is done outside globaltransaction", Description:"", MySQLVersion:"5.7"},
    1401: {ErrorNumber:1401, ErrorType:"ServerError", Symbol:"ER_XAER_RMERR", SQLState:"XAE03", Message:"XAER_RMERR: Fatal error occurred in the transactionbranch - check your data for consistency", Description:"", MySQLVersion:"5.7"},
    1402: {ErrorNumber:1402, ErrorType:"ServerError", Symbol:"ER_XA_RBROLLBACK", SQLState:"XA100", Message:"XA_RBROLLBACK: Transaction branch was rolled back", Description:"", MySQLVersion:"5.7"},
    1403: {ErrorNumber:1403, ErrorType:"ServerError", Symbol:"ER_NONEXISTING_PROC_GRANT", SQLState:"42000", Message:"There is no such grant defined for user '%s' on host '%s'on routine '%s'", Description:"", MySQLVersion:"5.7"},
    1404: {ErrorNumber:1404, ErrorType:"ServerError", Symbol:"ER_PROC_AUTO_GRANT_FAIL", SQLState:"HY000", Message:"Failed to grant EXECUTE and ALTER ROUTINE privileges", Description:"", MySQLVersion:"5.7"},
    1405: {ErrorNumber:1405, ErrorType:"ServerError", Symbol:"ER_PROC_AUTO_REVOKE_FAIL", SQLState:"HY000", Message:"Failed to revoke all privileges to dropped routine", Description:"", MySQLVersion:"5.7"},
    1406: {ErrorNumber:1406, ErrorType:"ServerError", Symbol:"ER_DATA_TOO_LONG", SQLState:"22001", Message:"Data too long for column '%s' at row %ld", Description:"", MySQLVersion:"5.7"},
    1407: {ErrorNumber:1407, ErrorType:"ServerError", Symbol:"ER_SP_BAD_SQLSTATE", SQLState:"42000", Message:"Bad SQLSTATE: '%s'", Description:"", MySQLVersion:"5.7"},
    1408: {ErrorNumber:1408, ErrorType:"ServerError", Symbol:"ER_STARTUP", SQLState:"HY000", Message:"%s: ready for connections. Version: '%s' socket: '%s'port: %d %s", Description:"", MySQLVersion:"5.7"},
    1409: {ErrorNumber:1409, ErrorType:"ServerError", Symbol:"ER_LOAD_FROM_FIXED_SIZE_ROWS_TO_VAR", SQLState:"HY000", Message:"Can't load value from file with fixed size rows tovariable", Description:"", MySQLVersion:"5.7"},
    1410: {ErrorNumber:1410, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_USER_WITH_GRANT", SQLState:"42000", Message:"You are not allowed to create a user with GRANT", Description:"", MySQLVersion:"5.7"},
    1411: {ErrorNumber:1411, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE_FOR_TYPE", SQLState:"HY000", Message:"Incorrect %s value: '%s' for function %s", Description:"", MySQLVersion:"5.7"},
    1412: {ErrorNumber:1412, ErrorType:"ServerError", Symbol:"ER_TABLE_DEF_CHANGED", SQLState:"HY000", Message:"Table definition has changed, please retry transaction", Description:"", MySQLVersion:"5.7"},
    1413: {ErrorNumber:1413, ErrorType:"ServerError", Symbol:"ER_SP_DUP_HANDLER", SQLState:"42000", Message:"Duplicate handler declared in the same block", Description:"", MySQLVersion:"5.7"},
    1414: {ErrorNumber:1414, ErrorType:"ServerError", Symbol:"ER_SP_NOT_VAR_ARG", SQLState:"42000", Message:"OUT or INOUT argument %d for routine %s is not a variableor NEW pseudo-variable in BEFORE trigger", Description:"", MySQLVersion:"5.7"},
    1415: {ErrorNumber:1415, ErrorType:"ServerError", Symbol:"ER_SP_NO_RETSET", SQLState:"0A000", Message:"Not allowed to return a result set from a %s", Description:"", MySQLVersion:"5.7"},
    1416: {ErrorNumber:1416, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_GEOMETRY_OBJECT", SQLState:"22003", Message:"Cannot get geometry object from data you send to theGEOMETRY field", Description:"", MySQLVersion:"5.7"},
    1417: {ErrorNumber:1417, ErrorType:"ServerError", Symbol:"ER_FAILED_ROUTINE_BREAK_BINLOG", SQLState:"HY000", Message:"A routine failed and has neither NO SQL nor READS SQLDATA in its declaration and binary logging is enabled", Description:"ifnon-transactional tables were updated, the binary log will misstheir changes", MySQLVersion:"5.7"},
    ...
    1419: {ErrorNumber:1419, ErrorType:"ServerError", Symbol:"ER_BINLOG_CREATE_ROUTINE_NEED_SUPER", SQLState:"HY000", Message:"You do not have the SUPER privilege and binary logging isenabled (you *might* want to use the less safelog_bin_trust_function_creators variable)", Description:"", MySQLVersion:"5.7"},
    1420: {ErrorNumber:1420, ErrorType:"ServerError", Symbol:"ER_EXEC_STMT_WITH_OPEN_CURSOR", SQLState:"HY000", Message:"You can't execute a prepared statement which has an opencursor associated with it. Reset the statement to re-execute it.", Description:"", MySQLVersion:"5.7"},
    1421: {ErrorNumber:1421, ErrorType:"ServerError", Symbol:"ER_STMT_HAS_NO_OPEN_CURSOR", SQLState:"HY000", Message:"The statement (%lu) has no open cursor.", Description:"", MySQLVersion:"5.7"},
    1422: {ErrorNumber:1422, ErrorType:"ServerError", Symbol:"ER_COMMIT_NOT_ALLOWED_IN_SF_OR_TRG", SQLState:"HY000", Message:"Explicit or implicit commit is not allowed in storedfunction or trigger.", Description:"", MySQLVersion:"5.7"},
    1423: {ErrorNumber:1423, ErrorType:"ServerError", Symbol:"ER_NO_DEFAULT_FOR_VIEW_FIELD", SQLState:"HY000", Message:"Field of view '%s.%s' underlying table doesn't have adefault value", Description:"", MySQLVersion:"5.7"},
    1424: {ErrorNumber:1424, ErrorType:"ServerError", Symbol:"ER_SP_NO_RECURSION", SQLState:"HY000", Message:"Recursive stored functions and triggers are not allowed.", Description:"", MySQLVersion:"5.7"},
    1425: {ErrorNumber:1425, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_SCALE", SQLState:"42000", Message:"Too big scale %d specified for column '%s'. Maximum is%lu.", Description:"", MySQLVersion:"5.7"},
    1426: {ErrorNumber:1426, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_PRECISION", SQLState:"42000", Message:"Too-big precision %d specified for '%s'. Maximum is %lu.", Description:"", MySQLVersion:"5.7"},
    1427: {ErrorNumber:1427, ErrorType:"ServerError", Symbol:"ER_M_BIGGER_THAN_D", SQLState:"42000", Message:"For float(M,D), double(M,D) or decimal(M,D), M must be>= D (column '%s').", Description:"", MySQLVersion:"5.7"},
    1428: {ErrorNumber:1428, ErrorType:"ServerError", Symbol:"ER_WRONG_LOCK_OF_SYSTEM_TABLE", SQLState:"HY000", Message:"You can't combine write-locking of system tables withother tables or lock types", Description:"", MySQLVersion:"5.7"},
    1429: {ErrorNumber:1429, ErrorType:"ServerError", Symbol:"ER_CONNECT_TO_FOREIGN_DATA_SOURCE", SQLState:"HY000", Message:"Unable to connect to foreign data source: %s", Description:"", MySQLVersion:"5.7"},
    1430: {ErrorNumber:1430, ErrorType:"ServerError", Symbol:"ER_QUERY_ON_FOREIGN_DATA_SOURCE", SQLState:"HY000", Message:"There was a problem processing the query on the foreigndata source. Data source error: %s", Description:"", MySQLVersion:"5.7"},
    1431: {ErrorNumber:1431, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_SOURCE_DOESNT_EXIST", SQLState:"HY000", Message:"The foreign data source you are trying to reference doesnot exist. Data source error: %s", Description:"", MySQLVersion:"5.7"},
    1432: {ErrorNumber:1432, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE", SQLState:"HY000", Message:"Can't create federated table. The data source connectionstring '%s' is not in the correct format", Description:"", MySQLVersion:"5.7"},
    1433: {ErrorNumber:1433, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DATA_STRING_INVALID", SQLState:"HY000", Message:"The data source connection string '%s' is not in thecorrect format", Description:"", MySQLVersion:"5.7"},
    1434: {ErrorNumber:1434, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_FEDERATED_TABLE", SQLState:"HY000", Message:"Can't create federated table. Foreign data src error: %s", Description:"", MySQLVersion:"5.7"},
    1435: {ErrorNumber:1435, ErrorType:"ServerError", Symbol:"ER_TRG_IN_WRONG_SCHEMA", SQLState:"HY000", Message:"Trigger in wrong schema", Description:"", MySQLVersion:"5.7"},
    1436: {ErrorNumber:1436, ErrorType:"ServerError", Symbol:"ER_STACK_OVERRUN_NEED_MORE", SQLState:"HY000", Message:"Thread stack overrun: %ld bytes used of a %ld byte stack,and %ld bytes needed. Use 'mysqld --thread_stack=#' to specify abigger stack.", Description:"", MySQLVersion:"5.7"},
    1437: {ErrorNumber:1437, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_BODY", SQLState:"42000", Message:"Routine body for '%s' is too long", Description:"", MySQLVersion:"5.7"},
    1438: {ErrorNumber:1438, ErrorType:"ServerError", Symbol:"ER_WARN_CANT_DROP_DEFAULT_KEYCACHE", SQLState:"HY000", Message:"Cannot drop default keycache", Description:"", MySQLVersion:"5.7"},
    1439: {ErrorNumber:1439, ErrorType:"ServerError", Symbol:"ER_TOO_BIG_DISPLAYWIDTH", SQLState:"42000", Message:"Display width out of range for column '%s' (max = %lu)", Description:"", MySQLVersion:"5.7"},
    1440: {ErrorNumber:1440, ErrorType:"ServerError", Symbol:"ER_XAER_DUPID", SQLState:"XAE08", Message:"XAER_DUPID: The XID already exists", Description:"", MySQLVersion:"5.7"},
    1441: {ErrorNumber:1441, ErrorType:"ServerError", Symbol:"ER_DATETIME_FUNCTION_OVERFLOW", SQLState:"22008", Message:"Datetime function: %s field overflow", Description:"", MySQLVersion:"5.7"},
    1442: {ErrorNumber:1442, ErrorType:"ServerError", Symbol:"ER_CANT_UPDATE_USED_TABLE_IN_SF_OR_TRG", SQLState:"HY000", Message:"Can't update table '%s' in stored function/triggerbecause it is already used by statement which invoked this storedfunction/trigger.", Description:"", MySQLVersion:"5.7"},
    1443: {ErrorNumber:1443, ErrorType:"ServerError", Symbol:"ER_VIEW_PREVENT_UPDATE", SQLState:"HY000", Message:"The definition of table '%s' prevents operation %s ontable '%s'.", Description:"", MySQLVersion:"5.7"},
    1444: {ErrorNumber:1444, ErrorType:"ServerError", Symbol:"ER_PS_NO_RECURSION", SQLState:"HY000", Message:"The prepared statement contains a stored routine callthat refers to that same statement. It's not allowed to execute aprepared statement in such a recursive manner", Description:"", MySQLVersion:"5.7"},
    1445: {ErrorNumber:1445, ErrorType:"ServerError", Symbol:"ER_SP_CANT_SET_AUTOCOMMIT", SQLState:"HY000", Message:"Not allowed to set autocommit from a stored function ortrigger", Description:"", MySQLVersion:"5.7"},
    1446: {ErrorNumber:1446, ErrorType:"ServerError", Symbol:"ER_MALFORMED_DEFINER", SQLState:"HY000", Message:"Definer is not fully qualified", Description:"", MySQLVersion:"5.7"},
    1447: {ErrorNumber:1447, ErrorType:"ServerError", Symbol:"ER_VIEW_FRM_NO_USER", SQLState:"HY000", Message:"View '%s'.'%s' has no definer information (old tableformat). Current user is used as definer. Please recreate theview!", Description:"", MySQLVersion:"5.7"},
    1448: {ErrorNumber:1448, ErrorType:"ServerError", Symbol:"ER_VIEW_OTHER_USER", SQLState:"HY000", Message:"You need the SUPER privilege for creation view with'%s'@'%s' definer", Description:"", MySQLVersion:"5.7"},
    1449: {ErrorNumber:1449, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_USER", SQLState:"HY000", Message:"The user specified as a definer ('%s'@'%s') does notexist", Description:"", MySQLVersion:"5.7"},
    1450: {ErrorNumber:1450, ErrorType:"ServerError", Symbol:"ER_FORBID_SCHEMA_CHANGE", SQLState:"HY000", Message:"Changing schema from '%s' to '%s' is not allowed.", Description:"", MySQLVersion:"5.7"},
    1451: {ErrorNumber:1451, ErrorType:"ServerError", Symbol:"ER_ROW_IS_REFERENCED_2", SQLState:"23000", Message:"Cannot delete or update a parent row: a foreign keyconstraint fails (%s)", Description:"InnoDB reports this error when you try todelete a parent row that has children, and aforeign keyconstraint fails. Delete the children first.", MySQLVersion:"5.7"},
    1452: {ErrorNumber:1452, ErrorType:"ServerError", Symbol:"ER_NO_REFERENCED_ROW_2", SQLState:"23000", Message:"Cannot add or update a child row: a foreign keyconstraint fails (%s)", Description:"InnoDB reports this error when you try to add arow but there is no parent row, and aforeign keyconstraint fails. Add the parent row first.", MySQLVersion:"5.7"},
    1453: {ErrorNumber:1453, ErrorType:"ServerError", Symbol:"ER_SP_BAD_VAR_SHADOW", SQLState:"42000", Message:"Variable '%s' must be quoted with `...`, or renamed", Description:"", MySQLVersion:"5.7"},
    1454: {ErrorNumber:1454, ErrorType:"ServerError", Symbol:"ER_TRG_NO_DEFINER", SQLState:"HY000", Message:"No definer attribute for trigger '%s'.'%s'. The triggerwill be activated under the authorization of the invoker, whichmay have insufficient privileges. Please recreate the trigger.", Description:"", MySQLVersion:"5.7"},
    1455: {ErrorNumber:1455, ErrorType:"ServerError", Symbol:"ER_OLD_FILE_FORMAT", SQLState:"HY000", Message:"'%s' has an old format, you should re-create the '%s'object(s)", Description:"", MySQLVersion:"5.7"},
    1456: {ErrorNumber:1456, ErrorType:"ServerError", Symbol:"ER_SP_RECURSION_LIMIT", SQLState:"HY000", Message:"Recursive limit %d (as set by the max_sp_recursion_depthvariable) was exceeded for routine %s", Description:"", MySQLVersion:"5.7"},
    1457: {ErrorNumber:1457, ErrorType:"ServerError", Symbol:"ER_SP_PROC_TABLE_CORRUPT", SQLState:"HY000", Message:"Failed to load routine %s. The table mysql.proc ismissing, corrupt, or contains bad data (internal code %d)", Description:"", MySQLVersion:"5.7"},
    1458: {ErrorNumber:1458, ErrorType:"ServerError", Symbol:"ER_SP_WRONG_NAME", SQLState:"42000", Message:"Incorrect routine name '%s'", Description:"", MySQLVersion:"5.7"},
    1459: {ErrorNumber:1459, ErrorType:"ServerError", Symbol:"ER_TABLE_NEEDS_UPGRADE", SQLState:"HY000", Message:"Table upgrade required. Please do \"REPAIR TABLE `%s`\" ordump/reload to fix it!", Description:"", MySQLVersion:"5.7"},
    1460: {ErrorNumber:1460, ErrorType:"ServerError", Symbol:"ER_SP_NO_AGGREGATE", SQLState:"42000", Message:"AGGREGATE is not supported for stored functions", Description:"", MySQLVersion:"5.7"},
    1461: {ErrorNumber:1461, ErrorType:"ServerError", Symbol:"ER_MAX_PREPARED_STMT_COUNT_REACHED", SQLState:"42000", Message:"Can't create more than max_prepared_stmt_count statements(current value: %lu)", Description:"", MySQLVersion:"5.7"},
    1462: {ErrorNumber:1462, ErrorType:"ServerError", Symbol:"ER_VIEW_RECURSIVE", SQLState:"HY000", Message:"`%s`.`%s` contains view recursion", Description:"", MySQLVersion:"5.7"},
    1463: {ErrorNumber:1463, ErrorType:"ServerError", Symbol:"ER_NON_GROUPING_FIELD_USED", SQLState:"42000", Message:"Non-grouping field '%s' is used in %s clause", Description:"", MySQLVersion:"5.7"},
    1464: {ErrorNumber:1464, ErrorType:"ServerError", Symbol:"ER_TABLE_CANT_HANDLE_SPKEYS", SQLState:"HY000", Message:"The used table type doesn't support SPATIAL indexes", Description:"", MySQLVersion:"5.7"},
    1465: {ErrorNumber:1465, ErrorType:"ServerError", Symbol:"ER_NO_TRIGGERS_ON_SYSTEM_SCHEMA", SQLState:"HY000", Message:"Triggers can not be created on system tables", Description:"", MySQLVersion:"5.7"},
    1466: {ErrorNumber:1466, ErrorType:"ServerError", Symbol:"ER_REMOVED_SPACES", SQLState:"HY000", Message:"Leading spaces are removed from name '%s'", Description:"", MySQLVersion:"5.7"},
    1467: {ErrorNumber:1467, ErrorType:"ServerError", Symbol:"ER_AUTOINC_READ_FAILED", SQLState:"HY000", Message:"Failed to read auto-increment value from storage engine", Description:"", MySQLVersion:"5.7"},
    1468: {ErrorNumber:1468, ErrorType:"ServerError", Symbol:"ER_USERNAME", SQLState:"HY000", Message:"user name", Description:"", MySQLVersion:"5.7"},
    1469: {ErrorNumber:1469, ErrorType:"ServerError", Symbol:"ER_HOSTNAME", SQLState:"HY000", Message:"host name", Description:"", MySQLVersion:"5.7"},
    1470: {ErrorNumber:1470, ErrorType:"ServerError", Symbol:"ER_WRONG_STRING_LENGTH", SQLState:"HY000", Message:"String '%s' is too long for %s (should be no longer than%d)", Description:"", MySQLVersion:"5.7"},
    1471: {ErrorNumber:1471, ErrorType:"ServerError", Symbol:"ER_NON_INSERTABLE_TABLE", SQLState:"HY000", Message:"The target table %s of the %s is not insertable-into", Description:"", MySQLVersion:"5.7"},
    1472: {ErrorNumber:1472, ErrorType:"ServerError", Symbol:"ER_ADMIN_WRONG_MRG_TABLE", SQLState:"HY000", Message:"Table '%s' is differently defined or of non-MyISAM typeor doesn't exist", Description:"", MySQLVersion:"5.7"},
    1473: {ErrorNumber:1473, ErrorType:"ServerError", Symbol:"ER_TOO_HIGH_LEVEL_OF_NESTING_FOR_SELECT", SQLState:"HY000", Message:"Too high level of nesting for select", Description:"", MySQLVersion:"5.7"},
    1474: {ErrorNumber:1474, ErrorType:"ServerError", Symbol:"ER_NAME_BECOMES_EMPTY", SQLState:"HY000", Message:"Name '%s' has become ''", Description:"", MySQLVersion:"5.7"},
    1475: {ErrorNumber:1475, ErrorType:"ServerError", Symbol:"ER_AMBIGUOUS_FIELD_TERM", SQLState:"HY000", Message:"First character of the FIELDS TERMINATED string isambiguous", Description:"please use non-optional and non-empty FIELDS ENCLOSEDBY", MySQLVersion:"5.7"},
    1476: {ErrorNumber:1476, ErrorType:"ServerError", Symbol:"ER_FOREIGN_SERVER_EXISTS", SQLState:"HY000", Message:"The foreign server, %s, you are trying to create alreadyexists.", Description:"", MySQLVersion:"5.7"},
    1477: {ErrorNumber:1477, ErrorType:"ServerError", Symbol:"ER_FOREIGN_SERVER_DOESNT_EXIST", SQLState:"HY000", Message:"The foreign server name you are trying to reference doesnot exist. Data source error: %s", Description:"", MySQLVersion:"5.7"},
    1478: {ErrorNumber:1478, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_HA_CREATE_OPTION", SQLState:"HY000", Message:"Table storage engine '%s' does not support the createoption '%s'", Description:"", MySQLVersion:"5.7"},
    1479: {ErrorNumber:1479, ErrorType:"ServerError", Symbol:"ER_PARTITION_REQUIRES_VALUES_ERROR", SQLState:"HY000", Message:"Syntax error: %s PARTITIONING requires definition ofVALUES %s for each partition", Description:"", MySQLVersion:"5.7"},
    1480: {ErrorNumber:1480, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_VALUES_ERROR", SQLState:"HY000", Message:"Only %s PARTITIONING can use VALUES %s in partitiondefinition", Description:"", MySQLVersion:"5.7"},
    1481: {ErrorNumber:1481, ErrorType:"ServerError", Symbol:"ER_PARTITION_MAXVALUE_ERROR", SQLState:"HY000", Message:"MAXVALUE can only be used in last partition definition", Description:"", MySQLVersion:"5.7"},
    1482: {ErrorNumber:1482, ErrorType:"ServerError", Symbol:"ER_PARTITION_SUBPARTITION_ERROR", SQLState:"HY000", Message:"Subpartitions can only be hash partitions and by key", Description:"", MySQLVersion:"5.7"},
    1483: {ErrorNumber:1483, ErrorType:"ServerError", Symbol:"ER_PARTITION_SUBPART_MIX_ERROR", SQLState:"HY000", Message:"Must define subpartitions on all partitions if on onepartition", Description:"", MySQLVersion:"5.7"},
    1484: {ErrorNumber:1484, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_NO_PART_ERROR", SQLState:"HY000", Message:"Wrong number of partitions defined, mismatch withprevious setting", Description:"", MySQLVersion:"5.7"},
    1485: {ErrorNumber:1485, ErrorType:"ServerError", Symbol:"ER_PARTITION_WRONG_NO_SUBPART_ERROR", SQLState:"HY000", Message:"Wrong number of subpartitions defined, mismatch withprevious setting", Description:"", MySQLVersion:"5.7"},
    1486: {ErrorNumber:1486, ErrorType:"ServerError", Symbol:"ER_WRONG_EXPR_IN_PARTITION_FUNC_ERROR", SQLState:"HY000", Message:"Constant, random or timezone-dependent expressions in(sub)partitioning function are not allowed", Description:"", MySQLVersion:"5.7"},
    1487: {ErrorNumber:1487, ErrorType:"ServerError", Symbol:"ER_NO_CONST_EXPR_IN_RANGE_OR_LIST_ERROR", SQLState:"HY000", Message:"Expression in RANGE/LIST VALUES must be constant", Description:"", MySQLVersion:"5.7"},
    1488: {ErrorNumber:1488, ErrorType:"ServerError", Symbol:"ER_FIELD_NOT_FOUND_PART_ERROR", SQLState:"HY000", Message:"Field in list of fields for partition function not foundin table", Description:"", MySQLVersion:"5.7"},
    1489: {ErrorNumber:1489, ErrorType:"ServerError", Symbol:"ER_LIST_OF_FIELDS_ONLY_IN_HASH_ERROR", SQLState:"HY000", Message:"List of fields is only allowed in KEY partitions", Description:"", MySQLVersion:"5.7"},
    1490: {ErrorNumber:1490, ErrorType:"ServerError", Symbol:"ER_INCONSISTENT_PARTITION_INFO_ERROR", SQLState:"HY000", Message:"The partition info in the frm file is not consistent withwhat can be written into the frm file", Description:"", MySQLVersion:"5.7"},
    1491: {ErrorNumber:1491, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNC_NOT_ALLOWED_ERROR", SQLState:"HY000", Message:"The %s function returns the wrong type", Description:"", MySQLVersion:"5.7"},
    1492: {ErrorNumber:1492, ErrorType:"ServerError", Symbol:"ER_PARTITIONS_MUST_BE_DEFINED_ERROR", SQLState:"HY000", Message:"For %s partitions each partition must be defined", Description:"", MySQLVersion:"5.7"},
    1493: {ErrorNumber:1493, ErrorType:"ServerError", Symbol:"ER_RANGE_NOT_INCREASING_ERROR", SQLState:"HY000", Message:"VALUES LESS THAN value must be strictly increasing foreach partition", Description:"", MySQLVersion:"5.7"},
    1494: {ErrorNumber:1494, ErrorType:"ServerError", Symbol:"ER_INCONSISTENT_TYPE_OF_FUNCTIONS_ERROR", SQLState:"HY000", Message:"VALUES value must be of same type as partition function", Description:"", MySQLVersion:"5.7"},
    1495: {ErrorNumber:1495, ErrorType:"ServerError", Symbol:"ER_MULTIPLE_DEF_CONST_IN_LIST_PART_ERROR", SQLState:"HY000", Message:"Multiple definition of same constant in list partitioning", Description:"", MySQLVersion:"5.7"},
    1496: {ErrorNumber:1496, ErrorType:"ServerError", Symbol:"ER_PARTITION_ENTRY_ERROR", SQLState:"HY000", Message:"Partitioning can not be used stand-alone in query", Description:"", MySQLVersion:"5.7"},
    1497: {ErrorNumber:1497, ErrorType:"ServerError", Symbol:"ER_MIX_HANDLER_ERROR", SQLState:"HY000", Message:"The mix of handlers in the partitions is not allowed inthis version of MySQL", Description:"", MySQLVersion:"5.7"},
    1498: {ErrorNumber:1498, ErrorType:"ServerError", Symbol:"ER_PARTITION_NOT_DEFINED_ERROR", SQLState:"HY000", Message:"For the partitioned engine it is necessary to define all%s", Description:"", MySQLVersion:"5.7"},
    1499: {ErrorNumber:1499, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_PARTITIONS_ERROR", SQLState:"HY000", Message:"Too many partitions (including subpartitions) weredefined", Description:"", MySQLVersion:"5.7"},
    1500: {ErrorNumber:1500, ErrorType:"ServerError", Symbol:"ER_SUBPARTITION_ERROR", SQLState:"HY000", Message:"It is only possible to mix RANGE/LIST partitioning withHASH/KEY partitioning for subpartitioning", Description:"", MySQLVersion:"5.7"},
    1501: {ErrorNumber:1501, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_HANDLER_FILE", SQLState:"HY000", Message:"Failed to create specific handler file", Description:"", MySQLVersion:"5.7"},
    1502: {ErrorNumber:1502, ErrorType:"ServerError", Symbol:"ER_BLOB_FIELD_IN_PART_FUNC_ERROR", SQLState:"HY000", Message:"A BLOB field is not allowed in partition function", Description:"", MySQLVersion:"5.7"},
    1503: {ErrorNumber:1503, ErrorType:"ServerError", Symbol:"ER_UNIQUE_KEY_NEED_ALL_FIELDS_IN_PF", SQLState:"HY000", Message:"A %s must include all columns in the table's partitioningfunction", Description:"", MySQLVersion:"5.7"},
    1504: {ErrorNumber:1504, ErrorType:"ServerError", Symbol:"ER_NO_PARTS_ERROR", SQLState:"HY000", Message:"Number of %s = 0 is not an allowed value", Description:"", MySQLVersion:"5.7"},
    1505: {ErrorNumber:1505, ErrorType:"ServerError", Symbol:"ER_PARTITION_MGMT_ON_NONPARTITIONED", SQLState:"HY000", Message:"Partition management on a not partitioned table is notpossible", Description:"", MySQLVersion:"5.7"},
    1506: {ErrorNumber:1506, ErrorType:"ServerError", Symbol:"ER_FOREIGN_KEY_ON_PARTITIONED", SQLState:"HY000", Message:"Foreign keys are not yet supported in conjunction withpartitioning", Description:"", MySQLVersion:"5.7"},
    1507: {ErrorNumber:1507, ErrorType:"ServerError", Symbol:"ER_DROP_PARTITION_NON_EXISTENT", SQLState:"HY000", Message:"Error in list of partitions to %s", Description:"", MySQLVersion:"5.7"},
    1508: {ErrorNumber:1508, ErrorType:"ServerError", Symbol:"ER_DROP_LAST_PARTITION", SQLState:"HY000", Message:"Cannot remove all partitions, use DROP TABLE instead", Description:"", MySQLVersion:"5.7"},
    1509: {ErrorNumber:1509, ErrorType:"ServerError", Symbol:"ER_COALESCE_ONLY_ON_HASH_PARTITION", SQLState:"HY000", Message:"COALESCE PARTITION can only be used on HASH/KEYpartitions", Description:"", MySQLVersion:"5.7"},
    1510: {ErrorNumber:1510, ErrorType:"ServerError", Symbol:"ER_REORG_HASH_ONLY_ON_SAME_NO", SQLState:"HY000", Message:"REORGANIZE PARTITION can only be used to reorganizepartitions not to change their numbers", Description:"", MySQLVersion:"5.7"},
    1511: {ErrorNumber:1511, ErrorType:"ServerError", Symbol:"ER_REORG_NO_PARAM_ERROR", SQLState:"HY000", Message:"REORGANIZE PARTITION without parameters can only be usedon auto-partitioned tables using HASH PARTITIONs", Description:"", MySQLVersion:"5.7"},
    1512: {ErrorNumber:1512, ErrorType:"ServerError", Symbol:"ER_ONLY_ON_RANGE_LIST_PARTITION", SQLState:"HY000", Message:"%s PARTITION can only be used on RANGE/LIST partitions", Description:"", MySQLVersion:"5.7"},
    1513: {ErrorNumber:1513, ErrorType:"ServerError", Symbol:"ER_ADD_PARTITION_SUBPART_ERROR", SQLState:"HY000", Message:"Trying to Add partition(s) with wrong number ofsubpartitions", Description:"", MySQLVersion:"5.7"},
    1514: {ErrorNumber:1514, ErrorType:"ServerError", Symbol:"ER_ADD_PARTITION_NO_NEW_PARTITION", SQLState:"HY000", Message:"At least one partition must be added", Description:"", MySQLVersion:"5.7"},
    1515: {ErrorNumber:1515, ErrorType:"ServerError", Symbol:"ER_COALESCE_PARTITION_NO_PARTITION", SQLState:"HY000", Message:"At least one partition must be coalesced", Description:"", MySQLVersion:"5.7"},
    1516: {ErrorNumber:1516, ErrorType:"ServerError", Symbol:"ER_REORG_PARTITION_NOT_EXIST", SQLState:"HY000", Message:"More partitions to reorganize than there are partitions", Description:"", MySQLVersion:"5.7"},
    1517: {ErrorNumber:1517, ErrorType:"ServerError", Symbol:"ER_SAME_NAME_PARTITION", SQLState:"HY000", Message:"Duplicate partition name %s", Description:"", MySQLVersion:"5.7"},
    1518: {ErrorNumber:1518, ErrorType:"ServerError", Symbol:"ER_NO_BINLOG_ERROR", SQLState:"HY000", Message:"It is not allowed to shut off binlog on this command", Description:"", MySQLVersion:"5.7"},
    1519: {ErrorNumber:1519, ErrorType:"ServerError", Symbol:"ER_CONSECUTIVE_REORG_PARTITIONS", SQLState:"HY000", Message:"When reorganizing a set of partitions they must be inconsecutive order", Description:"", MySQLVersion:"5.7"},
    1520: {ErrorNumber:1520, ErrorType:"ServerError", Symbol:"ER_REORG_OUTSIDE_RANGE", SQLState:"HY000", Message:"Reorganize of range partitions cannot change total rangesexcept for last partition where it can extend the range", Description:"", MySQLVersion:"5.7"},
    1521: {ErrorNumber:1521, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNCTION_FAILURE", SQLState:"HY000", Message:"Partition function not supported in this version for thishandler", Description:"", MySQLVersion:"5.7"},
    1522: {ErrorNumber:1522, ErrorType:"ServerError", Symbol:"ER_PART_STATE_ERROR", SQLState:"HY000", Message:"Partition state cannot be defined from CREATE/ALTER TABLE", Description:"", MySQLVersion:"5.7"},
    1523: {ErrorNumber:1523, ErrorType:"ServerError", Symbol:"ER_LIMITED_PART_RANGE", SQLState:"HY000", Message:"The %s handler only supports 32 bit integers in VALUES", Description:"", MySQLVersion:"5.7"},
    1524: {ErrorNumber:1524, ErrorType:"ServerError", Symbol:"ER_PLUGIN_IS_NOT_LOADED", SQLState:"HY000", Message:"Plugin '%s' is not loaded", Description:"", MySQLVersion:"5.7"},
    1525: {ErrorNumber:1525, ErrorType:"ServerError", Symbol:"ER_WRONG_VALUE", SQLState:"HY000", Message:"Incorrect %s value: '%s'", Description:"", MySQLVersion:"5.7"},
    1526: {ErrorNumber:1526, ErrorType:"ServerError", Symbol:"ER_NO_PARTITION_FOR_GIVEN_VALUE", SQLState:"HY000", Message:"Table has no partition for value %s", Description:"", MySQLVersion:"5.7"},
    1527: {ErrorNumber:1527, ErrorType:"ServerError", Symbol:"ER_FILEGROUP_OPTION_ONLY_ONCE", SQLState:"HY000", Message:"It is not allowed to specify %s more than once", Description:"", MySQLVersion:"5.7"},
    1528: {ErrorNumber:1528, ErrorType:"ServerError", Symbol:"ER_CREATE_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to create %s", Description:"", MySQLVersion:"5.7"},
    1529: {ErrorNumber:1529, ErrorType:"ServerError", Symbol:"ER_DROP_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to drop %s", Description:"", MySQLVersion:"5.7"},
    1530: {ErrorNumber:1530, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_AUTO_EXTEND_ERROR", SQLState:"HY000", Message:"The handler doesn't support autoextend of tablespaces", Description:"", MySQLVersion:"5.7"},
    1531: {ErrorNumber:1531, ErrorType:"ServerError", Symbol:"ER_WRONG_SIZE_NUMBER", SQLState:"HY000", Message:"A size parameter was incorrectly specified, either numberor on the form 10M", Description:"", MySQLVersion:"5.7"},
    1532: {ErrorNumber:1532, ErrorType:"ServerError", Symbol:"ER_SIZE_OVERFLOW_ERROR", SQLState:"HY000", Message:"The size number was correct but we don't allow the digitpart to be more than 2 billion", Description:"", MySQLVersion:"5.7"},
    1533: {ErrorNumber:1533, ErrorType:"ServerError", Symbol:"ER_ALTER_FILEGROUP_FAILED", SQLState:"HY000", Message:"Failed to alter: %s", Description:"", MySQLVersion:"5.7"},
    1534: {ErrorNumber:1534, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_LOGGING_FAILED", SQLState:"HY000", Message:"Writing one row to the row-based binary log failed", Description:"", MySQLVersion:"5.7"},
    1535: {ErrorNumber:1535, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_WRONG_TABLE_DEF", SQLState:"HY000", Message:"Table definition on master and slave does not match: %s", Description:"", MySQLVersion:"5.7"},
    1536: {ErrorNumber:1536, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_RBR_TO_SBR", SQLState:"HY000", Message:"Slave running with --log-slave-updates must use row-basedbinary logging to be able to replicate row-based binary log events", Description:"", MySQLVersion:"5.7"},
    1537: {ErrorNumber:1537, ErrorType:"ServerError", Symbol:"ER_EVENT_ALREADY_EXISTS", SQLState:"HY000", Message:"Event '%s' already exists", Description:"", MySQLVersion:"5.7"},
    1538: {ErrorNumber:1538, ErrorType:"ServerError", Symbol:"ER_EVENT_STORE_FAILED", SQLState:"HY000", Message:"Failed to store event %s. Error code %d from storageengine.", Description:"", MySQLVersion:"5.7"},
    1539: {ErrorNumber:1539, ErrorType:"ServerError", Symbol:"ER_EVENT_DOES_NOT_EXIST", SQLState:"HY000", Message:"Unknown event '%s'", Description:"", MySQLVersion:"5.7"},
    1540: {ErrorNumber:1540, ErrorType:"ServerError", Symbol:"ER_EVENT_CANT_ALTER", SQLState:"HY000", Message:"Failed to alter event '%s'", Description:"", MySQLVersion:"5.7"},
    1541: {ErrorNumber:1541, ErrorType:"ServerError", Symbol:"ER_EVENT_DROP_FAILED", SQLState:"HY000", Message:"Failed to drop %s", Description:"", MySQLVersion:"5.7"},
    1542: {ErrorNumber:1542, ErrorType:"ServerError", Symbol:"ER_EVENT_INTERVAL_NOT_POSITIVE_OR_TOO_BIG", SQLState:"HY000", Message:"INTERVAL is either not positive or too big", Description:"", MySQLVersion:"5.7"},
    1543: {ErrorNumber:1543, ErrorType:"ServerError", Symbol:"ER_EVENT_ENDS_BEFORE_STARTS", SQLState:"HY000", Message:"ENDS is either invalid or before STARTS", Description:"", MySQLVersion:"5.7"},
    1544: {ErrorNumber:1544, ErrorType:"ServerError", Symbol:"ER_EVENT_EXEC_TIME_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past. Event has beendisabled", Description:"", MySQLVersion:"5.7"},
    1545: {ErrorNumber:1545, ErrorType:"ServerError", Symbol:"ER_EVENT_OPEN_TABLE_FAILED", SQLState:"HY000", Message:"Failed to open mysql.event", Description:"", MySQLVersion:"5.7"},
    1546: {ErrorNumber:1546, ErrorType:"ServerError", Symbol:"ER_EVENT_NEITHER_M_EXPR_NOR_M_AT", SQLState:"HY000", Message:"No datetime expression provided", Description:"", MySQLVersion:"5.7"},
    1547: {ErrorNumber:1547, ErrorType:"ServerError", Symbol:"ER_OBSOLETE_COL_COUNT_DOESNT_MATCH_CORRUPTED", SQLState:"HY000", Message:"Column count of mysql.%s is wrong. Expected %d, found %d.The table is probably corrupted", Description:"", MySQLVersion:"5.7"},
    1548: {ErrorNumber:1548, ErrorType:"ServerError", Symbol:"ER_OBSOLETE_CANNOT_LOAD_FROM_TABLE", SQLState:"HY000", Message:"Cannot load from mysql.%s. The table is probablycorrupted", Description:"", MySQLVersion:"5.7"},
    1549: {ErrorNumber:1549, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_DELETE", SQLState:"HY000", Message:"Failed to delete the event from mysql.event", Description:"", MySQLVersion:"5.7"},
    1550: {ErrorNumber:1550, ErrorType:"ServerError", Symbol:"ER_EVENT_COMPILE_ERROR", SQLState:"HY000", Message:"Error during compilation of event's body", Description:"", MySQLVersion:"5.7"},
    1551: {ErrorNumber:1551, ErrorType:"ServerError", Symbol:"ER_EVENT_SAME_NAME", SQLState:"HY000", Message:"Same old and new event name", Description:"", MySQLVersion:"5.7"},
    1552: {ErrorNumber:1552, ErrorType:"ServerError", Symbol:"ER_EVENT_DATA_TOO_LONG", SQLState:"HY000", Message:"Data for column '%s' too long", Description:"", MySQLVersion:"5.7"},
    1553: {ErrorNumber:1553, ErrorType:"ServerError", Symbol:"ER_DROP_INDEX_FK", SQLState:"HY000", Message:"Cannot drop index '%s': needed in a foreign keyconstraint", Description:"When you drop an index, InnoDB checks if theindex is used for checking a foreign key constraint. It is stillOK to drop the index if there is another index that can be used toenforce the same constraint. InnoDB preventsyou from dropping the last index that can enforce a particularreferential constraint.", MySQLVersion:"5.7"},
    1554: {ErrorNumber:1554, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYNTAX_WITH_VER", SQLState:"HY000", Message:"The syntax '%s' is deprecated and will be removed inMySQL %s. Please use %s instead", Description:"", MySQLVersion:"5.7"},
    1555: {ErrorNumber:1555, ErrorType:"ServerError", Symbol:"ER_CANT_WRITE_LOCK_LOG_TABLE", SQLState:"HY000", Message:"You can't write-lock a log table. Only read access ispossible", Description:"", MySQLVersion:"5.7"},
    1556: {ErrorNumber:1556, ErrorType:"ServerError", Symbol:"ER_CANT_LOCK_LOG_TABLE", SQLState:"HY000", Message:"You can't use locks with log tables.", Description:"", MySQLVersion:"5.7"},
    1557: {ErrorNumber:1557, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DUPLICATE_KEY_OLD_UNUSED", SQLState:"23000", Message:"Upholding foreign key constraints for table '%s', entry'%s', key %d would lead to a duplicate entry", Description:"", MySQLVersion:"5.7"},
    1558: {ErrorNumber:1558, ErrorType:"ServerError", Symbol:"ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE", SQLState:"HY000", Message:"Column count of mysql.%s is wrong. Expected %d, found %d.Created with MySQL %d, now running %d. Please use mysql_upgrade tofix this error.", Description:"", MySQLVersion:"5.7"},
    1559: {ErrorNumber:1559, ErrorType:"ServerError", Symbol:"ER_TEMP_TABLE_PREVENTS_SWITCH_OUT_OF_RBR", SQLState:"HY000", Message:"Cannot switch out of the row-based binary log format whenthe session has open temporary tables", Description:"", MySQLVersion:"5.7"},
    1560: {ErrorNumber:1560, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"Cannot change the binary logging format inside a storedfunction or trigger", Description:"", MySQLVersion:"5.7"},
    1561: {ErrorNumber:1561, ErrorType:"ServerError", Symbol:"ER_NDB_CANT_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"The NDB cluster engine does not support changing thebinlog format on the fly yet", Description:"", MySQLVersion:"5.7"},
    1562: {ErrorNumber:1562, ErrorType:"ServerError", Symbol:"ER_PARTITION_NO_TEMPORARY", SQLState:"HY000", Message:"Cannot create temporary table with partitions", Description:"", MySQLVersion:"5.7"},
    1563: {ErrorNumber:1563, ErrorType:"ServerError", Symbol:"ER_PARTITION_CONST_DOMAIN_ERROR", SQLState:"HY000", Message:"Partition constant is out of partition function domain", Description:"", MySQLVersion:"5.7"},
    1564: {ErrorNumber:1564, ErrorType:"ServerError", Symbol:"ER_PARTITION_FUNCTION_IS_NOT_ALLOWED", SQLState:"HY000", Message:"This partition function is not allowed", Description:"", MySQLVersion:"5.7"},
    1565: {ErrorNumber:1565, ErrorType:"ServerError", Symbol:"ER_DDL_LOG_ERROR", SQLState:"HY000", Message:"Error in DDL log", Description:"", MySQLVersion:"5.7"},
    1566: {ErrorNumber:1566, ErrorType:"ServerError", Symbol:"ER_NULL_IN_VALUES_LESS_THAN", SQLState:"HY000", Message:"Not allowed to use NULL value in VALUES LESS THAN", Description:"", MySQLVersion:"5.7"},
    1567: {ErrorNumber:1567, ErrorType:"ServerError", Symbol:"ER_WRONG_PARTITION_NAME", SQLState:"HY000", Message:"Incorrect partition name", Description:"", MySQLVersion:"5.7"},
    1568: {ErrorNumber:1568, ErrorType:"ServerError", Symbol:"ER_CANT_CHANGE_TX_CHARACTERISTICS", SQLState:"25001", Message:"Transaction characteristics can't be changed while atransaction is in progress", Description:"", MySQLVersion:"5.7"},
    1569: {ErrorNumber:1569, ErrorType:"ServerError", Symbol:"ER_DUP_ENTRY_AUTOINCREMENT_CASE", SQLState:"HY000", Message:"ALTER TABLE causes auto_increment resequencing, resultingin duplicate entry '%s' for key '%s'", Description:"", MySQLVersion:"5.7"},
    1570: {ErrorNumber:1570, ErrorType:"ServerError", Symbol:"ER_EVENT_MODIFY_QUEUE_ERROR", SQLState:"HY000", Message:"Internal scheduler error %d", Description:"", MySQLVersion:"5.7"},
    1571: {ErrorNumber:1571, ErrorType:"ServerError", Symbol:"ER_EVENT_SET_VAR_ERROR", SQLState:"HY000", Message:"Error during starting/stopping of the scheduler. Errorcode %u", Description:"", MySQLVersion:"5.7"},
    1572: {ErrorNumber:1572, ErrorType:"ServerError", Symbol:"ER_PARTITION_MERGE_ERROR", SQLState:"HY000", Message:"Engine cannot be used in partitioned tables", Description:"", MySQLVersion:"5.7"},
    1573: {ErrorNumber:1573, ErrorType:"ServerError", Symbol:"ER_CANT_ACTIVATE_LOG", SQLState:"HY000", Message:"Cannot activate '%s' log", Description:"", MySQLVersion:"5.7"},
    1574: {ErrorNumber:1574, ErrorType:"ServerError", Symbol:"ER_RBR_NOT_AVAILABLE", SQLState:"HY000", Message:"The server was not built with row-based replication", Description:"", MySQLVersion:"5.7"},
    1575: {ErrorNumber:1575, ErrorType:"ServerError", Symbol:"ER_BASE64_DECODE_ERROR", SQLState:"HY000", Message:"Decoding of base64 string failed", Description:"", MySQLVersion:"5.7"},
    1576: {ErrorNumber:1576, ErrorType:"ServerError", Symbol:"ER_EVENT_RECURSION_FORBIDDEN", SQLState:"HY000", Message:"Recursion of EVENT DDL statements is forbidden when bodyis present", Description:"", MySQLVersion:"5.7"},
    1577: {ErrorNumber:1577, ErrorType:"ServerError", Symbol:"ER_EVENTS_DB_ERROR", SQLState:"HY000", Message:"Cannot proceed because system tables used by EventScheduler were found damaged at server start", Description:"To address this issue, try runningmysql_upgrade.", MySQLVersion:"5.7"},
    1578: {ErrorNumber:1578, ErrorType:"ServerError", Symbol:"ER_ONLY_INTEGERS_ALLOWED", SQLState:"HY000", Message:"Only integers allowed as number here", Description:"", MySQLVersion:"5.7"},
    1579: {ErrorNumber:1579, ErrorType:"ServerError", Symbol:"ER_UNSUPORTED_LOG_ENGINE", SQLState:"HY000", Message:"This storage engine cannot be used for log tables\"", Description:"", MySQLVersion:"5.7"},
    1580: {ErrorNumber:1580, ErrorType:"ServerError", Symbol:"ER_BAD_LOG_STATEMENT", SQLState:"HY000", Message:"You cannot '%s' a log table if logging is enabled", Description:"", MySQLVersion:"5.7"},
    1581: {ErrorNumber:1581, ErrorType:"ServerError", Symbol:"ER_CANT_RENAME_LOG_TABLE", SQLState:"HY000", Message:"Cannot rename '%s'. When logging enabled, rename to/fromlog table must rename two tables: the log table to an archivetable and another table back to '%s'", Description:"", MySQLVersion:"5.7"},
    1582: {ErrorNumber:1582, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT", SQLState:"42000", Message:"Incorrect parameter count in the call to native function'%s'", Description:"", MySQLVersion:"5.7"},
    1583: {ErrorNumber:1583, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_NATIVE_FCT", SQLState:"42000", Message:"Incorrect parameters in the call to native function '%s'", Description:"", MySQLVersion:"5.7"},
    1584: {ErrorNumber:1584, ErrorType:"ServerError", Symbol:"ER_WRONG_PARAMETERS_TO_STORED_FCT", SQLState:"42000", Message:"Incorrect parameters in the call to stored function %s", Description:"", MySQLVersion:"5.7"},
    1585: {ErrorNumber:1585, ErrorType:"ServerError", Symbol:"ER_NATIVE_FCT_NAME_COLLISION", SQLState:"HY000", Message:"This function '%s' has the same name as a native function", Description:"", MySQLVersion:"5.7"},
    1586: {ErrorNumber:1586, ErrorType:"ServerError", Symbol:"ER_DUP_ENTRY_WITH_KEY_NAME", SQLState:"23000", Message:"Duplicate entry '%s' for key '%s'", Description:"The format string for this error is also used withER_DUP_ENTRY.", MySQLVersion:"5.7"},
    1587: {ErrorNumber:1587, ErrorType:"ServerError", Symbol:"ER_BINLOG_PURGE_EMFILE", SQLState:"HY000", Message:"Too many files opened, please execute the command again", Description:"", MySQLVersion:"5.7"},
    1588: {ErrorNumber:1588, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_CREATE_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past and ON COMPLETION NOTPRESERVE is set. The event was dropped immediately after creation.", Description:"", MySQLVersion:"5.7"},
    1589: {ErrorNumber:1589, ErrorType:"ServerError", Symbol:"ER_EVENT_CANNOT_ALTER_IN_THE_PAST", SQLState:"HY000", Message:"Event execution time is in the past and ON COMPLETION NOTPRESERVE is set. The event was not changed. Specify a time in thefuture.", Description:"", MySQLVersion:"5.7"},
    1590: {ErrorNumber:1590, ErrorType:"ServerError", Symbol:"ER_SLAVE_INCIDENT", SQLState:"HY000", Message:"The incident %s occured on the master.Message: %s", Description:"", MySQLVersion:"5.7"},
    1591: {ErrorNumber:1591, ErrorType:"ServerError", Symbol:"ER_NO_PARTITION_FOR_GIVEN_VALUE_SILENT", SQLState:"HY000", Message:"Table has no partition for some existing values", Description:"", MySQLVersion:"5.7"},
    1592: {ErrorNumber:1592, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_STATEMENT", SQLState:"HY000", Message:"Unsafe statement written to the binary log usingstatement format since BINLOG_FORMAT = STATEMENT. %s", Description:"", MySQLVersion:"5.7"},
    1593: {ErrorNumber:1593, ErrorType:"ServerError", Symbol:"ER_SLAVE_FATAL_ERROR", SQLState:"HY000", Message:"Fatal error: %s", Description:"", MySQLVersion:"5.7"},
    1594: {ErrorNumber:1594, ErrorType:"ServerError", Symbol:"ER_SLAVE_RELAY_LOG_READ_FAILURE", SQLState:"HY000", Message:"Relay log read failure: %s", Description:"", MySQLVersion:"5.7"},
    1595: {ErrorNumber:1595, ErrorType:"ServerError", Symbol:"ER_SLAVE_RELAY_LOG_WRITE_FAILURE", SQLState:"HY000", Message:"Relay log write failure: %s", Description:"", MySQLVersion:"5.7"},
    1596: {ErrorNumber:1596, ErrorType:"ServerError", Symbol:"ER_SLAVE_CREATE_EVENT_FAILURE", SQLState:"HY000", Message:"Failed to create %s", Description:"", MySQLVersion:"5.7"},
    1597: {ErrorNumber:1597, ErrorType:"ServerError", Symbol:"ER_SLAVE_MASTER_COM_FAILURE", SQLState:"HY000", Message:"Master command %s failed: %s", Description:"", MySQLVersion:"5.7"},
    1598: {ErrorNumber:1598, ErrorType:"ServerError", Symbol:"ER_BINLOG_LOGGING_IMPOSSIBLE", SQLState:"HY000", Message:"Binary logging not possible.Message: %s", Description:"", MySQLVersion:"5.7"},
    1599: {ErrorNumber:1599, ErrorType:"ServerError", Symbol:"ER_VIEW_NO_CREATION_CTX", SQLState:"HY000", Message:"View `%s`.`%s` has no creation context", Description:"", MySQLVersion:"5.7"},
    1600: {ErrorNumber:1600, ErrorType:"ServerError", Symbol:"ER_VIEW_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of view `%s`.`%s' is invalid", Description:"", MySQLVersion:"5.7"},
    1601: {ErrorNumber:1601, ErrorType:"ServerError", Symbol:"ER_SR_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of stored routine `%s`.`%s` is invalid", Description:"", MySQLVersion:"5.7"},
    1602: {ErrorNumber:1602, ErrorType:"ServerError", Symbol:"ER_TRG_CORRUPTED_FILE", SQLState:"HY000", Message:"Corrupted TRG file for table `%s`.`%s`", Description:"", MySQLVersion:"5.7"},
    1603: {ErrorNumber:1603, ErrorType:"ServerError", Symbol:"ER_TRG_NO_CREATION_CTX", SQLState:"HY000", Message:"Triggers for table `%s`.`%s` have no creation context", Description:"", MySQLVersion:"5.7"},
    1604: {ErrorNumber:1604, ErrorType:"ServerError", Symbol:"ER_TRG_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Trigger creation context of table `%s`.`%s` is invalid", Description:"", MySQLVersion:"5.7"},
    1605: {ErrorNumber:1605, ErrorType:"ServerError", Symbol:"ER_EVENT_INVALID_CREATION_CTX", SQLState:"HY000", Message:"Creation context of event `%s`.`%s` is invalid", Description:"", MySQLVersion:"5.7"},
    1606: {ErrorNumber:1606, ErrorType:"ServerError", Symbol:"ER_TRG_CANT_OPEN_TABLE", SQLState:"HY000", Message:"Cannot open table for trigger `%s`.`%s`", Description:"", MySQLVersion:"5.7"},
    1607: {ErrorNumber:1607, ErrorType:"ServerError", Symbol:"ER_CANT_CREATE_SROUTINE", SQLState:"HY000", Message:"Cannot create stored routine `%s`. Check warnings", Description:"", MySQLVersion:"5.7"},
    1608: {ErrorNumber:1608, ErrorType:"ServerError", Symbol:"ER_NEVER_USED", SQLState:"HY000", Message:"Ambiguous slave modes combination. %s", Description:"", MySQLVersion:"5.7"},
    1609: {ErrorNumber:1609, ErrorType:"ServerError", Symbol:"ER_NO_FORMAT_DESCRIPTION_EVENT_BEFORE_BINLOG_STATEMENT", SQLState:"HY000", Message:"The BINLOG statement of type `%s` was not preceded by aformat description BINLOG statement.", Description:"", MySQLVersion:"5.7"},
    1610: {ErrorNumber:1610, ErrorType:"ServerError", Symbol:"ER_SLAVE_CORRUPT_EVENT", SQLState:"HY000", Message:"Corrupted replication event was detected", Description:"", MySQLVersion:"5.7"},
    1611: {ErrorNumber:1611, ErrorType:"ServerError", Symbol:"ER_LOAD_DATA_INVALID_COLUMN_UNUSED", SQLState:"HY000", Message:"Invalid column reference (%s) in LOAD DATA", Description:"ER_LOAD_DATA_INVALID_COLUMN_UNUSEDwas added in 5.7.8.", MySQLVersion:"5.7"},
    1612: {ErrorNumber:1612, ErrorType:"ServerError", Symbol:"ER_LOG_PURGE_NO_FILE", SQLState:"HY000", Message:"Being purged log %s was not found", Description:"", MySQLVersion:"5.7"},
    1613: {ErrorNumber:1613, ErrorType:"ServerError", Symbol:"ER_XA_RBTIMEOUT", SQLState:"XA106", Message:"XA_RBTIMEOUT: Transaction branch was rolled back: tooktoo long", Description:"", MySQLVersion:"5.7"},
    1614: {ErrorNumber:1614, ErrorType:"ServerError", Symbol:"ER_XA_RBDEADLOCK", SQLState:"XA102", Message:"XA_RBDEADLOCK: Transaction branch was rolled back:deadlock was detected", Description:"", MySQLVersion:"5.7"},
    1615: {ErrorNumber:1615, ErrorType:"ServerError", Symbol:"ER_NEED_REPREPARE", SQLState:"HY000", Message:"Prepared statement needs to be re-prepared", Description:"", MySQLVersion:"5.7"},
    1616: {ErrorNumber:1616, ErrorType:"ServerError", Symbol:"ER_DELAYED_NOT_SUPPORTED", SQLState:"HY000", Message:"DELAYED option not supported for table '%s'", Description:"", MySQLVersion:"5.7"},
    1617: {ErrorNumber:1617, ErrorType:"ServerError", Symbol:"WARN_NO_MASTER_INFO", SQLState:"HY000", Message:"The master info structure does not exist", Description:"", MySQLVersion:"5.7"},
    1618: {ErrorNumber:1618, ErrorType:"ServerError", Symbol:"WARN_OPTION_IGNORED", SQLState:"HY000", Message:"<%s> option ignored", Description:"", MySQLVersion:"5.7"},
    1619: {ErrorNumber:1619, ErrorType:"ServerError", Symbol:"ER_PLUGIN_DELETE_BUILTIN", SQLState:"HY000", Message:"Built-in plugins cannot be deleted", Description:"ER_PLUGIN_DELETE_BUILTIN was addedin 5.7.5.", MySQLVersion:"5.7"},
    1620: {ErrorNumber:1620, ErrorType:"ServerError", Symbol:"WARN_PLUGIN_BUSY", SQLState:"HY000", Message:"Plugin is busy and will be uninstalled on shutdown", Description:"", MySQLVersion:"5.7"},
    1621: {ErrorNumber:1621, ErrorType:"ServerError", Symbol:"ER_VARIABLE_IS_READONLY", SQLState:"HY000", Message:"%s variable '%s' is read-only. Use SET %s to assign thevalue", Description:"", MySQLVersion:"5.7"},
    1622: {ErrorNumber:1622, ErrorType:"ServerError", Symbol:"ER_WARN_ENGINE_TRANSACTION_ROLLBACK", SQLState:"HY000", Message:"Storage engine %s does not support rollback for thisstatement. Transaction rolled back and must be restarted", Description:"", MySQLVersion:"5.7"},
    1623: {ErrorNumber:1623, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_FAILURE", SQLState:"HY000", Message:"Unexpected master's heartbeat data: %s", Description:"", MySQLVersion:"5.7"},
    1624: {ErrorNumber:1624, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE", SQLState:"HY000", Message:"The requested value for the heartbeat period is eithernegative or exceeds the maximum allowed (%s seconds).", Description:"", MySQLVersion:"5.7"},
    1625: {ErrorNumber:1625, ErrorType:"ServerError", Symbol:"ER_NDB_REPLICATION_SCHEMA_ERROR", SQLState:"HY000", Message:"Bad schema for mysql.ndb_replication table.Message: %s", Description:"", MySQLVersion:"5.7"},
    1626: {ErrorNumber:1626, ErrorType:"ServerError", Symbol:"ER_CONFLICT_FN_PARSE_ERROR", SQLState:"HY000", Message:"Error in parsing conflict function.Message: %s", Description:"", MySQLVersion:"5.7"},
    1627: {ErrorNumber:1627, ErrorType:"ServerError", Symbol:"ER_EXCEPTIONS_WRITE_ERROR", SQLState:"HY000", Message:"Write to exceptions table failed.Message: %s\"", Description:"", MySQLVersion:"5.7"},
    1628: {ErrorNumber:1628, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_TABLE_COMMENT", SQLState:"HY000", Message:"Comment for table '%s' is too long (max = %lu)", Description:"", MySQLVersion:"5.7"},
    1629: {ErrorNumber:1629, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_FIELD_COMMENT", SQLState:"HY000", Message:"Comment for field '%s' is too long (max = %lu)", Description:"", MySQLVersion:"5.7"},
    1630: {ErrorNumber:1630, ErrorType:"ServerError", Symbol:"ER_FUNC_INEXISTENT_NAME_COLLISION", SQLState:"42000", Message:"FUNCTION %s does not exist. Check the 'Function NameParsing and Resolution' section in the Reference Manual", Description:"", MySQLVersion:"5.7"},
    1631: {ErrorNumber:1631, ErrorType:"ServerError", Symbol:"ER_DATABASE_NAME", SQLState:"HY000", Message:"Database", Description:"", MySQLVersion:"5.7"},
    1632: {ErrorNumber:1632, ErrorType:"ServerError", Symbol:"ER_TABLE_NAME", SQLState:"HY000", Message:"Table", Description:"", MySQLVersion:"5.7"},
    1633: {ErrorNumber:1633, ErrorType:"ServerError", Symbol:"ER_PARTITION_NAME", SQLState:"HY000", Message:"Partition", Description:"", MySQLVersion:"5.7"},
    1634: {ErrorNumber:1634, ErrorType:"ServerError", Symbol:"ER_SUBPARTITION_NAME", SQLState:"HY000", Message:"Subpartition", Description:"", MySQLVersion:"5.7"},
    1635: {ErrorNumber:1635, ErrorType:"ServerError", Symbol:"ER_TEMPORARY_NAME", SQLState:"HY000", Message:"Temporary", Description:"", MySQLVersion:"5.7"},
    1636: {ErrorNumber:1636, ErrorType:"ServerError", Symbol:"ER_RENAMED_NAME", SQLState:"HY000", Message:"Renamed", Description:"", MySQLVersion:"5.7"},
    1637: {ErrorNumber:1637, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_CONCURRENT_TRXS", SQLState:"HY000", Message:"Too many active concurrent transactions", Description:"", MySQLVersion:"5.7"},
    1638: {ErrorNumber:1638, ErrorType:"ServerError", Symbol:"WARN_NON_ASCII_SEPARATOR_NOT_IMPLEMENTED", SQLState:"HY000", Message:"Non-ASCII separator arguments are not fully supported", Description:"", MySQLVersion:"5.7"},
    1639: {ErrorNumber:1639, ErrorType:"ServerError", Symbol:"ER_DEBUG_SYNC_TIMEOUT", SQLState:"HY000", Message:"debug sync point wait timed out", Description:"", MySQLVersion:"5.7"},
    1640: {ErrorNumber:1640, ErrorType:"ServerError", Symbol:"ER_DEBUG_SYNC_HIT_LIMIT", SQLState:"HY000", Message:"debug sync point hit limit reached", Description:"", MySQLVersion:"5.7"},
    1641: {ErrorNumber:1641, ErrorType:"ServerError", Symbol:"ER_DUP_SIGNAL_SET", SQLState:"42000", Message:"Duplicate condition information item '%s'", Description:"", MySQLVersion:"5.7"},
    1642: {ErrorNumber:1642, ErrorType:"ServerError", Symbol:"ER_SIGNAL_WARN", SQLState:"01000", Message:"Unhandled user-defined warning condition", Description:"", MySQLVersion:"5.7"},
    1643: {ErrorNumber:1643, ErrorType:"ServerError", Symbol:"ER_SIGNAL_NOT_FOUND", SQLState:"02000", Message:"Unhandled user-defined not found condition", Description:"", MySQLVersion:"5.7"},
    1644: {ErrorNumber:1644, ErrorType:"ServerError", Symbol:"ER_SIGNAL_EXCEPTION", SQLState:"HY000", Message:"Unhandled user-defined exception condition", Description:"", MySQLVersion:"5.7"},
    1645: {ErrorNumber:1645, ErrorType:"ServerError", Symbol:"ER_RESIGNAL_WITHOUT_ACTIVE_HANDLER", SQLState:"0K000", Message:"RESIGNAL when handler not active", Description:"", MySQLVersion:"5.7"},
    1646: {ErrorNumber:1646, ErrorType:"ServerError", Symbol:"ER_SIGNAL_BAD_CONDITION_TYPE", SQLState:"HY000", Message:"SIGNAL/RESIGNAL can only use a CONDITION defined withSQLSTATE", Description:"", MySQLVersion:"5.7"},
    1647: {ErrorNumber:1647, ErrorType:"ServerError", Symbol:"WARN_COND_ITEM_TRUNCATED", SQLState:"HY000", Message:"Data truncated for condition item '%s'", Description:"", MySQLVersion:"5.7"},
    1648: {ErrorNumber:1648, ErrorType:"ServerError", Symbol:"ER_COND_ITEM_TOO_LONG", SQLState:"HY000", Message:"Data too long for condition item '%s'", Description:"", MySQLVersion:"5.7"},
    1649: {ErrorNumber:1649, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_LOCALE", SQLState:"HY000", Message:"Unknown locale: '%s'", Description:"", MySQLVersion:"5.7"},
    1650: {ErrorNumber:1650, ErrorType:"ServerError", Symbol:"ER_SLAVE_IGNORE_SERVER_IDS", SQLState:"HY000", Message:"The requested server id %d clashes with the slave startupoption --replicate-same-server-id", Description:"", MySQLVersion:"5.7"},
    1651: {ErrorNumber:1651, ErrorType:"ServerError", Symbol:"ER_QUERY_CACHE_DISABLED", SQLState:"HY000", Message:"Query cache is disabled", Description:"restart the server withquery_cache_type=1 to enable it", MySQLVersion:"5.7"},
    1652: {ErrorNumber:1652, ErrorType:"ServerError", Symbol:"ER_SAME_NAME_PARTITION_FIELD", SQLState:"HY000", Message:"Duplicate partition field name '%s'", Description:"", MySQLVersion:"5.7"},
    1653: {ErrorNumber:1653, ErrorType:"ServerError", Symbol:"ER_PARTITION_COLUMN_LIST_ERROR", SQLState:"HY000", Message:"Inconsistency in usage of column lists for partitioning", Description:"", MySQLVersion:"5.7"},
    1654: {ErrorNumber:1654, ErrorType:"ServerError", Symbol:"ER_WRONG_TYPE_COLUMN_VALUE_ERROR", SQLState:"HY000", Message:"Partition column values of incorrect type", Description:"", MySQLVersion:"5.7"},
    1655: {ErrorNumber:1655, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_PARTITION_FUNC_FIELDS_ERROR", SQLState:"HY000", Message:"Too many fields in '%s'", Description:"", MySQLVersion:"5.7"},
    1656: {ErrorNumber:1656, ErrorType:"ServerError", Symbol:"ER_MAXVALUE_IN_VALUES_IN", SQLState:"HY000", Message:"Cannot use MAXVALUE as value in VALUES IN", Description:"", MySQLVersion:"5.7"},
    1657: {ErrorNumber:1657, ErrorType:"ServerError", Symbol:"ER_TOO_MANY_VALUES_ERROR", SQLState:"HY000", Message:"Cannot have more than one value for this type of %spartitioning", Description:"", MySQLVersion:"5.7"},
    1658: {ErrorNumber:1658, ErrorType:"ServerError", Symbol:"ER_ROW_SINGLE_PARTITION_FIELD_ERROR", SQLState:"HY000", Message:"Row expressions in VALUES IN only allowed for multi-fieldcolumn partitioning", Description:"", MySQLVersion:"5.7"},
    1659: {ErrorNumber:1659, ErrorType:"ServerError", Symbol:"ER_FIELD_TYPE_NOT_ALLOWED_AS_PARTITION_FIELD", SQLState:"HY000", Message:"Field '%s' is of a not allowed type for this type ofpartitioning", Description:"", MySQLVersion:"5.7"},
    1660: {ErrorNumber:1660, ErrorType:"ServerError", Symbol:"ER_PARTITION_FIELDS_TOO_LONG", SQLState:"HY000", Message:"The total length of the partitioning fields is too large", Description:"", MySQLVersion:"5.7"},
    1661: {ErrorNumber:1661, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_ENGINE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since both row-incapable engines and statement-incapableengines are involved.", Description:"", MySQLVersion:"5.7"},
    1662: {ErrorNumber:1662, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_MODE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since BINLOG_FORMAT = ROW and at least one table uses astorage engine limited to statement-based logging.", Description:"", MySQLVersion:"5.7"},
    1663: {ErrorNumber:1663, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since statement is unsafe, storage engine is limited tostatement-based logging, and BINLOG_FORMAT = MIXED. %s", Description:"", MySQLVersion:"5.7"},
    1664: {ErrorNumber:1664, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_INJECTION_AND_STMT_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since statement is in row format and at least one table uses astorage engine limited to statement-based logging.", Description:"", MySQLVersion:"5.7"},
    1665: {ErrorNumber:1665, ErrorType:"ServerError", Symbol:"ER_BINLOG_STMT_MODE_AND_ROW_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since BINLOG_FORMAT = STATEMENT and at least one table uses astorage engine limited to row-based logging.%s", Description:"", MySQLVersion:"5.7"},
    1666: {ErrorNumber:1666, ErrorType:"ServerError", Symbol:"ER_BINLOG_ROW_INJECTION_AND_STMT_MODE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since statement is in row format and BINLOG_FORMAT =STATEMENT.", Description:"", MySQLVersion:"5.7"},
    1667: {ErrorNumber:1667, ErrorType:"ServerError", Symbol:"ER_BINLOG_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since more than one engine is involved and at least one engineis self-logging.", Description:"", MySQLVersion:"5.7"},
    1668: {ErrorNumber:1668, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_LIMIT", SQLState:"HY000", Message:"The statement is unsafe because it uses a LIMIT clause.This is unsafe because the set of rows included cannot bepredicted.", Description:"", MySQLVersion:"5.7"},
    1669: {ErrorNumber:1669, ErrorType:"ServerError", Symbol:"ER_UNUSED4", SQLState:"HY000", Message:"The statement is unsafe because it uses INSERT DELAYED.This is unsafe because the times when rows are inserted cannot bepredicted.", Description:"", MySQLVersion:"5.7"},
    1670: {ErrorNumber:1670, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_TABLE", SQLState:"HY000", Message:"The statement is unsafe because it uses the general log,slow query log, or performance_schema table(s). This is unsafebecause system tables may differ on slaves.", Description:"", MySQLVersion:"5.7"},
    1671: {ErrorNumber:1671, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AUTOINC_COLUMNS", SQLState:"HY000", Message:"Statement is unsafe because it invokes a trigger or astored function that inserts into an AUTO_INCREMENT column.Inserted values cannot be logged correctly.", Description:"", MySQLVersion:"5.7"},
    1672: {ErrorNumber:1672, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_UDF", SQLState:"HY000", Message:"Statement is unsafe because it uses a UDF which may notreturn the same value on the slave.", Description:"", MySQLVersion:"5.7"},
    1673: {ErrorNumber:1673, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_VARIABLE", SQLState:"HY000", Message:"Statement is unsafe because it uses a system variablethat may have a different value on the slave.", Description:"", MySQLVersion:"5.7"},
    1674: {ErrorNumber:1674, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_SYSTEM_FUNCTION", SQLState:"HY000", Message:"Statement is unsafe because it uses a system functionthat may return a different value on the slave.", Description:"", MySQLVersion:"5.7"},
    1675: {ErrorNumber:1675, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_NONTRANS_AFTER_TRANS", SQLState:"HY000", Message:"Statement is unsafe because it accesses anon-transactional table after accessing a transactional tablewithin the same transaction.", Description:"", MySQLVersion:"5.7"},
    1676: {ErrorNumber:1676, ErrorType:"ServerError", Symbol:"ER_MESSAGE_AND_STATEMENT", SQLState:"HY000", Message:"%s Statement: %s", Description:"", MySQLVersion:"5.7"},
    1677: {ErrorNumber:1677, ErrorType:"ServerError", Symbol:"ER_SLAVE_CONVERSION_FAILED", SQLState:"HY000", Message:"Column %d of table '%s.%s' cannot be converted from type'%s' to type '%s'", Description:"", MySQLVersion:"5.7"},
    1678: {ErrorNumber:1678, ErrorType:"ServerError", Symbol:"ER_SLAVE_CANT_CREATE_CONVERSION", SQLState:"HY000", Message:"Can't create conversion table for table '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1679: {ErrorNumber:1679, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_BINLOG_FORMAT", SQLState:"HY000", Message:"Cannot modify @@session.binlog_format inside atransaction", Description:"", MySQLVersion:"5.7"},
    1680: {ErrorNumber:1680, ErrorType:"ServerError", Symbol:"ER_PATH_LENGTH", SQLState:"HY000", Message:"The path specified for %s is too long.", Description:"", MySQLVersion:"5.7"},
    1681: {ErrorNumber:1681, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYNTAX_NO_REPLACEMENT", SQLState:"HY000", Message:"'%s' is deprecated and will be removed in a futurerelease.", Description:"", MySQLVersion:"5.7"},
    1682: {ErrorNumber:1682, ErrorType:"ServerError", Symbol:"ER_WRONG_NATIVE_TABLE_STRUCTURE", SQLState:"HY000", Message:"Native table '%s'.'%s' has the wrong structure", Description:"", MySQLVersion:"5.7"},
    1683: {ErrorNumber:1683, ErrorType:"ServerError", Symbol:"ER_WRONG_PERFSCHEMA_USAGE", SQLState:"HY000", Message:"Invalid performance_schema usage.", Description:"", MySQLVersion:"5.7"},
    1684: {ErrorNumber:1684, ErrorType:"ServerError", Symbol:"ER_WARN_I_S_SKIPPED_TABLE", SQLState:"HY000", Message:"Table '%s'.'%s' was skipped since its definition is beingmodified by concurrent DDL statement", Description:"", MySQLVersion:"5.7"},
    1685: {ErrorNumber:1685, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_BINLOG_DIRECT", SQLState:"HY000", Message:"Cannot modify@@session.binlog_direct_non_transactional_updates inside atransaction", Description:"", MySQLVersion:"5.7"},
    1686: {ErrorNumber:1686, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_DIRECT", SQLState:"HY000", Message:"Cannot change the binlog direct flag inside a storedfunction or trigger", Description:"", MySQLVersion:"5.7"},
    1687: {ErrorNumber:1687, ErrorType:"ServerError", Symbol:"ER_SPATIAL_MUST_HAVE_GEOM_COL", SQLState:"42000", Message:"A SPATIAL index may only contain a geometrical typecolumn", Description:"", MySQLVersion:"5.7"},
    1688: {ErrorNumber:1688, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_INDEX_COMMENT", SQLState:"HY000", Message:"Comment for index '%s' is too long (max = %lu)", Description:"", MySQLVersion:"5.7"},
    1689: {ErrorNumber:1689, ErrorType:"ServerError", Symbol:"ER_LOCK_ABORTED", SQLState:"HY000", Message:"Wait on a lock was aborted due to a pending exclusivelock", Description:"", MySQLVersion:"5.7"},
    1690: {ErrorNumber:1690, ErrorType:"ServerError", Symbol:"ER_DATA_OUT_OF_RANGE", SQLState:"22003", Message:"%s value is out of range in '%s'", Description:"", MySQLVersion:"5.7"},
    1691: {ErrorNumber:1691, ErrorType:"ServerError", Symbol:"ER_WRONG_SPVAR_TYPE_IN_LIMIT", SQLState:"HY000", Message:"A variable of a non-integer based type in LIMIT clause", Description:"", MySQLVersion:"5.7"},
    1692: {ErrorNumber:1692, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE", SQLState:"HY000", Message:"Mixing self-logging and non-self-logging engines in astatement is unsafe.", Description:"", MySQLVersion:"5.7"},
    1693: {ErrorNumber:1693, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_MIXED_STATEMENT", SQLState:"HY000", Message:"Statement accesses nontransactional table as well astransactional or temporary table, and writes to any of them.", Description:"", MySQLVersion:"5.7"},
    1694: {ErrorNumber:1694, ErrorType:"ServerError", Symbol:"ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_SQL_LOG_BIN", SQLState:"HY000", Message:"Cannot modify @@session.sql_log_bin inside a transaction", Description:"", MySQLVersion:"5.7"},
    1695: {ErrorNumber:1695, ErrorType:"ServerError", Symbol:"ER_STORED_FUNCTION_PREVENTS_SWITCH_SQL_LOG_BIN", SQLState:"HY000", Message:"Cannot change the sql_log_bin inside a stored function ortrigger", Description:"", MySQLVersion:"5.7"},
    1696: {ErrorNumber:1696, ErrorType:"ServerError", Symbol:"ER_FAILED_READ_FROM_PAR_FILE", SQLState:"HY000", Message:"Failed to read from the .par file", Description:"", MySQLVersion:"5.7"},
    1697: {ErrorNumber:1697, ErrorType:"ServerError", Symbol:"ER_VALUES_IS_NOT_INT_TYPE_ERROR", SQLState:"HY000", Message:"VALUES value for partition '%s' must have type INT", Description:"", MySQLVersion:"5.7"},
    1698: {ErrorNumber:1698, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_NO_PASSWORD_ERROR", SQLState:"28000", Message:"Access denied for user '%s'@'%s'", Description:"", MySQLVersion:"5.7"},
    1699: {ErrorNumber:1699, ErrorType:"ServerError", Symbol:"ER_SET_PASSWORD_AUTH_PLUGIN", SQLState:"HY000", Message:"SET PASSWORD has no significance for users authenticatingvia plugins", Description:"", MySQLVersion:"5.7"},
    1700: {ErrorNumber:1700, ErrorType:"ServerError", Symbol:"ER_GRANT_PLUGIN_USER_EXISTS", SQLState:"HY000", Message:"GRANT with IDENTIFIED WITH is illegal because the user%-.*s already exists", Description:"", MySQLVersion:"5.7"},
    1701: {ErrorNumber:1701, ErrorType:"ServerError", Symbol:"ER_TRUNCATE_ILLEGAL_FK", SQLState:"42000", Message:"Cannot truncate a table referenced in a foreign keyconstraint (%s)", Description:"", MySQLVersion:"5.7"},
    1702: {ErrorNumber:1702, ErrorType:"ServerError", Symbol:"ER_PLUGIN_IS_PERMANENT", SQLState:"HY000", Message:"Plugin '%s' is force_plus_permanent and can not beunloaded", Description:"", MySQLVersion:"5.7"},
    1703: {ErrorNumber:1703, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN", SQLState:"HY000", Message:"The requested value for the heartbeat period is less than1 millisecond. The value is reset to 0, meaning that heartbeatingwill effectively be disabled.", Description:"", MySQLVersion:"5.7"},
    1704: {ErrorNumber:1704, ErrorType:"ServerError", Symbol:"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX", SQLState:"HY000", Message:"The requested value for the heartbeat period exceeds thevalue of `slave_net_timeout' seconds. A sensible value for theperiod should be less than the timeout.", Description:"", MySQLVersion:"5.7"},
    1705: {ErrorNumber:1705, ErrorType:"ServerError", Symbol:"ER_STMT_CACHE_FULL", SQLState:"HY000", Message:"Multi-row statements required more than'max_binlog_stmt_cache_size' bytes of storage", Description:"increase thismysqld variable and try again", MySQLVersion:"5.7"},
    1706: {ErrorNumber:1706, ErrorType:"ServerError", Symbol:"ER_MULTI_UPDATE_KEY_CONFLICT", SQLState:"HY000", Message:"Primary key/partition key update is not allowed since thetable is updated both as '%s' and '%s'.", Description:"", MySQLVersion:"5.7"},
    1707: {ErrorNumber:1707, ErrorType:"ServerError", Symbol:"ER_TABLE_NEEDS_REBUILD", SQLState:"HY000", Message:"Table rebuild required. Please do \"ALTER TABLE `%s`FORCE\" or dump/reload to fix it!", Description:"", MySQLVersion:"5.7"},
    1708: {ErrorNumber:1708, ErrorType:"ServerError", Symbol:"WARN_OPTION_BELOW_LIMIT", SQLState:"HY000", Message:"The value of '%s' should be no less than the value of'%s'", Description:"", MySQLVersion:"5.7"},
    1709: {ErrorNumber:1709, ErrorType:"ServerError", Symbol:"ER_INDEX_COLUMN_TOO_LONG", SQLState:"HY000", Message:"Index column size too large. The maximum column size is%lu bytes.", Description:"", MySQLVersion:"5.7"},
    1710: {ErrorNumber:1710, ErrorType:"ServerError", Symbol:"ER_ERROR_IN_TRIGGER_BODY", SQLState:"HY000", Message:"Trigger '%s' has an error in its body: '%s'", Description:"", MySQLVersion:"5.7"},
    1711: {ErrorNumber:1711, ErrorType:"ServerError", Symbol:"ER_ERROR_IN_UNKNOWN_TRIGGER_BODY", SQLState:"HY000", Message:"Unknown trigger has an error in its body: '%s'", Description:"", MySQLVersion:"5.7"},
    1712: {ErrorNumber:1712, ErrorType:"ServerError", Symbol:"ER_INDEX_CORRUPT", SQLState:"HY000", Message:"Index %s is corrupted", Description:"", MySQLVersion:"5.7"},
    1713: {ErrorNumber:1713, ErrorType:"ServerError", Symbol:"ER_UNDO_RECORD_TOO_BIG", SQLState:"HY000", Message:"Undo log record is too big.", Description:"", MySQLVersion:"5.7"},
    1714: {ErrorNumber:1714, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_IGNORE_SELECT", SQLState:"HY000", Message:"INSERT IGNORE... SELECT is unsafe because the order inwhich rows are retrieved by the SELECT determines which (if any)rows are ignored. This order cannot be predicted and may differ onmaster and the slave.", Description:"", MySQLVersion:"5.7"},
    1715: {ErrorNumber:1715, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_SELECT_UPDATE", SQLState:"HY000", Message:"INSERT... SELECT... ON DUPLICATE KEY UPDATE is unsafebecause the order in which rows are retrieved by the SELECTdetermines which (if any) rows are updated. This order cannot bepredicted and may differ on master and the slave.", Description:"", MySQLVersion:"5.7"},
    ...
    1718: {ErrorNumber:1718, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_CREATE_REPLACE_SELECT", SQLState:"HY000", Message:"CREATE... REPLACE SELECT is unsafe because the order inwhich rows are retrieved by the SELECT determines which (if any)rows are replaced. This order cannot be predicted and may differon master and the slave.", Description:"", MySQLVersion:"5.7"},
    1719: {ErrorNumber:1719, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_UPDATE_IGNORE", SQLState:"HY000", Message:"UPDATE IGNORE is unsafe because the order in which rowsare updated determines which (if any) rows are ignored. This ordercannot be predicted and may differ on master and the slave.", Description:"", MySQLVersion:"5.7"},
    1720: {ErrorNumber:1720, ErrorType:"ServerError", Symbol:"ER_PLUGIN_NO_UNINSTALL", SQLState:"HY000", Message:"Plugin '%s' is marked as not dynamically uninstallable.You have to stop the server to uninstall it.", Description:"", MySQLVersion:"5.7"},
    1721: {ErrorNumber:1721, ErrorType:"ServerError", Symbol:"ER_PLUGIN_NO_INSTALL", SQLState:"HY000", Message:"Plugin '%s' is marked as not dynamically installable. Youhave to stop the server to install it.", Description:"", MySQLVersion:"5.7"},
    ...
    1723: {ErrorNumber:1723, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_CREATE_SELECT_AUTOINC", SQLState:"HY000", Message:"CREATE TABLE... SELECT... on a table with anauto-increment column is unsafe because the order in which rowsare retrieved by the SELECT determines which (if any) rows areinserted. This order cannot be predicted and may differ on masterand the slave.", Description:"", MySQLVersion:"5.7"},
    1724: {ErrorNumber:1724, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_INSERT_TWO_KEYS", SQLState:"HY000", Message:"INSERT... ON DUPLICATE KEY UPDATE on a table with morethan one UNIQUE KEY is unsafe", Description:"", MySQLVersion:"5.7"},
    1725: {ErrorNumber:1725, ErrorType:"ServerError", Symbol:"ER_TABLE_IN_FK_CHECK", SQLState:"HY000", Message:"Table is being used in foreign key check.", Description:"", MySQLVersion:"5.7"},
    1726: {ErrorNumber:1726, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ENGINE", SQLState:"HY000", Message:"Storage engine '%s' does not support system tables.[%s.%s]", Description:"", MySQLVersion:"5.7"},
    1727: {ErrorNumber:1727, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST", SQLState:"HY000", Message:"INSERT into autoincrement field which is not the firstpart in the composed primary key is unsafe.", Description:"", MySQLVersion:"5.7"},
    1728: {ErrorNumber:1728, ErrorType:"ServerError", Symbol:"ER_CANNOT_LOAD_FROM_TABLE_V2", SQLState:"HY000", Message:"Cannot load from %s.%s. The table is probably corrupted", Description:"", MySQLVersion:"5.7"},
    1729: {ErrorNumber:1729, ErrorType:"ServerError", Symbol:"ER_MASTER_DELAY_VALUE_OUT_OF_RANGE", SQLState:"HY000", Message:"The requested value %s for the master delay exceeds themaximum %u", Description:"", MySQLVersion:"5.7"},
    1730: {ErrorNumber:1730, ErrorType:"ServerError", Symbol:"ER_ONLY_FD_AND_RBR_EVENTS_ALLOWED_IN_BINLOG_STATEMENT", SQLState:"HY000", Message:"Only Format_description_log_event and row events areallowed in BINLOG statements (but %s was provided)", Description:"", MySQLVersion:"5.7"},
    1731: {ErrorNumber:1731, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_DIFFERENT_OPTION", SQLState:"HY000", Message:"Non matching attribute '%s' between partition and table", Description:"", MySQLVersion:"5.7"},
    1732: {ErrorNumber:1732, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_PART_TABLE", SQLState:"HY000", Message:"Table to exchange with partition is partitioned: '%s'", Description:"", MySQLVersion:"5.7"},
    1733: {ErrorNumber:1733, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_TEMP_TABLE", SQLState:"HY000", Message:"Table to exchange with partition is temporary: '%s'", Description:"", MySQLVersion:"5.7"},
    1734: {ErrorNumber:1734, ErrorType:"ServerError", Symbol:"ER_PARTITION_INSTEAD_OF_SUBPARTITION", SQLState:"HY000", Message:"Subpartitioned table, use subpartition instead ofpartition", Description:"", MySQLVersion:"5.7"},
    1735: {ErrorNumber:1735, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_PARTITION", SQLState:"HY000", Message:"Unknown partition '%s' in table '%s'", Description:"", MySQLVersion:"5.7"},
    1736: {ErrorNumber:1736, ErrorType:"ServerError", Symbol:"ER_TABLES_DIFFERENT_METADATA", SQLState:"HY000", Message:"Tables have different definitions", Description:"", MySQLVersion:"5.7"},
    1737: {ErrorNumber:1737, ErrorType:"ServerError", Symbol:"ER_ROW_DOES_NOT_MATCH_PARTITION", SQLState:"HY000", Message:"Found a row that does not match the partition", Description:"", MySQLVersion:"5.7"},
    1738: {ErrorNumber:1738, ErrorType:"ServerError", Symbol:"ER_BINLOG_CACHE_SIZE_GREATER_THAN_MAX", SQLState:"HY000", Message:"Option binlog_cache_size (%lu) is greater thanmax_binlog_cache_size (%lu)", Description:"setting binlog_cache_size equal tomax_binlog_cache_size.", MySQLVersion:"5.7"},
    1739: {ErrorNumber:1739, ErrorType:"ServerError", Symbol:"ER_WARN_INDEX_NOT_APPLICABLE", SQLState:"HY000", Message:"Cannot use %s access on index '%s' due to type orcollation conversion on field '%s'", Description:"", MySQLVersion:"5.7"},
    1740: {ErrorNumber:1740, ErrorType:"ServerError", Symbol:"ER_PARTITION_EXCHANGE_FOREIGN_KEY", SQLState:"HY000", Message:"Table to exchange with partition has foreign keyreferences: '%s'", Description:"", MySQLVersion:"5.7"},
    1741: {ErrorNumber:1741, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_KEY_VALUE", SQLState:"HY000", Message:"Key value '%s' was not found in table '%s.%s'", Description:"", MySQLVersion:"5.7"},
    1742: {ErrorNumber:1742, ErrorType:"ServerError", Symbol:"ER_RPL_INFO_DATA_TOO_LONG", SQLState:"HY000", Message:"Data for column '%s' too long", Description:"", MySQLVersion:"5.7"},
    1743: {ErrorNumber:1743, ErrorType:"ServerError", Symbol:"ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE", SQLState:"HY000", Message:"Replication event checksum verification failed whilereading from network.", Description:"", MySQLVersion:"5.7"},
    1744: {ErrorNumber:1744, ErrorType:"ServerError", Symbol:"ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE", SQLState:"HY000", Message:"Replication event checksum verification failed whilereading from a log file.", Description:"", MySQLVersion:"5.7"},
    1745: {ErrorNumber:1745, ErrorType:"ServerError", Symbol:"ER_BINLOG_STMT_CACHE_SIZE_GREATER_THAN_MAX", SQLState:"HY000", Message:"Option binlog_stmt_cache_size (%lu) is greater thanmax_binlog_stmt_cache_size (%lu)", Description:"setting binlog_stmt_cache_sizeequal to max_binlog_stmt_cache_size.", MySQLVersion:"5.7"},
    1746: {ErrorNumber:1746, ErrorType:"ServerError", Symbol:"ER_CANT_UPDATE_TABLE_IN_CREATE_TABLE_SELECT", SQLState:"HY000", Message:"Can't update table '%s' while '%s' is being created.", Description:"", MySQLVersion:"5.7"},
    1747: {ErrorNumber:1747, ErrorType:"ServerError", Symbol:"ER_PARTITION_CLAUSE_ON_NONPARTITIONED", SQLState:"HY000", Message:"PARTITION () clause on non partitioned table", Description:"", MySQLVersion:"5.7"},
    1748: {ErrorNumber:1748, ErrorType:"ServerError", Symbol:"ER_ROW_DOES_NOT_MATCH_GIVEN_PARTITION_SET", SQLState:"HY000", Message:"Found a row not matching the given partition set", Description:"", MySQLVersion:"5.7"},
    1749: {ErrorNumber:1749, ErrorType:"ServerError", Symbol:"ER_NO_SUCH_PARTITION__UNUSED", SQLState:"HY000", Message:"partition '%s' doesn't exist", Description:"", MySQLVersion:"5.7"},
    1750: {ErrorNumber:1750, ErrorType:"ServerError", Symbol:"ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE", SQLState:"HY000", Message:"Failure while changing the type of replicationrepository: %s.", Description:"", MySQLVersion:"5.7"},
    1751: {ErrorNumber:1751, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_CREATED_TEMP_TABLE", SQLState:"HY000", Message:"The creation of some temporary tables could not be rolledback.", Description:"", MySQLVersion:"5.7"},
    1752: {ErrorNumber:1752, ErrorType:"ServerError", Symbol:"ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_DROPPED_TEMP_TABLE", SQLState:"HY000", Message:"Some temporary tables were dropped, but these operationscould not be rolled back.", Description:"", MySQLVersion:"5.7"},
    1753: {ErrorNumber:1753, ErrorType:"ServerError", Symbol:"ER_MTS_FEATURE_IS_NOT_SUPPORTED", SQLState:"HY000", Message:"%s is not supported in multi-threaded slave mode. %s", Description:"", MySQLVersion:"5.7"},
    1754: {ErrorNumber:1754, ErrorType:"ServerError", Symbol:"ER_MTS_UPDATED_DBS_GREATER_MAX", SQLState:"HY000", Message:"The number of modified databases exceeds the maximum %d", Description:"the database names will not be included in the replication eventmetadata.", MySQLVersion:"5.7"},
    1755: {ErrorNumber:1755, ErrorType:"ServerError", Symbol:"ER_MTS_CANT_PARALLEL", SQLState:"HY000", Message:"Cannot execute the current event group in the parallelmode. Encountered event %s, relay-log name %s, position %s whichprevents execution of this event group in parallel mode. Reason:%s.", Description:"", MySQLVersion:"5.7"},
    1756: {ErrorNumber:1756, ErrorType:"ServerError", Symbol:"ER_MTS_INCONSISTENT_DATA", SQLState:"HY000", Message:"%s", Description:"", MySQLVersion:"5.7"},
    1757: {ErrorNumber:1757, ErrorType:"ServerError", Symbol:"ER_FULLTEXT_NOT_SUPPORTED_WITH_PARTITIONING", SQLState:"HY000", Message:"FULLTEXT index is not supported for partitioned tables.", Description:"", MySQLVersion:"5.7"},
    1758: {ErrorNumber:1758, ErrorType:"ServerError", Symbol:"ER_DA_INVALID_CONDITION_NUMBER", SQLState:"35000", Message:"Invalid condition number", Description:"", MySQLVersion:"5.7"},
    1759: {ErrorNumber:1759, ErrorType:"ServerError", Symbol:"ER_INSECURE_PLAIN_TEXT", SQLState:"HY000", Message:"Sending passwords in plain text without SSL/TLS isextremely insecure.", Description:"", MySQLVersion:"5.7"},
    1760: {ErrorNumber:1760, ErrorType:"ServerError", Symbol:"ER_INSECURE_CHANGE_MASTER", SQLState:"HY000", Message:"Storing MySQL user name or password information in themaster info repository is not secure and is therefore notrecommended. Please consider using the USER and PASSWORDconnection options for START SLAVE", Description:"see the 'START SLAVE Syntax'in the MySQL Manual for more information.", MySQLVersion:"5.7"},
    1761: {ErrorNumber:1761, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DUPLICATE_KEY_WITH_CHILD_INFO", SQLState:"23000", Message:"Foreign key constraint for table '%s', record '%s' wouldlead to a duplicate entry in table '%s', key '%s'", Description:"", MySQLVersion:"5.7"},
    1762: {ErrorNumber:1762, ErrorType:"ServerError", Symbol:"ER_FOREIGN_DUPLICATE_KEY_WITHOUT_CHILD_INFO", SQLState:"23000", Message:"Foreign key constraint for table '%s', record '%s' wouldlead to a duplicate entry in a child table", Description:"", MySQLVersion:"5.7"},
    1763: {ErrorNumber:1763, ErrorType:"ServerError", Symbol:"ER_SQLTHREAD_WITH_SECURE_SLAVE", SQLState:"HY000", Message:"Setting authentication options is not possible when onlythe Slave SQL Thread is being started.", Description:"", MySQLVersion:"5.7"},
    1764: {ErrorNumber:1764, ErrorType:"ServerError", Symbol:"ER_TABLE_HAS_NO_FT", SQLState:"HY000", Message:"The table does not have FULLTEXT index to support thisquery", Description:"", MySQLVersion:"5.7"},
    1765: {ErrorNumber:1765, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_SF_OR_TRIGGER", SQLState:"HY000", Message:"The system variable %s cannot be set in stored functionsor triggers.", Description:"", MySQLVersion:"5.7"},
    1766: {ErrorNumber:1766, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_TRANSACTION", SQLState:"HY000", Message:"The system variable %s cannot be set when there is anongoing transaction.", Description:"", MySQLVersion:"5.7"},
    1767: {ErrorNumber:1767, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_IS_NOT_IN_GTID_NEXT_LIST", SQLState:"HY000", Message:"The system variable @@SESSION.GTID_NEXT has the value %s,which is not listed in @@SESSION.GTID_NEXT_LIST.", Description:"", MySQLVersion:"5.7"},
    1768: {ErrorNumber:1768, ErrorType:"ServerError", Symbol:"ER_CANT_CHANGE_GTID_NEXT_IN_TRANSACTION", SQLState:"HY000", Message:"The system variable @@SESSION.GTID_NEXT cannot changeinside a transaction.", Description:"ER_CANT_CHANGE_GTID_NEXT_IN_TRANSACTIONwas added in 5.7.6.", MySQLVersion:"5.7"},
    1769: {ErrorNumber:1769, ErrorType:"ServerError", Symbol:"ER_SET_STATEMENT_CANNOT_INVOKE_FUNCTION", SQLState:"HY000", Message:"The statement 'SET %s' cannot invoke a stored function.", Description:"", MySQLVersion:"5.7"},
    1770: {ErrorNumber:1770, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_CANT_BE_AUTOMATIC_IF_GTID_NEXT_LIST_IS_NON_NULL", SQLState:"HY000", Message:"The system variable @@SESSION.GTID_NEXT cannot be'AUTOMATIC' when @@SESSION.GTID_NEXT_LIST is non-NULL.", Description:"", MySQLVersion:"5.7"},
    1771: {ErrorNumber:1771, ErrorType:"ServerError", Symbol:"ER_SKIPPING_LOGGED_TRANSACTION", SQLState:"HY000", Message:"Skipping transaction %s because it has already beenexecuted and logged.", Description:"", MySQLVersion:"5.7"},
    1772: {ErrorNumber:1772, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SET_SPECIFICATION", SQLState:"HY000", Message:"Malformed GTID set specification '%s'.", Description:"", MySQLVersion:"5.7"},
    1773: {ErrorNumber:1773, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SET_ENCODING", SQLState:"HY000", Message:"Malformed GTID set encoding.", Description:"", MySQLVersion:"5.7"},
    1774: {ErrorNumber:1774, ErrorType:"ServerError", Symbol:"ER_MALFORMED_GTID_SPECIFICATION", SQLState:"HY000", Message:"Malformed GTID specification '%s'.", Description:"", MySQLVersion:"5.7"},
    1775: {ErrorNumber:1775, ErrorType:"ServerError", Symbol:"ER_GNO_EXHAUSTED", SQLState:"HY000", Message:"Impossible to generate GTID: the integer componentreached the maximum value. Restart the server with a newserver_uuid.", Description:"", MySQLVersion:"5.7"},
    1776: {ErrorNumber:1776, ErrorType:"ServerError", Symbol:"ER_BAD_SLAVE_AUTO_POSITION", SQLState:"HY000", Message:"Parameters MASTER_LOG_FILE, MASTER_LOG_POS,RELAY_LOG_FILE and RELAY_LOG_POS cannot be set whenMASTER_AUTO_POSITION is active.", Description:"", MySQLVersion:"5.7"},
    1777: {ErrorNumber:1777, ErrorType:"ServerError", Symbol:"ER_AUTO_POSITION_REQUIRES_GTID_MODE_NOT_OFF", SQLState:"HY000", Message:"CHANGE MASTER TO MASTER_AUTO_POSITION = 1 cannot beexecuted because @@GLOBAL.GTID_MODE = OFF.", Description:"ER_AUTO_POSITION_REQUIRES_GTID_MODE_NOT_OFFwas added in 5.7.6.", MySQLVersion:"5.7"},
    1778: {ErrorNumber:1778, ErrorType:"ServerError", Symbol:"ER_CANT_DO_IMPLICIT_COMMIT_IN_TRX_WHEN_GTID_NEXT_IS_SET", SQLState:"HY000", Message:"Cannot execute statements with implicit commit inside atransaction when @@SESSION.GTID_NEXT == 'UUID:NUMBER'.", Description:"", MySQLVersion:"5.7"},
    1779: {ErrorNumber:1779, ErrorType:"ServerError", Symbol:"ER_GTID_MODE_ON_REQUIRES_ENFORCE_GTID_CONSISTENCY_ON", SQLState:"HY000", Message:"GTID_MODE = ON requires ENFORCE_GTID_CONSISTENCY = ON.", Description:"ER_GTID_MODE_ON_REQUIRES_ENFORCE_GTID_CONSISTENCY_ONwas added in 5.7.6.", MySQLVersion:"5.7"},
    1780: {ErrorNumber:1780, ErrorType:"ServerError", Symbol:"ER_GTID_MODE_REQUIRES_BINLOG", SQLState:"HY000", Message:"@@GLOBAL.GTID_MODE = ON or ON_PERMISSIVE orOFF_PERMISSIVE requires --log-bin and --log-slave-updates.", Description:"", MySQLVersion:"5.7"},
    1781: {ErrorNumber:1781, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_TO_GTID_WHEN_GTID_MODE_IS_OFF", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT cannot be set to UUID:NUMBER when@@GLOBAL.GTID_MODE = OFF.", Description:"", MySQLVersion:"5.7"},
    1782: {ErrorNumber:1782, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_TO_ANONYMOUS_WHEN_GTID_MODE_IS_ON", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT cannot be set to ANONYMOUS when@@GLOBAL.GTID_MODE = ON.", Description:"", MySQLVersion:"5.7"},
    1783: {ErrorNumber:1783, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_LIST_TO_NON_NULL_WHEN_GTID_MODE_IS_OFF", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT_LIST cannot be set to a non-NULLvalue when @@GLOBAL.GTID_MODE = OFF.", Description:"", MySQLVersion:"5.7"},
    1784: {ErrorNumber:1784, ErrorType:"ServerError", Symbol:"ER_FOUND_GTID_EVENT_WHEN_GTID_MODE_IS_OFF__UNUSED", SQLState:"HY000", Message:"Found a Gtid_log_event when @@GLOBAL.GTID_MODE = OFF.", Description:"ER_FOUND_GTID_EVENT_WHEN_GTID_MODE_IS_OFF__UNUSEDwas added in 5.7.6.", MySQLVersion:"5.7"},
    1785: {ErrorNumber:1785, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_NON_TRANSACTIONAL_TABLE", SQLState:"HY000", Message:"Statement violates GTID consistency: Updates tonon-transactional tables can only be done in either autocommittedstatements or single-statement transactions, and never in the samestatement as updates to transactional tables.", Description:"", MySQLVersion:"5.7"},
    1786: {ErrorNumber:1786, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_CREATE_SELECT", SQLState:"HY000", Message:"Statement violates GTID consistency: CREATE TABLE ...SELECT.", Description:"", MySQLVersion:"5.7"},
    1787: {ErrorNumber:1787, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_CREATE_DROP_TEMPORARY_TABLE_IN_TRANSACTION", SQLState:"HY000", Message:"Statement violates GTID consistency: CREATE TEMPORARYTABLE and DROP TEMPORARY TABLE can only be executed outsidetransactional context. These statements are also not allowed in afunction or trigger because functions and triggers are alsoconsidered to be multi-statement transactions.", Description:"", MySQLVersion:"5.7"},
    1788: {ErrorNumber:1788, ErrorType:"ServerError", Symbol:"ER_GTID_MODE_CAN_ONLY_CHANGE_ONE_STEP_AT_A_TIME", SQLState:"HY000", Message:"The value of @@GLOBAL.GTID_MODE can only be changed onestep at a time: OFF <-> OFF_PERMISSIVE <->ON_PERMISSIVE <-> ON. Also note that this value must bestepped up or down simultaneously on all servers. See the Manualfor instructions.", Description:"", MySQLVersion:"5.7"},
    ...
    1790: {ErrorNumber:1790, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_NEXT_WHEN_OWNING_GTID", SQLState:"HY000", Message:"@@SESSION.GTID_NEXT cannot be changed by a client thatowns a GTID. The client owns %s. Ownership is released on COMMITor ROLLBACK.", Description:"", MySQLVersion:"5.7"},
    1791: {ErrorNumber:1791, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_EXPLAIN_FORMAT", SQLState:"HY000", Message:"Unknown EXPLAIN format name: '%s'", Description:"", MySQLVersion:"5.7"},
    1792: {ErrorNumber:1792, ErrorType:"ServerError", Symbol:"ER_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION", SQLState:"25006", Message:"Cannot execute statement in a READ ONLY transaction.", Description:"", MySQLVersion:"5.7"},
    1793: {ErrorNumber:1793, ErrorType:"ServerError", Symbol:"ER_TOO_LONG_TABLE_PARTITION_COMMENT", SQLState:"HY000", Message:"Comment for table partition '%s' is too long (max = %lu)", Description:"", MySQLVersion:"5.7"},
    1794: {ErrorNumber:1794, ErrorType:"ServerError", Symbol:"ER_SLAVE_CONFIGURATION", SQLState:"HY000", Message:"Slave is not configured or failed to initialize properly.You must at least set --server-id to enable either a master or aslave. Additional error messages can be found in the MySQL errorlog.", Description:"", MySQLVersion:"5.7"},
    1795: {ErrorNumber:1795, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_LIMIT", SQLState:"HY000", Message:"InnoDB presently supports one FULLTEXT index creation ata time", Description:"", MySQLVersion:"5.7"},
    1796: {ErrorNumber:1796, ErrorType:"ServerError", Symbol:"ER_INNODB_NO_FT_TEMP_TABLE", SQLState:"HY000", Message:"Cannot create FULLTEXT index on temporary InnoDB table", Description:"", MySQLVersion:"5.7"},
    1797: {ErrorNumber:1797, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_WRONG_DOCID_COLUMN", SQLState:"HY000", Message:"Column '%s' is of wrong type for an InnoDB FULLTEXT index", Description:"", MySQLVersion:"5.7"},
    1798: {ErrorNumber:1798, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_WRONG_DOCID_INDEX", SQLState:"HY000", Message:"Index '%s' is of wrong type for an InnoDB FULLTEXT index", Description:"", MySQLVersion:"5.7"},
    1799: {ErrorNumber:1799, ErrorType:"ServerError", Symbol:"ER_INNODB_ONLINE_LOG_TOO_BIG", SQLState:"HY000", Message:"Creating index '%s' required more than'innodb_online_alter_log_max_size' bytes of modification log.Please try again.", Description:"", MySQLVersion:"5.7"},
    1800: {ErrorNumber:1800, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ALTER_ALGORITHM", SQLState:"HY000", Message:"Unknown ALGORITHM '%s'", Description:"", MySQLVersion:"5.7"},
    1801: {ErrorNumber:1801, ErrorType:"ServerError", Symbol:"ER_UNKNOWN_ALTER_LOCK", SQLState:"HY000", Message:"Unknown LOCK type '%s'", Description:"", MySQLVersion:"5.7"},
    1802: {ErrorNumber:1802, ErrorType:"ServerError", Symbol:"ER_MTS_CHANGE_MASTER_CANT_RUN_WITH_GAPS", SQLState:"HY000", Message:"CHANGE MASTER cannot be executed when the slave wasstopped with an error or killed in MTS mode. Consider using RESETSLAVE or START SLAVE UNTIL.", Description:"", MySQLVersion:"5.7"},
    1803: {ErrorNumber:1803, ErrorType:"ServerError", Symbol:"ER_MTS_RECOVERY_FAILURE", SQLState:"HY000", Message:"Cannot recover after SLAVE errored out in parallelexecution mode. Additional error messages can be found in theMySQL error log.", Description:"", MySQLVersion:"5.7"},
    1804: {ErrorNumber:1804, ErrorType:"ServerError", Symbol:"ER_MTS_RESET_WORKERS", SQLState:"HY000", Message:"Cannot clean up worker info tables. Additional errormessages can be found in the MySQL error log.", Description:"", MySQLVersion:"5.7"},
    1805: {ErrorNumber:1805, ErrorType:"ServerError", Symbol:"ER_COL_COUNT_DOESNT_MATCH_CORRUPTED_V2", SQLState:"HY000", Message:"Column count of %s.%s is wrong. Expected %d, found %d.The table is probably corrupted", Description:"", MySQLVersion:"5.7"},
    1806: {ErrorNumber:1806, ErrorType:"ServerError", Symbol:"ER_SLAVE_SILENT_RETRY_TRANSACTION", SQLState:"HY000", Message:"Slave must silently retry current transaction", Description:"", MySQLVersion:"5.7"},
    1807: {ErrorNumber:1807, ErrorType:"ServerError", Symbol:"ER_DISCARD_FK_CHECKS_RUNNING", SQLState:"HY000", Message:"There is a foreign key check running on table '%s'.Cannot discard the table.", Description:"", MySQLVersion:"5.7"},
    1808: {ErrorNumber:1808, ErrorType:"ServerError", Symbol:"ER_TABLE_SCHEMA_MISMATCH", SQLState:"HY000", Message:"Schema mismatch (%s)", Description:"", MySQLVersion:"5.7"},
    1809: {ErrorNumber:1809, ErrorType:"ServerError", Symbol:"ER_TABLE_IN_SYSTEM_TABLESPACE", SQLState:"HY000", Message:"Table '%s' in system tablespace", Description:"", MySQLVersion:"5.7"},
    1810: {ErrorNumber:1810, ErrorType:"ServerError", Symbol:"ER_IO_READ_ERROR", SQLState:"HY000", Message:"IO Read error: (%lu, %s) %s", Description:"", MySQLVersion:"5.7"},
    1811: {ErrorNumber:1811, ErrorType:"ServerError", Symbol:"ER_IO_WRITE_ERROR", SQLState:"HY000", Message:"IO Write error: (%lu, %s) %s", Description:"", MySQLVersion:"5.7"},
    1812: {ErrorNumber:1812, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_MISSING", SQLState:"HY000", Message:"Tablespace is missing for table %s.", Description:"", MySQLVersion:"5.7"},
    1813: {ErrorNumber:1813, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_EXISTS", SQLState:"HY000", Message:"Tablespace '%s' exists.", Description:"", MySQLVersion:"5.7"},
    1814: {ErrorNumber:1814, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_DISCARDED", SQLState:"HY000", Message:"Tablespace has been discarded for table '%s'", Description:"", MySQLVersion:"5.7"},
    1815: {ErrorNumber:1815, ErrorType:"ServerError", Symbol:"ER_INTERNAL_ERROR", SQLState:"HY000", Message:"Internal error: %s", Description:"", MySQLVersion:"5.7"},
    1816: {ErrorNumber:1816, ErrorType:"ServerError", Symbol:"ER_INNODB_IMPORT_ERROR", SQLState:"HY000", Message:"ALTER TABLE %s IMPORT TABLESPACE failed with error %lu :'%s'", Description:"", MySQLVersion:"5.7"},
    1817: {ErrorNumber:1817, ErrorType:"ServerError", Symbol:"ER_INNODB_INDEX_CORRUPT", SQLState:"HY000", Message:"Index corrupt: %s", Description:"", MySQLVersion:"5.7"},
    1818: {ErrorNumber:1818, ErrorType:"ServerError", Symbol:"ER_INVALID_YEAR_COLUMN_LENGTH", SQLState:"HY000", Message:"Supports only YEAR or YEAR(4) column.", Description:"", MySQLVersion:"5.7"},
    1819: {ErrorNumber:1819, ErrorType:"ServerError", Symbol:"ER_NOT_VALID_PASSWORD", SQLState:"HY000", Message:"Your password does not satisfy the current policyrequirements", Description:"", MySQLVersion:"5.7"},
    1820: {ErrorNumber:1820, ErrorType:"ServerError", Symbol:"ER_MUST_CHANGE_PASSWORD", SQLState:"HY000", Message:"You must reset your password using ALTER USER statementbefore executing this statement.", Description:"", MySQLVersion:"5.7"},
    1821: {ErrorNumber:1821, ErrorType:"ServerError", Symbol:"ER_FK_NO_INDEX_CHILD", SQLState:"HY000", Message:"Failed to add the foreign key constaint. Missing indexfor constraint '%s' in the foreign table '%s'", Description:"", MySQLVersion:"5.7"},
    1822: {ErrorNumber:1822, ErrorType:"ServerError", Symbol:"ER_FK_NO_INDEX_PARENT", SQLState:"HY000", Message:"Failed to add the foreign key constaint. Missing indexfor constraint '%s' in the referenced table '%s'", Description:"", MySQLVersion:"5.7"},
    1823: {ErrorNumber:1823, ErrorType:"ServerError", Symbol:"ER_FK_FAIL_ADD_SYSTEM", SQLState:"HY000", Message:"Failed to add the foreign key constraint '%s' to systemtables", Description:"", MySQLVersion:"5.7"},
    1824: {ErrorNumber:1824, ErrorType:"ServerError", Symbol:"ER_FK_CANNOT_OPEN_PARENT", SQLState:"HY000", Message:"Failed to open the referenced table '%s'", Description:"", MySQLVersion:"5.7"},
    1825: {ErrorNumber:1825, ErrorType:"ServerError", Symbol:"ER_FK_INCORRECT_OPTION", SQLState:"HY000", Message:"Failed to add the foreign key constraint on table '%s'.Incorrect options in FOREIGN KEY constraint '%s'", Description:"", MySQLVersion:"5.7"},
    1826: {ErrorNumber:1826, ErrorType:"ServerError", Symbol:"ER_FK_DUP_NAME", SQLState:"HY000", Message:"Duplicate foreign key constraint name '%s'", Description:"", MySQLVersion:"5.7"},
    1827: {ErrorNumber:1827, ErrorType:"ServerError", Symbol:"ER_PASSWORD_FORMAT", SQLState:"HY000", Message:"The password hash doesn't have the expected format. Checkif the correct password algorithm is being used with thePASSWORD() function.", Description:"", MySQLVersion:"5.7"},
    1828: {ErrorNumber:1828, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_DROP", SQLState:"HY000", Message:"Cannot drop column '%s': needed in a foreign keyconstraint '%s'", Description:"", MySQLVersion:"5.7"},
    1829: {ErrorNumber:1829, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_DROP_CHILD", SQLState:"HY000", Message:"Cannot drop column '%s': needed in a foreign keyconstraint '%s' of table '%s'", Description:"", MySQLVersion:"5.7"},
    1830: {ErrorNumber:1830, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_NOT_NULL", SQLState:"HY000", Message:"Column '%s' cannot be NOT NULL: needed in a foreign keyconstraint '%s' SET NULL", Description:"", MySQLVersion:"5.7"},
    1831: {ErrorNumber:1831, ErrorType:"ServerError", Symbol:"ER_DUP_INDEX", SQLState:"HY000", Message:"Duplicate index '%s' defined on the table '%s.%s'. Thisis deprecated and will be disallowed in a future release.", Description:"", MySQLVersion:"5.7"},
    1832: {ErrorNumber:1832, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_CHANGE", SQLState:"HY000", Message:"Cannot change column '%s': used in a foreign keyconstraint '%s'", Description:"", MySQLVersion:"5.7"},
    1833: {ErrorNumber:1833, ErrorType:"ServerError", Symbol:"ER_FK_COLUMN_CANNOT_CHANGE_CHILD", SQLState:"HY000", Message:"Cannot change column '%s': used in a foreign keyconstraint '%s' of table '%s'", Description:"", MySQLVersion:"5.7"},
    1834: {ErrorNumber:1834, ErrorType:"ServerError", Symbol:"ER_UNUSED5", SQLState:"HY000", Message:"Cannot delete rows from table which is parent in aforeign key constraint '%s' of table '%s'", Description:"ER_UNUSED5 was added in 5.7.4.", MySQLVersion:"5.7"},
    1835: {ErrorNumber:1835, ErrorType:"ServerError", Symbol:"ER_MALFORMED_PACKET", SQLState:"HY000", Message:"Malformed communication packet.", Description:"", MySQLVersion:"5.7"},
    1836: {ErrorNumber:1836, ErrorType:"ServerError", Symbol:"ER_READ_ONLY_MODE", SQLState:"HY000", Message:"Running in read-only mode", Description:"", MySQLVersion:"5.7"},
    1837: {ErrorNumber:1837, ErrorType:"ServerError", Symbol:"ER_GTID_NEXT_TYPE_UNDEFINED_GROUP", SQLState:"HY000", Message:"When @@SESSION.GTID_NEXT is set to a GTID, you mustexplicitly set it to a different value after a COMMIT or ROLLBACK.Please check GTID_NEXT variable manual page for detailedexplanation. Current @@SESSION.GTID_NEXT is '%s'.", Description:"", MySQLVersion:"5.7"},
    1838: {ErrorNumber:1838, ErrorType:"ServerError", Symbol:"ER_VARIABLE_NOT_SETTABLE_IN_SP", SQLState:"HY000", Message:"The system variable %s cannot be set in storedprocedures.", Description:"", MySQLVersion:"5.7"},
    1839: {ErrorNumber:1839, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_MODE_IS_OFF", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when@@GLOBAL.GTID_MODE = ON.", Description:"", MySQLVersion:"5.7"},
    1840: {ErrorNumber:1840, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_GTID_EXECUTED_IS_NOT_EMPTY", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when@@GLOBAL.GTID_EXECUTED is empty.", Description:"", MySQLVersion:"5.7"},
    1841: {ErrorNumber:1841, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_PURGED_WHEN_OWNED_GTIDS_IS_NOT_EMPTY", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED can only be set when there are noongoing transactions (not even in other clients).", Description:"", MySQLVersion:"5.7"},
    1842: {ErrorNumber:1842, ErrorType:"ServerError", Symbol:"ER_GTID_PURGED_WAS_CHANGED", SQLState:"HY000", Message:"@@GLOBAL.GTID_PURGED was changed from '%s' to '%s'.", Description:"", MySQLVersion:"5.7"},
    1843: {ErrorNumber:1843, ErrorType:"ServerError", Symbol:"ER_GTID_EXECUTED_WAS_CHANGED", SQLState:"HY000", Message:"@@GLOBAL.GTID_EXECUTED was changed from '%s' to '%s'.", Description:"", MySQLVersion:"5.7"},
    1844: {ErrorNumber:1844, ErrorType:"ServerError", Symbol:"ER_BINLOG_STMT_MODE_AND_NO_REPL_TABLES", SQLState:"HY000", Message:"Cannot execute statement: impossible to write to binarylog since BINLOG_FORMAT = STATEMENT, and both replicated and nonreplicated tables are written to.", Description:"", MySQLVersion:"5.7"},
    1845: {ErrorNumber:1845, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED", SQLState:"0A000", Message:"%s is not supported for this operation. Try %s.", Description:"ER_ALTER_OPERATION_NOT_SUPPORTEDwas added in 5.7.1.", MySQLVersion:"5.7"},
    1846: {ErrorNumber:1846, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON", SQLState:"0A000", Message:"%s is not supported. Reason: %s. Try %s.", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASONwas added in 5.7.1.", MySQLVersion:"5.7"},
    1847: {ErrorNumber:1847, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COPY", SQLState:"HY000", Message:"COPY algorithm requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COPYwas added in 5.7.1.", MySQLVersion:"5.7"},
    1848: {ErrorNumber:1848, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_PARTITION", SQLState:"HY000", Message:"Partition specific operations do not yet supportLOCK/ALGORITHM", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_PARTITIONwas added in 5.7.1.", MySQLVersion:"5.7"},
    1849: {ErrorNumber:1849, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_RENAME", SQLState:"HY000", Message:"Columns participating in a foreign key are renamed", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_RENAMEwas added in 5.7.1.", MySQLVersion:"5.7"},
    1850: {ErrorNumber:1850, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COLUMN_TYPE", SQLState:"HY000", Message:"Cannot change column type INPLACE", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_COLUMN_TYPEwas added in 5.7.1.", MySQLVersion:"5.7"},
    1851: {ErrorNumber:1851, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_CHECK", SQLState:"HY000", Message:"Adding foreign keys needs foreign_key_checks=OFF", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FK_CHECKwas added in 5.7.1.", MySQLVersion:"5.7"},
    1852: {ErrorNumber:1852, ErrorType:"ServerError", Symbol:"ER_UNUSED6", SQLState:"HY000", Message:"Creating unique indexes with IGNORE requires COPYalgorithm to remove duplicate rows", Description:"ER_UNUSED6 was added in 5.7.4.", MySQLVersion:"5.7"},
    1853: {ErrorNumber:1853, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOPK", SQLState:"HY000", Message:"Dropping a primary key is not allowed without also addinga new primary key", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOPKwas added in 5.7.1.", MySQLVersion:"5.7"},
    1854: {ErrorNumber:1854, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_AUTOINC", SQLState:"HY000", Message:"Adding an auto-increment column requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_AUTOINCwas added in 5.7.1.", MySQLVersion:"5.7"},
    1855: {ErrorNumber:1855, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_HIDDEN_FTS", SQLState:"HY000", Message:"Cannot replace hidden FTS_DOC_ID with a user-visible one", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_HIDDEN_FTSwas added in 5.7.1.", MySQLVersion:"5.7"},
    1856: {ErrorNumber:1856, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTS", SQLState:"HY000", Message:"Cannot drop or rename FTS_DOC_ID", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_CHANGE_FTSwas added in 5.7.1.", MySQLVersion:"5.7"},
    1857: {ErrorNumber:1857, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTS", SQLState:"HY000", Message:"Fulltext index creation requires a lock", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_FTSwas added in 5.7.1.", MySQLVersion:"5.7"},
    1858: {ErrorNumber:1858, ErrorType:"ServerError", Symbol:"ER_SQL_SLAVE_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODE", SQLState:"HY000", Message:"sql_slave_skip_counter can not be set when the server isrunning with @@GLOBAL.GTID_MODE = ON. Instead, for eachtransaction that you want to skip, generate an empty transactionwith the same GTID as the transaction", Description:"ER_SQL_SLAVE_SKIP_COUNTER_NOT_SETTABLE_IN_GTID_MODEwas added in 5.7.1.", MySQLVersion:"5.7"},
    1859: {ErrorNumber:1859, ErrorType:"ServerError", Symbol:"ER_DUP_UNKNOWN_IN_INDEX", SQLState:"23000", Message:"Duplicate entry for key '%s'", Description:"ER_DUP_UNKNOWN_IN_INDEX was addedin 5.7.1.", MySQLVersion:"5.7"},
    1860: {ErrorNumber:1860, ErrorType:"ServerError", Symbol:"ER_IDENT_CAUSES_TOO_LONG_PATH", SQLState:"HY000", Message:"Long database name and identifier for object resulted inpath length exceeding %d characters. Path: '%s'.", Description:"ER_IDENT_CAUSES_TOO_LONG_PATH wasadded in 5.7.1.", MySQLVersion:"5.7"},
    1861: {ErrorNumber:1861, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOT_NULL", SQLState:"HY000", Message:"cannot silently convert NULL values, as required in thisSQL_MODE", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_NOT_NULLwas added in 5.7.1.", MySQLVersion:"5.7"},
    1862: {ErrorNumber:1862, ErrorType:"ServerError", Symbol:"ER_MUST_CHANGE_PASSWORD_LOGIN", SQLState:"HY000", Message:"Your password has expired. To log in you must change itusing a client that supports expired passwords.", Description:"ER_MUST_CHANGE_PASSWORD_LOGIN wasadded in 5.7.1.", MySQLVersion:"5.7"},
    1863: {ErrorNumber:1863, ErrorType:"ServerError", Symbol:"ER_ROW_IN_WRONG_PARTITION", SQLState:"HY000", Message:"Found a row in wrong partition %s", Description:"ER_ROW_IN_WRONG_PARTITION wasadded in 5.7.1.", MySQLVersion:"5.7"},
    1864: {ErrorNumber:1864, ErrorType:"ServerError", Symbol:"ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAX", SQLState:"HY000", Message:"Cannot schedule event %s, relay-log name %s, position %sto Worker thread because its size %lu exceeds %lu ofslave_pending_jobs_size_max.", Description:"ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAXwas added in 5.7.2.", MySQLVersion:"5.7"},
    1865: {ErrorNumber:1865, ErrorType:"ServerError", Symbol:"ER_INNODB_NO_FT_USES_PARSER", SQLState:"HY000", Message:"Cannot CREATE FULLTEXT INDEX WITH PARSER on InnoDB table", Description:"ER_INNODB_NO_FT_USES_PARSER wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1866: {ErrorNumber:1866, ErrorType:"ServerError", Symbol:"ER_BINLOG_LOGICAL_CORRUPTION", SQLState:"HY000", Message:"The binary log file '%s' is logically corrupted: %s", Description:"ER_BINLOG_LOGICAL_CORRUPTION wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1867: {ErrorNumber:1867, ErrorType:"ServerError", Symbol:"ER_WARN_PURGE_LOG_IN_USE", SQLState:"HY000", Message:"file %s was not purged because it was being read by %dthread(s), purged only %d out of %d files.", Description:"ER_WARN_PURGE_LOG_IN_USE was addedin 5.7.2.", MySQLVersion:"5.7"},
    1868: {ErrorNumber:1868, ErrorType:"ServerError", Symbol:"ER_WARN_PURGE_LOG_IS_ACTIVE", SQLState:"HY000", Message:"file %s was not purged because it is the active log file.", Description:"ER_WARN_PURGE_LOG_IS_ACTIVE wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1869: {ErrorNumber:1869, ErrorType:"ServerError", Symbol:"ER_AUTO_INCREMENT_CONFLICT", SQLState:"HY000", Message:"Auto-increment value in UPDATE conflicts with internallygenerated values", Description:"ER_AUTO_INCREMENT_CONFLICT wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1870: {ErrorNumber:1870, ErrorType:"ServerError", Symbol:"WARN_ON_BLOCKHOLE_IN_RBR", SQLState:"HY000", Message:"Row events are not logged for %s statements that modifyBLACKHOLE tables in row format. Table(s): '%s'", Description:"WARN_ON_BLOCKHOLE_IN_RBR was addedin 5.7.2.", MySQLVersion:"5.7"},
    1871: {ErrorNumber:1871, ErrorType:"ServerError", Symbol:"ER_SLAVE_MI_INIT_REPOSITORY", SQLState:"HY000", Message:"Slave failed to initialize master info structure from therepository", Description:"ER_SLAVE_MI_INIT_REPOSITORY wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1872: {ErrorNumber:1872, ErrorType:"ServerError", Symbol:"ER_SLAVE_RLI_INIT_REPOSITORY", SQLState:"HY000", Message:"Slave failed to initialize relay log info structure fromthe repository", Description:"ER_SLAVE_RLI_INIT_REPOSITORY wasadded in 5.7.2.", MySQLVersion:"5.7"},
    1873: {ErrorNumber:1873, ErrorType:"ServerError", Symbol:"ER_ACCESS_DENIED_CHANGE_USER_ERROR", SQLState:"28000", Message:"Access denied trying to change to user '%s'@'%s' (usingpassword: %s). Disconnecting.", Description:"ER_ACCESS_DENIED_CHANGE_USER_ERRORwas added in 5.7.2.", MySQLVersion:"5.7"},
    1874: {ErrorNumber:1874, ErrorType:"ServerError", Symbol:"ER_INNODB_READ_ONLY", SQLState:"HY000", Message:"InnoDB is in read only mode.", Description:"ER_INNODB_READ_ONLY was added in5.7.2.", MySQLVersion:"5.7"},
    1875: {ErrorNumber:1875, ErrorType:"ServerError", Symbol:"ER_STOP_SLAVE_SQL_THREAD_TIMEOUT", SQLState:"HY000", Message:"STOP SLAVE command execution is incomplete: Slave SQLthread got the stop signal, thread is busy, SQL thread will stoponce the current task is complete.", Description:"ER_STOP_SLAVE_SQL_THREAD_TIMEOUTwas added in 5.7.2.", MySQLVersion:"5.7"},
    1876: {ErrorNumber:1876, ErrorType:"ServerError", Symbol:"ER_STOP_SLAVE_IO_THREAD_TIMEOUT", SQLState:"HY000", Message:"STOP SLAVE command execution is incomplete: Slave IOthread got the stop signal, thread is busy, IO thread will stoponce the current task is complete.", Description:"ER_STOP_SLAVE_IO_THREAD_TIMEOUTwas added in 5.7.2.", MySQLVersion:"5.7"},
    1877: {ErrorNumber:1877, ErrorType:"ServerError", Symbol:"ER_TABLE_CORRUPT", SQLState:"HY000", Message:"Operation cannot be performed. The table '%s.%s' ismissing, corrupt or contains bad data.", Description:"ER_TABLE_CORRUPT was added in5.7.2.", MySQLVersion:"5.7"},
    1878: {ErrorNumber:1878, ErrorType:"ServerError", Symbol:"ER_TEMP_FILE_WRITE_FAILURE", SQLState:"HY000", Message:"Temporary file write failure.", Description:"ER_TEMP_FILE_WRITE_FAILURE wasadded in 5.7.3.", MySQLVersion:"5.7"},
    1879: {ErrorNumber:1879, ErrorType:"ServerError", Symbol:"ER_INNODB_FT_AUX_NOT_HEX_ID", SQLState:"HY000", Message:"Upgrade index name failed, please use create index(altertable) algorithm copy to rebuild index.", Description:"ER_INNODB_FT_AUX_NOT_HEX_ID wasadded in 5.7.4.", MySQLVersion:"5.7"},
    1880: {ErrorNumber:1880, ErrorType:"ServerError", Symbol:"ER_OLD_TEMPORALS_UPGRADED", SQLState:"HY000", Message:"TIME/TIMESTAMP/DATETIME columns of old format have beenupgraded to the new format.", Description:"ER_OLD_TEMPORALS_UPGRADED wasadded in 5.7.4.", MySQLVersion:"5.7"},
    1881: {ErrorNumber:1881, ErrorType:"ServerError", Symbol:"ER_INNODB_FORCED_RECOVERY", SQLState:"HY000", Message:"Operation not allowed when innodb_forced_recovery > 0.", Description:"ER_INNODB_FORCED_RECOVERY wasadded in 5.7.4.", MySQLVersion:"5.7"},
    1882: {ErrorNumber:1882, ErrorType:"ServerError", Symbol:"ER_AES_INVALID_IV", SQLState:"HY000", Message:"The initialization vector supplied to %s is too short.Must be at least %d bytes long", Description:"ER_AES_INVALID_IV was added in5.7.4.", MySQLVersion:"5.7"},
    1883: {ErrorNumber:1883, ErrorType:"ServerError", Symbol:"ER_PLUGIN_CANNOT_BE_UNINSTALLED", SQLState:"HY000", Message:"Plugin '%s' cannot be uninstalled now. %s", Description:"ER_PLUGIN_CANNOT_BE_UNINSTALLEDwas added in 5.7.5.", MySQLVersion:"5.7"},
    1884: {ErrorNumber:1884, ErrorType:"ServerError", Symbol:"ER_GTID_UNSAFE_BINLOG_SPLITTABLE_STATEMENT_AND_GTID_GROUP", SQLState:"HY000", Message:"Cannot execute statement because it needs to be writtento the binary log as multiple statements, and this is not allowedwhen @@SESSION.GTID_NEXT == 'UUID:NUMBER'.", Description:"ER_GTID_UNSAFE_BINLOG_SPLITTABLE_STATEMENT_AND_GTID_GROUPwas added in 5.7.5.", MySQLVersion:"5.7"},
    1885: {ErrorNumber:1885, ErrorType:"ServerError", Symbol:"ER_SLAVE_HAS_MORE_GTIDS_THAN_MASTER", SQLState:"HY000", Message:"Slave has more GTIDs than the master has, using themaster's SERVER_UUID. This may indicate that the end of the binarylog was truncated or that the last binary log file was lost, e.g.,after a power or disk failure when sync_binlog != 1. The mastermay or may not have rolled back transactions that were alreadyreplicated to the slave. Suggest to replicate any transactionsthat master has rolled back from slave to master, and/or commitempty transactions on master to account for transactions that havebeen committed on master but are not included in GTID_EXECUTED.", Description:"ER_SLAVE_HAS_MORE_GTIDS_THAN_MASTERwas added in 5.7.6.", MySQLVersion:"5.7"},
    1886: {ErrorNumber:1886, ErrorType:"ServerError", Symbol:"ER_MISSING_KEY", SQLState:"HY000", Message:"The table '%s.%s' does not have the necessary key(s)defined on it. Please check the table definition and createindex(s) accordingly.", Description:"ER_MISSING_KEY was added in5.7.22.", MySQLVersion:"5.7"},
    1887: {ErrorNumber:1887, ErrorType:"ServerError", Symbol:"WARN_NAMED_PIPE_ACCESS_EVERYONE", SQLState:"HY000", Message:"Setting named_pipe_full_access_group='%s' is insecure.Consider using a Windows group with fewer members.", Description:"WARN_NAMED_PIPE_ACCESS_EVERYONEwas added in 5.7.27.", MySQLVersion:"5.7"},
    1888: {ErrorNumber:1888, ErrorType:"ServerError", Symbol:"ER_FOUND_MISSING_GTIDS", SQLState:"HY000", Message:"Cannot replicate to server with server_uuid='%s' becausethe present server has purged required binary logs. The connectingserver needs to replicate the missing transactions from elsewhere,or be replaced by a new server created from a more recent backup.To prevent this error in the future, consider increasing thebinary log expiration period on the present server. %s.", Description:"ER_FOUND_MISSING_GTIDS was addedin 5.7.29.", MySQLVersion:"5.7"},
    1906: {ErrorNumber:1906, ErrorType:"ServerError", Symbol:"ER_SLAVE_IO_THREAD_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slaveio thread", Description:"ER_SLAVE_IO_THREAD_MUST_STOP wasadded in 5.7.4, removed after 5.7.5.", MySQLVersion:"5.7"},
    3000: {ErrorNumber:3000, ErrorType:"ServerError", Symbol:"ER_FILE_CORRUPT", SQLState:"HY000", Message:"File %s is corrupted", Description:"", MySQLVersion:"5.7"},
    3001: {ErrorNumber:3001, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_MASTER", SQLState:"HY000", Message:"Query partially completed on the master (error on master:%d) and was aborted. There is a chance that your master isinconsistent at this point. If you are sure that your master isok, run this query manually on the slave and then restart theslave with SET GLOBAL SQL_SLAVE_SKIP_COUNTER=1", Description:".Query:'%s'", MySQLVersion:"5.7"},
    3002: {ErrorNumber:3002, ErrorType:"ServerError", Symbol:"ER_INCONSISTENT_ERROR", SQLState:"HY000", Message:"Query caused different errors on master and slave. Erroron master: message (format)='%s' error code=%d", Description:"Error onslave:actual message='%s', error code=%d. Default database:'%s'.Query:'%s'", MySQLVersion:"5.7"},
    3003: {ErrorNumber:3003, ErrorType:"ServerError", Symbol:"ER_STORAGE_ENGINE_NOT_LOADED", SQLState:"HY000", Message:"Storage engine for table '%s'.'%s' is not loaded.", Description:"", MySQLVersion:"5.7"},
    3004: {ErrorNumber:3004, ErrorType:"ServerError", Symbol:"ER_GET_STACKED_DA_WITHOUT_ACTIVE_HANDLER", SQLState:"0Z002", Message:"GET STACKED DIAGNOSTICS when handler not active", Description:"", MySQLVersion:"5.7"},
    3005: {ErrorNumber:3005, ErrorType:"ServerError", Symbol:"ER_WARN_LEGACY_SYNTAX_CONVERTED", SQLState:"HY000", Message:"%s is no longer supported. The statement was converted to%s.", Description:"", MySQLVersion:"5.7"},
    3006: {ErrorNumber:3006, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_FULLTEXT_PLUGIN", SQLState:"HY000", Message:"Statement is unsafe because it uses a fulltext parserplugin which may not return the same value on the slave.", Description:"ER_BINLOG_UNSAFE_FULLTEXT_PLUGINwas added in 5.7.1.", MySQLVersion:"5.7"},
    3007: {ErrorNumber:3007, ErrorType:"ServerError", Symbol:"ER_CANNOT_DISCARD_TEMPORARY_TABLE", SQLState:"HY000", Message:"Cannot DISCARD/IMPORT tablespace associated withtemporary table", Description:"ER_CANNOT_DISCARD_TEMPORARY_TABLEwas added in 5.7.1.", MySQLVersion:"5.7"},
    3008: {ErrorNumber:3008, ErrorType:"ServerError", Symbol:"ER_FK_DEPTH_EXCEEDED", SQLState:"HY000", Message:"Foreign key cascade delete/update exceeds max depth of%d.", Description:"ER_FK_DEPTH_EXCEEDED was added in5.7.2.", MySQLVersion:"5.7"},
    3009: {ErrorNumber:3009, ErrorType:"ServerError", Symbol:"ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2", SQLState:"HY000", Message:"Column count of %s.%s is wrong. Expected %d, found %d.Created with MySQL %d, now running %d. Please use mysql_upgrade tofix this error.", Description:"ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2was added in 5.7.2.", MySQLVersion:"5.7"},
    3010: {ErrorNumber:3010, ErrorType:"ServerError", Symbol:"ER_WARN_TRIGGER_DOESNT_HAVE_CREATED", SQLState:"HY000", Message:"Trigger %s.%s.%s does not have CREATED attribute.", Description:"ER_WARN_TRIGGER_DOESNT_HAVE_CREATEDwas added in 5.7.2.", MySQLVersion:"5.7"},
    3011: {ErrorNumber:3011, ErrorType:"ServerError", Symbol:"ER_REFERENCED_TRG_DOES_NOT_EXIST", SQLState:"HY000", Message:"Referenced trigger '%s' for the given action time andevent type does not exist.", Description:"ER_REFERENCED_TRG_DOES_NOT_EXISTwas added in 5.7.2.", MySQLVersion:"5.7"},
    3012: {ErrorNumber:3012, ErrorType:"ServerError", Symbol:"ER_EXPLAIN_NOT_SUPPORTED", SQLState:"HY000", Message:"EXPLAIN FOR CONNECTION command is supported only forSELECT/UPDATE/INSERT/DELETE/REPLACE", Description:"ER_EXPLAIN_NOT_SUPPORTED was addedin 5.7.2.", MySQLVersion:"5.7"},
    3013: {ErrorNumber:3013, ErrorType:"ServerError", Symbol:"ER_INVALID_FIELD_SIZE", SQLState:"HY000", Message:"Invalid size for column '%s'.", Description:"ER_INVALID_FIELD_SIZE was added in5.7.2.", MySQLVersion:"5.7"},
    3014: {ErrorNumber:3014, ErrorType:"ServerError", Symbol:"ER_MISSING_HA_CREATE_OPTION", SQLState:"HY000", Message:"Table storage engine '%s' found required create optionmissing", Description:"ER_MISSING_HA_CREATE_OPTION wasadded in 5.7.2.", MySQLVersion:"5.7"},
    3015: {ErrorNumber:3015, ErrorType:"ServerError", Symbol:"ER_ENGINE_OUT_OF_MEMORY", SQLState:"HY000", Message:"Out of memory in storage engine '%s'.", Description:"ER_ENGINE_OUT_OF_MEMORY was addedin 5.7.3.", MySQLVersion:"5.7"},
    3016: {ErrorNumber:3016, ErrorType:"ServerError", Symbol:"ER_PASSWORD_EXPIRE_ANONYMOUS_USER", SQLState:"HY000", Message:"The password for anonymous user cannot be expired.", Description:"ER_PASSWORD_EXPIRE_ANONYMOUS_USERwas added in 5.7.3.", MySQLVersion:"5.7"},
    3017: {ErrorNumber:3017, ErrorType:"ServerError", Symbol:"ER_SLAVE_SQL_THREAD_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slavesql thread", Description:"ER_SLAVE_SQL_THREAD_MUST_STOP wasadded in 5.7.3.", MySQLVersion:"5.7"},
    3018: {ErrorNumber:3018, ErrorType:"ServerError", Symbol:"ER_NO_FT_MATERIALIZED_SUBQUERY", SQLState:"HY000", Message:"Cannot create FULLTEXT index on materialized subquery", Description:"ER_NO_FT_MATERIALIZED_SUBQUERY wasadded in 5.7.4.", MySQLVersion:"5.7"},
    3019: {ErrorNumber:3019, ErrorType:"ServerError", Symbol:"ER_INNODB_UNDO_LOG_FULL", SQLState:"HY000", Message:"Undo Log error: %s", Description:"ER_INNODB_UNDO_LOG_FULL was addedin 5.7.4.", MySQLVersion:"5.7"},
    3020: {ErrorNumber:3020, ErrorType:"ServerError", Symbol:"ER_INVALID_ARGUMENT_FOR_LOGARITHM", SQLState:"2201E", Message:"Invalid argument for logarithm", Description:"ER_INVALID_ARGUMENT_FOR_LOGARITHMwas added in 5.7.4.", MySQLVersion:"5.7"},
    3021: {ErrorNumber:3021, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_IO_THREAD_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slaveio thread", Description:"ER_SLAVE_CHANNEL_IO_THREAD_MUST_STOPwas added in 5.7.6.", MySQLVersion:"5.7"},
    3022: {ErrorNumber:3022, ErrorType:"ServerError", Symbol:"ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZERO", SQLState:"HY000", Message:"This operation may not be safe when the slave hastemporary tables. The tables will be kept open until the serverrestarts or until the tables are deleted by any replicated DROPstatement. Suggest to wait until slave_open_temp_tables = 0.", Description:"ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZEROwas added in 5.7.4.", MySQLVersion:"5.7"},
    3023: {ErrorNumber:3023, ErrorType:"ServerError", Symbol:"ER_WARN_ONLY_MASTER_LOG_FILE_NO_POS", SQLState:"HY000", Message:"CHANGE MASTER TO with a MASTER_LOG_FILE clause but noMASTER_LOG_POS clause may not be safe. The old position value maynot be valid for the new binary log file.", Description:"ER_WARN_ONLY_MASTER_LOG_FILE_NO_POSwas added in 5.7.4.", MySQLVersion:"5.7"},
    3024: {ErrorNumber:3024, ErrorType:"ServerError", Symbol:"ER_QUERY_TIMEOUT", SQLState:"HY000", Message:"Query execution was interrupted, maximum statementexecution time exceeded", Description:"ER_QUERY_TIMEOUT was added in5.7.4.", MySQLVersion:"5.7"},
    3025: {ErrorNumber:3025, ErrorType:"ServerError", Symbol:"ER_NON_RO_SELECT_DISABLE_TIMER", SQLState:"HY000", Message:"Select is not a read only statement, disabling timer", Description:"ER_NON_RO_SELECT_DISABLE_TIMER wasadded in 5.7.4.", MySQLVersion:"5.7"},
    3026: {ErrorNumber:3026, ErrorType:"ServerError", Symbol:"ER_DUP_LIST_ENTRY", SQLState:"HY000", Message:"Duplicate entry '%s'.", Description:"ER_DUP_LIST_ENTRY was added in5.7.4.", MySQLVersion:"5.7"},
    3027: {ErrorNumber:3027, ErrorType:"ServerError", Symbol:"ER_SQL_MODE_NO_EFFECT", SQLState:"HY000", Message:"'%s' mode no longer has any effect. Use STRICT_ALL_TABLESor STRICT_TRANS_TABLES instead.", Description:"ER_SQL_MODE_NO_EFFECT was added in5.7.4.", MySQLVersion:"5.7"},
    3028: {ErrorNumber:3028, ErrorType:"ServerError", Symbol:"ER_AGGREGATE_ORDER_FOR_UNION", SQLState:"HY000", Message:"Expression #%u of ORDER BY contains aggregate functionand applies to a UNION", Description:"ER_AGGREGATE_ORDER_FOR_UNION wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3029: {ErrorNumber:3029, ErrorType:"ServerError", Symbol:"ER_AGGREGATE_ORDER_NON_AGG_QUERY", SQLState:"HY000", Message:"Expression #%u of ORDER BY contains aggregate functionand applies to the result of a non-aggregated query", Description:"ER_AGGREGATE_ORDER_NON_AGG_QUERYwas added in 5.7.5.", MySQLVersion:"5.7"},
    3030: {ErrorNumber:3030, ErrorType:"ServerError", Symbol:"ER_SLAVE_WORKER_STOPPED_PREVIOUS_THD_ERROR", SQLState:"HY000", Message:"Slave worker has stopped after at least one previousworker encountered an error when slave-preserve-commit-order wasenabled. To preserve commit order, the last transaction executedby this thread has not been committed. When restarting the slaveafter fixing any failed threads, you should fix this worker aswell.", Description:"ER_SLAVE_WORKER_STOPPED_PREVIOUS_THD_ERRORwas added in 5.7.5.", MySQLVersion:"5.7"},
    3031: {ErrorNumber:3031, ErrorType:"ServerError", Symbol:"ER_DONT_SUPPORT_SLAVE_PRESERVE_COMMIT_ORDER", SQLState:"HY000", Message:"slave_preserve_commit_order is not supported %s.", Description:"ER_DONT_SUPPORT_SLAVE_PRESERVE_COMMIT_ORDERwas added in 5.7.5.", MySQLVersion:"5.7"},
    3032: {ErrorNumber:3032, ErrorType:"ServerError", Symbol:"ER_SERVER_OFFLINE_MODE", SQLState:"HY000", Message:"The server is currently in offline mode", Description:"ER_SERVER_OFFLINE_MODE was addedin 5.7.5.", MySQLVersion:"5.7"},
    3033: {ErrorNumber:3033, ErrorType:"ServerError", Symbol:"ER_GIS_DIFFERENT_SRIDS", SQLState:"HY000", Message:"Binary geometry function %s given two geometries ofdifferent srids: %u and %u, which should have been identical.", Description:"ER_GIS_DIFFERENT_SRIDS was addedin 5.7.5.", MySQLVersion:"5.7"},
    3034: {ErrorNumber:3034, ErrorType:"ServerError", Symbol:"ER_GIS_UNSUPPORTED_ARGUMENT", SQLState:"HY000", Message:"Calling geometry function %s with unsupported types ofarguments.", Description:"ER_GIS_UNSUPPORTED_ARGUMENT wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3035: {ErrorNumber:3035, ErrorType:"ServerError", Symbol:"ER_GIS_UNKNOWN_ERROR", SQLState:"HY000", Message:"Unknown GIS error occured in function %s.", Description:"ER_GIS_UNKNOWN_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3036: {ErrorNumber:3036, ErrorType:"ServerError", Symbol:"ER_GIS_UNKNOWN_EXCEPTION", SQLState:"HY000", Message:"Unknown exception caught in GIS function %s.", Description:"ER_GIS_UNKNOWN_EXCEPTION was addedin 5.7.5.", MySQLVersion:"5.7"},
    3037: {ErrorNumber:3037, ErrorType:"ServerError", Symbol:"ER_GIS_INVALID_DATA", SQLState:"22023", Message:"Invalid GIS data provided to function %s.", Description:"ER_GIS_INVALID_DATA was added in5.7.5.", MySQLVersion:"5.7"},
    3038: {ErrorNumber:3038, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_EMPTY_INPUT_EXCEPTION", SQLState:"HY000", Message:"The geometry has no data in function %s.", Description:"ER_BOOST_GEOMETRY_EMPTY_INPUT_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3039: {ErrorNumber:3039, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_CENTROID_EXCEPTION", SQLState:"HY000", Message:"Unable to calculate centroid because geometry is empty infunction %s.", Description:"ER_BOOST_GEOMETRY_CENTROID_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3040: {ErrorNumber:3040, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_OVERLAY_INVALID_INPUT_EXCEPTION", SQLState:"HY000", Message:"Geometry overlay calculation error: geometry data isinvalid in function %s.", Description:"ER_BOOST_GEOMETRY_OVERLAY_INVALID_INPUT_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3041: {ErrorNumber:3041, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_TURN_INFO_EXCEPTION", SQLState:"HY000", Message:"Geometry turn info calculation error: geometry data isinvalid in function %s.", Description:"ER_BOOST_GEOMETRY_TURN_INFO_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3042: {ErrorNumber:3042, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_SELF_INTERSECTION_POINT_EXCEPTION", SQLState:"HY000", Message:"Analysis procedures of intersection points interruptedunexpectedly in function %s.", Description:"ER_BOOST_GEOMETRY_SELF_INTERSECTION_POINT_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3043: {ErrorNumber:3043, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_UNKNOWN_EXCEPTION", SQLState:"HY000", Message:"Unknown exception thrown in function %s.", Description:"ER_BOOST_GEOMETRY_UNKNOWN_EXCEPTIONwas added in 5.7.5.", MySQLVersion:"5.7"},
    3044: {ErrorNumber:3044, ErrorType:"ServerError", Symbol:"ER_STD_BAD_ALLOC_ERROR", SQLState:"HY000", Message:"Memory allocation error: %s in function %s.", Description:"ER_STD_BAD_ALLOC_ERROR was addedin 5.7.5.", MySQLVersion:"5.7"},
    3045: {ErrorNumber:3045, ErrorType:"ServerError", Symbol:"ER_STD_DOMAIN_ERROR", SQLState:"HY000", Message:"Domain error: %s in function %s.", Description:"ER_STD_DOMAIN_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3046: {ErrorNumber:3046, ErrorType:"ServerError", Symbol:"ER_STD_LENGTH_ERROR", SQLState:"HY000", Message:"Length error: %s in function %s.", Description:"ER_STD_LENGTH_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3047: {ErrorNumber:3047, ErrorType:"ServerError", Symbol:"ER_STD_INVALID_ARGUMENT", SQLState:"HY000", Message:"Invalid argument error: %s in function %s.", Description:"ER_STD_INVALID_ARGUMENT was addedin 5.7.5.", MySQLVersion:"5.7"},
    3048: {ErrorNumber:3048, ErrorType:"ServerError", Symbol:"ER_STD_OUT_OF_RANGE_ERROR", SQLState:"HY000", Message:"Out of range error: %s in function %s.", Description:"ER_STD_OUT_OF_RANGE_ERROR wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3049: {ErrorNumber:3049, ErrorType:"ServerError", Symbol:"ER_STD_OVERFLOW_ERROR", SQLState:"HY000", Message:"Overflow error error: %s in function %s.", Description:"ER_STD_OVERFLOW_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3050: {ErrorNumber:3050, ErrorType:"ServerError", Symbol:"ER_STD_RANGE_ERROR", SQLState:"HY000", Message:"Range error: %s in function %s.", Description:"ER_STD_RANGE_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3051: {ErrorNumber:3051, ErrorType:"ServerError", Symbol:"ER_STD_UNDERFLOW_ERROR", SQLState:"HY000", Message:"Underflow error: %s in function %s.", Description:"ER_STD_UNDERFLOW_ERROR was addedin 5.7.5.", MySQLVersion:"5.7"},
    3052: {ErrorNumber:3052, ErrorType:"ServerError", Symbol:"ER_STD_LOGIC_ERROR", SQLState:"HY000", Message:"Logic error: %s in function %s.", Description:"ER_STD_LOGIC_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3053: {ErrorNumber:3053, ErrorType:"ServerError", Symbol:"ER_STD_RUNTIME_ERROR", SQLState:"HY000", Message:"Runtime error: %s in function %s.", Description:"ER_STD_RUNTIME_ERROR was added in5.7.5.", MySQLVersion:"5.7"},
    3054: {ErrorNumber:3054, ErrorType:"ServerError", Symbol:"ER_STD_UNKNOWN_EXCEPTION", SQLState:"HY000", Message:"Unknown exception: %s in function %s.", Description:"ER_STD_UNKNOWN_EXCEPTION was addedin 5.7.5.", MySQLVersion:"5.7"},
    3055: {ErrorNumber:3055, ErrorType:"ServerError", Symbol:"ER_GIS_DATA_WRONG_ENDIANESS", SQLState:"HY000", Message:"Geometry byte string must be little endian.", Description:"ER_GIS_DATA_WRONG_ENDIANESS wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3056: {ErrorNumber:3056, ErrorType:"ServerError", Symbol:"ER_CHANGE_MASTER_PASSWORD_LENGTH", SQLState:"HY000", Message:"The password provided for the replication user exceedsthe maximum length of 32 characters", Description:"ER_CHANGE_MASTER_PASSWORD_LENGTHwas added in 5.7.5.", MySQLVersion:"5.7"},
    3057: {ErrorNumber:3057, ErrorType:"ServerError", Symbol:"ER_USER_LOCK_WRONG_NAME", SQLState:"42000", Message:"Incorrect user-level lock name '%s'.", Description:"ER_USER_LOCK_WRONG_NAME was addedin 5.7.5.", MySQLVersion:"5.7"},
    3058: {ErrorNumber:3058, ErrorType:"ServerError", Symbol:"ER_USER_LOCK_DEADLOCK", SQLState:"HY000", Message:"Deadlock found when trying to get user-level lock", Description:"ER_USER_LOCK_DEADLOCK was added in5.7.5.", MySQLVersion:"5.7"},
    3059: {ErrorNumber:3059, ErrorType:"ServerError", Symbol:"ER_REPLACE_INACCESSIBLE_ROWS", SQLState:"HY000", Message:"REPLACE cannot be executed as it requires deleting rowsthat are not in the view", Description:"ER_REPLACE_INACCESSIBLE_ROWS wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3060: {ErrorNumber:3060, ErrorType:"ServerError", Symbol:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_GIS", SQLState:"HY000", Message:"Do not support online operation on table with GIS index", Description:"ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_GISwas added in 5.7.5.", MySQLVersion:"5.7"},
    3061: {ErrorNumber:3061, ErrorType:"ServerError", Symbol:"ER_ILLEGAL_USER_VAR", SQLState:"42000", Message:"User variable name '%s' is illegal", Description:"ER_ILLEGAL_USER_VAR was added in5.7.5.", MySQLVersion:"5.7"},
    3062: {ErrorNumber:3062, ErrorType:"ServerError", Symbol:"ER_GTID_MODE_OFF", SQLState:"HY000", Message:"Cannot %s when GTID_MODE = OFF.", Description:"ER_GTID_MODE_OFF was added in5.7.5.", MySQLVersion:"5.7"},
    3063: {ErrorNumber:3063, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_BY_REPLICATION_THREAD", SQLState:"HY000", Message:"Cannot %s from a replication slave thread.", Description:"ER_UNSUPPORTED_BY_REPLICATION_THREADwas added in 5.7.5.", MySQLVersion:"5.7"},
    3064: {ErrorNumber:3064, ErrorType:"ServerError", Symbol:"ER_INCORRECT_TYPE", SQLState:"HY000", Message:"Incorrect type for argument %s in function %s.", Description:"ER_INCORRECT_TYPE was added in5.7.5.", MySQLVersion:"5.7"},
    3065: {ErrorNumber:3065, ErrorType:"ServerError", Symbol:"ER_FIELD_IN_ORDER_NOT_SELECT", SQLState:"HY000", Message:"Expression #%u of ORDER BY clause is not in SELECT list,references column '%s' which is not in SELECT list", Description:"ER_FIELD_IN_ORDER_NOT_SELECT wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3066: {ErrorNumber:3066, ErrorType:"ServerError", Symbol:"ER_AGGREGATE_IN_ORDER_NOT_SELECT", SQLState:"HY000", Message:"Expression #%u of ORDER BY clause is not in SELECT list,contains aggregate function", Description:"ER_AGGREGATE_IN_ORDER_NOT_SELECTwas added in 5.7.5.", MySQLVersion:"5.7"},
    3067: {ErrorNumber:3067, ErrorType:"ServerError", Symbol:"ER_INVALID_RPL_WILD_TABLE_FILTER_PATTERN", SQLState:"HY000", Message:"Supplied filter list contains a value which is not in therequired format 'db_pattern.table_pattern'", Description:"ER_INVALID_RPL_WILD_TABLE_FILTER_PATTERNwas added in 5.7.5.", MySQLVersion:"5.7"},
    3068: {ErrorNumber:3068, ErrorType:"ServerError", Symbol:"ER_NET_OK_PACKET_TOO_LARGE", SQLState:"08S01", Message:"OK packet too large", Description:"ER_NET_OK_PACKET_TOO_LARGE wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3069: {ErrorNumber:3069, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_DATA", SQLState:"HY000", Message:"Invalid JSON data provided to function %s: %s", Description:"ER_INVALID_JSON_DATA was added in5.7.5.", MySQLVersion:"5.7"},
    3070: {ErrorNumber:3070, ErrorType:"ServerError", Symbol:"ER_INVALID_GEOJSON_MISSING_MEMBER", SQLState:"HY000", Message:"Invalid GeoJSON data provided to function %s: Missingrequired member '%s'", Description:"ER_INVALID_GEOJSON_MISSING_MEMBERwas added in 5.7.5.", MySQLVersion:"5.7"},
    3071: {ErrorNumber:3071, ErrorType:"ServerError", Symbol:"ER_INVALID_GEOJSON_WRONG_TYPE", SQLState:"HY000", Message:"Invalid GeoJSON data provided to function %s: Member '%s'must be of type '%s'", Description:"ER_INVALID_GEOJSON_WRONG_TYPE wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3072: {ErrorNumber:3072, ErrorType:"ServerError", Symbol:"ER_INVALID_GEOJSON_UNSPECIFIED", SQLState:"HY000", Message:"Invalid GeoJSON data provided to function %s", Description:"ER_INVALID_GEOJSON_UNSPECIFIED wasadded in 5.7.5.", MySQLVersion:"5.7"},
    3073: {ErrorNumber:3073, ErrorType:"ServerError", Symbol:"ER_DIMENSION_UNSUPPORTED", SQLState:"HY000", Message:"Unsupported number of coordinate dimensions in function%s: Found %u, expected %u", Description:"ER_DIMENSION_UNSUPPORTED was addedin 5.7.5.", MySQLVersion:"5.7"},
    3074: {ErrorNumber:3074, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_DOES_NOT_EXIST", SQLState:"HY000", Message:"Slave channel '%s' does not exist.", Description:"ER_SLAVE_CHANNEL_DOES_NOT_EXISTwas added in 5.7.6.", MySQLVersion:"5.7"},
    3075: {ErrorNumber:3075, ErrorType:"ServerError", Symbol:"ER_SLAVE_MULTIPLE_CHANNELS_HOST_PORT", SQLState:"HY000", Message:"A slave channel '%s' already exists for the given hostand port combination.", Description:"ER_SLAVE_MULTIPLE_CHANNELS_HOST_PORTwas added in 5.7.6.", MySQLVersion:"5.7"},
    3076: {ErrorNumber:3076, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_NAME_INVALID_OR_TOO_LONG", SQLState:"HY000", Message:"Couldn't create channel: Channel name is either invalidor too long.", Description:"ER_SLAVE_CHANNEL_NAME_INVALID_OR_TOO_LONGwas added in 5.7.6.", MySQLVersion:"5.7"},
    3077: {ErrorNumber:3077, ErrorType:"ServerError", Symbol:"ER_SLAVE_NEW_CHANNEL_WRONG_REPOSITORY", SQLState:"HY000", Message:"To have multiple channels, repository cannot be of typeFILE", Description:"ER_SLAVE_NEW_CHANNEL_WRONG_REPOSITORYwas added in 5.7.6.", MySQLVersion:"5.7"},
    3078: {ErrorNumber:3078, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_DELETE", SQLState:"HY000", Message:"Cannot delete slave info objects for channel '%s'.", Description:"ER_SLAVE_CHANNEL_DELETE was addedin 5.7.6.", MySQLVersion:"5.7"},
    3079: {ErrorNumber:3079, ErrorType:"ServerError", Symbol:"ER_SLAVE_MULTIPLE_CHANNELS_CMD", SQLState:"HY000", Message:"Multiple channels exist on the slave. Please providechannel name as an argument.", Description:"ER_SLAVE_MULTIPLE_CHANNELS_CMD wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3080: {ErrorNumber:3080, ErrorType:"ServerError", Symbol:"ER_SLAVE_MAX_CHANNELS_EXCEEDED", SQLState:"HY000", Message:"Maximum number of replication channels allowed exceeded.", Description:"ER_SLAVE_MAX_CHANNELS_EXCEEDED wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3081: {ErrorNumber:3081, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with runningreplication threads", Description:"ER_SLAVE_CHANNEL_MUST_STOP wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3082: {ErrorNumber:3082, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_NOT_RUNNING", SQLState:"HY000", Message:"This operation requires running replication threads", Description:"ER_SLAVE_CHANNEL_NOT_RUNNING wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3083: {ErrorNumber:3083, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_WAS_RUNNING", SQLState:"HY000", Message:"Replication thread(s) for channel '%s' are alreadyrunnning.", Description:"ER_SLAVE_CHANNEL_WAS_RUNNING wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3084: {ErrorNumber:3084, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_WAS_NOT_RUNNING", SQLState:"HY000", Message:"Replication thread(s) for channel '%s' are alreadystopped.", Description:"ER_SLAVE_CHANNEL_WAS_NOT_RUNNINGwas added in 5.7.6.", MySQLVersion:"5.7"},
    3085: {ErrorNumber:3085, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_SQL_THREAD_MUST_STOP", SQLState:"HY000", Message:"This operation cannot be performed with a running slavesql thread", Description:"ER_SLAVE_CHANNEL_SQL_THREAD_MUST_STOPwas added in 5.7.6.", MySQLVersion:"5.7"},
    3086: {ErrorNumber:3086, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_SQL_SKIP_COUNTER", SQLState:"HY000", Message:"When sql_slave_skip_counter > 0, it is not allowed tostart more than one SQL thread by using 'START SLAVE[SQL_THREAD]'. Value of sql_slave_skip_counter can only be used byone SQL thread at a time. Please use 'START SLAVE [SQL_THREAD] FORCHANNEL' to start the SQL thread which will use the value ofsql_slave_skip_counter.", Description:"ER_SLAVE_CHANNEL_SQL_SKIP_COUNTERwas added in 5.7.6.", MySQLVersion:"5.7"},
    3087: {ErrorNumber:3087, ErrorType:"ServerError", Symbol:"ER_WRONG_FIELD_WITH_GROUP_V2", SQLState:"HY000", Message:"Expression #%u of %s is not in GROUP BY clause andcontains nonaggregated column '%s' which is not functionallydependent on columns in GROUP BY clause", Description:"ER_WRONG_FIELD_WITH_GROUP_V2 wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3088: {ErrorNumber:3088, ErrorType:"ServerError", Symbol:"ER_MIX_OF_GROUP_FUNC_AND_FIELDS_V2", SQLState:"HY000", Message:"In aggregated query without GROUP BY, expression #%u of%s contains nonaggregated column '%s'", Description:"ER_MIX_OF_GROUP_FUNC_AND_FIELDS_V2was added in 5.7.6.", MySQLVersion:"5.7"},
    3089: {ErrorNumber:3089, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SYSVAR_UPDATE", SQLState:"HY000", Message:"Updating '%s' is deprecated. It will be made read-only ina future release.", Description:"ER_WARN_DEPRECATED_SYSVAR_UPDATEwas added in 5.7.6.", MySQLVersion:"5.7"},
    3090: {ErrorNumber:3090, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_SQLMODE", SQLState:"HY000", Message:"Changing sql mode '%s' is deprecated. It will be removedin a future release.", Description:"ER_WARN_DEPRECATED_SQLMODE wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3091: {ErrorNumber:3091, ErrorType:"ServerError", Symbol:"ER_CANNOT_LOG_PARTIAL_DROP_DATABASE_WITH_GTID", SQLState:"HY000", Message:"DROP DATABASE failed", Description:"ER_CANNOT_LOG_PARTIAL_DROP_DATABASE_WITH_GTIDwas added in 5.7.6.", MySQLVersion:"5.7"},
    3092: {ErrorNumber:3092, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_CONFIGURATION", SQLState:"HY000", Message:"The server is not configured properly to be an activemember of the group. Please see more details on error log.", Description:"ER_GROUP_REPLICATION_CONFIGURATIONwas added in 5.7.6.", MySQLVersion:"5.7"},
    3093: {ErrorNumber:3093, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_RUNNING", SQLState:"HY000", Message:"The START GROUP_REPLICATION command failed since thegroup is already running.", Description:"ER_GROUP_REPLICATION_RUNNING wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3094: {ErrorNumber:3094, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_APPLIER_INIT_ERROR", SQLState:"HY000", Message:"The START GROUP_REPLICATION command failed as the appliermodule failed to start.", Description:"ER_GROUP_REPLICATION_APPLIER_INIT_ERRORwas added in 5.7.6.", MySQLVersion:"5.7"},
    3095: {ErrorNumber:3095, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_STOP_APPLIER_THREAD_TIMEOUT", SQLState:"HY000", Message:"The STOP GROUP_REPLICATION command execution isincomplete: The applier thread got the stop signal while it wasbusy. The applier thread will stop once the current task iscomplete.", Description:"ER_GROUP_REPLICATION_STOP_APPLIER_THREAD_TIMEOUTwas added in 5.7.6.", MySQLVersion:"5.7"},
    3096: {ErrorNumber:3096, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_COMMUNICATION_LAYER_SESSION_ERROR", SQLState:"HY000", Message:"The START GROUP_REPLICATION command failed as there wasan error when initializing the group communication layer.", Description:"ER_GROUP_REPLICATION_COMMUNICATION_LAYER_SESSION_ERRORwas added in 5.7.6.", MySQLVersion:"5.7"},
    3097: {ErrorNumber:3097, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_COMMUNICATION_LAYER_JOIN_ERROR", SQLState:"HY000", Message:"The START GROUP_REPLICATION command failed as there wasan error when joining the communication group.", Description:"ER_GROUP_REPLICATION_COMMUNICATION_LAYER_JOIN_ERRORwas added in 5.7.6.", MySQLVersion:"5.7"},
    3098: {ErrorNumber:3098, ErrorType:"ServerError", Symbol:"ER_BEFORE_DML_VALIDATION_ERROR", SQLState:"HY000", Message:"The table does not comply with the requirements by anexternal plugin.", Description:"ER_BEFORE_DML_VALIDATION_ERROR wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3099: {ErrorNumber:3099, ErrorType:"ServerError", Symbol:"ER_PREVENTS_VARIABLE_WITHOUT_RBR", SQLState:"HY000", Message:"Cannot change the value of variable %s without binary logformat as ROW.", Description:"ER_PREVENTS_VARIABLE_WITHOUT_RBRwas added in 5.7.6.", MySQLVersion:"5.7"},
    3100: {ErrorNumber:3100, ErrorType:"ServerError", Symbol:"ER_RUN_HOOK_ERROR", SQLState:"HY000", Message:"Error on observer while running replication hook '%s'.", Description:"ER_RUN_HOOK_ERROR was added in5.7.6.", MySQLVersion:"5.7"},
    3101: {ErrorNumber:3101, ErrorType:"ServerError", Symbol:"ER_TRANSACTION_ROLLBACK_DURING_COMMIT", SQLState:"HY000", Message:"Plugin instructed the server to rollback the currenttransaction.", Description:"ER_TRANSACTION_ROLLBACK_DURING_COMMITwas added in 5.7.6.", MySQLVersion:"5.7"},
    3102: {ErrorNumber:3102, ErrorType:"ServerError", Symbol:"ER_GENERATED_COLUMN_FUNCTION_IS_NOT_ALLOWED", SQLState:"HY000", Message:"Expression of generated column '%s' contains a disallowedfunction.", Description:"ER_GENERATED_COLUMN_FUNCTION_IS_NOT_ALLOWEDwas added in 5.7.6.", MySQLVersion:"5.7"},
    3103: {ErrorNumber:3103, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ALTER_INPLACE_ON_VIRTUAL_COLUMN", SQLState:"HY000", Message:"INPLACE ADD or DROP of virtual columns cannot be combinedwith other ALTER TABLE actions", Description:"ER_UNSUPPORTED_ALTER_INPLACE_ON_VIRTUAL_COLUMNwas added in 5.7.8.", MySQLVersion:"5.7"},
    3104: {ErrorNumber:3104, ErrorType:"ServerError", Symbol:"ER_WRONG_FK_OPTION_FOR_GENERATED_COLUMN", SQLState:"HY000", Message:"Cannot define foreign key with %s clause on a generatedcolumn.", Description:"ER_WRONG_FK_OPTION_FOR_GENERATED_COLUMNwas added in 5.7.6.", MySQLVersion:"5.7"},
    3105: {ErrorNumber:3105, ErrorType:"ServerError", Symbol:"ER_NON_DEFAULT_VALUE_FOR_GENERATED_COLUMN", SQLState:"HY000", Message:"The value specified for generated column '%s' in table'%s' is not allowed.", Description:"ER_NON_DEFAULT_VALUE_FOR_GENERATED_COLUMNwas added in 5.7.6.", MySQLVersion:"5.7"},
    3106: {ErrorNumber:3106, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ACTION_ON_GENERATED_COLUMN", SQLState:"HY000", Message:"'%s' is not supported for generated columns.", Description:"ER_UNSUPPORTED_ACTION_ON_GENERATED_COLUMNwas added in 5.7.6.", MySQLVersion:"5.7"},
    3107: {ErrorNumber:3107, ErrorType:"ServerError", Symbol:"ER_GENERATED_COLUMN_NON_PRIOR", SQLState:"HY000", Message:"Generated column can refer only to generated columnsdefined prior to it.", Description:"ER_GENERATED_COLUMN_NON_PRIOR wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3108: {ErrorNumber:3108, ErrorType:"ServerError", Symbol:"ER_DEPENDENT_BY_GENERATED_COLUMN", SQLState:"HY000", Message:"Column '%s' has a generated column dependency.", Description:"ER_DEPENDENT_BY_GENERATED_COLUMNwas added in 5.7.6.", MySQLVersion:"5.7"},
    3109: {ErrorNumber:3109, ErrorType:"ServerError", Symbol:"ER_GENERATED_COLUMN_REF_AUTO_INC", SQLState:"HY000", Message:"Generated column '%s' cannot refer to auto-incrementcolumn.", Description:"ER_GENERATED_COLUMN_REF_AUTO_INCwas added in 5.7.6.", MySQLVersion:"5.7"},
    3110: {ErrorNumber:3110, ErrorType:"ServerError", Symbol:"ER_FEATURE_NOT_AVAILABLE", SQLState:"HY000", Message:"The '%s' feature is not available", Description:"ER_FEATURE_NOT_AVAILABLE was addedin 5.7.6.", MySQLVersion:"5.7"},
    3111: {ErrorNumber:3111, ErrorType:"ServerError", Symbol:"ER_CANT_SET_GTID_MODE", SQLState:"HY000", Message:"SET @@GLOBAL.GTID_MODE = %s is not allowed because %s.", Description:"ER_CANT_SET_GTID_MODE was added in5.7.6.", MySQLVersion:"5.7"},
    3112: {ErrorNumber:3112, ErrorType:"ServerError", Symbol:"ER_CANT_USE_AUTO_POSITION_WITH_GTID_MODE_OFF", SQLState:"HY000", Message:"The replication receiver thread%s cannot start inAUTO_POSITION mode: this server uses @@GLOBAL.GTID_MODE = OFF.", Description:"ER_CANT_USE_AUTO_POSITION_WITH_GTID_MODE_OFFwas added in 5.7.6.", MySQLVersion:"5.7"},
    3113: {ErrorNumber:3113, ErrorType:"ServerError", Symbol:"ER_CANT_REPLICATE_ANONYMOUS_WITH_AUTO_POSITION", SQLState:"HY000", Message:"Cannot replicate anonymous transaction when AUTO_POSITION= 1, at file %s, position %lld.", Description:"ER_CANT_REPLICATE_ANONYMOUS_WITH_AUTO_POSITIONwas added in 5.7.6.", MySQLVersion:"5.7"},
    3114: {ErrorNumber:3114, ErrorType:"ServerError", Symbol:"ER_CANT_REPLICATE_ANONYMOUS_WITH_GTID_MODE_ON", SQLState:"HY000", Message:"Cannot replicate anonymous transaction when@@GLOBAL.GTID_MODE = ON, at file %s, position %lld.", Description:"ER_CANT_REPLICATE_ANONYMOUS_WITH_GTID_MODE_ONwas added in 5.7.6.", MySQLVersion:"5.7"},
    3115: {ErrorNumber:3115, ErrorType:"ServerError", Symbol:"ER_CANT_REPLICATE_GTID_WITH_GTID_MODE_OFF", SQLState:"HY000", Message:"Cannot replicate GTID-transaction when @@GLOBAL.GTID_MODE= OFF, at file %s, position %lld.", Description:"ER_CANT_REPLICATE_GTID_WITH_GTID_MODE_OFFwas added in 5.7.6.", MySQLVersion:"5.7"},
    3116: {ErrorNumber:3116, ErrorType:"ServerError", Symbol:"ER_CANT_SET_ENFORCE_GTID_CONSISTENCY_ON_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONS", SQLState:"HY000", Message:"Cannot set ENFORCE_GTID_CONSISTENCY = ON because thereare ongoing transactions that violate GTID consistency.", Description:"ER_CANT_SET_ENFORCE_GTID_CONSISTENCY_ON_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONSwas added in 5.7.6.", MySQLVersion:"5.7"},
    3117: {ErrorNumber:3117, ErrorType:"ServerError", Symbol:"ER_SET_ENFORCE_GTID_CONSISTENCY_WARN_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONS", SQLState:"HY000", Message:"There are ongoing transactions that violate GTIDconsistency.", Description:"ER_SET_ENFORCE_GTID_CONSISTENCY_WARN_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONSwas added in 5.7.6.", MySQLVersion:"5.7"},
    3118: {ErrorNumber:3118, ErrorType:"ServerError", Symbol:"ER_ACCOUNT_HAS_BEEN_LOCKED", SQLState:"HY000", Message:"Access denied for user '%s'@'%s'. Account is locked.", Description:"ER_ACCOUNT_HAS_BEEN_LOCKED wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3119: {ErrorNumber:3119, ErrorType:"ServerError", Symbol:"ER_WRONG_TABLESPACE_NAME", SQLState:"42000", Message:"Incorrect tablespace name `%s`", Description:"ER_WRONG_TABLESPACE_NAME was addedin 5.7.6.", MySQLVersion:"5.7"},
    3120: {ErrorNumber:3120, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_IS_NOT_EMPTY", SQLState:"HY000", Message:"Tablespace `%s` is not empty.", Description:"ER_TABLESPACE_IS_NOT_EMPTY wasadded in 5.7.6.", MySQLVersion:"5.7"},
    3121: {ErrorNumber:3121, ErrorType:"ServerError", Symbol:"ER_WRONG_FILE_NAME", SQLState:"HY000", Message:"Incorrect File Name '%s'.", Description:"ER_WRONG_FILE_NAME was added in5.7.6.", MySQLVersion:"5.7"},
    3122: {ErrorNumber:3122, ErrorType:"ServerError", Symbol:"ER_BOOST_GEOMETRY_INCONSISTENT_TURNS_EXCEPTION", SQLState:"HY000", Message:"Inconsistent intersection points.", Description:"ER_BOOST_GEOMETRY_INCONSISTENT_TURNS_EXCEPTIONwas added in 5.7.7.", MySQLVersion:"5.7"},
    3123: {ErrorNumber:3123, ErrorType:"ServerError", Symbol:"ER_WARN_OPTIMIZER_HINT_SYNTAX_ERROR", SQLState:"HY000", Message:"Optimizer hint syntax error", Description:"ER_WARN_OPTIMIZER_HINT_SYNTAX_ERRORwas added in 5.7.7.", MySQLVersion:"5.7"},
    3124: {ErrorNumber:3124, ErrorType:"ServerError", Symbol:"ER_WARN_BAD_MAX_EXECUTION_TIME", SQLState:"HY000", Message:"Unsupported MAX_EXECUTION_TIME", Description:"ER_WARN_BAD_MAX_EXECUTION_TIME wasadded in 5.7.7.", MySQLVersion:"5.7"},
    3125: {ErrorNumber:3125, ErrorType:"ServerError", Symbol:"ER_WARN_UNSUPPORTED_MAX_EXECUTION_TIME", SQLState:"HY000", Message:"MAX_EXECUTION_TIME hint is supported by top-levelstandalone SELECT statements only", Description:"ER_WARN_UNSUPPORTED_MAX_EXECUTION_TIMEwas added in 5.7.7.", MySQLVersion:"5.7"},
    3126: {ErrorNumber:3126, ErrorType:"ServerError", Symbol:"ER_WARN_CONFLICTING_HINT", SQLState:"HY000", Message:"Hint %s is ignored as conflicting/duplicated", Description:"ER_WARN_CONFLICTING_HINT was addedin 5.7.7.", MySQLVersion:"5.7"},
    3127: {ErrorNumber:3127, ErrorType:"ServerError", Symbol:"ER_WARN_UNKNOWN_QB_NAME", SQLState:"HY000", Message:"Query block name %s is not found for %s hint", Description:"ER_WARN_UNKNOWN_QB_NAME was addedin 5.7.7.", MySQLVersion:"5.7"},
    3128: {ErrorNumber:3128, ErrorType:"ServerError", Symbol:"ER_UNRESOLVED_HINT_NAME", SQLState:"HY000", Message:"Unresolved name %s for %s hint", Description:"ER_UNRESOLVED_HINT_NAME was addedin 5.7.7.", MySQLVersion:"5.7"},
    3129: {ErrorNumber:3129, ErrorType:"ServerError", Symbol:"ER_WARN_ON_MODIFYING_GTID_EXECUTED_TABLE", SQLState:"HY000", Message:"Please do not modify the %s table. This is a mysqlinternal system table to store GTIDs for committed transactions.Modifying it can lead to an inconsistent GTID state.", Description:"ER_WARN_ON_MODIFYING_GTID_EXECUTED_TABLEwas added in 5.7.8.", MySQLVersion:"5.7"},
    3130: {ErrorNumber:3130, ErrorType:"ServerError", Symbol:"ER_PLUGGABLE_PROTOCOL_COMMAND_NOT_SUPPORTED", SQLState:"HY000", Message:"Command not supported by pluggable protocols", Description:"ER_PLUGGABLE_PROTOCOL_COMMAND_NOT_SUPPORTEDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3131: {ErrorNumber:3131, ErrorType:"ServerError", Symbol:"ER_LOCKING_SERVICE_WRONG_NAME", SQLState:"42000", Message:"Incorrect locking service lock name '%s'.", Description:"ER_LOCKING_SERVICE_WRONG_NAME wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3132: {ErrorNumber:3132, ErrorType:"ServerError", Symbol:"ER_LOCKING_SERVICE_DEADLOCK", SQLState:"HY000", Message:"Deadlock found when trying to get locking service lock", Description:"ER_LOCKING_SERVICE_DEADLOCK wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3133: {ErrorNumber:3133, ErrorType:"ServerError", Symbol:"ER_LOCKING_SERVICE_TIMEOUT", SQLState:"HY000", Message:"Service lock wait timeout exceeded.", Description:"ER_LOCKING_SERVICE_TIMEOUT wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3134: {ErrorNumber:3134, ErrorType:"ServerError", Symbol:"ER_GIS_MAX_POINTS_IN_GEOMETRY_OVERFLOWED", SQLState:"HY000", Message:"Parameter %s exceeds the maximum number of points in ageometry (%lu) in function %s.", Description:"ER_GIS_MAX_POINTS_IN_GEOMETRY_OVERFLOWEDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3135: {ErrorNumber:3135, ErrorType:"ServerError", Symbol:"ER_SQL_MODE_MERGED", SQLState:"HY000", Message:"'NO_ZERO_DATE', 'NO_ZERO_IN_DATE' and'ERROR_FOR_DIVISION_BY_ZERO' sql modes should be used with strictmode. They will be merged with strict mode in a future release.", Description:"ER_SQL_MODE_MERGED was added in5.7.8.", MySQLVersion:"5.7"},
    3136: {ErrorNumber:3136, ErrorType:"ServerError", Symbol:"ER_VTOKEN_PLUGIN_TOKEN_MISMATCH", SQLState:"HY000", Message:"Version token mismatch for %.*s. Correct value %.*s", Description:"ER_VTOKEN_PLUGIN_TOKEN_MISMATCHwas added in 5.7.8.", MySQLVersion:"5.7"},
    3137: {ErrorNumber:3137, ErrorType:"ServerError", Symbol:"ER_VTOKEN_PLUGIN_TOKEN_NOT_FOUND", SQLState:"HY000", Message:"Version token %.*s not found.", Description:"ER_VTOKEN_PLUGIN_TOKEN_NOT_FOUNDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3138: {ErrorNumber:3138, ErrorType:"ServerError", Symbol:"ER_CANT_SET_VARIABLE_WHEN_OWNING_GTID", SQLState:"HY000", Message:"Variable %s cannot be changed by a client that owns aGTID. The client owns %s. Ownership is released on COMMIT orROLLBACK.", Description:"ER_CANT_SET_VARIABLE_WHEN_OWNING_GTIDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3139: {ErrorNumber:3139, ErrorType:"ServerError", Symbol:"ER_SLAVE_CHANNEL_OPERATION_NOT_ALLOWED", SQLState:"HY000", Message:"%s cannot be performed on channel '%s'.", Description:"ER_SLAVE_CHANNEL_OPERATION_NOT_ALLOWEDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3140: {ErrorNumber:3140, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_TEXT", SQLState:"22032", Message:"Invalid JSON text: \"%s\" at position %u in value forcolumn '%s'.", Description:"ER_INVALID_JSON_TEXT was added in5.7.8.", MySQLVersion:"5.7"},
    3141: {ErrorNumber:3141, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_TEXT_IN_PARAM", SQLState:"22032", Message:"Invalid JSON text in argument %u to function %s: \"%s\" atposition %u.%s", Description:"ER_INVALID_JSON_TEXT_IN_PARAM wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3142: {ErrorNumber:3142, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_BINARY_DATA", SQLState:"HY000", Message:"The JSON binary value contains invalid data.", Description:"ER_INVALID_JSON_BINARY_DATA wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3143: {ErrorNumber:3143, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_PATH", SQLState:"42000", Message:"Invalid JSON path expression. The error is aroundcharacter position %u.%s", Description:"ER_INVALID_JSON_PATH was added in5.7.8.", MySQLVersion:"5.7"},
    3144: {ErrorNumber:3144, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_CHARSET", SQLState:"22032", Message:"Cannot create a JSON value from a string with CHARACTERSET '%s'.", Description:"ER_INVALID_JSON_CHARSET was addedin 5.7.8.", MySQLVersion:"5.7"},
    3145: {ErrorNumber:3145, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_CHARSET_IN_FUNCTION", SQLState:"22032", Message:"Invalid JSON character data provided to function %s:'%s'", Description:"ER_INVALID_JSON_CHARSET_IN_FUNCTIONwas added in 5.7.8.", MySQLVersion:"5.7"},
    3146: {ErrorNumber:3146, ErrorType:"ServerError", Symbol:"ER_INVALID_TYPE_FOR_JSON", SQLState:"22032", Message:"Invalid data type for JSON data in argument %u tofunction %s", Description:"ER_INVALID_TYPE_FOR_JSON was addedin 5.7.8.", MySQLVersion:"5.7"},
    3147: {ErrorNumber:3147, ErrorType:"ServerError", Symbol:"ER_INVALID_CAST_TO_JSON", SQLState:"22032", Message:"Cannot CAST value to JSON.", Description:"ER_INVALID_CAST_TO_JSON was addedin 5.7.8.", MySQLVersion:"5.7"},
    3148: {ErrorNumber:3148, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_PATH_CHARSET", SQLState:"42000", Message:"A path expression must be encoded in the utf8 characterset. The path expression '%s' is encoded in character set '%s'.", Description:"ER_INVALID_JSON_PATH_CHARSET wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3149: {ErrorNumber:3149, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_PATH_WILDCARD", SQLState:"42000", Message:"In this situation, path expressions may not contain the *and ** tokens.", Description:"ER_INVALID_JSON_PATH_WILDCARD wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3150: {ErrorNumber:3150, ErrorType:"ServerError", Symbol:"ER_JSON_VALUE_TOO_BIG", SQLState:"22032", Message:"The JSON value is too big to be stored in a JSON column.", Description:"ER_JSON_VALUE_TOO_BIG was added in5.7.8.", MySQLVersion:"5.7"},
    3151: {ErrorNumber:3151, ErrorType:"ServerError", Symbol:"ER_JSON_KEY_TOO_BIG", SQLState:"22032", Message:"The JSON object contains a key name that is too long.", Description:"ER_JSON_KEY_TOO_BIG was added in5.7.8.", MySQLVersion:"5.7"},
    3152: {ErrorNumber:3152, ErrorType:"ServerError", Symbol:"ER_JSON_USED_AS_KEY", SQLState:"42000", Message:"JSON column '%s' cannot be used in key specification.", Description:"ER_JSON_USED_AS_KEY was added in5.7.8.", MySQLVersion:"5.7"},
    3153: {ErrorNumber:3153, ErrorType:"ServerError", Symbol:"ER_JSON_VACUOUS_PATH", SQLState:"42000", Message:"The path expression '$' is not allowed in this context.", Description:"ER_JSON_VACUOUS_PATH was added in5.7.8.", MySQLVersion:"5.7"},
    3154: {ErrorNumber:3154, ErrorType:"ServerError", Symbol:"ER_JSON_BAD_ONE_OR_ALL_ARG", SQLState:"42000", Message:"The oneOrAll argument to %s may take these values: 'one'or 'all'.", Description:"ER_JSON_BAD_ONE_OR_ALL_ARG wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3155: {ErrorNumber:3155, ErrorType:"ServerError", Symbol:"ER_NUMERIC_JSON_VALUE_OUT_OF_RANGE", SQLState:"22003", Message:"Out of range JSON value for CAST to %s%s from column %sat row %ld", Description:"ER_NUMERIC_JSON_VALUE_OUT_OF_RANGEwas added in 5.7.8.", MySQLVersion:"5.7"},
    3156: {ErrorNumber:3156, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_VALUE_FOR_CAST", SQLState:"22018", Message:"Invalid JSON value for CAST to %s%s from column %s at row%ld", Description:"ER_INVALID_JSON_VALUE_FOR_CAST wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3157: {ErrorNumber:3157, ErrorType:"ServerError", Symbol:"ER_JSON_DOCUMENT_TOO_DEEP", SQLState:"22032", Message:"The JSON document exceeds the maximum depth.", Description:"ER_JSON_DOCUMENT_TOO_DEEP wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3158: {ErrorNumber:3158, ErrorType:"ServerError", Symbol:"ER_JSON_DOCUMENT_NULL_KEY", SQLState:"22032", Message:"JSON documents may not contain NULL member names.", Description:"ER_JSON_DOCUMENT_NULL_KEY wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3159: {ErrorNumber:3159, ErrorType:"ServerError", Symbol:"ER_SECURE_TRANSPORT_REQUIRED", SQLState:"HY000", Message:"Connections using insecure transport are prohibited while--require_secure_transport=ON.", Description:"ER_SECURE_TRANSPORT_REQUIRED wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3160: {ErrorNumber:3160, ErrorType:"ServerError", Symbol:"ER_NO_SECURE_TRANSPORTS_CONFIGURED", SQLState:"HY000", Message:"No secure transports (SSL or Shared Memory) areconfigured, unable to set --require_secure_transport=ON.", Description:"ER_NO_SECURE_TRANSPORTS_CONFIGUREDwas added in 5.7.8.", MySQLVersion:"5.7"},
    3161: {ErrorNumber:3161, ErrorType:"ServerError", Symbol:"ER_DISABLED_STORAGE_ENGINE", SQLState:"HY000", Message:"Storage engine %s is disabled (Table creation isdisallowed).", Description:"ER_DISABLED_STORAGE_ENGINE wasadded in 5.7.8.", MySQLVersion:"5.7"},
    3162: {ErrorNumber:3162, ErrorType:"ServerError", Symbol:"ER_USER_DOES_NOT_EXIST", SQLState:"HY000", Message:"User %s does not exist.", Description:"ER_USER_DOES_NOT_EXIST was addedin 5.7.8.", MySQLVersion:"5.7"},
    3163: {ErrorNumber:3163, ErrorType:"ServerError", Symbol:"ER_USER_ALREADY_EXISTS", SQLState:"HY000", Message:"User %s already exists.", Description:"ER_USER_ALREADY_EXISTS was addedin 5.7.8.", MySQLVersion:"5.7"},
    3164: {ErrorNumber:3164, ErrorType:"ServerError", Symbol:"ER_AUDIT_API_ABORT", SQLState:"HY000", Message:"Aborted by Audit API ('%s'", Description:"ER_AUDIT_API_ABORT was added in5.7.8.", MySQLVersion:"5.7"},
    3165: {ErrorNumber:3165, ErrorType:"ServerError", Symbol:"ER_INVALID_JSON_PATH_ARRAY_CELL", SQLState:"42000", Message:"A path expression is not a path to a cell in an array.", Description:"ER_INVALID_JSON_PATH_ARRAY_CELLwas added in 5.7.8.", MySQLVersion:"5.7"},
    3166: {ErrorNumber:3166, ErrorType:"ServerError", Symbol:"ER_BUFPOOL_RESIZE_INPROGRESS", SQLState:"HY000", Message:"Another buffer pool resize is already in progress.", Description:"ER_BUFPOOL_RESIZE_INPROGRESS wasadded in 5.7.9.", MySQLVersion:"5.7"},
    3167: {ErrorNumber:3167, ErrorType:"ServerError", Symbol:"ER_FEATURE_DISABLED_SEE_DOC", SQLState:"HY000", Message:"The '%s' feature is disabled", Description:"ER_FEATURE_DISABLED_SEE_DOC wasadded in 5.7.9.", MySQLVersion:"5.7"},
    3168: {ErrorNumber:3168, ErrorType:"ServerError", Symbol:"ER_SERVER_ISNT_AVAILABLE", SQLState:"HY000", Message:"Server isn't available", Description:"ER_SERVER_ISNT_AVAILABLE was addedin 5.7.9.", MySQLVersion:"5.7"},
    3169: {ErrorNumber:3169, ErrorType:"ServerError", Symbol:"ER_SESSION_WAS_KILLED", SQLState:"HY000", Message:"Session was killed", Description:"ER_SESSION_WAS_KILLED was added in5.7.9.", MySQLVersion:"5.7"},
    3170: {ErrorNumber:3170, ErrorType:"ServerError", Symbol:"ER_CAPACITY_EXCEEDED", SQLState:"HY000", Message:"Memory capacity of %llu bytes for '%s' exceeded. %s", Description:"ER_CAPACITY_EXCEEDED was added in5.7.9.", MySQLVersion:"5.7"},
    3171: {ErrorNumber:3171, ErrorType:"ServerError", Symbol:"ER_CAPACITY_EXCEEDED_IN_RANGE_OPTIMIZER", SQLState:"HY000", Message:"Range optimization was not done for this query.", Description:"ER_CAPACITY_EXCEEDED_IN_RANGE_OPTIMIZERwas added in 5.7.9.", MySQLVersion:"5.7"},
    3172: {ErrorNumber:3172, ErrorType:"ServerError", Symbol:"ER_TABLE_NEEDS_UPG_PART", SQLState:"HY000", Message:"Partitioning upgrade required. Please dump/reload to fixit or do: ALTER TABLE `%s`.`%s` UPGRADE PARTITIONING", Description:"ER_TABLE_NEEDS_UPG_PART was addedin 5.7.9.", MySQLVersion:"5.7"},
    3173: {ErrorNumber:3173, ErrorType:"ServerError", Symbol:"ER_CANT_WAIT_FOR_EXECUTED_GTID_SET_WHILE_OWNING_A_GTID", SQLState:"HY000", Message:"The client holds ownership of the GTID %s. Therefore,WAIT_FOR_EXECUTED_GTID_SET cannot wait for this GTID.", Description:"ER_CANT_WAIT_FOR_EXECUTED_GTID_SET_WHILE_OWNING_A_GTIDwas added in 5.7.9.", MySQLVersion:"5.7"},
    3174: {ErrorNumber:3174, ErrorType:"ServerError", Symbol:"ER_CANNOT_ADD_FOREIGN_BASE_COL_VIRTUAL", SQLState:"HY000", Message:"Cannot add foreign key on the base column of indexedvirtual column.", Description:"ER_CANNOT_ADD_FOREIGN_BASE_COL_VIRTUALwas added in 5.7.10.", MySQLVersion:"5.7"},
    3175: {ErrorNumber:3175, ErrorType:"ServerError", Symbol:"ER_CANNOT_CREATE_VIRTUAL_INDEX_CONSTRAINT", SQLState:"HY000", Message:"Cannot create index on virtual column whose base columnhas foreign constraint.", Description:"ER_CANNOT_CREATE_VIRTUAL_INDEX_CONSTRAINTwas added in 5.7.10.", MySQLVersion:"5.7"},
    3176: {ErrorNumber:3176, ErrorType:"ServerError", Symbol:"ER_ERROR_ON_MODIFYING_GTID_EXECUTED_TABLE", SQLState:"HY000", Message:"Please do not modify the %s table with an XA transaction.This is an internal system table used to store GTIDs for committedtransactions. Although modifying it can lead to an inconsistentGTID state, if neccessary you can modify it with a non-XAtransaction.", Description:"ER_ERROR_ON_MODIFYING_GTID_EXECUTED_TABLEwas added in 5.7.11.", MySQLVersion:"5.7"},
    3177: {ErrorNumber:3177, ErrorType:"ServerError", Symbol:"ER_LOCK_REFUSED_BY_ENGINE", SQLState:"HY000", Message:"Lock acquisition refused by storage engine.", Description:"ER_LOCK_REFUSED_BY_ENGINE wasadded in 5.7.11.", MySQLVersion:"5.7"},
    3178: {ErrorNumber:3178, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ALTER_ONLINE_ON_VIRTUAL_COLUMN", SQLState:"HY000", Message:"ADD COLUMN col...VIRTUAL, ADD INDEX(col)", Description:"ER_UNSUPPORTED_ALTER_ONLINE_ON_VIRTUAL_COLUMNwas added in 5.7.11.", MySQLVersion:"5.7"},
    3179: {ErrorNumber:3179, ErrorType:"ServerError", Symbol:"ER_MASTER_KEY_ROTATION_NOT_SUPPORTED_BY_SE", SQLState:"HY000", Message:"Master key rotation is not supported by storage engine.", Description:"ER_MASTER_KEY_ROTATION_NOT_SUPPORTED_BY_SEwas added in 5.7.11.", MySQLVersion:"5.7"},
    3180: {ErrorNumber:3180, ErrorType:"ServerError", Symbol:"ER_MASTER_KEY_ROTATION_ERROR_BY_SE", SQLState:"HY000", Message:"Encryption key rotation error reported by SE: %s", Description:"ER_MASTER_KEY_ROTATION_ERROR_BY_SEwas added in 5.7.11.", MySQLVersion:"5.7"},
    3181: {ErrorNumber:3181, ErrorType:"ServerError", Symbol:"ER_MASTER_KEY_ROTATION_BINLOG_FAILED", SQLState:"HY000", Message:"Write to binlog failed. However, master key rotation hasbeen completed successfully.", Description:"ER_MASTER_KEY_ROTATION_BINLOG_FAILEDwas added in 5.7.11.", MySQLVersion:"5.7"},
    3182: {ErrorNumber:3182, ErrorType:"ServerError", Symbol:"ER_MASTER_KEY_ROTATION_SE_UNAVAILABLE", SQLState:"HY000", Message:"Storage engine is not available.", Description:"ER_MASTER_KEY_ROTATION_SE_UNAVAILABLEwas added in 5.7.11.", MySQLVersion:"5.7"},
    3183: {ErrorNumber:3183, ErrorType:"ServerError", Symbol:"ER_TABLESPACE_CANNOT_ENCRYPT", SQLState:"HY000", Message:"This tablespace can't be encrypted.", Description:"ER_TABLESPACE_CANNOT_ENCRYPT wasadded in 5.7.11.", MySQLVersion:"5.7"},
    3184: {ErrorNumber:3184, ErrorType:"ServerError", Symbol:"ER_INVALID_ENCRYPTION_OPTION", SQLState:"HY000", Message:"Invalid encryption option.", Description:"ER_INVALID_ENCRYPTION_OPTION wasadded in 5.7.11.", MySQLVersion:"5.7"},
    3185: {ErrorNumber:3185, ErrorType:"ServerError", Symbol:"ER_CANNOT_FIND_KEY_IN_KEYRING", SQLState:"HY000", Message:"Can't find master key from keyring, please check in theserver log if a keyring plugin is loaded and initializedsuccessfully.", Description:"ER_CANNOT_FIND_KEY_IN_KEYRING wasadded in 5.7.11.", MySQLVersion:"5.7"},
    3186: {ErrorNumber:3186, ErrorType:"ServerError", Symbol:"ER_CAPACITY_EXCEEDED_IN_PARSER", SQLState:"HY000", Message:"Parser bailed out for this query.", Description:"ER_CAPACITY_EXCEEDED_IN_PARSER wasadded in 5.7.12.", MySQLVersion:"5.7"},
    3187: {ErrorNumber:3187, ErrorType:"ServerError", Symbol:"ER_UNSUPPORTED_ALTER_ENCRYPTION_INPLACE", SQLState:"HY000", Message:"Cannot alter encryption attribute by inplace algorithm.", Description:"ER_UNSUPPORTED_ALTER_ENCRYPTION_INPLACEwas added in 5.7.13.", MySQLVersion:"5.7"},
    3188: {ErrorNumber:3188, ErrorType:"ServerError", Symbol:"ER_KEYRING_UDF_KEYRING_SERVICE_ERROR", SQLState:"HY000", Message:"Function '%s' failed because underlying keyring servicereturned an error. Please check if a keyring plugin is installedand that provided arguments are valid for the keyring you areusing.", Description:"ER_KEYRING_UDF_KEYRING_SERVICE_ERRORwas added in 5.7.13.", MySQLVersion:"5.7"},
    3189: {ErrorNumber:3189, ErrorType:"ServerError", Symbol:"ER_USER_COLUMN_OLD_LENGTH", SQLState:"HY000", Message:"It seems that your db schema is old. The %s column is 77characters long and should be 93 characters long. Please runmysql_upgrade.", Description:"ER_USER_COLUMN_OLD_LENGTH wasadded in 5.7.13.", MySQLVersion:"5.7"},
    3190: {ErrorNumber:3190, ErrorType:"ServerError", Symbol:"ER_CANT_RESET_MASTER", SQLState:"HY000", Message:"RESET MASTER is not allowed because %s.", Description:"ER_CANT_RESET_MASTER was added in5.7.14.", MySQLVersion:"5.7"},
    3191: {ErrorNumber:3191, ErrorType:"ServerError", Symbol:"ER_GROUP_REPLICATION_MAX_GROUP_SIZE", SQLState:"HY000", Message:"The START GROUP_REPLICATION command failed since thegroup already has 9 members.", Description:"ER_GROUP_REPLICATION_MAX_GROUP_SIZEwas added in 5.7.14.", MySQLVersion:"5.7"},
    3192: {ErrorNumber:3192, ErrorType:"ServerError", Symbol:"ER_CANNOT_ADD_FOREIGN_BASE_COL_STORED", SQLState:"HY000", Message:"Cannot add foreign key on the base column of storedcolumn.", Description:"ER_CANNOT_ADD_FOREIGN_BASE_COL_STOREDwas added in 5.7.14.", MySQLVersion:"5.7"},
    3193: {ErrorNumber:3193, ErrorType:"ServerError", Symbol:"ER_TABLE_REFERENCED", SQLState:"HY000", Message:"Cannot complete the operation because table is referencedby another connection.", Description:"ER_TABLE_REFERENCED was added in5.7.14.", MySQLVersion:"5.7"},
    3194: {ErrorNumber:3194, ErrorType:"ServerError", Symbol:"ER_PARTITION_ENGINE_DEPRECATED_FOR_TABLE", SQLState:"HY000", Message:"The partition engine, used by table '%s.%s', isdeprecated and will be removed in a future release. Please usenative partitioning instead.", Description:"ER_PARTITION_ENGINE_DEPRECATED_FOR_TABLEwas added in 5.7.17.", MySQLVersion:"5.7"},
    3195: {ErrorNumber:3195, ErrorType:"ServerError", Symbol:"ER_WARN_USING_GEOMFROMWKB_TO_SET_SRID_ZERO", SQLState:"01000", Message:"%s(geometry) is deprecated and will be replaced byst_srid(geometry, 0) in a future version. Use%s(st_aswkb(geometry), 0) instead.", Description:"ER_WARN_USING_GEOMFROMWKB_TO_SET_SRID_ZEROwas added in 5.7.19.", MySQLVersion:"5.7"},
    3196: {ErrorNumber:3196, ErrorType:"ServerError", Symbol:"ER_WARN_USING_GEOMFROMWKB_TO_SET_SRID", SQLState:"01000", Message:"%s(geometry, srid) is deprecated and will be replaced byst_srid(geometry, srid) in a future version. Use%s(st_aswkb(geometry), srid) instead.", Description:"ER_WARN_USING_GEOMFROMWKB_TO_SET_SRIDwas added in 5.7.19.", MySQLVersion:"5.7"},
    3197: {ErrorNumber:3197, ErrorType:"ServerError", Symbol:"ER_XA_RETRY", SQLState:"HY000", Message:"The resource manager is not able to commit thetransaction branch at this time. Please retry later.", Description:"ER_XA_RETRY was added in 5.7.19.", MySQLVersion:"5.7"},
    3198: {ErrorNumber:3198, ErrorType:"ServerError", Symbol:"ER_KEYRING_AWS_UDF_AWS_KMS_ERROR", SQLState:"HY000", Message:"Function %s failed due to: %s.", Description:"ER_KEYRING_AWS_UDF_AWS_KMS_ERRORwas added in 5.7.19.", MySQLVersion:"5.7"},
    3199: {ErrorNumber:3199, ErrorType:"ServerError", Symbol:"ER_BINLOG_UNSAFE_XA", SQLState:"HY000", Message:"Statement is unsafe because it is being used inside a XAtransaction. Concurrent XA transactions may deadlock on slaveswhen replicated using statements.", Description:"ER_BINLOG_UNSAFE_XA was added in5.7.20.", MySQLVersion:"5.7"},
    3200: {ErrorNumber:3200, ErrorType:"ServerError", Symbol:"ER_UDF_ERROR", SQLState:"HY000", Message:"%s UDF failed", Description:"ER_UDF_ERROR was added in 5.7.21.", MySQLVersion:"5.7"},
    3201: {ErrorNumber:3201, ErrorType:"ServerError", Symbol:"ER_KEYRING_MIGRATION_FAILURE", SQLState:"HY000", Message:"Can not perform keyring migration : %s", Description:"ER_KEYRING_MIGRATION_FAILURE wasadded in 5.7.21.", MySQLVersion:"5.7"},
    3202: {ErrorNumber:3202, ErrorType:"ServerError", Symbol:"ER_KEYRING_ACCESS_DENIED_ERROR", SQLState:"42000", Message:"Access denied", Description:"ER_KEYRING_ACCESS_DENIED_ERROR wasadded in 5.7.21.", MySQLVersion:"5.7"},
    3203: {ErrorNumber:3203, ErrorType:"ServerError", Symbol:"ER_KEYRING_MIGRATION_STATUS", SQLState:"HY000", Message:"Keyring migration %s.", Description:"ER_KEYRING_MIGRATION_STATUS wasadded in 5.7.21.", MySQLVersion:"5.7"},
    3204: {ErrorNumber:3204, ErrorType:"ServerError", Symbol:"ER_PLUGIN_FAILED_TO_OPEN_TABLES", SQLState:"HY000", Message:"Failed to open the %s filter tables.", Description:"ER_PLUGIN_FAILED_TO_OPEN_TABLESwas added in 5.7.22.", MySQLVersion:"5.7"},
    3205: {ErrorNumber:3205, ErrorType:"ServerError", Symbol:"ER_PLUGIN_FAILED_TO_OPEN_TABLE", SQLState:"HY000", Message:"Failed to open '%s.%s' %s table.", Description:"ER_PLUGIN_FAILED_TO_OPEN_TABLE wasadded in 5.7.22.", MySQLVersion:"5.7"},
    3206: {ErrorNumber:3206, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_NO_KEYRING_PLUGIN_INSTALLED", SQLState:"HY000", Message:"No keyring plugin installed.", Description:"ER_AUDIT_LOG_NO_KEYRING_PLUGIN_INSTALLEDwas added in 5.7.22.", MySQLVersion:"5.7"},
    3207: {ErrorNumber:3207, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_ENCRYPTION_PASSWORD_HAS_NOT_BEEN_SET", SQLState:"HY000", Message:"Audit log encryption password has not been set", Description:"ER_AUDIT_LOG_ENCRYPTION_PASSWORD_HAS_NOT_BEEN_SETwas added in 5.7.22.", MySQLVersion:"5.7"},
    3208: {ErrorNumber:3208, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_COULD_NOT_CREATE_AES_KEY", SQLState:"HY000", Message:"Could not create AES key. OpenSSL's EVP_BytesToKeyfunction failed.", Description:"ER_AUDIT_LOG_COULD_NOT_CREATE_AES_KEYwas added in 5.7.22.", MySQLVersion:"5.7"},
    3209: {ErrorNumber:3209, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_ENCRYPTION_PASSWORD_CANNOT_BE_FETCHED", SQLState:"HY000", Message:"Audit log encryption password cannot be fetched from thekeyring. Password used so far is used for encryption.", Description:"ER_AUDIT_LOG_ENCRYPTION_PASSWORD_CANNOT_BE_FETCHEDwas added in 5.7.22.", MySQLVersion:"5.7"},
    3210: {ErrorNumber:3210, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_JSON_FILTERING_NOT_ENABLED", SQLState:"HY000", Message:"Audit Log filtering has not been installed.", Description:"ER_AUDIT_LOG_JSON_FILTERING_NOT_ENABLEDwas added in 5.7.22.", MySQLVersion:"5.7"},
    3211: {ErrorNumber:3211, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_UDF_INSUFFICIENT_PRIVILEGE", SQLState:"HY000", Message:"Request ignored for '%s'@'%s'. SUPER_ACL needed toperform operation", Description:"ER_AUDIT_LOG_UDF_INSUFFICIENT_PRIVILEGEwas added in 5.7.22.", MySQLVersion:"5.7"},
    3212: {ErrorNumber:3212, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_SUPER_PRIVILEGE_REQUIRED", SQLState:"HY000", Message:"SUPER privilege required for '%s'@'%s' user.", Description:"ER_AUDIT_LOG_SUPER_PRIVILEGE_REQUIREDwas added in 5.7.22.", MySQLVersion:"5.7"},
    3213: {ErrorNumber:3213, ErrorType:"ServerError", Symbol:"ER_COULD_NOT_REINITIALIZE_AUDIT_LOG_FILTERS", SQLState:"HY000", Message:"Could not reinitialize audit log filters.", Description:"ER_COULD_NOT_REINITIALIZE_AUDIT_LOG_FILTERSwas added in 5.7.22.", MySQLVersion:"5.7"},
    3214: {ErrorNumber:3214, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_TYPE", SQLState:"HY000", Message:"Invalid argument type", Description:"ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_TYPEwas added in 5.7.22.", MySQLVersion:"5.7"},
    3215: {ErrorNumber:3215, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_COUNT", SQLState:"HY000", Message:"Invalid argument count", Description:"ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_COUNTwas added in 5.7.22.", MySQLVersion:"5.7"},
    3216: {ErrorNumber:3216, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_HAS_NOT_BEEN_INSTALLED", SQLState:"HY000", Message:"audit_log plugin has not been installed using INSTALLPLUGIN syntax.", Description:"ER_AUDIT_LOG_HAS_NOT_BEEN_INSTALLEDwas added in 5.7.22.", MySQLVersion:"5.7"},
    3217: {ErrorNumber:3217, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_TYPE", SQLState:"HY000", Message:"Invalid \"max_array_length\" argument type.", Description:"ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_TYPEwas added in 5.7.22.", MySQLVersion:"5.7"},
    3218: {ErrorNumber:3218, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_VALUE", SQLState:"HY000", Message:"Invalid \"max_array_length\" argument value.", Description:"ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_VALUEwas added in 5.7.22.", MySQLVersion:"5.7"},
    3219: {ErrorNumber:3219, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_JSON_FILTER_PARSING_ERROR", SQLState:"HY000", Message:"%s", Description:"ER_AUDIT_LOG_JSON_FILTER_PARSING_ERRORwas added in 5.7.22.", MySQLVersion:"5.7"},
    3220: {ErrorNumber:3220, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_JSON_FILTER_NAME_CANNOT_BE_EMPTY", SQLState:"HY000", Message:"Filter name cannot be empty.", Description:"ER_AUDIT_LOG_JSON_FILTER_NAME_CANNOT_BE_EMPTYwas added in 5.7.22.", MySQLVersion:"5.7"},
    3221: {ErrorNumber:3221, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_JSON_USER_NAME_CANNOT_BE_EMPTY", SQLState:"HY000", Message:"User cannot be empty.", Description:"ER_AUDIT_LOG_JSON_USER_NAME_CANNOT_BE_EMPTYwas added in 5.7.22.", MySQLVersion:"5.7"},
    3222: {ErrorNumber:3222, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_JSON_FILTER_DOES_NOT_EXISTS", SQLState:"HY000", Message:"Specified filter has not been found.", Description:"ER_AUDIT_LOG_JSON_FILTER_DOES_NOT_EXISTSwas added in 5.7.22.", MySQLVersion:"5.7"},
    3223: {ErrorNumber:3223, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_USER_FIRST_CHARACTER_MUST_BE_ALPHANUMERIC", SQLState:"HY000", Message:"First character of the user name must be alphanumeric.", Description:"ER_AUDIT_LOG_USER_FIRST_CHARACTER_MUST_BE_ALPHANUMERICwas added in 5.7.22.", MySQLVersion:"5.7"},
    3224: {ErrorNumber:3224, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_USER_NAME_INVALID_CHARACTER", SQLState:"HY000", Message:"Invalid character in the user name.", Description:"ER_AUDIT_LOG_USER_NAME_INVALID_CHARACTERwas added in 5.7.22.", MySQLVersion:"5.7"},
    3225: {ErrorNumber:3225, ErrorType:"ServerError", Symbol:"ER_AUDIT_LOG_HOST_NAME_INVALID_CHARACTER", SQLState:"HY000", Message:"Invalid character in the host name.", Description:"ER_AUDIT_LOG_HOST_NAME_INVALID_CHARACTERwas added in 5.7.22.", MySQLVersion:"5.7"},
    3226: {ErrorNumber:3226, ErrorType:"ServerError", Symbol:"WARN_DEPRECATED_MAXDB_SQL_MODE_FOR_TIMESTAMP", SQLState:"HY000", Message:"With the MAXDB SQL mode enabled, TIMESTAMP is identicalwith DATETIME. The MAXDB SQL mode is deprecated and will beremoved in a future release. Please disable the MAXDB SQL mode anduse DATETIME instead.", Description:"WARN_DEPRECATED_MAXDB_SQL_MODE_FOR_TIMESTAMPwas added in 5.7.22.", MySQLVersion:"5.7"},
    3227: {ErrorNumber:3227, ErrorType:"ServerError", Symbol:"ER_XA_REPLICATION_FILTERS", SQLState:"HY000", Message:"The use of replication filters with XA transactions isnot supported, and can lead to an undefined state in thereplication slave.", Description:"ER_XA_REPLICATION_FILTERS wasadded in 5.7.23.", MySQLVersion:"5.7"},
    3228: {ErrorNumber:3228, ErrorType:"ServerError", Symbol:"ER_CANT_OPEN_ERROR_LOG", SQLState:"HY000", Message:"Could not open file '%s' for error logging%s%s", Description:"ER_CANT_OPEN_ERROR_LOG was addedin 5.7.24.", MySQLVersion:"5.7"},
    3229: {ErrorNumber:3229, ErrorType:"ServerError", Symbol:"ER_GROUPING_ON_TIMESTAMP_IN_DST", SQLState:"HY000", Message:"Grouping on temporal is non-deterministic for timezoneshaving DST. Please consider switching to UTC for this query.", Description:"ER_GROUPING_ON_TIMESTAMP_IN_DSTwas added in 5.7.27.", MySQLVersion:"5.7"},
    3230: {ErrorNumber:3230, ErrorType:"ServerError", Symbol:"ER_CANT_START_SERVER_NAMED_PIPE", SQLState:"HY000", Message:"Can't start server : Named Pipe \"%s\" already in use.", Description:"ER_CANT_START_SERVER_NAMED_PIPEwas added in 5.7.27.", MySQLVersion:"5.7"},
    3231: {ErrorNumber:3231, ErrorType:"ServerError", Symbol:"ER_WRITE_SET_EXCEEDS_LIMIT", SQLState:"HY000", Message:"The size of writeset data for the current transactionexceeds a limit imposed by an external component. If using GroupReplication check 'group_replication_transaction_size_limit'.", Description:"ER_WRITE_SET_EXCEEDS_LIMIT wasadded in 5.7.33.", MySQLVersion:"5.7"},
    3232: {ErrorNumber:3232, ErrorType:"ServerError", Symbol:"ER_DEPRECATED_TLS_VERSION_SESSION", SQLState:"HY000", Message:"Accepted a connection with deprecated protocol '%s' foraccount `%s`@`%s` from host `%s`. Client supplied username `%s`", Description:"ER_DEPRECATED_TLS_VERSION_SESSIONwas added in 5.7.35.", MySQLVersion:"5.7"},
    3233: {ErrorNumber:3233, ErrorType:"ServerError", Symbol:"ER_WARN_DEPRECATED_TLS_VERSION", SQLState:"HY000", Message:"A deprecated TLS version %s is enabled. Please useTLSv1.2 or higher.", Description:"ER_WARN_DEPRECATED_TLS_VERSION wasadded in 5.7.35.", MySQLVersion:"5.7"},
    3234: {ErrorNumber:3234, ErrorType:"ServerError", Symbol:"ER_WARN_WRONG_NATIVE_TABLE_STRUCTURE", SQLState:"HY000", Message:"Optional native table '%s'.'%s' has the wrong structureor is missing.", Description:"ER_WARN_WRONG_NATIVE_TABLE_STRUCTUREwas added in 5.7.39.", MySQLVersion:"5.7"},
    3235: {ErrorNumber:3235, ErrorType:"ServerError", Symbol:"ER_AES_INVALID_KDF_NAME", SQLState:"HY000", Message:"KDF method name is not valid. Please use hkdf orpbkdf2_hmac method name", Description:"ER_AES_INVALID_KDF_NAME was addedin 5.7.40.", MySQLVersion:"5.7"},
    3236: {ErrorNumber:3236, ErrorType:"ServerError", Symbol:"ER_AES_INVALID_KDF_ITERATIONS", SQLState:"HY000", Message:"For KDF method pbkdf2_hmac iterations value less than1000 or more than 65535 is not allowed due to security reasons.Please provide iterations >= 1000 and iterations < 65535", Description:"ER_AES_INVALID_KDF_ITERATIONS wasadded in 5.7.40.", MySQLVersion:"5.7"},
    3237: {ErrorNumber:3237, ErrorType:"ServerError", Symbol:"WARN_AES_KEY_SIZE", SQLState:"HY000", Message:"AES key size should be %d bytes length or secure KDFmethods hkdf or pbkdf2_hmac should be used, please provide exactAES key size or use KDF methods for better security.", Description:"WARN_AES_KEY_SIZE was added in5.7.40.", MySQLVersion:"5.7"},
    3238: {ErrorNumber:3238, ErrorType:"ServerError", Symbol:"ER_AES_INVALID_KDF_OPTION_SIZE", SQLState:"HY000", Message:"KDF option size is invalid, please provide valid size< %d bytes and not NULL", Description:"ER_AES_INVALID_KDF_OPTION_SIZE wasadded in 5.7.40.", MySQLVersion:"5.7"},
    2000: {ErrorNumber:2000, ErrorType:"ClientError", Symbol:"CR_UNKNOWN_ERROR", SQLState:"", Message:"Unknown MySQL error", Description:"", MySQLVersion:"5.7"},
    2001: {ErrorNumber:2001, ErrorType:"ClientError", Symbol:"CR_SOCKET_CREATE_ERROR", SQLState:"", Message:"Can't create UNIX socket (%d)", Description:"", MySQLVersion:"5.7"},
    2002: {ErrorNumber:2002, ErrorType:"ClientError", Symbol:"CR_CONNECTION_ERROR", SQLState:"", Message:"Can't connect to local MySQL server through socket '%s'(%d)", Description:"", MySQLVersion:"5.7"},
    2003: {ErrorNumber:2003, ErrorType:"ClientError", Symbol:"CR_CONN_HOST_ERROR", SQLState:"", Message:"Can't connect to MySQL server on '%s' (%d)", Description:"", MySQLVersion:"5.7"},
    2004: {ErrorNumber:2004, ErrorType:"ClientError", Symbol:"CR_IPSOCK_ERROR", SQLState:"", Message:"Can't create TCP/IP socket (%d)", Description:"", MySQLVersion:"5.7"},
    2005: {ErrorNumber:2005, ErrorType:"ClientError", Symbol:"CR_UNKNOWN_HOST", SQLState:"", Message:"Unknown MySQL server host '%s' (%d)", Description:"", MySQLVersion:"5.7"},
    2006: {ErrorNumber:2006, ErrorType:"ClientError", Symbol:"CR_SERVER_GONE_ERROR", SQLState:"", Message:"MySQL server has gone away", Description:"", MySQLVersion:"5.7"},
    2007: {ErrorNumber:2007, ErrorType:"ClientError", Symbol:"CR_VERSION_ERROR", SQLState:"", Message:"Protocol mismatch", Description:"server version = %d, client version =%d", MySQLVersion:"5.7"},
    2008: {ErrorNumber:2008, ErrorType:"ClientError", Symbol:"CR_OUT_OF_MEMORY", SQLState:"", Message:"MySQL client ran out of memory", Description:"", MySQLVersion:"5.7"},
    2009: {ErrorNumber:2009, ErrorType:"ClientError", Symbol:"CR_WRONG_HOST_INFO", SQLState:"", Message:"Wrong host info", Description:"", MySQLVersion:"5.7"},
    2010: {ErrorNumber:2010, ErrorType:"ClientError", Symbol:"CR_LOCALHOST_CONNECTION", SQLState:"", Message:"Localhost via UNIX socket", Description:"", MySQLVersion:"5.7"},
    2011: {ErrorNumber:2011, ErrorType:"ClientError", Symbol:"CR_TCP_CONNECTION", SQLState:"", Message:"%s via TCP/IP", Description:"", MySQLVersion:"5.7"},
    2012: {ErrorNumber:2012, ErrorType:"ClientError", Symbol:"CR_SERVER_HANDSHAKE_ERR", SQLState:"", Message:"Error in server handshake", Description:"", MySQLVersion:"5.7"},
    2013: {ErrorNumber:2013, ErrorType:"ClientError", Symbol:"CR_SERVER_LOST", SQLState:"", Message:"Lost connection to MySQL server during query", Description:"", MySQLVersion:"5.7"},
    ...
    2015: {ErrorNumber:2015, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPE_CONNECTION", SQLState:"", Message:"Named pipe: %s", Description:"", MySQLVersion:"5.7"},
    2016: {ErrorNumber:2016, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPEWAIT_ERROR", SQLState:"", Message:"Can't wait for named pipe to host: %s pipe: %s (%lu)", Description:"", MySQLVersion:"5.7"},
    2017: {ErrorNumber:2017, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPEOPEN_ERROR", SQLState:"", Message:"Can't open named pipe to host: %s pipe: %s (%lu)", Description:"", MySQLVersion:"5.7"},
    2018: {ErrorNumber:2018, ErrorType:"ClientError", Symbol:"CR_NAMEDPIPESETSTATE_ERROR", SQLState:"", Message:"Can't set state of named pipe to host: %s pipe: %s (%lu)", Description:"", MySQLVersion:"5.7"},
    2019: {ErrorNumber:2019, ErrorType:"ClientError", Symbol:"CR_CANT_READ_CHARSET", SQLState:"", Message:"Can't initialize character set %s (path: %s)", Description:"", MySQLVersion:"5.7"},
    2020: {ErrorNumber:2020, ErrorType:"ClientError", Symbol:"CR_NET_PACKET_TOO_LARGE", SQLState:"", Message:"Got packet bigger than 'max_allowed_packet' bytes", Description:"", MySQLVersion:"5.7"},
    2021: {ErrorNumber:2021, ErrorType:"ClientError", Symbol:"CR_EMBEDDED_CONNECTION", SQLState:"", Message:"Embedded server", Description:"", MySQLVersion:"5.7"},
    2022: {ErrorNumber:2022, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_STATUS", SQLState:"", Message:"Error on SHOW SLAVE STATUS:", Description:"", MySQLVersion:"5.7"},
    2023: {ErrorNumber:2023, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_HOSTS", SQLState:"", Message:"Error on SHOW SLAVE HOSTS:", Description:"", MySQLVersion:"5.7"},
    2024: {ErrorNumber:2024, ErrorType:"ClientError", Symbol:"CR_PROBE_SLAVE_CONNECT", SQLState:"", Message:"Error connecting to slave:", Description:"", MySQLVersion:"5.7"},
    2025: {ErrorNumber:2025, ErrorType:"ClientError", Symbol:"CR_PROBE_MASTER_CONNECT", SQLState:"", Message:"Error connecting to master:", Description:"", MySQLVersion:"5.7"},
    2026: {ErrorNumber:2026, ErrorType:"ClientError", Symbol:"CR_SSL_CONNECTION_ERROR", SQLState:"", Message:"SSL connection error: %s", Description:"", MySQLVersion:"5.7"},
    2027: {ErrorNumber:2027, ErrorType:"ClientError", Symbol:"CR_MALFORMED_PACKET", SQLState:"", Message:"Malformed packet", Description:"", MySQLVersion:"5.7"},
    2028: {ErrorNumber:2028, ErrorType:"ClientError", Symbol:"CR_WRONG_LICENSE", SQLState:"", Message:"This client library is licensed only for use with MySQLservers having '%s' license", Description:"", MySQLVersion:"5.7"},
    2029: {ErrorNumber:2029, ErrorType:"ClientError", Symbol:"CR_NULL_POINTER", SQLState:"", Message:"Invalid use of null pointer", Description:"", MySQLVersion:"5.7"},
    2030: {ErrorNumber:2030, ErrorType:"ClientError", Symbol:"CR_NO_PREPARE_STMT", SQLState:"", Message:"Statement not prepared", Description:"", MySQLVersion:"5.7"},
    2031: {ErrorNumber:2031, ErrorType:"ClientError", Symbol:"CR_PARAMS_NOT_BOUND", SQLState:"", Message:"No data supplied for parameters in prepared statement", Description:"", MySQLVersion:"5.7"},
    2032: {ErrorNumber:2032, ErrorType:"ClientError", Symbol:"CR_DATA_TRUNCATED", SQLState:"", Message:"Data truncated", Description:"", MySQLVersion:"5.7"},
    2033: {ErrorNumber:2033, ErrorType:"ClientError", Symbol:"CR_NO_PARAMETERS_EXISTS", SQLState:"", Message:"No parameters exist in the statement", Description:"", MySQLVersion:"5.7"},
    2034: {ErrorNumber:2034, ErrorType:"ClientError", Symbol:"CR_INVALID_PARAMETER_NO", SQLState:"", Message:"Invalid parameter number", Description:"A key name was empty or the amount of connection attribute datafor mysql_options4() exceeds the64KB limit.", MySQLVersion:"5.7"},
    2035: {ErrorNumber:2035, ErrorType:"ClientError", Symbol:"CR_INVALID_BUFFER_USE", SQLState:"", Message:"Can't send long data for non-string/non-binary data types(parameter: %d)", Description:"", MySQLVersion:"5.7"},
    2036: {ErrorNumber:2036, ErrorType:"ClientError", Symbol:"CR_UNSUPPORTED_PARAM_TYPE", SQLState:"", Message:"Using unsupported buffer type: %d (parameter: %d)", Description:"", MySQLVersion:"5.7"},
    2037: {ErrorNumber:2037, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECTION", SQLState:"", Message:"Shared memory: %s", Description:"", MySQLVersion:"5.7"},
    2038: {ErrorNumber:2038, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_REQUEST_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not create requestevent (%lu)", MySQLVersion:"5.7"},
    2039: {ErrorNumber:2039, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_ANSWER_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"no answer event received fromserver (%lu)", MySQLVersion:"5.7"},
    2040: {ErrorNumber:2040, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_FILE_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"server could not allocate filemapping (%lu)", MySQLVersion:"5.7"},
    2041: {ErrorNumber:2041, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"server could not get pointer tofile mapping (%lu)", MySQLVersion:"5.7"},
    2042: {ErrorNumber:2042, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_FILE_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not allocate filemapping (%lu)", MySQLVersion:"5.7"},
    2043: {ErrorNumber:2043, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_MAP_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not get pointer tofile mapping (%lu)", MySQLVersion:"5.7"},
    2044: {ErrorNumber:2044, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_EVENT_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"client could not create %sevent (%lu)", MySQLVersion:"5.7"},
    2045: {ErrorNumber:2045, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_ABANDONED_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"no answer from server (%lu)", MySQLVersion:"5.7"},
    2046: {ErrorNumber:2046, ErrorType:"ClientError", Symbol:"CR_SHARED_MEMORY_CONNECT_SET_ERROR", SQLState:"", Message:"Can't open shared memory", Description:"cannot send request event toserver (%lu)", MySQLVersion:"5.7"},
    2047: {ErrorNumber:2047, ErrorType:"ClientError", Symbol:"CR_CONN_UNKNOW_PROTOCOL", SQLState:"", Message:"Wrong or unknown protocol", Description:"", MySQLVersion:"5.7"},
    2048: {ErrorNumber:2048, ErrorType:"ClientError", Symbol:"CR_INVALID_CONN_HANDLE", SQLState:"", Message:"Invalid connection handle", Description:"", MySQLVersion:"5.7"},
    2049: {ErrorNumber:2049, ErrorType:"ClientError", Symbol:"CR_UNUSED_1", SQLState:"", Message:"Connection using old (pre-4.1.1) authentication protocolrefused (client option 'secure_auth' enabled)", Description:"CR_UNUSED_1 was added in 5.7.5.", MySQLVersion:"5.7"},
    2050: {ErrorNumber:2050, ErrorType:"ClientError", Symbol:"CR_FETCH_CANCELED", SQLState:"", Message:"Row retrieval was canceled by mysql_stmt_close() call", Description:"", MySQLVersion:"5.7"},
    2051: {ErrorNumber:2051, ErrorType:"ClientError", Symbol:"CR_NO_DATA", SQLState:"", Message:"Attempt to read column without prior row fetch", Description:"", MySQLVersion:"5.7"},
    2052: {ErrorNumber:2052, ErrorType:"ClientError", Symbol:"CR_NO_STMT_METADATA", SQLState:"", Message:"Prepared statement contains no metadata", Description:"", MySQLVersion:"5.7"},
    2053: {ErrorNumber:2053, ErrorType:"ClientError", Symbol:"CR_NO_RESULT_SET", SQLState:"", Message:"Attempt to read a row while there is no result setassociated with the statement", Description:"", MySQLVersion:"5.7"},
    2054: {ErrorNumber:2054, ErrorType:"ClientError", Symbol:"CR_NOT_IMPLEMENTED", SQLState:"", Message:"This feature is not implemented yet", Description:"", MySQLVersion:"5.7"},
    2055: {ErrorNumber:2055, ErrorType:"ClientError", Symbol:"CR_SERVER_LOST_EXTENDED", SQLState:"", Message:"Lost connection to MySQL server at '%s', system error: %d", Description:"", MySQLVersion:"5.7"},
    2056: {ErrorNumber:2056, ErrorType:"ClientError", Symbol:"CR_STMT_CLOSED", SQLState:"", Message:"Statement closed indirectly because of a preceding %s()call", Description:"", MySQLVersion:"5.7"},
    2057: {ErrorNumber:2057, ErrorType:"ClientError", Symbol:"CR_NEW_STMT_METADATA", SQLState:"", Message:"The number of columns in the result set differs from thenumber of bound buffers. You must reset the statement, rebind theresult set columns, and execute the statement again", Description:"", MySQLVersion:"5.7"},
    2058: {ErrorNumber:2058, ErrorType:"ClientError", Symbol:"CR_ALREADY_CONNECTED", SQLState:"", Message:"This handle is already connected. Use a separate handlefor each connection.", Description:"", MySQLVersion:"5.7"},
    2059: {ErrorNumber:2059, ErrorType:"ClientError", Symbol:"CR_AUTH_PLUGIN_CANNOT_LOAD", SQLState:"", Message:"Authentication plugin '%s' cannot be loaded: %s", Description:"", MySQLVersion:"5.7"},
    2060: {ErrorNumber:2060, ErrorType:"ClientError", Symbol:"CR_DUPLICATE_CONNECTION_ATTR", SQLState:"", Message:"There is an attribute with the same name already", Description:"A duplicate connection attribute name was specified formysql_options4().", MySQLVersion:"5.7"},
    2061: {ErrorNumber:2061, ErrorType:"ClientError", Symbol:"CR_AUTH_PLUGIN_ERR", SQLState:"", Message:"Authentication plugin '%s' reported error: %s", Description:"CR_AUTH_PLUGIN_ERR was added in5.7.1.", MySQLVersion:"5.7"},
    2062: {ErrorNumber:2062, ErrorType:"ClientError", Symbol:"CR_INSECURE_API_ERR", SQLState:"", Message:"Insecure API function call: '%s' Use instead: '%s'", Description:"CR_INSECURE_API_ERR was added in5.7.6.", MySQLVersion:"5.7"},
    1: {ErrorNumber:1, ErrorType:"GlobalError", Symbol:"EE_CANTCREATEFILE", SQLState:"", Message:"Can't create/write to file '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    2: {ErrorNumber:2, ErrorType:"GlobalError", Symbol:"EE_READ", SQLState:"", Message:"Error reading file '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    3: {ErrorNumber:3, ErrorType:"GlobalError", Symbol:"EE_WRITE", SQLState:"", Message:"Error writing file '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    4: {ErrorNumber:4, ErrorType:"GlobalError", Symbol:"EE_BADCLOSE", SQLState:"", Message:"Error on close of '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    5: {ErrorNumber:5, ErrorType:"GlobalError", Symbol:"EE_OUTOFMEMORY", SQLState:"", Message:"Out of memory (Needed %u bytes)", Description:"", MySQLVersion:"5.7"},
    6: {ErrorNumber:6, ErrorType:"GlobalError", Symbol:"EE_DELETE", SQLState:"", Message:"Error on delete of '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    7: {ErrorNumber:7, ErrorType:"GlobalError", Symbol:"EE_LINK", SQLState:"", Message:"Error on rename of '%s' to '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    9: {ErrorNumber:9, ErrorType:"GlobalError", Symbol:"EE_EOFERR", SQLState:"", Message:"Unexpected EOF found when reading file '%s' (Errcode: %d- %s)", Description:"", MySQLVersion:"5.7"},
    10: {ErrorNumber:10, ErrorType:"GlobalError", Symbol:"EE_CANTLOCK", SQLState:"", Message:"Can't lock file (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    11: {ErrorNumber:11, ErrorType:"GlobalError", Symbol:"EE_CANTUNLOCK", SQLState:"", Message:"Can't unlock file (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    12: {ErrorNumber:12, ErrorType:"GlobalError", Symbol:"EE_DIR", SQLState:"", Message:"Can't read dir of '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    13: {ErrorNumber:13, ErrorType:"GlobalError", Symbol:"EE_STAT", SQLState:"", Message:"Can't get stat of '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    14: {ErrorNumber:14, ErrorType:"GlobalError", Symbol:"EE_CANT_CHSIZE", SQLState:"", Message:"Can't change size of file (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    15: {ErrorNumber:15, ErrorType:"GlobalError", Symbol:"EE_CANT_OPEN_STREAM", SQLState:"", Message:"Can't open stream from handle (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    16: {ErrorNumber:16, ErrorType:"GlobalError", Symbol:"EE_GETWD", SQLState:"", Message:"Can't get working directory (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    17: {ErrorNumber:17, ErrorType:"GlobalError", Symbol:"EE_SETWD", SQLState:"", Message:"Can't change dir to '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    18: {ErrorNumber:18, ErrorType:"GlobalError", Symbol:"EE_LINK_WARNING", SQLState:"", Message:"Warning: '%s' had %d links", Description:"", MySQLVersion:"5.7"},
    19: {ErrorNumber:19, ErrorType:"GlobalError", Symbol:"EE_OPEN_WARNING", SQLState:"", Message:"Warning: %d files and %d streams is left open", Description:"", MySQLVersion:"5.7"},
    20: {ErrorNumber:20, ErrorType:"GlobalError", Symbol:"EE_DISK_FULL", SQLState:"", Message:"Disk is full writing '%s' (Errcode: %d - %s). Waiting forsomeone to free space...", Description:"", MySQLVersion:"5.7"},
    21: {ErrorNumber:21, ErrorType:"GlobalError", Symbol:"EE_CANT_MKDIR", SQLState:"", Message:"Can't create directory '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    22: {ErrorNumber:22, ErrorType:"GlobalError", Symbol:"EE_UNKNOWN_CHARSET", SQLState:"", Message:"Character set '%s' is not a compiled character set and isnot specified in the '%s' file", Description:"", MySQLVersion:"5.7"},
    23: {ErrorNumber:23, ErrorType:"GlobalError", Symbol:"EE_OUT_OF_FILERESOURCES", SQLState:"", Message:"Out of resources when opening file '%s' (Errcode: %d -%s)", Description:"", MySQLVersion:"5.7"},
    24: {ErrorNumber:24, ErrorType:"GlobalError", Symbol:"EE_CANT_READLINK", SQLState:"", Message:"Can't read value for symlink '%s' (Error %d - %s)", Description:"", MySQLVersion:"5.7"},
    25: {ErrorNumber:25, ErrorType:"GlobalError", Symbol:"EE_CANT_SYMLINK", SQLState:"", Message:"Can't create symlink '%s' pointing at '%s' (Error %d -%s)", Description:"", MySQLVersion:"5.7"},
    26: {ErrorNumber:26, ErrorType:"GlobalError", Symbol:"EE_REALPATH", SQLState:"", Message:"Error on realpath() on '%s' (Error %d - %s)", Description:"", MySQLVersion:"5.7"},
    27: {ErrorNumber:27, ErrorType:"GlobalError", Symbol:"EE_SYNC", SQLState:"", Message:"Can't sync file '%s' to disk (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    28: {ErrorNumber:28, ErrorType:"GlobalError", Symbol:"EE_UNKNOWN_COLLATION", SQLState:"", Message:"Collation '%s' is not a compiled collation and is notspecified in the '%s' file", Description:"", MySQLVersion:"5.7"},
    29: {ErrorNumber:29, ErrorType:"GlobalError", Symbol:"EE_FILENOTFOUND", SQLState:"", Message:"File '%s' not found (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    30: {ErrorNumber:30, ErrorType:"GlobalError", Symbol:"EE_FILE_NOT_CLOSED", SQLState:"", Message:"File '%s' (fileno: %d) was not closed", Description:"", MySQLVersion:"5.7"},
    31: {ErrorNumber:31, ErrorType:"GlobalError", Symbol:"EE_CHANGE_OWNERSHIP", SQLState:"", Message:"Can't change ownership of the file '%s' (Errcode: %d -%s)", Description:"", MySQLVersion:"5.7"},
    32: {ErrorNumber:32, ErrorType:"GlobalError", Symbol:"EE_CHANGE_PERMISSIONS", SQLState:"", Message:"Can't change permissions of the file '%s' (Errcode: %d -%s)", Description:"", MySQLVersion:"5.7"},
    33: {ErrorNumber:33, ErrorType:"GlobalError", Symbol:"EE_CANT_SEEK", SQLState:"", Message:"Can't seek in file '%s' (Errcode: %d - %s)", Description:"", MySQLVersion:"5.7"},
    34: {ErrorNumber:34, ErrorType:"GlobalError", Symbol:"EE_CAPACITY_EXCEEDED", SQLState:"", Message:"Memory capacity exceeded (capacity %llu bytes)", Description:"EE_CAPACITY_EXCEEDED was added in5.7.9.", MySQLVersion:"5.7"},
}
...
ER_HASHCHK int64 = 1000
    ...
    ER_UNUSED1 int64 = 1150
    ER_UNUSED2 int64 = 1151
    ...
    ER_VIEW_SELECT_DERIVED_UNUSED int64 = 1349
    ...
    ER_LOAD_DATA_INVALID_COLUMN_UNUSED int64 = 1611
    ...
    ER_PLUGIN_DELETE_BUILTIN int64 = 1619
    ...
    ER_CANT_CHANGE_GTID_NEXT_IN_TRANSACTION int64 = 1768
    ...
    ER_AUTO_POSITION_REQUIRES_GTID_MODE_NOT_OFF int64 = 1777
    ER_CANT_DO_IMPLICIT_COMMIT_IN_TRX_WHEN_GTID_NEXT_IS_SET int64 = 1778
    ER_GTID_MODE_ON_REQUIRES_ENFORCE_GTID_CONSISTENCY_ON int64 = 1779
    ...
    ER_FOUND_GTID_EVENT_WHEN_GTID_MODE_IS_OFF__UNUSED int64 = 1784
    ...
    ER_SLAVE_IO_THREAD_MUST_STOP int64 = 1906
    ER_FILE_CORRUPT int64 = 3000
    ER_ERROR_ON_MASTER int64 = 3001
    ER_INCONSISTENT_ERROR int64 = 3002
    ER_STORAGE_ENGINE_NOT_LOADED int64 = 3003
    ER_GET_STACKED_DA_WITHOUT_ACTIVE_HANDLER int64 = 3004
    ER_WARN_LEGACY_SYNTAX_CONVERTED int64 = 3005
    ER_BINLOG_UNSAFE_FULLTEXT_PLUGIN int64 = 3006
    ER_CANNOT_DISCARD_TEMPORARY_TABLE int64 = 3007
    ER_FK_DEPTH_EXCEEDED int64 = 3008
    ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2 int64 = 3009
    ER_WARN_TRIGGER_DOESNT_HAVE_CREATED int64 = 3010
    ER_REFERENCED_TRG_DOES_NOT_EXIST int64 = 3011
    ER_EXPLAIN_NOT_SUPPORTED int64 = 3012
    ER_INVALID_FIELD_SIZE int64 = 3013
    ER_MISSING_HA_CREATE_OPTION int64 = 3014
    ER_ENGINE_OUT_OF_MEMORY int64 = 3015
    ER_PASSWORD_EXPIRE_ANONYMOUS_USER int64 = 3016
    ER_SLAVE_SQL_THREAD_MUST_STOP int64 = 3017
    ER_NO_FT_MATERIALIZED_SUBQUERY int64 = 3018
    ER_INNODB_UNDO_LOG_FULL int64 = 3019
    ER_INVALID_ARGUMENT_FOR_LOGARITHM int64 = 3020
    ER_SLAVE_CHANNEL_IO_THREAD_MUST_STOP int64 = 3021
    ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZERO int64 = 3022
    ER_WARN_ONLY_MASTER_LOG_FILE_NO_POS int64 = 3023
    ER_QUERY_TIMEOUT int64 = 3024
    ER_NON_RO_SELECT_DISABLE_TIMER int64 = 3025
    ER_DUP_LIST_ENTRY int64 = 3026
    ER_SQL_MODE_NO_EFFECT int64 = 3027
    ER_AGGREGATE_ORDER_FOR_UNION int64 = 3028
    ER_AGGREGATE_ORDER_NON_AGG_QUERY int64 = 3029
    ER_SLAVE_WORKER_STOPPED_PREVIOUS_THD_ERROR int64 = 3030
    ER_DONT_SUPPORT_SLAVE_PRESERVE_COMMIT_ORDER int64 = 3031
    ER_SERVER_OFFLINE_MODE int64 = 3032
    ER_GIS_DIFFERENT_SRIDS int64 = 3033
    ER_GIS_UNSUPPORTED_ARGUMENT int64 = 3034
    ER_GIS_UNKNOWN_ERROR int64 = 3035
    ER_GIS_UNKNOWN_EXCEPTION int64 = 3036
    ER_GIS_INVALID_DATA int64 = 3037
    ER_BOOST_GEOMETRY_EMPTY_INPUT_EXCEPTION int64 = 3038
    ER_BOOST_GEOMETRY_CENTROID_EXCEPTION int64 = 3039
    ER_BOOST_GEOMETRY_OVERLAY_INVALID_INPUT_EXCEPTION int64 = 3040
    ER_BOOST_GEOMETRY_TURN_INFO_EXCEPTION int64 = 3041
    ER_BOOST_GEOMETRY_SELF_INTERSECTION_POINT_EXCEPTION int64 = 3042
    ER_BOOST_GEOMETRY_UNKNOWN_EXCEPTION int64 = 3043
    ER_STD_BAD_ALLOC_ERROR int64 = 3044
    ER_STD_DOMAIN_ERROR int64 = 3045
    ER_STD_LENGTH_ERROR int64 = 3046
    ER_STD_INVALID_ARGUMENT int64 = 3047
    ER_STD_OUT_OF_RANGE_ERROR int64 = 3048
    ER_STD_OVERFLOW_ERROR int64 = 3049
    ER_STD_RANGE_ERROR int64 = 3050
    ER_STD_UNDERFLOW_ERROR int64 = 3051
    ER_STD_LOGIC_ERROR int64 = 3052
    ER_STD_RUNTIME_ERROR int64 = 3053
    ER_STD_UNKNOWN_EXCEPTION int64 = 3054
    ER_GIS_DATA_WRONG_ENDIANESS int64 = 3055
    ER_CHANGE_MASTER_PASSWORD_LENGTH int64 = 3056
    ER_USER_LOCK_WRONG_NAME int64 = 3057
    ER_USER_LOCK_DEADLOCK int64 = 3058
    ER_REPLACE_INACCESSIBLE_ROWS int64 = 3059
    ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_GIS int64 = 3060
    ER_ILLEGAL_USER_VAR int64 = 3061
    ER_GTID_MODE_OFF int64 = 3062
    ER_UNSUPPORTED_BY_REPLICATION_THREAD int64 = 3063
    ER_INCORRECT_TYPE int64 = 3064
    ER_FIELD_IN_ORDER_NOT_SELECT int64 = 3065
    ER_AGGREGATE_IN_ORDER_NOT_SELECT int64 = 3066
    ER_INVALID_RPL_WILD_TABLE_FILTER_PATTERN int64 = 3067
    ER_NET_OK_PACKET_TOO_LARGE int64 = 3068
    ER_INVALID_JSON_DATA int64 = 3069
    ER_INVALID_GEOJSON_MISSING_MEMBER int64 = 3070
    ER_INVALID_GEOJSON_WRONG_TYPE int64 = 3071
    ER_INVALID_GEOJSON_UNSPECIFIED int64 = 3072
    ER_DIMENSION_UNSUPPORTED int64 = 3073
    ER_SLAVE_CHANNEL_DOES_NOT_EXIST int64 = 3074
    ER_SLAVE_MULTIPLE_CHANNELS_HOST_PORT int64 = 3075
    ER_SLAVE_CHANNEL_NAME_INVALID_OR_TOO_LONG int64 = 3076
    ER_SLAVE_NEW_CHANNEL_WRONG_REPOSITORY int64 = 3077
    ER_SLAVE_CHANNEL_DELETE int64 = 3078
    ER_SLAVE_MULTIPLE_CHANNELS_CMD int64 = 3079
    ER_SLAVE_MAX_CHANNELS_EXCEEDED int64 = 3080
    ER_SLAVE_CHANNEL_MUST_STOP int64 = 3081
    ER_SLAVE_CHANNEL_NOT_RUNNING int64 = 3082
    ER_SLAVE_CHANNEL_WAS_RUNNING int64 = 3083
    ER_SLAVE_CHANNEL_WAS_NOT_RUNNING int64 = 3084
    ER_SLAVE_CHANNEL_SQL_THREAD_MUST_STOP int64 = 3085
    ER_SLAVE_CHANNEL_SQL_SKIP_COUNTER int64 = 3086
    ER_WRONG_FIELD_WITH_GROUP_V2 int64 = 3087
    ER_MIX_OF_GROUP_FUNC_AND_FIELDS_V2 int64 = 3088
    ER_WARN_DEPRECATED_SYSVAR_UPDATE int64 = 3089
    ER_WARN_DEPRECATED_SQLMODE int64 = 3090
    ER_CANNOT_LOG_PARTIAL_DROP_DATABASE_WITH_GTID int64 = 3091
    ER_GROUP_REPLICATION_CONFIGURATION int64 = 3092
    ER_GROUP_REPLICATION_RUNNING int64 = 3093
    ER_GROUP_REPLICATION_APPLIER_INIT_ERROR int64 = 3094
    ER_GROUP_REPLICATION_STOP_APPLIER_THREAD_TIMEOUT int64 = 3095
    ER_GROUP_REPLICATION_COMMUNICATION_LAYER_SESSION_ERROR int64 = 3096
    ER_GROUP_REPLICATION_COMMUNICATION_LAYER_JOIN_ERROR int64 = 3097
    ER_BEFORE_DML_VALIDATION_ERROR int64 = 3098
    ER_PREVENTS_VARIABLE_WITHOUT_RBR int64 = 3099
    ER_RUN_HOOK_ERROR int64 = 3100
    ER_TRANSACTION_ROLLBACK_DURING_COMMIT int64 = 3101
    ER_GENERATED_COLUMN_FUNCTION_IS_NOT_ALLOWED int64 = 3102
    ER_UNSUPPORTED_ALTER_INPLACE_ON_VIRTUAL_COLUMN int64 = 3103
    ER_WRONG_FK_OPTION_FOR_GENERATED_COLUMN int64 = 3104
    ER_NON_DEFAULT_VALUE_FOR_GENERATED_COLUMN int64 = 3105
    ER_UNSUPPORTED_ACTION_ON_GENERATED_COLUMN int64 = 3106
    ER_GENERATED_COLUMN_NON_PRIOR int64 = 3107
    ER_DEPENDENT_BY_GENERATED_COLUMN int64 = 3108
    ER_GENERATED_COLUMN_REF_AUTO_INC int64 = 3109
    ER_FEATURE_NOT_AVAILABLE int64 = 3110
    ER_CANT_SET_GTID_MODE int64 = 3111
    ER_CANT_USE_AUTO_POSITION_WITH_GTID_MODE_OFF int64 = 3112
    ER_CANT_REPLICATE_ANONYMOUS_WITH_AUTO_POSITION int64 = 3113
    ER_CANT_REPLICATE_ANONYMOUS_WITH_GTID_MODE_ON int64 = 3114
    ER_CANT_REPLICATE_GTID_WITH_GTID_MODE_OFF int64 = 3115
    ER_CANT_SET_ENFORCE_GTID_CONSISTENCY_ON_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONS int64 = 3116
    ER_SET_ENFORCE_GTID_CONSISTENCY_WARN_WITH_ONGOING_GTID_VIOLATING_TRANSACTIONS int64 = 3117
    ER_ACCOUNT_HAS_BEEN_LOCKED int64 = 3118
    ER_WRONG_TABLESPACE_NAME int64 = 3119
    ER_TABLESPACE_IS_NOT_EMPTY int64 = 3120
    ER_WRONG_FILE_NAME int64 = 3121
    ER_BOOST_GEOMETRY_INCONSISTENT_TURNS_EXCEPTION int64 = 3122
    ER_WARN_OPTIMIZER_HINT_SYNTAX_ERROR int64 = 3123
    ER_WARN_BAD_MAX_EXECUTION_TIME int64 = 3124
    ER_WARN_UNSUPPORTED_MAX_EXECUTION_TIME int64 = 3125
    ER_WARN_CONFLICTING_HINT int64 = 3126
    ER_WARN_UNKNOWN_QB_NAME int64 = 3127
    ER_UNRESOLVED_HINT_NAME int64 = 3128
    ER_WARN_ON_MODIFYING_GTID_EXECUTED_TABLE int64 = 3129
    ER_PLUGGABLE_PROTOCOL_COMMAND_NOT_SUPPORTED int64 = 3130
    ER_LOCKING_SERVICE_WRONG_NAME int64 = 3131
    ER_LOCKING_SERVICE_DEADLOCK int64 = 3132
    ER_LOCKING_SERVICE_TIMEOUT int64 = 3133
    ER_GIS_MAX_POINTS_IN_GEOMETRY_OVERFLOWED int64 = 3134
    ER_SQL_MODE_MERGED int64 = 3135
    ER_VTOKEN_PLUGIN_TOKEN_MISMATCH int64 = 3136
    ER_VTOKEN_PLUGIN_TOKEN_NOT_FOUND int64 = 3137
    ER_CANT_SET_VARIABLE_WHEN_OWNING_GTID int64 = 3138
    ER_SLAVE_CHANNEL_OPERATION_NOT_ALLOWED int64 = 3139
    ER_INVALID_JSON_TEXT int64 = 3140
    ER_INVALID_JSON_TEXT_IN_PARAM int64 = 3141
    ER_INVALID_JSON_BINARY_DATA int64 = 3142
    ER_INVALID_JSON_PATH int64 = 3143
    ER_INVALID_JSON_CHARSET int64 = 3144
    ER_INVALID_JSON_CHARSET_IN_FUNCTION int64 = 3145
    ER_INVALID_TYPE_FOR_JSON int64 = 3146
    ER_INVALID_CAST_TO_JSON int64 = 3147
    ER_INVALID_JSON_PATH_CHARSET int64 = 3148
    ER_INVALID_JSON_PATH_WILDCARD int64 = 3149
    ER_JSON_VALUE_TOO_BIG int64 = 3150
    ER_JSON_KEY_TOO_BIG int64 = 3151
    ER_JSON_USED_AS_KEY int64 = 3152
    ER_JSON_VACUOUS_PATH int64 = 3153
    ER_JSON_BAD_ONE_OR_ALL_ARG int64 = 3154
    ER_NUMERIC_JSON_VALUE_OUT_OF_RANGE int64 = 3155
    ER_INVALID_JSON_VALUE_FOR_CAST int64 = 3156
    ER_JSON_DOCUMENT_TOO_DEEP int64 = 3157
    ER_JSON_DOCUMENT_NULL_KEY int64 = 3158
    ER_SECURE_TRANSPORT_REQUIRED int64 = 3159
    ER_NO_SECURE_TRANSPORTS_CONFIGURED int64 = 3160
    ER_DISABLED_STORAGE_ENGINE int64 = 3161
    ER_USER_DOES_NOT_EXIST int64 = 3162
    ER_USER_ALREADY_EXISTS int64 = 3163
    ER_AUDIT_API_ABORT int64 = 3164
    ER_INVALID_JSON_PATH_ARRAY_CELL int64 = 3165
    ER_BUFPOOL_RESIZE_INPROGRESS int64 = 3166
    ER_FEATURE_DISABLED_SEE_DOC int64 = 3167
    ER_SERVER_ISNT_AVAILABLE int64 = 3168
    ER_SESSION_WAS_KILLED int64 = 3169
    ER_CAPACITY_EXCEEDED int64 = 3170
    ER_CAPACITY_EXCEEDED_IN_RANGE_OPTIMIZER int64 = 3171
    ER_TABLE_NEEDS_UPG_PART int64 = 3172
    ER_CANT_WAIT_FOR_EXECUTED_GTID_SET_WHILE_OWNING_A_GTID int64 = 3173
    ER_CANNOT_ADD_FOREIGN_BASE_COL_VIRTUAL int64 = 3174
    ER_CANNOT_CREATE_VIRTUAL_INDEX_CONSTRAINT int64 = 3175
    ER_ERROR_ON_MODIFYING_GTID_EXECUTED_TABLE int64 = 3176
    ER_LOCK_REFUSED_BY_ENGINE int64 = 3177
    ER_UNSUPPORTED_ALTER_ONLINE_ON_VIRTUAL_COLUMN int64 = 3178
    ER_MASTER_KEY_ROTATION_NOT_SUPPORTED_BY_SE int64 = 3179
    ER_MASTER_KEY_ROTATION_ERROR_BY_SE int64 = 3180
    ER_MASTER_KEY_ROTATION_BINLOG_FAILED int64 = 3181
    ER_MASTER_KEY_ROTATION_SE_UNAVAILABLE int64 = 3182
    ER_TABLESPACE_CANNOT_ENCRYPT int64 = 3183
    ER_INVALID_ENCRYPTION_OPTION int64 = 3184
    ER_CANNOT_FIND_KEY_IN_KEYRING int64 = 3185
    ER_CAPACITY_EXCEEDED_IN_PARSER int64 = 3186
    ER_UNSUPPORTED_ALTER_ENCRYPTION_INPLACE int64 = 3187
    ER_KEYRING_UDF_KEYRING_SERVICE_ERROR int64 = 3188
    ER_USER_COLUMN_OLD_LENGTH int64 = 3189
    ER_CANT_RESET_MASTER int64 = 3190
    ER_GROUP_REPLICATION_MAX_GROUP_SIZE int64 = 3191
    ER_CANNOT_ADD_FOREIGN_BASE_COL_STORED int64 = 3192
    ER_TABLE_REFERENCED int64 = 3193
    ER_PARTITION_ENGINE_DEPRECATED_FOR_TABLE int64 = 3194
    ER_WARN_USING_GEOMFROMWKB_TO_SET_SRID_ZERO int64 = 3195
    ER_WARN_USING_GEOMFROMWKB_TO_SET_SRID int64 = 3196
    ER_XA_RETRY int64 = 3197
    ER_KEYRING_AWS_UDF_AWS_KMS_ERROR int64 = 3198
    ER_BINLOG_UNSAFE_XA int64 = 3199
    ER_UDF_ERROR int64 = 3200
    ER_KEYRING_MIGRATION_FAILURE int64 = 3201
    ER_KEYRING_ACCESS_DENIED_ERROR int64 = 3202
    ER_KEYRING_MIGRATION_STATUS int64 = 3203
    ER_PLUGIN_FAILED_TO_OPEN_TABLES int64 = 3204
    ER_PLUGIN_FAILED_TO_OPEN_TABLE int64 = 3205
    ER_AUDIT_LOG_NO_KEYRING_PLUGIN_INSTALLED int64 = 3206
    ER_AUDIT_LOG_ENCRYPTION_PASSWORD_HAS_NOT_BEEN_SET int64 = 3207
    ER_AUDIT_LOG_COULD_NOT_CREATE_AES_KEY int64 = 3208
    ER_AUDIT_LOG_ENCRYPTION_PASSWORD_CANNOT_BE_FETCHED int64 = 3209
    ER_AUDIT_LOG_JSON_FILTERING_NOT_ENABLED int64 = 3210
    ER_AUDIT_LOG_UDF_INSUFFICIENT_PRIVILEGE int64 = 3211
    ER_AUDIT_LOG_SUPER_PRIVILEGE_REQUIRED int64 = 3212
    ER_COULD_NOT_REINITIALIZE_AUDIT_LOG_FILTERS int64 = 3213
    ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_TYPE int64 = 3214
    ER_AUDIT_LOG_UDF_INVALID_ARGUMENT_COUNT int64 = 3215
    ER_AUDIT_LOG_HAS_NOT_BEEN_INSTALLED int64 = 3216
    ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_TYPE int64 = 3217
    ER_AUDIT_LOG_UDF_READ_INVALID_MAX_ARRAY_LENGTH_ARG_VALUE int64 = 3218
    ER_AUDIT_LOG_JSON_FILTER_PARSING_ERROR int64 = 3219
    ER_AUDIT_LOG_JSON_FILTER_NAME_CANNOT_BE_EMPTY int64 = 3220
    ER_AUDIT_LOG_JSON_USER_NAME_CANNOT_BE_EMPTY int64 = 3221
    ER_AUDIT_LOG_JSON_FILTER_DOES_NOT_EXISTS int64 = 3222
    ER_AUDIT_LOG_USER_FIRST_CHARACTER_MUST_BE_ALPHANUMERIC int64 = 3223
    ER_AUDIT_LOG_USER_NAME_INVALID_CHARACTER int64 = 3224
    ER_AUDIT_LOG_HOST_NAME_INVALID_CHARACTER int64 = 3225
    WARN_DEPRECATED_MAXDB_SQL_MODE_FOR_TIMESTAMP int64 = 3226
    ER_XA_REPLICATION_FILTERS int64 = 3227
    ER_CANT_OPEN_ERROR_LOG int64 = 3228
    ER_GROUPING_ON_TIMESTAMP_IN_DST int64 = 3229
    ER_CANT_START_SERVER_NAMED_PIPE int64 = 3230
    ER_WRITE_SET_EXCEEDS_LIMIT int64 = 3231
    ER_DEPRECATED_TLS_VERSION_SESSION int64 = 3232
    ER_WARN_DEPRECATED_TLS_VERSION int64 = 3233
    ER_WARN_WRONG_NATIVE_TABLE_STRUCTURE int64 = 3234
    ER_AES_INVALID_KDF_NAME int64 = 3235
    ER_AES_INVALID_KDF_ITERATIONS int64 = 3236
    WARN_AES_KEY_SIZE int64 = 3237
    ER_AES_INVALID_KDF_OPTION_SIZE int64 = 3238
    ...
    CR_INSECURE_API_ERR int64 = 2062
...
// IsServerErrorBlobCantHaveDefault check mysql error is "BLOB, TEXT, GEOMETRY or JSON column '%s' can't have adefault value" 
...
// IsServerErrorUnused1 check mysql error is "Delayed insert thread couldn't get requested lock fortable %s" 
...
// IsServerErrorUnused3 check mysql error is "INSERT DELAYED can't be used with table '%s' because itis locked with LOCK TABLES" 
...
// IsServerErrorUpdateWithoutKeyInSafeMode check mysql error is "You are using safe update mode and you tried to update atable without a WHERE that uses a KEY column. %s" 
...
// IsServerErrorForeignKeyOnPartitioned check mysql error is "Foreign keys are not yet supported in conjunction withpartitioning" 
...
// IsServerErrorUnused4 check mysql error is "The statement is unsafe because it uses INSERT DELAYED.This is unsafe because the times when rows are inserted cannot bepredicted." 
...
// IsServerErrorCantChangeGtidNextInTransaction check mysql error is "The system variable @@SESSION.GTID_NEXT cannot changeinside a transaction." 
...
// IsServerErrorGnoExhausted check mysql error is "Impossible to generate GTID: the integer componentreached the maximum value. Restart the server with a newserver_uuid." 
...
// IsServerErrorAutoPositionRequiresGtidModeNotOff check mysql error is "CHANGE MASTER TO MASTER_AUTO_POSITION = 1 cannot beexecuted because @@GLOBAL.GTID_MODE = OFF." 
...
// IsServerErrorCantDoImplicitCommitInTrxWhenGtidNextIsSet check mysql error is "Cannot execute statements with implicit commit inside atransaction when @@SESSION.GTID_NEXT == 'UUID:NUMBER'." 
...
// IsServerErrorGtidModeRequiresBinlog check mysql error is "@@GLOBAL.GTID_MODE = ON or ON_PERMISSIVE orOFF_PERMISSIVE requires --log-bin and --log-slave-updates." 
...
// IsServerErrorGtidUnsafeNonTransactionalTable check mysql error is "Statement violates GTID consistency: Updates tonon-transactional tables can only be done in either autocommittedstatements or single-statement transactions, and never in the samestatement as updates to transactional tables." 
...
// IsServerErrorGtidUnsafeCreateDropTemporaryTableInTransaction check mysql error is "Statement violates GTID consistency: CREATE TEMPORARYTABLE and DROP TEMPORARY TABLE can only be executed outsidetransactional context. These statements are also not allowed in afunction or trigger because functions and triggers are alsoconsidered to be multi-statement transactions." 
...
// IsServerErrorGtidModeCanOnlyChangeOneStepAtATime check mysql error is "The value of @@GLOBAL.GTID_MODE can only be changed onestep at a time: OFF <-> OFF_PERMISSIVE <->ON_PERMISSIVE <-> ON. Also note that this value must bestepped up or down simultaneously on all servers. See the Manualfor instructions." 
...
// IsServerErrorMustChangePassword check mysql error is "You must reset your password using ALTER USER statementbefore executing this statement." 
...
// IsServerErrorUnused5 check mysql error is "Cannot delete rows from table which is parent in aforeign key constraint '%s' of table '%s'" 
...
// IsServerErrorUnused6 check mysql error is "Creating unique indexes with IGNORE requires COPYalgorithm to remove duplicate rows" 
...
// IsServerErrorSlaveIoThreadMustStop check mysql error is "This operation cannot be performed with a running slaveio thread" 
...
// IsServerErrorErrorOnMaster check mysql error is "Query partially completed on the master (error on master:%d) and was aborted. There is a chance that your master isinconsistent at this point. If you are sure that your master isok, run this query manually on the slave and then restart theslave with SET GLOBAL SQL_SLAVE_SKIP_COUNTER=1" 
...
// IsServerErrorInconsistentError check mysql error is "Query caused different errors on master and slave. Erroron master: message (format)='%s' error code=%d" 
...
// IsServerErrorBinlogUnsafeFulltextPlugin check mysql error is "Statement is unsafe because it uses a fulltext parserplugin which may not return the same value on the slave." 
...
// IsServerErrorCannotDiscardTemporaryTable check mysql error is "Cannot DISCARD/IMPORT tablespace associated withtemporary table" 
...
// IsServerErrorColCountDoesntMatchPleaseUpdateV2 check mysql error is "Column count of %s.%s is wrong. Expected %d, found %d.Created with MySQL %d, now running %d. Please use mysql_upgrade tofix this error." 
...
// IsServerErrorReferencedTrgDoesNotExist check mysql error is "Referenced trigger '%s' for the given action time andevent type does not exist." 
...
// IsServerErrorExplainNotSupported check mysql error is "EXPLAIN FOR CONNECTION command is supported only forSELECT/UPDATE/INSERT/DELETE/REPLACE" 
...
// IsServerErrorMissingHaCreateOption check mysql error is "Table storage engine '%s' found required create optionmissing" 
...
// IsServerErrorSlaveSqlThreadMustStop check mysql error is "This operation cannot be performed with a running slavesql thread" 
...
// IsServerErrorSlaveChannelIoThreadMustStop check mysql error is "This operation cannot be performed with a running slaveio thread" 
...
// IsServerErrorWarnOpenTempTablesMustBeZero check mysql error is "This operation may not be safe when the slave hastemporary tables. The tables will be kept open until the serverrestarts or until the tables are deleted by any replicated DROPstatement. Suggest to wait until slave_open_temp_tables = 0." 
...
// IsServerErrorWarnOnlyMasterLogFileNoPos check mysql error is "CHANGE MASTER TO with a MASTER_LOG_FILE clause but noMASTER_LOG_POS clause may not be safe. The old position value maynot be valid for the new binary log file." 
...
// IsServerErrorQueryTimeout check mysql error is "Query execution was interrupted, maximum statementexecution time exceeded" 
...
// IsServerErrorSqlModeNoEffect check mysql error is "'%s' mode no longer has any effect. Use STRICT_ALL_TABLESor STRICT_TRANS_TABLES instead." 
...
// IsServerErrorAggregateOrderForUnion check mysql error is "Expression #%u of ORDER BY contains aggregate functionand applies to a UNION" 
...
// IsServerErrorAggregateOrderNonAggQuery check mysql error is "Expression #%u of ORDER BY contains aggregate functionand applies to the result of a non-aggregated query" 
...
// IsServerErrorSlaveWorkerStoppedPreviousThdError check mysql error is "Slave worker has stopped after at least one previousworker encountered an error when slave-preserve-commit-order wasenabled. To preserve commit order, the last transaction executedby this thread has not been committed. When restarting the slaveafter fixing any failed threads, you should fix this worker aswell." 
...
// IsServerErrorGisDifferentSrids check mysql error is "Binary geometry function %s given two geometries ofdifferent srids: %u and %u, which should have been identical." 
...
// IsServerErrorGisUnsupportedArgument check mysql error is "Calling geometry function %s with unsupported types ofarguments." 
...
// IsServerErrorBoostGeometryCentroidException check mysql error is "Unable to calculate centroid because geometry is empty infunction %s." 
...
// IsServerErrorBoostGeometryOverlayInvalidInputException check mysql error is "Geometry overlay calculation error: geometry data isinvalid in function %s." 
...
// IsServerErrorBoostGeometryTurnInfoException check mysql error is "Geometry turn info calculation error: geometry data isinvalid in function %s." 
...
// IsServerErrorBoostGeometrySelfIntersectionPointException check mysql error is "Analysis procedures of intersection points interruptedunexpectedly in function %s." 
...
// IsServerErrorChangeMasterPasswordLength check mysql error is "The password provided for the replication user exceedsthe maximum length of 32 characters" 
...
// IsServerErrorReplaceInaccessibleRows check mysql error is "REPLACE cannot be executed as it requires deleting rowsthat are not in the view" 
...
// IsServerErrorInvalidRplWildTableFilterPattern check mysql error is "Supplied filter list contains a value which is not in therequired format 'db_pattern.table_pattern'" 
...
// IsServerErrorInvalidGeojsonMissingMember check mysql error is "Invalid GeoJSON data provided to function %s: Missingrequired member '%s'" 
...
// IsServerErrorSlaveMultipleChannelsHostPort check mysql error is "A slave channel '%s' already exists for the given hostand port combination." 
...
// IsServerErrorSlaveChannelNameInvalidOrTooLong check mysql error is "Couldn't create channel: Channel name is either invalidor too long." 
...
// IsServerErrorSlaveNewChannelWrongRepository check mysql error is "To have multiple channels, repository cannot be of typeFILE" 
...
// IsServerErrorSlaveMultipleChannelsCmd check mysql error is "Multiple channels exist on the slave. Please providechannel name as an argument." 
...
// IsServerErrorSlaveChannelMustStop check mysql error is "This operation cannot be performed with runningreplication threads" 
...
// IsServerErrorSlaveChannelWasRunning check mysql error is "Replication thread(s) for channel '%s' are alreadyrunnning." 
...
// IsServerErrorSlaveChannelWasNotRunning check mysql error is "Replication thread(s) for channel '%s' are alreadystopped." 
...
// IsServerErrorSlaveChannelSqlThreadMustStop check mysql error is "This operation cannot be performed with a running slavesql thread" 
...
// IsServerErrorSlaveChannelSqlSkipCounter check mysql error is "When sql_slave_skip_counter > 0, it is not allowed tostart more than one SQL thread by using 'START SLAVE[SQL_THREAD]'. Value of sql_slave_skip_counter can only be used byone SQL thread at a time. Please use 'START SLAVE [SQL_THREAD] FORCHANNEL' to start the SQL thread which will use the value ofsql_slave_skip_counter." 
...
// IsServerErrorWrongFieldWithGroupV2 check mysql error is "Expression #%u of %s is not in GROUP BY clause andcontains nonaggregated column '%s' which is not functionallydependent on columns in GROUP BY clause" 
...
// IsServerErrorWarnDeprecatedSysvarUpdate check mysql error is "Updating '%s' is deprecated. It will be made read-only ina future release." 
...
// IsServerErrorWarnDeprecatedSqlmode check mysql error is "Changing sql mode '%s' is deprecated. It will be removedin a future release." 
...
// IsServerErrorGroupReplicationConfiguration check mysql error is "The server is not configured properly to be an activemember of the group. Please see more details on error log." 
...
// IsServerErrorGroupReplicationRunning check mysql error is "The START GROUP_REPLICATION command failed since thegroup is already running." 
...
// IsServerErrorGroupReplicationApplierInitError check mysql error is "The START GROUP_REPLICATION command failed as the appliermodule failed to start." 
...
// IsServerErrorGroupReplicationStopApplierThreadTimeout check mysql error is "The STOP GROUP_REPLICATION command execution isincomplete: The applier thread got the stop signal while it wasbusy. The applier thread will stop once the current task iscomplete." 
...
// IsServerErrorGroupReplicationCommunicationLayerSessionError check mysql error is "The START GROUP_REPLICATION command failed as there wasan error when initializing the group communication layer." 
...
// IsServerErrorGroupReplicationCommunicationLayerJoinError check mysql error is "The START GROUP_REPLICATION command failed as there wasan error when joining the communication group." 
...
// IsServerErrorBeforeDmlValidationError check mysql error is "The table does not comply with the requirements by anexternal plugin." 
...
// IsServerErrorPreventsVariableWithoutRbr check mysql error is "Cannot change the value of variable %s without binary logformat as ROW." 
...
// IsServerErrorTransactionRollbackDuringCommit check mysql error is "Plugin instructed the server to rollback the currenttransaction." 
...
// IsServerErrorGeneratedColumnFunctionIsNotAllowed check mysql error is "Expression of generated column '%s' contains a disallowedfunction." 
...
// IsServerErrorUnsupportedAlterInplaceOnVirtualColumn check mysql error is "INPLACE ADD or DROP of virtual columns cannot be combinedwith other ALTER TABLE actions" 
...
// IsServerErrorWrongFkOptionForGeneratedColumn check mysql error is "Cannot define foreign key with %s clause on a generatedcolumn." 
...
// IsServerErrorGeneratedColumnNonPrior check mysql error is "Generated column can refer only to generated columnsdefined prior to it." 
...
// IsServerErrorGeneratedColumnRefAutoInc check mysql error is "Generated column '%s' cannot refer to auto-incrementcolumn." 
...
// IsServerErrorCantUseAutoPositionWithGtidModeOff check mysql error is "The replication receiver thread%s cannot start inAUTO_POSITION mode: this server uses @@GLOBAL.GTID_MODE = OFF." 
...
// IsServerErrorCantSetEnforceGtidConsistencyOnWithOngoingGtidViolatingTransactions check mysql error is "Cannot set ENFORCE_GTID_CONSISTENCY = ON because thereare ongoing transactions that violate GTID consistency." 
...
// IsServerErrorSetEnforceGtidConsistencyWarnWithOngoingGtidViolatingTransactions check mysql error is "There are ongoing transactions that violate GTIDconsistency." 
...
// IsServerErrorWarnUnsupportedMaxExecutionTime check mysql error is "MAX_EXECUTION_TIME hint is supported by top-levelstandalone SELECT statements only" 
...
// IsServerErrorWarnOnModifyingGtidExecutedTable check mysql error is "Please do not modify the %s table. This is a mysqlinternal system table to store GTIDs for committed transactions.Modifying it can lead to an inconsistent GTID state." 
...
// IsServerErrorGisMaxPointsInGeometryOverflowed check mysql error is "Parameter %s exceeds the maximum number of points in ageometry (%lu) in function %s." 
...
// IsServerErrorSqlModeMerged check mysql error is "'NO_ZERO_DATE', 'NO_ZERO_IN_DATE' and'ERROR_FOR_DIVISION_BY_ZERO' sql modes should be used with strictmode. They will be merged with strict mode in a future release." 
...
// IsServerErrorCantSetVariableWhenOwningGtid check mysql error is "Variable %s cannot be changed by a client that owns aGTID. The client owns %s. Ownership is released on COMMIT orROLLBACK." 
...
// IsServerErrorInvalidJsonText check mysql error is "Invalid JSON text: "%s" at position %u in value forcolumn '%s'." 
...
// IsServerErrorInvalidJsonTextInParam check mysql error is "Invalid JSON text in argument %u to function %s: "%s" atposition %u.%s" 
...
// IsServerErrorInvalidJsonPath check mysql error is "Invalid JSON path expression. The error is aroundcharacter position %u.%s" 
...
// IsServerErrorInvalidJsonCharset check mysql error is "Cannot create a JSON value from a string with CHARACTERSET '%s'." 
...
// IsServerErrorInvalidTypeForJson check mysql error is "Invalid data type for JSON data in argument %u tofunction %s" 
...
// IsServerErrorInvalidJsonPathCharset check mysql error is "A path expression must be encoded in the utf8 characterset. The path expression '%s' is encoded in character set '%s'." 
...
// IsServerErrorNumericJsonValueOutOfRange check mysql error is "Out of range JSON value for CAST to %s%s from column %sat row %ld" 
...
// IsServerErrorNoSecureTransportsConfigured check mysql error is "No secure transports (SSL or Shared Memory) areconfigured, unable to set --require_secure_transport=ON." 
...
// IsServerErrorDisabledStorageEngine check mysql error is "Storage engine %s is disabled (Table creation isdisallowed)." 
...
// IsServerErrorTableNeedsUpgPart check mysql error is "Partitioning upgrade required. Please dump/reload to fixit or do: ALTER TABLE `%s`.`%s` UPGRADE PARTITIONING" 
...
// IsServerErrorCannotAddForeignBaseColVirtual check mysql error is "Cannot add foreign key on the base column of indexedvirtual column." 
...
// IsServerErrorCannotCreateVirtualIndexConstraint check mysql error is "Cannot create index on virtual column whose base columnhas foreign constraint." 
...
// IsServerErrorErrorOnModifyingGtidExecutedTable check mysql error is "Please do not modify the %s table with an XA transaction.This is an internal system table used to store GTIDs for committedtransactions. Although modifying it can lead to an inconsistentGTID state, if neccessary you can modify it with a non-XAtransaction." 
...
// IsServerErrorMasterKeyRotationBinlogFailed check mysql error is "Write to binlog failed. However, master key rotation hasbeen completed successfully." 
...
// IsServerErrorCannotFindKeyInKeyring check mysql error is "Can't find master key from keyring, please check in theserver log if a keyring plugin is loaded and initializedsuccessfully." 
...
// IsServerErrorKeyringUdfKeyringServiceError check mysql error is "Function '%s' failed because underlying keyring servicereturned an error. Please check if a keyring plugin is installedand that provided arguments are valid for the keyring you areusing." 
...
// IsServerErrorUserColumnOldLength check mysql error is "It seems that your db schema is old. The %s column is 77characters long and should be 93 characters long. Please runmysql_upgrade." 
...
// IsServerErrorGroupReplicationMaxGroupSize check mysql error is "The START GROUP_REPLICATION command failed since thegroup already has 9 members." 
...
// IsServerErrorCannotAddForeignBaseColStored check mysql error is "Cannot add foreign key on the base column of storedcolumn." 
...
// IsServerErrorTableReferenced check mysql error is "Cannot complete the operation because table is referencedby another connection." 
...
// IsServerErrorPartitionEngineDeprecatedForTable check mysql error is "The partition engine, used by table '%s.%s', isdeprecated and will be removed in a future release. Please usenative partitioning instead." 
...
// IsServerErrorWarnUsingGeomfromwkbToSetSridZero check mysql error is "%s(geometry) is deprecated and will be replaced byst_srid(geometry, 0) in a future version. Use%s(st_aswkb(geometry), 0) instead." 
...
// IsServerErrorWarnUsingGeomfromwkbToSetSrid check mysql error is "%s(geometry, srid) is deprecated and will be replaced byst_srid(geometry, srid) in a future version. Use%s(st_aswkb(geometry), srid) instead." 
...
// IsServerErrorXaRetry check mysql error is "The resource manager is not able to commit thetransaction branch at this time. Please retry later." 
...
// IsServerErrorBinlogUnsafeXa check mysql error is "Statement is unsafe because it is being used inside a XAtransaction. Concurrent XA transactions may deadlock on slaveswhen replicated using statements." 
...
// IsServerErrorAuditLogCouldNotCreateAesKey check mysql error is "Could not create AES key. OpenSSL's EVP_BytesToKeyfunction failed." 
...
// IsServerErrorAuditLogEncryptionPasswordCannotBeFetched check mysql error is "Audit log encryption password cannot be fetched from thekeyring. Password used so far is used for encryption." 
...
// IsServerErrorAuditLogUdfInsufficientPrivilege check mysql error is "Request ignored for '%s'@'%s'. SUPER_ACL needed toperform operation" 
...
// IsServerErrorAuditLogHasNotBeenInstalled check mysql error is "audit_log plugin has not been installed using INSTALLPLUGIN syntax." 
...
// IsWarnDeprecatedMaxdbSqlModeForTimestamp check mysql error is "With the MAXDB SQL mode enabled, TIMESTAMP is identicalwith DATETIME. The MAXDB SQL mode is deprecated and will beremoved in a future release. Please disable the MAXDB SQL mode anduse DATETIME instead." 
...
// IsServerErrorXaReplicationFilters check mysql error is "The use of replication filters with XA transactions isnot supported, and can lead to an undefined state in thereplication slave." 
...
// IsServerErrorGroupingOnTimestampInDst check mysql error is "Grouping on temporal is non-deterministic for timezoneshaving DST. Please consider switching to UTC for this query." 
...
// IsServerErrorWriteSetExceedsLimit check mysql error is "The size of writeset data for the current transactionexceeds a limit imposed by an external component. If using GroupReplication check 'group_replication_transaction_size_limit'." 
func IsServerErrorWriteSetExceedsLimit(err error) bool {
    result := Isa(err, ER_WRITE_SET_EXCEEDS_LIMIT)
    return result
}

    
// IsServerErrorDeprecatedTlsVersionSession check mysql error is "Accepted a connection with deprecated protocol '%s' foraccount `%s`@`%s` from host `%s`. Client supplied username `%s`" 
func IsServerErrorDeprecatedTlsVersionSession(err error) bool {
    result := Isa(err, ER_DEPRECATED_TLS_VERSION_SESSION)
    return result
}

    
// IsServerErrorWarnDeprecatedTlsVersion check mysql error is "A deprecated TLS version %s is enabled. Please useTLSv1.2 or higher." 
func IsServerErrorWarnDeprecatedTlsVersion(err error) bool {
    result := Isa(err, ER_WARN_DEPRECATED_TLS_VERSION)
    return result
}

    
// IsServerErrorWarnWrongNativeTableStructure check mysql error is "Optional native table '%s'.'%s' has the wrong structureor is missing." 
func IsServerErrorWarnWrongNativeTableStructure(err error) bool {
    result := Isa(err, ER_WARN_WRONG_NATIVE_TABLE_STRUCTURE)
    return result
}

    
// IsServerErrorAesInvalidKdfName check mysql error is "KDF method name is not valid. Please use hkdf orpbkdf2_hmac method name" 
func IsServerErrorAesInvalidKdfName(err error) bool {
    result := Isa(err, ER_AES_INVALID_KDF_NAME)
    return result
}

    
// IsServerErrorAesInvalidKdfIterations check mysql error is "For KDF method pbkdf2_hmac iterations value less than1000 or more than 65535 is not allowed due to security reasons.Please provide iterations >= 1000 and iterations < 65535" 
func IsServerErrorAesInvalidKdfIterations(err error) bool {
    result := Isa(err, ER_AES_INVALID_KDF_ITERATIONS)
    return result
}

    
// IsWarnAesKeySize check mysql error is "AES key size should be %d bytes length or secure KDFmethods hkdf or pbkdf2_hmac should be used, please provide exactAES key size or use KDF methods for better security." 
func IsWarnAesKeySize(err error) bool {
    result := Isa(err, WARN_AES_KEY_SIZE)
    return result
}

    
// IsServerErrorAesInvalidKdfOptionSize check mysql error is "KDF option size is invalid, please provide valid size< %d bytes and not NULL" 
func IsServerErrorAesInvalidKdfOptionSize(err error) bool {
    result := Isa(err, ER_AES_INVALID_KDF_OPTION_SIZE)
    return result
}
...
// IsClientErrorUnused1 check mysql error is "Connection using old (pre-4.1.1) authentication protocolrefused (client option 'secure_auth' enabled)" 
